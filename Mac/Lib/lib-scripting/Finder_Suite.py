...
class information_window(aetools.ComponentItem):
	"""information window - An information window (opened by ≥Get Infoä≤)"""
	want = 'iwnd'
...
class warn_before_emptying(aetools.NProperty):
	"""warn before emptying - Is a dialog displayed when ≥Empty trashä≤ is selected?"""
	which = 'warn'
	want = 'bool'
...
class sharing_window(aetools.ComponentItem):
	"""sharing window - A sharing window (opened by ≥Sharingä≤)"""
	want = 'swnd'
...
class trash_2d_object(aetools.ComponentItem):
	...
	want = 'ctrs'
# repeated property warn_before_emptying Is a dialog displayed when ≥Empty trashä≤ is selected?
#        element 'dsut' as ['indx', 'name']
#        element 'alia' as ['indx', 'name']
#        element 'appf' as ['indx', 'name']
#        element 'ctnr' as ['indx', 'name']
