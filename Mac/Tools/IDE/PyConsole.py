...
class PyConsole(W.Window):
	...
	def makenamespacemenu(self, *args):
		...
		self.namespacemenu.set([("Clear window", self.clearbuffer), ("Font settingsä", self.dofontsettings), 
				["Namespace"] + namespacelist, ("Browse namespaceä", self.browsenamespace)])
...
class PyOutput:
	...
	def setupwidgets(self):
		...
		menuitems = [("Clear window", self.clearbuffer), ("Font settingsä", self.dofontsettings)]
