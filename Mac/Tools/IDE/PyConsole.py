...
class PyConsole(W.Window):
	...
	def makenamespacemenu(self, *args):
		...
		self.namespacemenu.set([("Clear window", self.clearbuffer), ("Font settings…", self.dofontsettings), 
				["Namespace"] + namespacelist, ("Browse namespace…", self.browsenamespace)])
...
class PyOutput:
	...
	def setupwidgets(self):
		...
		menuitems = [("Clear window", self.clearbuffer), ("Font settings…", self.dofontsettings)]
