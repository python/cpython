...
our %target = (
  ...
  cpuid_obj => "mem_clr.o",
  defines => [ "OPENSSL_SYS_WIN32", "WIN32_LEAN_AND_MEAN", "UNICODE", "_UNICODE", "_CRT_SECURE_NO_DEPRECATE", "_WINSOCK_DEPRECATED_NO_WARNINGS", "_ARM_WINAPI_PARTITION_DESKTOP_SDK_AVAILABLE", "OPENSSL_SYS_WIN_CORE" ],
  ...
  ldoutflag => "/out:",
  lflags => "/NODEFAULTLIB:kernel32.lib",
...
our %unified_info = (
    ...
    "sharednames" =>
        {
            "libcrypto" => "libcrypto-1_1-arm",
            "libssl" => "libssl-1_1-arm",
        },
    "sources" =>
        {
            "apps\\CA.pl" =>
