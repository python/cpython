...
# The runtime expects some modules to always be imported frozen,
# even if the .py files are available.
USE_FROZEN_ONLY = {
    # These frozen modules are necessary for bootstrapping the import
    # system and the name of their frozen modules is different than
    # their source modules..
    'importlib._bootstrap',
    'importlib._bootstrap_external',
    # Some Python builds rely on a builtin zip file instead of a filesystem.
    'zipimport',
}
REQUIRED = USE_FROZEN_ONLY
