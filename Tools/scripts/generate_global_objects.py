...
def generate_global_strings(identifiers):
...
def generate_runtime_init(identifiers):
...
def main(*, check=False) -> None:
    identifiers = {name
                   for name, _, _ in iter_identifiers()
                   if name not in IGNORED}
    identifiers.update(IDENTIFIERS)

    generate_global_strings(identifiers)
    generate_runtime_init(identifiers)
