...
from .utils import (
    fail, warn, ClinicError,  VersionTuple, unknown,
    Sentinels,
    is_legal_py_identifier, is_legal_c_identifier,
    _text_accumulator,
)
from .parameter import Parameter
from .function import (
    Function, Class, Module,
    FunctionKind, METHOD_NEW, CLASS_METHOD,
    CALLABLE, METHOD_INIT, GETTER, SETTER, STATIC_METHOD,
)
from .converter import converters, ConverterArgs, legacy_converters
from .converters import NULL, Null, correct_name_for_self
...
class PythonParser:
    ...
    def parse(self, block: Block) -> None:
        ...
        from . import return_converter
        with contextlib.redirect_stdout(io.StringIO()) as s:
            exec_globals = {
                **vars(converter),
                **vars(converters),
                **vars(return_converter),
            }
            exec(block.input, exec_globals)
