...
from libclinic.converter import CConverter, converters, legacy_converters
from libclinic.return_converter import CReturnConverter, return_converters
from libclinic.int_converters import (
    int_converter,)
from libclinic.obj_converters import (
    object_converter, str_converter, buffer, robuffer, rwbuffer)
from libclinic.misc_converters import (
    defining_class_converter, correct_name_for_self, self_converter)

# Import converters to register them
import libclinic.int_converters
import libclinic.obj_converters
import libclinic.misc_converters
