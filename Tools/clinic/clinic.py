...
class CConverter(metaclass=CConverterAutoRegister):
    ...
    def bad_argument(self, displayname: str, expected: str, *, limited_capi: bool, clinic: Clinic, expected_literal: bool = True) -> str:
    ...
    def parse_arg(self, argname: str, displayname: str,
                  *, limited_capi: bool, clinic: Clinic) -> str | None:
        if self.format_unit == 'O&':
...
class bool_converter(CConverter):
    ...
    def parse_arg(self, argname: str, displayname: str,
        ...
        return super().parse_arg(argname, displayname,
                                 limited_capi=limited_capi, clinic=clinic)
