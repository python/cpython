...
PyAPI_FUNC(void *)_PyJustin_CompileTrace(int size, _Py_CODEUNIT **trace);
...
static const unsigned char CALL_NO_KW_BUILTIN_FAST_stencil_bytes[] = {
    ...
    0x8B, 0x46, 0x5C, 0x85, 0xC0, 0x74, 0x3B, 0x48,
    0x83, 0xC2, 0x08, 0xB8, 0xFD, 0xFF, 0xFF, 0xFF,
    0xEB, 0x15, 0xF7, 0xD8, 0x48, 0x98, 0x49, 0x8D,
    0x0C, 0xC4, 0x48, 0x83, 0xC1, 0xF0, 0x48, 0x83,
    0xC2, 0x02, 0xB8, 0xFE, 0xFF, 0xFF, 0xFF, 0x48,
...
static const unsigned char POP_JUMP_IF_FALSE_stencil_bytes[] = {
    ...
    0x48, 0xB8, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
    0x00, 0x00, 0x48, 0x39, 0xC3, 0x74, 0x7D, 0x48,
    0xB8, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
    0x00, 0x48, 0x39, 0xC3, 0x74, 0x78, 0x48, 0xB8,
    0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
    ...
    0x45, 0x85, 0xF6, 0x78, 0x4F, 0x4C, 0x89, 0xFA,
    0x31, 0xC0, 0x49, 0x89, 0xD7, 0xF6, 0xC1, 0x01,
    0x75, 0x35, 0xEB, 0x45, 0x48, 0x83, 0x00, 0xFF,
    0x49, 0x83, 0xC7, 0x02, 0xEB, 0x18, 0x48, 0x83,
    0x00, 0xFF, 0x48, 0xB8, 0x00, 0x00, 0x00, 0x00,
    0x00, 0x00, 0x00, 0x00, 0x48, 0x98, 0x4D, 0x8D,
    0x3C, 0x47, 0x49, 0x83, 0xC7, 0x02, 0x31, 0xC0,
    0x48, 0xB9, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
    0x00, 0x00, 0x49, 0x39, 0xCF, 0x75, 0x12, 0x48,
    0xB8, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
    0x00, 0x59, 0xFF, 0xE0, 0xB8, 0xFE, 0xFF, 0xFF,
    0xFF, 0x4C, 0x89, 0x7D, 0x38, 0x49, 0x29, 0xEC,
    0x49, 0x83, 0xC4, 0xB8, 0x49, 0xC1, 0xEC, 0x03,
    0x44, 0x89, 0x65, 0x40, 0x59, 0xC3,
};
static const Hole POP_JUMP_IF_FALSE_stencil_holes[] = {
    {.offset =   3, .addend =   0, .kind = HOLE_next_instr},
    {.offset =  26, .addend =   0, .kind = LOAD__Py_TrueStruct},
    {.offset =  41, .addend =   0, .kind = LOAD__Py_FalseStruct},
    {.offset =  56, .addend =   0, .kind = LOAD_PyObject_IsTrue},
    {.offset =  80, .addend =   0, .kind = LOAD__Py_Dealloc},
    {.offset =  95, .addend =   0, .kind = HOLE_oparg},
    {.offset = 115, .addend =   0, .kind = HOLE_next_trace},
    {.offset = 180, .addend =   0, .kind = HOLE_oparg},
    {.offset = 202, .addend =   0, .kind = HOLE_next_trace},
    {.offset = 217, .addend =   0, .kind = HOLE_continue},
};
