...
arg_parser.add_argument(
    ...
    help=f"Generated metadata (changes output default to {DEFAULT_METADATA_OUTPUT})"
)
...
class Instruction:
    ...
    input_registers: list[str] = dataclasses.field(repr=False)  # Parallel to input_effects
    output_registers: list[str] = dataclasses.field(repr=False)  # Etc.
