...
void *_PyPegen_raise_error(Parser *p, PyObject *, int no_col_number, const char *errmsg, ...);
...
#define RAISE_SYNTAX_ERROR_NO_COL_OFFSET(msg, ...) _PyPegen_raise_error(p, PyExc_SyntaxError, 1, msg, ##__VA_ARGS__)
