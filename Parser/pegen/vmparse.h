...
static Rule all_rules[] = {
    ...
    {"if_stmt",
     ...
     {0, -1},
     {
         OP_SAVE_MARK, OP_TOKEN, 500, OP_POS_LOOKAHEAD, OP_TOKEN, 500, OP_NAME, OP_TOKEN, COLON, OP_RULE, R_STMT, OP_RETURN, A_IF_STMT_0,
     },
    },
    {"expr",
     R_EXPR,
...
call_action(Parser *p, Frame *_f, int _iaction)
{
    ...
    case A__GATHER_2_1:
        return _f->vals[0];
    case A_IF_STMT_0:
        return _Py_If ( _f->vals[2] , CHECK ( _PyPegen_singleton_seq ( p , _f->vals[4] ) ) , NULL , EXTRA );
    case A_EXPR_0:
