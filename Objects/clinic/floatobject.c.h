...
float___getformat__(PyTypeObject *type, PyObject *arg)
{
    ...
    if (!PyUnicode_Check(arg)) {
        _PyArg_BadArgument("__getformat__", 0, "argument", "str", arg);
        goto exit;
    }
...
float___set_format__(PyTypeObject *type, PyObject *const *args, Py_ssize_t nargs)
{
    ...
    if (!PyUnicode_Check(args[0])) {
        _PyArg_BadArgument("__set_format__", 1, "argument 1", "str", args[0]);
        goto exit;
    }
    Py_ssize_t typestr_length;
    ...
    if (!PyUnicode_Check(args[1])) {
        _PyArg_BadArgument("__set_format__", 2, "argument 2", "str", args[1]);
        goto exit;
    }
...
/*[clinic end generated code: output=40b435f5108eb792 input=a9049054013a1b77]*/
