...
bytes_partition(PyBytesObject *self, PyObject *arg)
{
    ...
    if (!PyBuffer_IsContiguous(&sep, 'C')) {
        _PyArg_BadArgument("partition", 0, NULL, "contiguous buffer", arg);
        goto exit;
    }
...
bytes_rpartition(PyBytesObject *self, PyObject *arg)
{
    ...
    if (!PyBuffer_IsContiguous(&sep, 'C')) {
        _PyArg_BadArgument("rpartition", 0, NULL, "contiguous buffer", arg);
        goto exit;
    }
...
/*[clinic end generated code: output=852535b3ae0b8cdb input=a9049054013a1b77]*/
