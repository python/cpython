...
bytes_partition(PyBytesObject *self, PyObject *arg)
{
    ...
    if (!PyBuffer_IsContiguous(&sep, 'C')) {
        _PyArg_BadArgument("partition", 0, "argument", "contiguous buffer", arg);
        goto exit;
    }
...
bytes_rpartition(PyBytesObject *self, PyObject *arg)
{
    ...
    if (!PyBuffer_IsContiguous(&sep, 'C')) {
        _PyArg_BadArgument("rpartition", 0, "argument", "contiguous buffer", arg);
        goto exit;
    }
...
/*[clinic end generated code: output=f74ee04e5192e286 input=a9049054013a1b77]*/
