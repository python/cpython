...
"code(argcount, posonlyargcount, kwonlyargcount, nlocals, ntmps, flags,\n"
...
skip_optional:
    return_value = code_new_impl(type, argcount, posonlyargcount, kwonlyargcount, nlocals, ntmps, flags, code, consts, names, varnames, filename, name, firstlineno, linetable, freevars, cellvars);
...
"        co_kwonlyargcount=-1, co_nlocals=-1, co_ntmps=-1, co_flags=-1,\n"
"        co_firstlineno=-1, co_code=None, co_consts=None, co_names=None,\n"
"        co_varnames=None, co_freevars=None, co_cellvars=None,\n"
"        co_filename=None, co_name=None, co_linetable=None)\n"
"--\n"
"\n"
...
{
    PyObject *return_value = NULL;
    static const char * const _keywords[] = {"co_argcount", "co_posonlyargcount", "co_kwonlyargcount", "co_nlocals", "co_ntmps", "co_flags", "co_firstlineno", "co_code", "co_consts", "co_names", "co_varnames", "co_freevars", "co_cellvars", "co_filename", "co_name", "co_linetable", NULL};
...
skip_optional_kwonly:
    return_value = code_replace_impl(self, co_argcount, co_posonlyargcount, co_kwonlyargcount, co_nlocals, co_ntmps, co_flags, co_firstlineno, co_code, co_consts, co_names, co_varnames, co_freevars, co_cellvars, co_filename, co_name, co_linetable);

exit:
    return return_value;
}
/*[clinic end generated code: output=3724e13f693021d7 input=a9049054013a1b77]*/
