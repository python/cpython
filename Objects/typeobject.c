                        ...
                        PyTypeObject **type_p, PyObject **obj_p)
{
    ...
    PyObject *firstarg = PyStackRef_To_PyObject_Borrow(_PyFrame_GetLocalsArray(cframe)[0]);
    ...
    for (; i < co->co_nlocalsplus; i++) {
        ...
        if (_PyUnicode_Equal(name, &_Py_ID(__class__))) {
            PyObject *cell = PyStackRef_To_PyObject_Borrow(_PyFrame_GetLocalsArray(cframe)[i]);
