...
/* Divide long pin, w/ size digits, by non-zero digit n, storing quotient
   ...
   on todays compilers.  It evolved from Mark Dickenson observing that on
   x86_64 a 128:64 divide instruction was always being generated by the
   compiler despite us working with 30-bit digit values.  See the thread
   for full context:
   ...
   Verify that 17 isn't specialized and this works as a useful test:
     python -m timeit -n 1500000 -s 'x = 10**1000; r=x//10; assert r == 10**999, r' 'x//17'
*/
static digit
