...
long_divmod(PyObject *a, PyObject *b)
{
    ...
    z = PyTuple_MakePairSteal((PyObject *) div, (PyObject *) mod);
    return z;
}
...
_PyLong_DivmodNear(PyObject *a, PyObject *b)
{
    ...
    */
    ...
    result = PyTuple_MakePairSteal((PyObject *)quo, (PyObject *)rem);
    return result;
...
/*[clinic end generated code: output=e60803ae1cc8621a input=384ff1766634bec2]*/
{
    ...
    ratio_tuple = PyTuple_MakePair(numerator, _PyLong_GetOne());
    Py_DECREF(numerator);
    return ratio_tuple;
}
