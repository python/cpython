...
list_resize(PyListObject *self, Py_ssize_t newsize)
{
    ...
    */
    ...
    /* can't overflow, largest number is PY_SSIZE_T_MAX * (9 / 8) + 6 */
    ...
    if (newsize == 0)
        new_allocated = 0;
    size = new_allocated * sizeof(PyObject *);
    items = (PyObject **)PyMem_Realloc(self->ob_item, size);
    if (items == NULL) {
        PyErr_NoMemory();
        return -1;
    }
