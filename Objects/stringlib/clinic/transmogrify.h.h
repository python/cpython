...
stringlib_ljust(PyObject *self, PyObject *const *args, Py_ssize_t nargs)
{
    ...
    if (PyBytes_Check(args[1]) && PyBytes_GET_SIZE(args[1]) == 1) {
        ...
        _PyArg_BadArgument("ljust", 2, "argument 2", "a byte string of length 1", args[1]);
        goto exit;
    }
skip_optional:
...
stringlib_rjust(PyObject *self, PyObject *const *args, Py_ssize_t nargs)
{
    ...
    if (PyBytes_Check(args[1]) && PyBytes_GET_SIZE(args[1]) == 1) {
        ...
        _PyArg_BadArgument("rjust", 2, "argument 2", "a byte string of length 1", args[1]);
        goto exit;
    }
skip_optional:
...
stringlib_center(PyObject *self, PyObject *const *args, Py_ssize_t nargs)
{
    ...
    if (PyBytes_Check(args[1]) && PyBytes_GET_SIZE(args[1]) == 1) {
        ...
        _PyArg_BadArgument("center", 2, "argument 2", "a byte string of length 1", args[1]);
        goto exit;
    }
skip_optional:
...
/*[clinic end generated code: output=12ba03626b7614b2 input=a9049054013a1b77]*/
