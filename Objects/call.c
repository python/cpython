                             ...
                             PyObject *kwargs)
{
    ...
    case METH_VARARGS | METH_KEYWORDS:
    {
        ...
        if (flags & METH_KEYWORDS) {
            result = (*(PyCFunctionWithKeywords)(void *)meth) (self, argstuple, kwargs);
        }
        else {
    ...
    case METH_FASTCALL:
    {
        ...
        result = (*(_PyCFunctionFast)(void *)meth) (self, args, nargs);
        break;
    }
    ...
    case METH_FASTCALL | METH_KEYWORDS:
    {
        ...
        PyObject *kwnames;
        _PyCFunctionFastWithKeywords fastmeth = (_PyCFunctionFastWithKeywords)(void *)meth;
                                 ...
                                 PyObject *kwnames)
{
    ...
    case METH_FASTCALL | METH_KEYWORDS:
        ...
        result = ((_PyCFunctionFastWithKeywords)(void *)meth) (self, args, nargs, kwnames);
        break;
    ...
    case METH_VARARGS | METH_KEYWORDS:
    {
        ...
        if (flags & METH_KEYWORDS) {
            ...
            result = (*(PyCFunctionWithKeywords)(void *)meth) (self, argtuple, kwdict);
            Py_XDECREF(kwdict);
        }
        else {
...
cfunction_call_varargs(PyObject *func, PyObject *args, PyObject *kwargs)
{
    ...
    if (PyCFunction_GET_FLAGS(func) & METH_KEYWORDS) {
        ...
        result = (*(PyCFunctionWithKeywords)(void *)meth)(self, args, kwargs);
