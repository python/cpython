...
static void
deepfreezefloat_dealloc(PyObject *self)
{
    /* This should never get called, but we also don't want to SEGV if
     * we accidentally decref DeepFreeze Float out of existence. Instead,
     * since DeepFreeze Float are immortal, re-set the reference count.
     */
     _Py_SetImmortal(self);
}

PyDoc_STRVAR(deepfreezefloat_doc,
"deepfreezefloat is a subclass of float meant to be used by deepfrozen objects.");

PyTypeObject PyDeepFreezeFloat_Type = {
    PyVarObject_HEAD_INIT(&PyType_Type, 0)
    "deepfreezfloat",                           /* tp_name */
    0,                                          /* tp_basicsize */
    0,                                          /* tp_itemsize */
    deepfreezefloat_dealloc,                    /* tp_dealloc */
    0,                                          /* tp_vectorcall_offset */
    0,                                          /* tp_getattr */
    0,                                          /* tp_setattr */
    0,                                          /* tp_as_async */
