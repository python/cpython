...
static void
deepfreezecomplex_dealloc(PyObject *self)
{
    /* This should never get called, but we also don't want to SEGV if
     * we accidentally decref DeepFreeze Complex out of existence. Instead,
     * since DeepFreeze Complex are immortal, re-set the reference count.
     */
     _Py_SetImmortal(self);
}

PyDoc_STRVAR(deepfreezecomplex_doc,
"deepfreezecomplex is a subclass of complex meant to be used by deepfrozen objects.");

PyTypeObject PyDeepFreezeComplex_Type = {
    PyVarObject_HEAD_INIT(&PyType_Type, 0)
    "deepfreezecomplex",                        /* tp_name */
    0,                                          /* tp_basicsize */
    0,                                          /* tp_itemsize */
    deepfreezecomplex_dealloc,                  /* tp_dealloc */
    0,                                          /* tp_vectorcall_offset */
    0,                                          /* tp_getattr */
    0,                                          /* tp_setattr */
    0,                                          /* tp_as_async */
