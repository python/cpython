...
# bpo-5846: getTestCaseNames, makeSuite, and findTestCases are deprecated as
#           of Python 3.11, scheduled for removal in Python 3.13.
def getTestCaseNames(testCaseClass, prefix, sortUsing=util.three_way_cmp, testNamePatterns=None):
    warnings.warn(
        "getTestCaseNames() is deprecated and will be removed in Python 3.13.",
...
def findTestCases(module, prefix='test', sortUsing=util.three_way_cmp,
                  suiteClass=suite.TestSuite):
    warnings.warn(
        "findTestCases() is deprecated and will be removed in Python 3.13. "
