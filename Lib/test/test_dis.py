...
expected_opinfo_jumpy = [
  ...
  Instruction(opname='FOR_ITER', opcode=93, arg=30, argval=88, argrepr='to 88', offset=24, starts_line=None, is_jump_target=True, positions=None),
  ...
  Instruction(opname='UNARY_NOT', opcode=12, arg=None, argval=None, argrepr='', offset=60, starts_line=None, is_jump_target=False, positions=None),
  Instruction(opname='POP_JUMP_IF_TRUE', opcode=115, arg=2, argval=68, argrepr='to 68', offset=62, starts_line=None, is_jump_target=False, positions=None),
  Instruction(opname='JUMP_BACKWARD', opcode=140, arg=22, argval=24, argrepr='to 24', offset=64, starts_line=6, is_jump_target=False, positions=None),
  ...
  Instruction(opname='UNARY_NOT', opcode=12, arg=None, argval=None, argrepr='', offset=76, starts_line=None, is_jump_target=False, positions=None),
  Instruction(opname='POP_JUMP_IF_FALSE', opcode=114, arg=2, argval=84, argrepr='to 84', offset=78, starts_line=None, is_jump_target=False, positions=None),
  Instruction(opname='JUMP_BACKWARD', opcode=140, arg=30, argval=24, argrepr='to 24', offset=80, starts_line=None, is_jump_target=False, positions=None),
  ...
  Instruction(opname='JUMP_FORWARD', opcode=110, arg=12, argval=112, argrepr='to 112', offset=86, starts_line=None, is_jump_target=False, positions=None),
  ...
  Instruction(opname='POP_TOP', opcode=1, arg=None, argval=None, argrepr='', offset=110, starts_line=None, is_jump_target=False, positions=None),
  Instruction(opname='LOAD_FAST_CHECK', opcode=127, arg=0, argval='i', argrepr='i', offset=112, starts_line=11, is_jump_target=True, positions=None),
  Instruction(opname='UNARY_NOT', opcode=12, arg=None, argval=None, argrepr='', offset=114, starts_line=None, is_jump_target=False, positions=None),
  Instruction(opname='POP_JUMP_IF_TRUE', opcode=115, arg=36, argval=190, argrepr='to 190', offset=116, starts_line=None, is_jump_target=False, positions=None),
  ...
  Instruction(opname='CALL', opcode=171, arg=1, argval=1, argrepr='', offset=130, starts_line=None, is_jump_target=False, positions=None),
  ...
  Instruction(opname='LOAD_FAST', opcode=124, arg=0, argval='i', argrepr='i', offset=140, starts_line=13, is_jump_target=False, positions=None),
  Instruction(opname='LOAD_CONST', opcode=100, arg=5, argval=1, argrepr='1', offset=142, starts_line=None, is_jump_target=False, positions=None),
  Instruction(opname='BINARY_OP', opcode=122, arg=23, argval=23, argrepr='-=', offset=144, starts_line=None, is_jump_target=False, positions=None),
  Instruction(opname='STORE_FAST', opcode=125, arg=0, argval='i', argrepr='i', offset=148, starts_line=None, is_jump_target=False, positions=None),
  Instruction(opname='LOAD_FAST', opcode=124, arg=0, argval='i', argrepr='i', offset=150, starts_line=14, is_jump_target=False, positions=None),
  Instruction(opname='LOAD_CONST', opcode=100, arg=3, argval=6, argrepr='6', offset=152, starts_line=None, is_jump_target=False, positions=None),
  Instruction(opname='COMPARE_OP', opcode=107, arg=68, argval='>', argrepr='>', offset=154, starts_line=None, is_jump_target=False, positions=None),
  Instruction(opname='UNARY_NOT', opcode=12, arg=None, argval=None, argrepr='', offset=158, starts_line=None, is_jump_target=False, positions=None),
  Instruction(opname='POP_JUMP_IF_TRUE', opcode=115, arg=2, argval=166, argrepr='to 166', offset=160, starts_line=None, is_jump_target=False, positions=None),
  Instruction(opname='JUMP_BACKWARD', opcode=140, arg=27, argval=112, argrepr='to 112', offset=162, starts_line=15, is_jump_target=False, positions=None),
  ...
  Instruction(opname='UNARY_NOT', opcode=12, arg=None, argval=None, argrepr='', offset=174, starts_line=None, is_jump_target=False, positions=None),
  Instruction(opname='POP_JUMP_IF_TRUE', opcode=115, arg=1, argval=180, argrepr='to 180', offset=176, starts_line=None, is_jump_target=False, positions=None),
  ...
  Instruction(opname='UNARY_NOT', opcode=12, arg=None, argval=None, argrepr='', offset=182, starts_line=None, is_jump_target=False, positions=None),
  Instruction(opname='POP_JUMP_IF_TRUE', opcode=115, arg=2, argval=190, argrepr='to 190', offset=184, starts_line=None, is_jump_target=False, positions=None),
  Instruction(opname='JUMP_BACKWARD', opcode=140, arg=36, argval=118, argrepr='to 118', offset=186, starts_line=None, is_jump_target=False, positions=None),
  Instruction(opname='LOAD_GLOBAL', opcode=116, arg=3, argval='print', argrepr='NULL + print', offset=190, starts_line=19, is_jump_target=True, positions=None),
  ...
  Instruction(opname='LOAD_CONST', opcode=100, arg=8, argval='Never reach this', argrepr="'Never reach this'", offset=240, starts_line=None, is_jump_target=False, positions=None),
  ...
  Instruction(opname='CALL', opcode=171, arg=2, argval=2, argrepr='', offset=258, starts_line=None, is_jump_target=False, positions=None),
  ...
  Instruction(opname='LOAD_GLOBAL', opcode=116, arg=3, argval='print', argrepr='NULL + print', offset=268, starts_line=28, is_jump_target=True, positions=None),
  Instruction(opname='LOAD_CONST', opcode=100, arg=10, argval="OK, now we're done", argrepr='"OK, now we\'re done"', offset=278, starts_line=None, is_jump_target=False, positions=None),
  ...
  Instruction(opname='RETURN_CONST', opcode=121, arg=0, argval=None, argrepr='None', offset=290, starts_line=None, is_jump_target=False, positions=None),
  Instruction(opname='PUSH_EXC_INFO', opcode=35, arg=None, argval=None, argrepr='', offset=292, starts_line=25, is_jump_target=False, positions=None),
  Instruction(opname='WITH_EXCEPT_START', opcode=49, arg=None, argval=None, argrepr='', offset=294, starts_line=None, is_jump_target=False, positions=None),
  Instruction(opname='UNARY_NOT', opcode=12, arg=None, argval=None, argrepr='', offset=296, starts_line=None, is_jump_target=False, positions=None),
  Instruction(opname='POP_JUMP_IF_FALSE', opcode=114, arg=1, argval=302, argrepr='to 302', offset=298, starts_line=None, is_jump_target=False, positions=None),
  Instruction(opname='RERAISE', opcode=119, arg=2, argval=2, argrepr='', offset=300, starts_line=None, is_jump_target=False, positions=None),
  Instruction(opname='POP_TOP', opcode=1, arg=None, argval=None, argrepr='', offset=302, starts_line=None, is_jump_target=True, positions=None),
  ...
  Instruction(opname='JUMP_BACKWARD', opcode=140, arg=23, argval=268, argrepr='to 268', offset=310, starts_line=None, is_jump_target=False, positions=None),
  ...
  Instruction(opname='PUSH_EXC_INFO', opcode=35, arg=None, argval=None, argrepr='', offset=320, starts_line=None, is_jump_target=False, positions=None),
  Instruction(opname='LOAD_GLOBAL', opcode=116, arg=4, argval='ZeroDivisionError', argrepr='ZeroDivisionError', offset=322, starts_line=22, is_jump_target=False, positions=None),
  Instruction(opname='CHECK_EXC_MATCH', opcode=36, arg=None, argval=None, argrepr='', offset=332, starts_line=None, is_jump_target=False, positions=None),
  Instruction(opname='POP_JUMP_IF_FALSE', opcode=114, arg=15, argval=366, argrepr='to 366', offset=334, starts_line=None, is_jump_target=False, positions=None),
  ...
  Instruction(opname='LOAD_GLOBAL', opcode=116, arg=3, argval='print', argrepr='NULL + print', offset=338, starts_line=23, is_jump_target=False, positions=None),
  Instruction(opname='LOAD_CONST', opcode=100, arg=9, argval='Here we go, here we go, here we go...', argrepr="'Here we go, here we go, here we go...'", offset=348, starts_line=None, is_jump_target=False, positions=None),
  ...
  Instruction(opname='POP_EXCEPT', opcode=89, arg=None, argval=None, argrepr='', offset=360, starts_line=None, is_jump_target=False, positions=None),
  Instruction(opname='JUMP_BACKWARD', opcode=140, arg=49, argval=268, argrepr='to 268', offset=362, starts_line=None, is_jump_target=False, positions=None),
  Instruction(opname='RERAISE', opcode=119, arg=0, argval=0, argrepr='', offset=366, starts_line=22, is_jump_target=True, positions=None),
  ...
  Instruction(opname='PUSH_EXC_INFO', opcode=35, arg=None, argval=None, argrepr='', offset=374, starts_line=None, is_jump_target=False, positions=None),
  Instruction(opname='LOAD_GLOBAL', opcode=116, arg=3, argval='print', argrepr='NULL + print', offset=376, starts_line=28, is_jump_target=False, positions=None),
  Instruction(opname='LOAD_CONST', opcode=100, arg=10, argval="OK, now we're done", argrepr='"OK, now we\'re done"', offset=386, starts_line=None, is_jump_target=False, positions=None),
  Instruction(opname='CALL', opcode=171, arg=1, argval=1, argrepr='', offset=388, starts_line=None, is_jump_target=False, positions=None),
  ...
  Instruction(opname='RERAISE', opcode=119, arg=0, argval=0, argrepr='', offset=398, starts_line=None, is_jump_target=False, positions=None),
  Instruction(opname='COPY', opcode=120, arg=3, argval=3, argrepr='', offset=400, starts_line=None, is_jump_target=False, positions=None),
  Instruction(opname='POP_EXCEPT', opcode=89, arg=None, argval=None, argrepr='', offset=402, starts_line=None, is_jump_target=False, positions=None),
  Instruction(opname='RERAISE', opcode=119, arg=1, argval=1, argrepr='', offset=404, starts_line=None, is_jump_target=False, positions=None),
]
