...
expected_opinfo_jumpy = [
  ...
  Instruction(opname='JUMP_FORWARD', opcode=110, arg=36, argval=208, argrepr='to 208', offset=134, starts_line=None, is_jump_target=False, positions=None),
  ...
  Instruction(opname='ROT_THREE', opcode=3, arg=None, argval=None, argrepr='', offset=138, starts_line=None, is_jump_target=False, positions=None),
  Instruction(opname='ROT_THREE', opcode=3, arg=None, argval=None, argrepr='', offset=140, starts_line=None, is_jump_target=False, positions=None),
  ...
  Instruction(opname='JUMP_FORWARD', opcode=110, arg=12, argval=196, argrepr='to 196', offset=170, starts_line=None, is_jump_target=False, positions=None),
  ...
  Instruction(opname='POP_JUMP_IF_TRUE', opcode=115, arg=94, argval=188, argrepr='to 188', offset=176, starts_line=None, is_jump_target=False, positions=None),
  ...
  Instruction(opname='ROT_THREE', opcode=3, arg=None, argval=None, argrepr='', offset=180, starts_line=None, is_jump_target=False, positions=None),
  Instruction(opname='ROT_THREE', opcode=3, arg=None, argval=None, argrepr='', offset=182, starts_line=None, is_jump_target=False, positions=None),
  ...
  Instruction(opname='RERAISE', opcode=119, arg=1, argval=1, argrepr='', offset=186, starts_line=None, is_jump_target=False, positions=None),
  Instruction(opname='POP_TOP', opcode=1, arg=None, argval=None, argrepr='', offset=188, starts_line=None, is_jump_target=True, positions=None),
  ...
  Instruction(opname='POP_TOP', opcode=1, arg=None, argval=None, argrepr='', offset=194, starts_line=None, is_jump_target=False, positions=None),
  Instruction(opname='LOAD_GLOBAL', opcode=116, arg=1, argval='print', argrepr='print', offset=196, starts_line=28, is_jump_target=True, positions=None),
  ...
  Instruction(opname='PUSH_EXC_INFO', opcode=35, arg=None, argval=None, argrepr='', offset=222, starts_line=None, is_jump_target=False, positions=None),
  Instruction(opname='LOAD_GLOBAL', opcode=116, arg=1, argval='print', argrepr='print', offset=224, starts_line=None, is_jump_target=False, positions=None),
  ...
  Instruction(opname='RERAISE', opcode=119, arg=0, argval=0, argrepr='', offset=232, starts_line=None, is_jump_target=False, positions=None),
  Instruction(opname='ROT_THREE', opcode=3, arg=None, argval=None, argrepr='', offset=234, starts_line=None, is_jump_target=False, positions=None),
  Instruction(opname='ROT_THREE', opcode=3, arg=None, argval=None, argrepr='', offset=236, starts_line=None, is_jump_target=False, positions=None),
  Instruction(opname='POP_EXCEPT', opcode=89, arg=None, argval=None, argrepr='', offset=238, starts_line=None, is_jump_target=False, positions=None),
  Instruction(opname='RERAISE', opcode=119, arg=1, argval=1, argrepr='', offset=240, starts_line=None, is_jump_target=False, positions=None)]
