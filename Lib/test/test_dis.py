...
expected_opinfo_jumpy = [
  ...
  Instruction(opname='CALL_FUNCTION', opcode=131, arg=1, argval=1, argrepr='', offset=188, starts_line=None, is_jump_target=False, positions=None),
  ...
  Instruction(opname='CALL_FUNCTION', opcode=131, arg=1, argval=1, argrepr='', offset=202, starts_line=None, is_jump_target=False, positions=None),
  ...
  Instruction(opname='CALL_FUNCTION', opcode=131, arg=1, argval=1, argrepr='', offset=216, starts_line=None, is_jump_target=False, positions=None),
