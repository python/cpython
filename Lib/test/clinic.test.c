...
test_deprecate_positional_pos1_len1_optional(PyObject *module, PyObject *const *args, Py_ssize_t nargs, PyObject *kwnames)
{
    ...
    "'test_deprecate_positional_pos1_len1_optional' to be keyword-only."
...
test_deprecate_positional_pos1_len1_optional_impl(PyObject *module,
                                                  PyObject *a, PyObject *b)
/*[clinic end generated code: output=14fb8aaae77d1722 input=89099f3dacd757da]*/
...
test_deprecate_positional_pos1_len1_impl(PyObject *module, PyObject *a,
                                         PyObject *b)
/*[clinic end generated code: output=e9652e0fd59943c1 input=1702bbab1e9b3b99]*/
...
test_deprecate_positional_pos1_len2_with_kwd(PyObject *module, PyObject *const *args, Py_ssize_t nargs, PyObject *kwnames)
{
    ...
    PyObject *d;
            ...
            #if PY_VERSION_HEX >= 0x030e00C0
            #  error  \
    "In clinic.test.c, update parameter(s) 'b' and 'c' in the clinic input " \
    "of 'test_deprecate_positional_pos1_len2_with_kwd' to be keyword-only."
            #elif PY_VERSION_HEX >= 0x030e00A0
            #  ifdef _MSC_VER
            #    pragma message ( \
    "In clinic.test.c, update parameter(s) 'b' and 'c' in the clinic input " \
...
test_deprecate_positional_pos1_len2_with_kwd_impl(PyObject *module,
                                                  PyObject *a, PyObject *b,
                                                  PyObject *c, PyObject *d)
/*[clinic end generated code: output=3f05b1810fca68c9 input=28cdb885f6c34eab]*/
...
static PyObject *
test_deprecate_positional_pos0_len1_impl(PyObject *module, PyObject *a)
/*[clinic end generated code: output=2d69d62449a64bf9 input=678206db25c0652c]*/
...
test_deprecate_positional_pos0_len2(PyObject *module, PyObject *const *args, Py_ssize_t nargs, PyObject *kwnames)
{
    ...
    PyObject *b;
            ...
            #if PY_VERSION_HEX >= 0x030e00C0
            #  error  \
    "In clinic.test.c, update parameter(s) 'a' and 'b' in the clinic input " \
    "of 'test_deprecate_positional_pos0_len2' to be keyword-only."
            #elif PY_VERSION_HEX >= 0x030e00A0
            #  ifdef _MSC_VER
            #    pragma message ( \
    "In clinic.test.c, update parameter(s) 'a' and 'b' in the clinic input " \
...
test_deprecate_positional_pos0_len3_with_kwdonly(PyObject *module, PyObject *const *args, Py_ssize_t nargs, PyObject *kwnames)
{
    ...
    PyObject *e;
            ...
            #if PY_VERSION_HEX >= 0x030e00C0
            #  error  \
    "In clinic.test.c, update parameter(s) 'a', 'b' and 'c' in the clinic " \
    "input of 'test_deprecate_positional_pos0_len3_with_kwdonly' to be " \
    "keyword-only."
            #elif PY_VERSION_HEX >= 0x030e00A0
            #  ifdef _MSC_VER
            #    pragma message ( \
...
test_deprecate_positional_pos0_len3_with_kwdonly_impl(PyObject *module,
                                                      ...
                                                      PyObject *c,
                                                      PyObject *e)
/*[clinic end generated code: output=cc96aff202cfcc40 input=1b0121770c0c52e0]*/
...
test_deprecate_positional_pos2_len2(PyObject *module, PyObject *const *args, Py_ssize_t nargs, PyObject *kwnames)
{
    ...
    PyObject *d;
            ...
            #if PY_VERSION_HEX >= 0x030e00C0
            #  error  \
    "In clinic.test.c, update parameter(s) 'c' and 'd' in the clinic input " \
    "of 'test_deprecate_positional_pos2_len2' to be keyword-only."
            #elif PY_VERSION_HEX >= 0x030e00A0
            #  ifdef _MSC_VER
            #    pragma message ( \
    "In clinic.test.c, update parameter(s) 'c' and 'd' in the clinic input " \
...
test_deprecate_positional_pos2_len2_impl(PyObject *module, PyObject *a,
                                         PyObject *b, PyObject *c,
                                         PyObject *d)
/*[clinic end generated code: output=593d77137bd117cb input=0d53533463a12792]*/
...
test_deprecate_positional_pos2_len3_with_kwdonly(PyObject *module, PyObject *const *args, Py_ssize_t nargs, PyObject *kwnames)
{
    ...
    PyObject *e;
            ...
            #  error  \
    "In clinic.test.c, update parameter(s) 'c' and 'd' in the clinic input " \
    "of 'test_deprecate_positional_pos2_len3_with_kwdonly' to be " \
    "keyword-only."
            #elif PY_VERSION_HEX >= 0x030e00A0
            #  ifdef _MSC_VER
            #    pragma message ( \
...
test_deprecate_positional_pos2_len3_with_kwdonly_impl(PyObject *module,
                                                      ...
                                                      PyObject *d,
                                                      PyObject *e)
/*[clinic end generated code: output=2bbf3e16262d2012 input=154fd450448d8935]*/
