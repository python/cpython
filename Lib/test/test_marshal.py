...
class CAPI_TestCase(unittest.TestCase, HelperMixin):
    ...
    def test_write_long_to_file(self):
        for v in range(marshal.version + 1):
            _testcapi.pymarshal_write_long_to_file(0x12345678, filesystem_helper.TESTFN, v)
            with open(filesystem_helper.TESTFN, 'rb') as f:
                data = f.read()
            filesystem_helper.unlink(filesystem_helper.TESTFN)
    ...
    def test_write_object_to_file(self):
        ...
        for v in range(marshal.version + 1):
            _testcapi.pymarshal_write_object_to_file(obj, filesystem_helper.TESTFN, v)
            with open(filesystem_helper.TESTFN, 'rb') as f:
                data = f.read()
            filesystem_helper.unlink(filesystem_helper.TESTFN)
    ...
    def test_read_short_from_file(self):
        ...
        r, p = _testcapi.pymarshal_read_short_from_file(filesystem_helper.TESTFN)
        filesystem_helper.unlink(filesystem_helper.TESTFN)
    ...
    def test_read_long_from_file(self):
        ...
        r, p = _testcapi.pymarshal_read_long_from_file(filesystem_helper.TESTFN)
        filesystem_helper.unlink(filesystem_helper.TESTFN)
    ...
    def test_read_last_object_from_file(self):
        ...
        for v in range(marshal.version + 1):
            ...
            with open(filesystem_helper.TESTFN, 'wb') as f:
                f.write(data + b'xxxx')
            r, p = _testcapi.pymarshal_read_last_object_from_file(filesystem_helper.TESTFN)
            filesystem_helper.unlink(filesystem_helper.TESTFN)
            ...
            with open(filesystem_helper.TESTFN, 'wb') as f:
                f.write(data[:1])
            with self.assertRaises(EOFError):
                _testcapi.pymarshal_read_last_object_from_file(filesystem_helper.TESTFN)
            filesystem_helper.unlink(filesystem_helper.TESTFN)
    ...
    def test_read_object_from_file(self):
        ...
        for v in range(marshal.version + 1):
            ...
            with open(filesystem_helper.TESTFN, 'wb') as f:
                f.write(data + b'xxxx')
            r, p = _testcapi.pymarshal_read_object_from_file(filesystem_helper.TESTFN)
            filesystem_helper.unlink(filesystem_helper.TESTFN)
            self.assertEqual(r, obj)
            ...
            with open(filesystem_helper.TESTFN, 'wb') as f:
                f.write(data[:1])
            with self.assertRaises(EOFError):
                _testcapi.pymarshal_read_object_from_file(filesystem_helper.TESTFN)
            filesystem_helper.unlink(filesystem_helper.TESTFN)
