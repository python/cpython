...
class MathTests(unittest.TestCase):
    ...
    @unittest.skipIf(not hasattr(math, "besselj"),
                    "The Bessel function of first kind is not available")
    def testBessel_first(self):
        self.assertEqual(math.besselj(0 , INF), 0.0)
        self.assertEqual(math.besselj(1 , INF), 0.0)
        self.assertEqual(math.besselj(2 , INF), 0.0)
        self.assertEqual(math.besselj(0 , NINF), 0.0)
        self.assertEqual(math.besselj(1 , NINF), 0.0)
        self.assertEqual(math.besselj(2 , NINF), 0.0)
        self.assertIsNaN(math.besselj(0 , NAN))
        self.assertIsNaN(math.besselj(1 , NAN))
        self.assertIsNaN(math.besselj(2 , NAN))
        self.assertAlmostEqual(math.besselj(0, 2.4048255576957727), 0)
        self.assertAlmostEqual(math.besselj(0, 5.5200781102863106), 0)
        self.assertAlmostEqual(math.besselj(0, 8.6537279129110122), 0)
        self.assertAlmostEqual(math.besselj(0, 0.), 1)
        self.assertTrue(math.besselj(0, 4.) < 0)
        self.assertAlmostEqual(math.besselj(1, 3.8317059702075123), 0)
        self.assertAlmostEqual(math.besselj(1, 7.0155866698156122), 0)
        self.assertAlmostEqual(math.besselj(1, 10.173468135062722), 0)
        self.assertAlmostEqual(math.besselj(1, 0.), 0.)
        self.assertTrue(math.besselj(1, 1.) > 0)
        self.assertTrue(math.besselj(0, 5.5) < 0)
        self.assertAlmostEqual(math.besselj(2, 5.1356223018406826), 0)
        self.assertAlmostEqual(math.besselj(2, 8.4172441403998629), 0)
        self.assertAlmostEqual(math.besselj(2, 11.619841172149059), 0)
        self.assertAlmostEqual(math.besselj(2, 0.), 0.)
        self.assertTrue(math.besselj(2 ,1.) > 0)
        self.assertTrue(math.besselj(2, 7.) < 0)
        self.assertEqual(math.besselj(-1, 1.2345), -math.besselj(1, 1.2345))
        self.assertEqual(math.besselj(-2, 1.2345), math.besselj(2, 1.2345))
        self.assertEqual(math.besselj(-3, 1.2345), -math.besselj(3, 1.2345))

    @unittest.skipIf(not hasattr(math, "besselj"),
                    "The Bessel function of second kind is not available")
    def testBessel_second(self):
        self.assertEqual(math.bessely(0 , INF), 0.0)
        self.assertEqual(math.bessely(1 , INF), 0.0)
        self.assertEqual(math.bessely(2 , INF), 0.0)
        self.assertEqual(math.bessely(0 , NINF), 0.0)
        self.assertEqual(math.bessely(1 , NINF), 0.0)
        self.assertEqual(math.bessely(2 , NINF), 0.0)
        self.assertIsNaN(math.bessely(0 , NAN))
        self.assertIsNaN(math.bessely(1 , NAN))
        self.assertIsNaN(math.bessely(2 , NAN))
        self.assertAlmostEqual(math.bessely(0, 0.89357696627916752), 0)
        self.assertAlmostEqual(math.bessely(0, 3.9576784193148579), 0)
        self.assertAlmostEqual(math.bessely(0, 7.0860510603017727), 0)
        self.assertRaises(TypeError, math.bessely, (0, 0.))
        self.assertRaises(TypeError, math.bessely, (1, 0.))
        self.assertRaises(TypeError, math.bessely, (2, 0.))
        self.assertAlmostEqual(math.bessely(1, 2.1971413260310170), 0)
        self.assertAlmostEqual(math.bessely(1, 5.4296810407941351), 0)
        self.assertAlmostEqual(math.bessely(1, 8.5960058683311689), 0)
        self.assertAlmostEqual(math.bessely(2, 3.3842417671495935), 0)
        self.assertAlmostEqual(math.bessely(2, 6.7938075132682675), 0)
        self.assertAlmostEqual(math.bessely(2, 10.023477979360038), 0)
        self.assertEqual(math.bessely(-1, 1.2345), -math.bessely(1, 1.2345))
        self.assertEqual(math.bessely(-2, 1.2345), math.bessely(2, 1.2345))
        self.assertEqual(math.bessely(-3, 1.2345), -math.bessely(3, 1.2345))
