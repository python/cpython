...
class CmdLineTest(unittest.TestCase):
    ...
    def test_script_abspath(self):
        ...
        # in __file__
        with filesystem_helper.temp_cwd() as script_dir:
    ...
    def test_issue8202(self):
        ...
        with filesystem_helper.temp_dir() as script_dir:
            with filesystem_helper.change_cwd(path=script_dir):
                pkg_dir = os.path.join(script_dir, 'test_pkg')
    ...
    def setup_test_pkg(self, *args):
        with filesystem_helper.temp_dir() as script_dir, \
                filesystem_helper.change_cwd(path=script_dir):
            pkg_dir = os.path.join(script_dir, 'test_pkg')
    ...
    def test_non_ascii(self):
        ...
        and sys.platform not in ('win32', 'darwin')):
            name = os.fsdecode(filesystem_helper.TESTFN_UNDECODABLE)
        ...
        self.addCleanup(filesystem_helper.unlink, script_name)
    ...
    def test_consistent_sys_path_for_direct_execution(self):
        ...
        self.maxDiff = None
        with filesystem_helper.temp_dir() as work_dir,
             filesystem_helper.temp_dir() as script_dir:
