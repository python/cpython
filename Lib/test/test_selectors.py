...
class BaseSelectorTestCase(unittest.TestCase):
    ...
    def test_register(self):
        ...
        key = s.register(rd, selectors.EVENT_READ | selectors.EVENT_EXCEPT, "data")
        self.assertIsInstance(key, selectors.SelectorKey)
        self.assertEqual(key.fileobj, rd)
        self.assertEqual(key.fd, rd.fileno())
        self.assertEqual(key.events, selectors.EVENT_READ | selectors.EVENT_EXCEPT)
    ...
    def test_unregister(self):
        ...
        s.register(rd, selectors.EVENT_READ | selectors.EVENT_EXCEPT)
        s.unregister(rd)
    ...
    def test_unregister_after_fd_close(self):
        ...
        s.register(r, selectors.EVENT_READ | selectors.EVENT_EXCEPT)
    ...
    def test_modify(self):
        ...
        key = s.register(rd, selectors.EVENT_READ | selectors.EVENT_EXCEPT)
        ...
        key = s.register(rd, selectors.EVENT_READ | selectors.EVENT_EXCEPT, d1)
        key2 = s.modify(rd, selectors.EVENT_READ | selectors.EVENT_EXCEPT, d2)
        ...
        self.assertRaises(KeyError, s.modify, 999999, selectors.EVENT_READ | selectors.EVENT_EXCEPT)
        ...
        s.modify(rd, selectors.EVENT_READ | selectors.EVENT_EXCEPT, d3)
    ...
    def test_context_manager(self):
        ...
        with s as sel:
            sel.register(rd, selectors.EVENT_READ | selectors.EVENT_EXCEPT)
    ...
    def test_register_file(self):
        ...
        with tempfile.NamedTemporaryFile() as f:
            with self.assertRaises(IOError):
                s.register(f, selectors.EVENT_READ | selectors.EVENT_EXCEPT)
...
class KqueueSelectorTestCase(BaseSelectorTestCase, ScalableSelectorMixIn):
    ...
    def test_register_bad_fd(self):
        ...
        with self.assertRaises(OSError) as cm:
            s.register(bad_f, selectors.EVENT_READ | selectors.EVENT_EXCEPT)
