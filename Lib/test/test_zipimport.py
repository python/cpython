...
class UncompressedZipImportTestCase(ImportHooksBaseTestCase):
    ...
    def makeTree(self, files, dirName=TEMP_DIR):
        ...
        self.addCleanup(filesystem_helper.rmtree, dirName)
    ...
    def makeZip(self, files, zipName=TEMP_ZIP, **kw):
        ...
        self.addCleanup(filesystem_helper.unlink, zipName)
    ...
    def testZipImporterMethods(self):
        ...
        self.addCleanup(filesystem_helper.unlink, TEMP_ZIP)
...
class BadFileZipImportTestCase(unittest.TestCase):
    ...
    def testEmptyFile(self):
        filesystem_helper.unlink(TESTMOD)
        filesystem_helper.create_empty_file(TESTMOD)
