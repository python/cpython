...
class TestGeneratedCases(unittest.TestCase):
    ...
    """
        ...
        TARGET(OP) {
            ...
            INSTRUCTION_STATS(OP);
            PyObject *value;
            value = PyStackRef_To_PyObject_Steal(stack_pointer[-1]);
            spam();
            stack_pointer += -1;
            DISPATCH();
        }
    ...
    """
        ...
        TARGET(OP) {
            ...
            PyObject *left;
            PyObject *res;
            right = PyStackRef_To_PyObject_Steal(stack_pointer[-1]);
            left = PyStackRef_To_PyObject_Steal(stack_pointer[-2]);
            spam();
    ...
    """
        ...
        TARGET(OP1) {
            ...
            PyObject *arg;
            PyObject *rest;
            arg = PyStackRef_To_PyObject_Steal(stack_pointer[-1]);
    ...
    """
        ...
        TARGET(OP) {
            ...
            // OP2
            arg2 = PyStackRef_To_PyObject_Steal(stack_pointer[-3]);
            {
    ...
    """
        ...
        TARGET(OP) {
            ...
            _PyStackRef *values;
            PyObject *below;
            above = PyStackRef_To_PyObject_Steal(stack_pointer[-1]);
            values = &stack_pointer[-1 - oparg*2];
            below = PyStackRef_To_PyObject_Steal(stack_pointer[-2 - oparg*2]);
            spam();
    ...
    """
        ...
        TARGET(OP) {
            ...
            PyObject *extra;
            values = &stack_pointer[-oparg];
            extra = PyStackRef_To_PyObject_Steal(stack_pointer[-1 - oparg]);
    ...
    """
        ...
        TARGET(OP) {
            ...
            PyObject *zz;
            cc = PyStackRef_To_PyObject_Steal(stack_pointer[-1]);
            if ((oparg & 1) == 1) { input = PyStackRef_To_PyObject_Steal(stack_pointer[-1 - (((oparg & 1) == 1) ? 1 : 0)]); }
            aa = PyStackRef_To_PyObject_Steal(stack_pointer[-2 - (((oparg & 1) == 1) ? 1 : 0)]);
            output = spam(oparg, input);
    ...
    """
        ...
        TARGET(M) {
            ...
            // A
            right = PyStackRef_To_PyObject_Steal(stack_pointer[-1]);
            middle = PyStackRef_To_PyObject_Steal(stack_pointer[-2]);
            left = PyStackRef_To_PyObject_Steal(stack_pointer[-3]);
            {
                # Body of A
            }
            // B
