...
class TestGeneratedCases(unittest.TestCase):
    ...
    """
        ...
        TARGET(OP1) {
            ...
            stack_pointer[-1] = Py_OBJ_TAG(rest);
            DISPATCH();
        }
    ...
    """
        ...
        TARGET(OP) {
            ...
            // OP2
            arg2 = Py_OBJ_UNTAG(stack_pointer[-3]);
            {
    ...
    """
        ...
        TARGET(OP) {
            ...
            below = Py_OBJ_UNTAG(stack_pointer[-2 - oparg*2]);
            spam();
    ...
    """
        ...
        TARGET(OP) {
            ...
            spam(values, oparg);
            stack_pointer[-2] = Py_OBJ_TAG(below);
            stack_pointer[-1 + oparg*3] = Py_OBJ_TAG(above);
    ...
    """
        ...
        TARGET(OP) {
            ...
            spam(values, oparg);
            stack_pointer[0] = Py_OBJ_TAG(above);
            stack_pointer += 1;
            DISPATCH();
        }
    ...
    """
        ...
        TARGET(OP) {
            ...
            PyObject *zz;
            cc = Py_OBJ_UNTAG(stack_pointer[-1]);
            if ((oparg & 1) == 1) { input = Py_OBJ_UNTAG(stack_pointer[-1 - (((oparg & 1) == 1) ? 1 : 0)]); }
            aa = Py_OBJ_UNTAG(stack_pointer[-2 - (((oparg & 1) == 1) ? 1 : 0)]);
            output = spam(oparg, input);
            stack_pointer[-2 - (((oparg & 1) == 1) ? 1 : 0)] = Py_OBJ_TAG(xx);
            if (oparg & 2) stack_pointer[-1 - (((oparg & 1) == 1) ? 1 : 0)] = Py_OBJ_TAG(output);
            stack_pointer[-1 - (((oparg & 1) == 1) ? 1 : 0) + ((oparg & 2) ? 1 : 0)] = Py_OBJ_TAG(zz);
    ...
    """
        ...
        TARGET(M) {
            ...
            // A
            right = Py_OBJ_UNTAG(stack_pointer[-1]);
            middle = Py_OBJ_UNTAG(stack_pointer[-2]);
            left = Py_OBJ_UNTAG(stack_pointer[-3]);
            {
                # Body of A
            }
            // B
            ...
            stack_pointer[-3] = Py_OBJ_TAG(deep);
            if (oparg) stack_pointer[-2] = Py_OBJ_TAG(extra);
            stack_pointer[-2 + ((oparg) ? 1 : 0)] = Py_OBJ_TAG(res);
    ...
    def test_macro_push_push(self):
        ...
        TARGET(M) {
            ...
            stack_pointer[0] = Py_OBJ_TAG(val1);
            stack_pointer[1] = Py_OBJ_TAG(val2);
            stack_pointer += 2;
            DISPATCH();
        }
        """
