...
class TestGeneratedCases(unittest.TestCase):
    ...
    """
        ...
        TARGET(OP1) {
            ...
            stack_pointer[-1] = Py_OBJ_PACK(rest);
            DISPATCH();
        }
    ...
    """
        ...
        TARGET(OP) {
            ...
            // OP2
            arg2 = Py_CLEAR_TAG(stack_pointer[-3]);
            {
    ...
    """
        ...
        TARGET(OP) {
            ...
            PyObject *below;
            above = Py_CLEAR_TAG(stack_pointer[-1]);
            values = &stack_pointer[-1 - oparg*2];
            below = Py_CLEAR_TAG(stack_pointer[-2 - oparg*2]);
            spam();
    ...
    """
        ...
        TARGET(OP) {
            ...
            spam(values, oparg);
            stack_pointer[-2] = Py_OBJ_PACK(below);
            stack_pointer[-1 + oparg*3] = Py_OBJ_PACK(above);
    ...
    """
        ...
        TARGET(OP) {
            ...
            spam(values, oparg);
            stack_pointer[0] = Py_OBJ_PACK(above);
            stack_pointer += 1;
            DISPATCH();
        }
    ...
    """
        ...
        TARGET(OP) {
            ...
            PyObject *extra;
            values = &stack_pointer[-oparg];
            extra = Py_CLEAR_TAG(stack_pointer[-1 - oparg]);
    ...
    """
        ...
        TARGET(OP) {
            ...
            PyObject *zz;
            cc = Py_CLEAR_TAG(stack_pointer[-1]);
            if ((oparg & 1) == 1) { input = Py_CLEAR_TAG(stack_pointer[-1 - (((oparg & 1) == 1) ? 1 : 0)]); }
            aa = Py_CLEAR_TAG(stack_pointer[-2 - (((oparg & 1) == 1) ? 1 : 0)]);
            output = spam(oparg, input);
            stack_pointer[-2 - (((oparg & 1) == 1) ? 1 : 0)] = Py_OBJ_PACK(xx);
            if (oparg & 2) stack_pointer[-1 - (((oparg & 1) == 1) ? 1 : 0)] = Py_OBJ_PACK(output);
            stack_pointer[-1 - (((oparg & 1) == 1) ? 1 : 0) + ((oparg & 2) ? 1 : 0)] = Py_OBJ_PACK(zz);
    ...
    """
        ...
        TARGET(M) {
            ...
            // A
            right = Py_CLEAR_TAG(stack_pointer[-1]);
            middle = Py_CLEAR_TAG(stack_pointer[-2]);
            left = Py_CLEAR_TAG(stack_pointer[-3]);
            {
                # Body of A
            }
            // B
            ...
            stack_pointer[-3] = Py_OBJ_PACK(deep);
            if (oparg) stack_pointer[-2] = Py_OBJ_PACK(extra);
            stack_pointer[-2 + ((oparg) ? 1 : 0)] = Py_OBJ_PACK(res);
    ...
    def test_macro_push_push(self):
        ...
        TARGET(M) {
            ...
            stack_pointer[0] = Py_OBJ_PACK(val1);
            stack_pointer[1] = Py_OBJ_PACK(val2);
            stack_pointer += 2;
            DISPATCH();
        }
        """
