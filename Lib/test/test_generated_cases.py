...
class TestGeneratedCases(unittest.TestCase):
    ...
    """
        ...
        TARGET(OP) {
            ...
            INSTRUCTION_STATS(OP);
            PyObject *value;
            value = PyStackRef_AsPyObjectBorrow(stack_pointer[-1]);
            spam();
            stack_pointer += -1;
            DISPATCH();
        }
    ...
    """
        ...
        TARGET(OP) {
            ...
            PyObject *left;
            PyObject *res;
            right = PyStackRef_AsPyObjectBorrow(stack_pointer[-1]);
            left = PyStackRef_AsPyObjectBorrow(stack_pointer[-2]);
            spam();
    ...
    """
        ...
        TARGET(OP) {
            ...
            left = PyStackRef_AsPyObjectBorrow(stack_pointer[-2]);
            spam();
            stack_pointer[-1] = PyStackRef_FromPyObjectSteal(result);
            DISPATCH();
        }
    """
        self.run_cases_test(input, output)
    ...
    """
        ...
        TARGET(OP1) {
            ...
            PyObject *arg;
            PyObject *rest;
            arg = PyStackRef_AsPyObjectBorrow(stack_pointer[-1]);
            stack_pointer[-1] = PyStackRef_FromPyObjectSteal(rest);
            DISPATCH();
        }
    ...
    """
        ...
        TARGET(OP) {
            ...
            // OP2
            arg2 = PyStackRef_AsPyObjectBorrow(stack_pointer[-3]);
            {
                uint32_t extra = read_u32(&this_instr[4].cache);
                (void)extra;
                res = op2(arg2, left, right);
            }
            stack_pointer[-3] = PyStackRef_FromPyObjectSteal(res);
            stack_pointer += -2;
            DISPATCH();
        }
    ...
    """
        ...
        TARGET(OP) {
            ...
            _PyStackRef *values;
            PyObject *below;
            above = PyStackRef_AsPyObjectBorrow(stack_pointer[-1]);
            values = &stack_pointer[-1 - oparg*2];
            below = PyStackRef_AsPyObjectBorrow(stack_pointer[-2 - oparg*2]);
            spam();
    ...
    """
        ...
        TARGET(OP) {
            ...
            spam(values, oparg);
            stack_pointer[-2] = PyStackRef_FromPyObjectSteal(below);
    ...
    """
        ...
        TARGET(OP) {
            ...
            spam(values, oparg);
            stack_pointer[0] = PyStackRef_FromPyObjectSteal(above);
            stack_pointer += 1;
            DISPATCH();
        }
    ...
    """
        ...
        TARGET(OP) {
            ...
            PyObject *extra;
            values = &stack_pointer[-oparg];
            extra = PyStackRef_AsPyObjectBorrow(stack_pointer[-1 - oparg]);
    ...
    """
        ...
        TARGET(OP) {
            ...
            PyObject *zz;
            cc = PyStackRef_AsPyObjectBorrow(stack_pointer[-1]);
            if ((oparg & 1) == 1) { input = PyStackRef_AsPyObjectBorrow(stack_pointer[-1 - (((oparg & 1) == 1) ? 1 : 0)]); }
            aa = PyStackRef_AsPyObjectBorrow(stack_pointer[-2 - (((oparg & 1) == 1) ? 1 : 0)]);
            output = spam(oparg, input);
            stack_pointer[-2 - (((oparg & 1) == 1) ? 1 : 0)] = PyStackRef_FromPyObjectSteal(xx);
            if (oparg & 2) stack_pointer[-1 - (((oparg & 1) == 1) ? 1 : 0)] = PyStackRef_FromPyObjectSteal(output);
            stack_pointer[-1 - (((oparg & 1) == 1) ? 1 : 0) + ((oparg & 2) ? 1 : 0)] = PyStackRef_FromPyObjectSteal(zz);
    ...
    """
        ...
        TARGET(M) {
            ...
            // A
            right = PyStackRef_AsPyObjectBorrow(stack_pointer[-1]);
            middle = PyStackRef_AsPyObjectBorrow(stack_pointer[-2]);
            left = PyStackRef_AsPyObjectBorrow(stack_pointer[-3]);
            {
                # Body of A
            }
            // B
            ...
            stack_pointer[-3] = PyStackRef_FromPyObjectSteal(deep);
            if (oparg) stack_pointer[-2] = PyStackRef_FromPyObjectSteal(extra);
            stack_pointer[-2 + ((oparg) ? 1 : 0)] = PyStackRef_FromPyObjectSteal(res);
    ...
    def test_macro_push_push(self):
        ...
        TARGET(M) {
            ...
            stack_pointer[0] = PyStackRef_FromPyObjectSteal(val1);
            stack_pointer[1] = PyStackRef_FromPyObjectSteal(val2);
            stack_pointer += 2;
            DISPATCH();
        }
        """
