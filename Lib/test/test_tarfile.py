...
tarname = support.findfile("testtar.tar", subdir="ziptestdata")
...
class CommonReadTest(ReadTest):
    ...
    def test_length_zero_header(self):
        ...
        with self.assertRaisesRegex(tarfile.ReadError, "file could not be opened successfully"):
            with tarfile.open(support.findfile('recursion.tar', subdir='ziptestdata')):
                pass
...
class MiscTest(unittest.TestCase):
    ...
    def test_useful_error_message_when_modules_missing(self):
        fname = os.path.join(os.path.dirname(__file__), 'ziptestdata', 'testtar.tar.xz')
...
class CommandLineTest(unittest.TestCase):
    ...
    def test_test_command_invalid_file(self):
        zipname = support.findfile('zipdir.zip', subdir='ziptestdata')
