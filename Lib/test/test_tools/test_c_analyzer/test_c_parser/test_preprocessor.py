...
class IterLinesTests(TestCaseBase):
    ...
    def test_single_directives(self):
        ...
        for line, directive in tests:
            with self.subTest(line):
                ...
                self.assertEqual(results, [
                    ('static int spam = 0;', None, ()),
                    (line, directive, ()),
                    (('static char buffer[256];', None, ('defined(SPAM)',))
                     if directive.kind in ('if', 'ifdef', 'elseif')
                     else ('static char buffer[256];', None, ('! defined(SPAM)',))
                     if directive.kind == 'ifndef'
                     else ('static char buffer[256];', None, ())),
                    ])
                self.check_calls(
                        ('_parse_directive', line),
                        )
    ...
    def test_split_lines(self):
        ...
        self.assertEqual(results, [
            ('static int spam = 0;', None, ()),
            ('#define eggs(a, b) \\', True, ()),
            ('    { \\', True, ()),
            ('        a = b; \\', True, ()),
            ('    }', directive, ()),
            ('static char buffer[256];', None, ()),
            ])
        self.check_calls(
                ('_parse_directive', '#define eggs(a, b) { a = b; }'),
                )
    ...
    def test_nested_conditions(self):
        ...
        self.assertEqual(results, [
            ('static int spam = 0;', None, ()),
            ('#ifdef SPAM', directives[0], ()),
            ('static int start = 0;', None, ('defined(SPAM)',)),
            ('#  if SPAM == 1', directives[1], ('defined(SPAM)',)),
            ('static char buffer[10];', None, ('defined(SPAM)', 'SPAM == 1')),
            ('#  elif SPAM == 2', directives[2], ('defined(SPAM)', 'SPAM == 1')),
            ('static char buffer[100];', None, ('defined(SPAM)', '! (SPAM == 1)', 'SPAM == 2')),
            ('#  else', directives[3], ('defined(SPAM)', '! (SPAM == 1)', 'SPAM == 2')),
            ('static char buffer[256];', None, ('defined(SPAM)', '! (SPAM == 1)', '! (SPAM == 2)')),
            ('#  endif', directives[4], ('defined(SPAM)', '! (SPAM == 1)', '! (SPAM == 2)')),
            ('static int end = 0;', None, ('defined(SPAM)',)),
            ('#endif', directives[5], ('defined(SPAM)',)),
            ('static int eggs = 0;', None, ()),
            ])
        self.check_calls(
    ...
    def test_split_blocks(self):
        ...
        self.assertEqual(results, [
            ('void str_copy(char *buffer, *orig);', None, ()),
            ('int init(char *name) {', None, ()),
            ('    static int initialized = 0;', None, ()),
            ('    if (initialized) {', None, ()),
            ('        return 0;', None, ()),
            ('    }', None, ()),
            ...
            ('    static char buffer[10];', None, ('defined(SPAM)',)),
            ('    str_copy(buffer, char);', None, ('defined(SPAM)',)),
            ('}', None, ('defined(SPAM)',)),
            ('void copy(char *buffer, *orig) {', None, ('defined(SPAM)',)),
            ('    strncpy(buffer, orig, 9);', None, ('defined(SPAM)',)),
            ('    buffer[9] = 0;', None, ('defined(SPAM)',)),
            ('}', None, ('defined(SPAM)',)),

            ('#else', directives[1], ('defined(SPAM)',)),

            ('    static char buffer[256];', None, ('! (defined(SPAM))',)),
            ('    str_copy(buffer, char);', None, ('! (defined(SPAM))',)),
            ('}', None, ('! (defined(SPAM))',)),
            ('void copy(char *buffer, *orig) {', None, ('! (defined(SPAM))',)),
            ('    strcpy(buffer, orig);', None, ('! (defined(SPAM))',)),
            ('}', None, ('! (defined(SPAM))',)),

            ('#endif', directives[2], ('! (defined(SPAM))',)),
            ])
        self.check_calls(
                ('_parse_directive', '#ifdef SPAM'),
                ('_parse_directive', '#else'),
    ...
    def test_typical(self):
        ...
        self.check_calls(
                ...
                ('_parse_directive', '#ifdef __cplusplus'),
                ('_parse_directive', '#endif'),
                ('_parse_directive', '#endif /* !Py_LIMITED_API */'),
                ...
                ('_parse_directive', '#endif /* !Py_COMPILE_H */'),
                )
