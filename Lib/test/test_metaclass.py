...
Use a metaclass that doesn't derive from type.
    ...
    ...
    meta: C ()
    ns: [('__expected_attributes__', ()), ('__module__', 'test.test_metaclass'), ('__qualname__', 'C'), ('a', 42), ('b', 24)]
    kw: []
    >>> type(C) is dict
    True
    >>> print(sorted(C.items()))
    [('__expected_attributes__', ()), ('__module__', 'test.test_metaclass'), ('__qualname__', 'C'), ('a', 42), ('b', 24)]
    >>>
...
And again, with a __prepare__ attribute.
    ...
    d['__expected_attributes__'] = ()
    meta: C ()
    ns: [('__expected_attributes__', ()), ('__module__', 'test.test_metaclass'), ('__qualname__', 'C'), ('a', 2), ('b', 3)]
    kw: [('other', 'booh')]
    >>>
