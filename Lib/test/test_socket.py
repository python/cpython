...
class UnixSocketTestBase(SocketTestBase):
    ...
    def bindSock(self, sock):
        ...
        self.addCleanup(filesystem_helper.unlink, path)
...
class TestUnixDomain(unittest.TestCase):
    ...
    def testSurrogateescapeBind(self):
        ...
        path = os.path.abspath(filesystem_helper.TESTFN_UNICODE)
        b = self.encoded(path)
    ...
    def testUnencodableAddr(self):
        ...
        if filesystem_helper.TESTFN_UNENCODABLE is None:
            self.skipTest("No unencodable filename available")
        path = os.path.abspath(filesystem_helper.TESTFN_UNENCODABLE)
        self.bind(self.sock, path)
        self.addCleanup(filesystem_helper.unlink, path)
        self.assertEqual(self.sock.getsockname(), path)
