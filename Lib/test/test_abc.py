    ...
    class TestABC(unittest.TestCase):
        ...
        def test_object_new_with_one_abstractmethod(self):
            class C(metaclass=abc_ABCMeta):
                ...
                def method_one(self):
                    pass
            msg = r"class C with no implementation for abstract method method_one"
        ...
        def test_object_new_with_many_abstractmethods(self):
            class C(metaclass=abc_ABCMeta):
                ...
                def method_two(self):
                    pass
            msg = r"class C with no implementation for abstract methods method_one, method_two"
            self.assertRaisesRegex(TypeError, msg, C)
        ...
        def test_update_new_abstractmethods(self):
            ...
            msg = "class A with no implementation for abstract methods bar, foo"
        ...
        def test_update_implementation(self):
            ...
            msg = "class B with no implementation for abstract method foo"
        ...
        def test_update_layered_implementation(self):
            ...
            msg = "class C with no implementation for abstract method foo"
            self.assertRaisesRegex(TypeError, msg, C)
