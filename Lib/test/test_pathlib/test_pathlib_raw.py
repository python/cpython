...
from pathlib._abc import UnsupportedOperation
from pathlib._raw import RawPurePath, RawPath
...
class RawPurePathTest(test_pathlib_abc.DummyPurePathTest):
    cls = RawPurePath
...
class RawPathTest(RawPurePathTest, test_pathlib_abc.DummyPathTest):
