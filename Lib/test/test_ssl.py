...
class TestSSLDebug(unittest.TestCase):
    ...
    def keylog_lines(self, fname=filesystem_helper.TESTFN):
    ...
    def test_keylog_defaults(self):
        ...
        self.assertFalse(os.path.isfile(filesystem_helper.TESTFN))
        ctx.keylog_filename = filesystem_helper.TESTFN
        self.assertEqual(ctx.keylog_filename, filesystem_helper.TESTFN)
        self.assertTrue(os.path.isfile(filesystem_helper.TESTFN))
        ...
        with self.assertRaises((IsADirectoryError, PermissionError)):
            ...
            ctx.keylog_filename = os.path.dirname(
                os.path.abspath(filesystem_helper.TESTFN))
    ...
    def test_keylog_filename(self):
        ...
        client_context.keylog_filename = filesystem_helper.TESTFN
        server = ThreadedEchoServer(context=server_context, chatty=False)
        with server:
            with client_context.wrap_socket(socket.socket(),
                                            server_hostname=hostname) as s:
        ...
        server_context.keylog_filename = filesystem_helper.TESTFN
        server = ThreadedEchoServer(context=server_context, chatty=False)
        with server:
            with client_context.wrap_socket(socket.socket(),
                                            server_hostname=hostname) as s:
    ...
    def test_keylog_env(self):
        ...
        with unittest.mock.patch.dict(os.environ):
            os.environ['SSLKEYLOGFILE'] = filesystem_helper.TESTFN
            self.assertEqual(os.environ['SSLKEYLOGFILE'], filesystem_helper.TESTFN)
