...
class FutureTest(unittest.TestCase):
    ...
    def test_future1(self):
        with import_helper.CleanImport('test.test_future_import.future_test1'):
            from test.test_future_import import future_test1
            self.assertEqual(future_test1.result, 6)

    def test_future2(self):
        with import_helper.CleanImport('test.test_future_import.future_test2'):
            from test.test_future_import import future_test2
            self.assertEqual(future_test2.result, 6)

    def test_future3(self):
        with import_helper.CleanImport('test.test_future_import.test_future3'):
            from test.test_future_import import test_future3
    ...
    def test_badfuture3(self):
        with self.assertRaises(SyntaxError) as cm:
            from test.test_future_import import badsyntax_future3
    ...
    def test_badfuture5(self):
        with self.assertRaises(SyntaxError) as cm:
            from test.test_future_import import badsyntax_future5
    ...
    def test_badfuture7(self):
        with self.assertRaises(SyntaxError) as cm:
            from test.test_future_import import badsyntax_future7
    ...
    def test_badfuture9(self):
        with self.assertRaises(SyntaxError) as cm:
            from test.test_future_import import badsyntax_future9
        self.check_syntax_error(cm.exception, "badsyntax_future9", 3)

    def test_badfuture10(self):
        with self.assertRaises(SyntaxError) as cm:
            from test.test_future_import import badsyntax_future10
    ...
    def test_multiple_features(self):
        with import_helper.CleanImport("test.test_future_import.test_future5"):
            from test.test_future_import import test_future5
