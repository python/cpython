...
from test.test_dis.snippets import (
    jumpy, outer, simple,
    expected_opinfo_jumpy, expected_outer_line, expected_opinfo_outer,
    expected_f_line, expected_opinfo_f, expected_jumpy_line,
    expected_opinfo_simple, expected_inner_line, expected_opinfo_inner,
)
