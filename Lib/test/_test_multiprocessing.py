...
class TestSyncManagerTypes(unittest.TestCase):
    ...
    process. "callback" function represents how the base type is
    ...
    def test_pool(self):
        def callback(obj):
            ...
            # or map() I get:
            #   .../multiprocessing/managers.py", line 802, in _callmethod
...
try:
    ...
    @unittest.skipIf(True, "SharedMemoryManager not available")
