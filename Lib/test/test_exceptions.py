...
class ExceptionTests(unittest.TestCase):
    ...
    def testAttributes(self):
        ...
        exceptionList = [
            ...
            # corresponds to no single errno, so it gets no default either
            (ConnectionError, (), {},
                {'args' : (), 'filename' : None, 'filename2' : None,
                 'errno' : None, 'strerror' : None}),
            (OSError, ('foo',), {},
                {'args' : ('foo',), 'filename' : None, 'filename2' : None,
                 'errno' : None, 'strerror' : 'foo'}),
            (OSError, ('foo', 'bar'), {},
                {'args' : ('foo', 'bar'),
            ...
            (OSError, ('foo', 'bar', 'baz', None, 'quux'), {},
                {'args' : ('foo', 'bar', 'baz', None, 'quux'),
                 'filename' : 'baz', 'filename2': 'quux'}),
            (OSError, ('errnoStr', 'strErrorStr', 'filenameStr'), {},
                {'args' : ('errnoStr', 'strErrorStr', 'filenameStr'),
                 'strerror' : 'strErrorStr', 'errno' : 'errnoStr',
                 'filename' : 'filenameStr'}),
            (OSError, (1, 'strErrorStr', 'filenameStr'), {},
                {'args' : (1, 'strErrorStr', 'filenameStr'), 'errno' : 1,
                 'strerror' : 'strErrorStr',
                 'filename' : 'filenameStr', 'filename2' : None}),
            (OSError, (), {'filename': 'filenameStr'},
                {'args' : (None, None, 'filenameStr'),
                 'errno' : None, 'strerror' : None,
                 'filename' : 'filenameStr', 'filename2' : None}),
            (OSError, ('strErrorStr',), {'filename': 'filenameStr'},
                {'args' : (None, 'strErrorStr', 'filenameStr'),
                 'errno' : None, 'strerror' : 'strErrorStr',
                 'filename' : 'filenameStr', 'filename2' : None}),
            (FileNotFoundError, (), {},
                {'args' : (errno.ENOENT, os.strerror(errno.ENOENT)),
                 'errno' : errno.ENOENT,
                 'strerror' : os.strerror(errno.ENOENT),
                 'filename' : None, 'filename2' : None}),
            (FileNotFoundError, (), {'filename': 'filenameStr'},
                {'args' : (errno.ENOENT, os.strerror(errno.ENOENT),
                           'filenameStr'),
                 'errno' : errno.ENOENT,
                 'strerror' : os.strerror(errno.ENOENT),
            ...
            (BlockingIOError, (), {'characters_written': 5},
                {'args' : (errno.EAGAIN, os.strerror(errno.EAGAIN), 5),
                 'errno' : errno.EAGAIN,
                 'strerror' : os.strerror(errno.EAGAIN),
                 'filename' : None, 'filename2' : None,
                 'characters_written' : 5}),
            (BlockingIOError, (errno.EAGAIN, 'strErrorStr', 3), {},
                {'args' : (errno.EAGAIN, 'strErrorStr', 3),
                 'errno' : errno.EAGAIN, 'strerror' : 'strErrorStr',
                 'filename' : None, 'filename2' : None,
                 'characters_written' : 3}),
        ...
        try:
            ...
            exceptionList.append(
                (WindowsError, (1, 'strErrorStr', 'filenameStr'), {},
                    {'args' : (1, 'strErrorStr', 'filenameStr'),
                     'strerror' : 'strErrorStr', 'winerror' : None,
                     'errno' : 1,
                     'filename' : 'filenameStr', 'filename2' : None})
            )
            # ERROR_PATH_NOT_FOUND (3) is translated to ENOENT
            exceptionList.append(
                (OSError, (0, 'strErrorStr', 'filenameStr', 3), {},
                    {'args' : (errno.ENOENT, 'strErrorStr', 'filenameStr', 3),
                     'strerror' : 'strErrorStr', 'winerror' : 3,
                     'errno' : errno.ENOENT,
                     'filename' : 'filenameStr', 'filename2' : None})
            )
            exceptionList.append(
                (OSError, (0, 'strErrorStr', 'filenameStr', 3, 'filename2Str'),
                 {},
                    {'args' : (errno.ENOENT, 'strErrorStr', 'filenameStr', 3,
                               'filename2Str'),
                     'strerror' : 'strErrorStr', 'winerror' : 3,
                     'errno' : errno.ENOENT,
                     'filename' : 'filenameStr', 'filename2' : 'filename2Str'})
            )
            exceptionList.append(
                (OSError, ('strErrorStr',),
                 {'winerror': 3, 'filename': 'filenameStr'},
                    {'args' : (errno.ENOENT, 'strErrorStr', 'filenameStr', 3),
                     'strerror' : 'strErrorStr', 'winerror' : 3,
                     'errno' : errno.ENOENT,
                     'filename' : 'filenameStr', 'filename2' : None})
