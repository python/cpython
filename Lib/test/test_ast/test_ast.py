...
Module(
   body=[
    ...
    def test_literal_eval(self):
        ...
        val = ast.literal_eval('sentinel("xyz")')
        self.assertTrue(isinstance(val, sentinel))
        self.assertEqual(val.__name__, "xyz")
        ...
        self.assertEqual(ast.literal_eval('1 == 2'), False)
        self.assertEqual(ast.literal_eval('1 != 2'), True)
        self.assertEqual(ast.literal_eval('1 < 2'), True)
        self.assertEqual(ast.literal_eval('1 <= 2'), True)
        self.assertEqual(ast.literal_eval('1 >= 2'), False)
        self.assertEqual(ast.literal_eval('1 > 2'), False)
