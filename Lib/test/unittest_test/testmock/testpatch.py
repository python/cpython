...
import unittest
from Lib.test.unittest_test.testmock import support
from Lib.test.unittest_test.testmock.support import SomeClass, is_instance
...
class PatchTest(unittest.TestCase):
    ...
    def test_patch_dict_decorator_resolution(self):
        ...
        @patch.dict('Lib.test.unittest_test.testmock.support.target', {'bar': 'BAR'})
        def test():
    ...
    def test_patch_nested_autospec_repr(self):
        with patch('Lib.test.unittest_test.testmock.support', autospec=True) as m:
    ...
    def test_special_attrs(self):
        ...
        self.assertEqual(foo.__module__, 'Lib.test.unittest_test.testmock.testpatch')
    ...
    def test_dotted_but_module_not_loaded(self):
        ...
        with patch.dict('sys.modules'):
            del sys.modules['Lib.test.unittest_test.testmock.support']
            del sys.modules['Lib.test.unittest_test.testmock']
            del sys.modules['Lib.test.unittest_test']
            del sys.modules['unittest']

            # now make sure we can patch based on a dotted path:
            @patch('Lib.test.unittest_test.testmock.support.X')
            def test(mock):
                pass
            test()
    ...
    def test_cant_set_kwargs_when_passing_a_mock(self):
        @patch('Lib.test.unittest_test.testmock.support.X', new=object(), x=1)
        def test(): pass
        with self.assertRaises(TypeError):
            test()
