...
def global_pos_only_optional(a, /, b):
    return (a,b)
...
class PositionalOnlyTestCase(unittest.TestCase):
    ...
    def test_invalid_syntax_errors(self):
        ...
        self.assertRaisesSyntaxError("def f(**kwargs, /): pass")
        self.assertRaisesSyntaxError("def f(/, a = 1): pass")
        self.assertRaisesSyntaxError("def f(/, a): pass")
        self.assertRaisesSyntaxError("def f(/): pass")
        self.assertRaisesSyntaxError("def f(*, a, /): pass")
        self.assertRaisesSyntaxError("def f(*, /, a): pass")
    ...
    def test_invalid_syntax_errors_async(self):
        ...
        self.assertRaisesSyntaxError("async def f(**kwargs, /): pass")
        self.assertRaisesSyntaxError("async def f(/, a = 1): pass")
        self.assertRaisesSyntaxError("async def f(/, a): pass")
        self.assertRaisesSyntaxError("async def f(/): pass")
        self.assertRaisesSyntaxError("async def f(*, a, /): pass")
        self.assertRaisesSyntaxError("async def f(*, /, a): pass")
    ...
    def test_invalid_syntax_lambda(self):
        self.assertRaisesSyntaxError("lambda a, b = 5, /, c: None", "non-default argument follows default argument")
        self.assertRaisesSyntaxError("lambda a = 5, b, /, c: None", "non-default argument follows default argument")
        self.assertRaisesSyntaxError("lambda a = 5, b, /: None", "non-default argument follows default argument")
        self.assertRaisesSyntaxError("lambda *args, /: None")
        self.assertRaisesSyntaxError("lambda *args, a, /: None")
        self.assertRaisesSyntaxError("lambda **kwargs, /: None")
        self.assertRaisesSyntaxError("lambda /, a = 1: None")
        self.assertRaisesSyntaxError("lambda /, a: None")
        self.assertRaisesSyntaxError("lambda /: None")
        self.assertRaisesSyntaxError("lambda *, a, /: None")
        self.assertRaisesSyntaxError("lambda *, /, a: None")
    ...
    def test_serialization(self):
        ...
        pickled_optional = pickle.dumps(global_pos_only_optional)
        ...
        expected = r"global_pos_only_optional\(\) got some positional-only arguments "\
