...
class UnicodeFileTests(unittest.TestCase):
    ...
    def test_listdir(self):
        ...
        with warnings.catch_warnings():
            ...
            f1 = os.listdir(filesystem_helpr.TESTFN.encode(sys.getfilesystemencoding()))
    ...
    def test_directory(self):
        dirname = os.path.join(filesystem_helper.TESTFN, 'Gr\xfc\xdf-\u66e8\u66e9\u66eb')
        filename = '\xdf-\u66e8\u66e9\u66eb'
        with filesystem_helper.temp_cwd(dirname):
