...
class OtherTests(unittest.TestCase):
    ...
    def test_file_local_header(self):
        data = (
            b'PK\x03\x04\x14\x00\x00\x00\x00\x00\x00\x00!\x00\xa3'
            b'\x1c)\x1c\x0c\x00\x00\x00\x0c\x00\x00\x00\t\x00\x00'
            b'\x00hello.txtHello World!PK\x03\x04\x14\x00\x00\x00'
            b'\x00\x00\x00\x00!\x00\xa3\x1c)\x1c\x0c\x00\x00\x00'
            b'\x0c\x00\x00\x00\t\x00\x00\x00world.txtHello World'
            b'!PK\x01\x02\x14\x03\x14\x00\x00\x00\x00\x00\x00\x00!'
            b'\x00\xa3\x1c)\x1c\x0c\x00\x00\x00\x0c\x00\x00\x00\t'
            b'\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x80\x01'
            b'\x00\x00\x00\x00hello.txtPK\x01\x02\x14\x03\x14\x00'
            b'\x00\x00\x00\x00\x00\x00!\x00\xa3\x1c)\x1c\x0c\x00\x00'
            b'\x00\x0c\x00\x00\x00\t\x00\x00\x00\x00\x00\x00\x00\x00'
            b'\x00\x00\x00\x80\x013\x00\x00\x00world.txtPK\x05\x06\x00'
            b'\x00\x00\x00\x02\x00\x02\x00n\x00\x00\x00f\x00\x00\x00\x00\x00'
        )
        from zipfile import structFileHeader, stringFileHeader
        with zipfile.ZipFile(io.BytesIO(data), 'r') as zipf:
            for i in zipf.infolist():
                sig_check = struct.unpack(structFileHeader, i.local_header)
                self.assertEqual(sig_check[0], stringFileHeader)
