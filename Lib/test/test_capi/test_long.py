...
class LongTests(unittest.TestCase):
    ...
    def test_long_ispositive(self):
        ...
        self.assertRaises(TypeError, ispositive, WithIndex(123))
    ...
    def test_long_isnegative(self):
        ...
        self.assertRaises(TypeError, isnegative, WithIndex(123))
    ...
    def test_long_iszero(self):
        ...
        self.assertRaises(TypeError, iszero, WithIndex(123))
