...
from .utils import format_duration, normalize_test_name, print_warning
...
def _decode_test_result(d: dict[str, Any]) -> TestResult | dict[str, Any]:
    if "__test_result__" in d:
