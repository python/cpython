...
from .utils import setup_unraisable_hook, setup_threading_excepthook


UNICODE_GUARD_ENV = "PYTHON_REGRTEST_UNICODE_GUARD"
...
def setup_support(runtests: RunTests) -> None:
...
def setup_tests(runtests: RunTests):
    ...
    if runtests.memlimit is not None:
        support.set_memlimit(runtests.memlimit)
