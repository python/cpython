...
class PosixTester(unittest.TestCase):
    ...
    def tearDown(self):
        for teardown_file in self.teardown_files:
            filesystem_helper.unlink(teardown_file)
    ...
    def test_mknod(self):
        ...
        try:
            ...
            self.assertTrue(stat.S_ISFIFO(posix.stat(filesystem_helper.TESTFN).st_mode))
    ...
    def test_chown(self):
        ...
        self.assertRaises(OSError, posix.chown, filesystem_helper.TESTFN, -1, -1)

        # re-create the file
        filesystem_helper.create_empty_file(filesystem_helper.TESTFN)
    ...
    def test_utime(self):
        ...
        self.assertRaises(TypeError, posix.utime, filesystem_helper.TESTFN, (None, None))
        self.assertRaises(TypeError, posix.utime, filesystem_helper.TESTFN, (now, None))
        self.assertRaises(TypeError, posix.utime, filesystem_helper.TESTFN, (None, now))
        posix.utime(filesystem_helper.TESTFN, (int(now), int(now)))
        posix.utime(filesystem_helper.TESTFN, (now, now))
    ...
    def test_chflags(self):
        self._test_chflags_regular_file(posix.chflags, filesystem_helper.TESTFN)

    @unittest.skipUnless(hasattr(posix, 'lchflags'), 'test needs os.lchflags()')
    def test_lchflags_regular_file(self):
        self._test_chflags_regular_file(posix.lchflags, filesystem_helper.TESTFN)
    ...
    def test_getcwd_long_pathnames(self):
        ...
        try:
            ...
            os.chdir(curdir)
            filesystem_helper.rmtree(base_path)
    ...
    def test_utime_dir_fd(self):
        ...
        try:
            ...
            self.assertRaises(TypeError, posix.utime, filesystem_helper.TESTFN, now, dir_fd=f)
            self.assertRaises(TypeError, posix.utime, filesystem_helper.TESTFN,
                              (None, None), dir_fd=f)
            self.assertRaises(TypeError, posix.utime, filesystem_helper.TESTFN,
                              (now, None), dir_fd=f)
    ...
    def test_link_dir_fd(self):
        ...
        try:
            ...
            posix.close(f)
            filesystem_helper.unlink(filesystem_helper.TESTFN + 'link')
    ...
    def test_mkdir_dir_fd(self):
        ...
        try:
            ...
            posix.close(f)
            filesystem_helper.rmtree(filesystem_helper.TESTFN + 'dir')
    ...
    def test_rename_dir_fd(self):
        filesystem_helper.unlink(filesystem_helper.TESTFN)
        filesystem_helper.create_empty_file(filesystem_helper.TESTFN + 'ren')
        f = posix.open(posix.getcwd(), posix.O_RDONLY)
        try:
    ...
    def test_unlink_dir_fd(self):
        f = posix.open(posix.getcwd(), posix.O_RDONLY)
        filesystem_helper.create_empty_file(filesystem_helper.TESTFN + 'del')
        posix.stat(filesystem_helper.TESTFN + 'del') # should not raise exception
        try:
            posix.unlink(filesystem_helper.TESTFN + 'del', dir_fd=f)
        except:
            filesystem_helper.unlink(filesystem_helper.TESTFN + 'del')
            raise
        else:
            self.assertRaises(OSError, posix.stat, filesystem_helper.TESTFN + 'link')
        finally:
            posix.close(f)
...
class _PosixSpawnMixin:
    ...
    def test_returns_pid(self):
        ...
        self.addCleanup(filesystem_helper.unlink, pidfile)
        script = f"""if 1:
            import os
    ...
    def test_specify_environment(self):
        ...
        self.addCleanup(filesystem_helper.unlink, envfile)
        script = f"""if 1:
            import os
    ...
    def test_open_file(self):
        ...
        self.addCleanup(filesystem_helper.unlink, outfile)
        script = """if 1:
            import sys
    ...
    def test_close_file(self):
        ...
        self.addCleanup(filesystem_helper.unlink, closefile)
        script = f"""if 1:
            import os
            try:
                os.fstat(0)
    ...
    def test_dup2(self):
        ...
        self.addCleanup(filesystem_helper.unlink, dupfile)
        script = """if 1:
            import sys
            sys.stdout.write("hello")
            """
