...
class StringlikeHashRandomizationTests(HashRandomizationTests):
    ...
    known_hashes = {
        ...
        'siphash13': [
            ...
            # seed 42, 'abc'
            [273876886, -4501618152524544106, 273876886, 3869580338025362921],
            # seed 42, 'abcdefghijk'
            [-1745215313, 4436719588892876975, -1745215313, 7764564197781545852],
            # seed 0, 'äú∑ℇ'
            [493570806, 5749986484189612790, -1006381564, -2810468059467891395],
            # seed 42, 'äú∑ℇ'
            [-1677110816, -2947981342227738144, -1860207793, -2845126246016066802],
        ],
        'siphash24': [
            # NOTE: PyUCS2 layout depends on endianness
            # seed 0, 'abc'
