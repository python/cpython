# -*- coding: utf-8 -*-
# Autogenerated by Sphinx on Fri Jan  5 14:06:02 2024
...
topics = {'assert': 'The "assert" statement\n'
 ...
 'match': 'The "match" statement\n'
          ...
          '     match.  The exact behavior is dependent on implementation and '
          'may\n'
          '     vary.  This is an intentional decision made to allow '
          'different\n'
          '     implementations to add optimizations.\n'
          ...
          '  Depending on implementation, the interpreter may cache values or '
          'use\n'
          '  other optimizations which skip repeated evaluations.\n'
          '\n'
          'A sample match statement:\n'
          ...
          'A "guard" (which is part of the "case") must succeed for code '
          'inside\n'
          'the "case" block to execute.  It takes the form: "if" followed by '
          'an\n'
          'expression.\n'
          '\n'
          'The logical flow of a "case" block with a "guard" follows:\n'
          ...
          '\n'
          'An irrefutable case block is a match-all case block.  A match\n'
          'statement may have at most one irrefutable case block, and it must '
          'be\n'
          'last.\n'
          '\n'
          'A case block is considered irrefutable if it has no guard and its\n'
          'pattern is irrefutable.  A pattern is considered irrefutable if we '
          'can\n'
          ...
          '                      | class_pattern\n'
          '\n'
          'The descriptions below will include a description “in simple terms” '
          'of\n'
          'what a pattern does for illustration purposes (credits to Raymond\n'
          'Hettinger for a document that inspired most of the descriptions). '
          'Note\n'
          'that these descriptions are purely for illustration purposes and '
          '**may\n'
          'not** reflect the underlying implementation.  Furthermore, they do '
          'not\n'
          'cover all valid forms.\n'
          '\n'
          '\n'
          ...
          '   or_pattern ::= "|".closed_pattern+\n'
          '\n'
          'Only the final subpattern may be irrefutable, and each subpattern '
          'must\n'
          'bind the same set of names to avoid ambiguity.\n'
          '\n'
          'An OR pattern matches each of its subpatterns in turn to the '
          ...
          'The rule "strings" and the token "NUMBER" are defined in the '
          'standard\n'
          'Python grammar.  Triple-quoted strings are supported.  Raw strings '
          'and\n'
          'byte strings are supported.  f-strings are not supported.\n'
          '\n'
          'The forms "signed_number \'+\' NUMBER" and "signed_number \'-\' '
          'NUMBER"\n'
          'are for expressing complex numbers; they require a real number on '
          'the\n'
          'left and an imaginary number on the right. E.g. "3 + 4j".\n'
          '\n'
          'In simple terms, "LITERAL" will succeed only if "<subject> ==\n'
          ...
          'Capture patterns always succeed.  The binding follows scoping '
          'rules\n'
          'established by the assignment expression operator in **PEP 572**; '
          'the\n'
          'name becomes a local variable in the closest containing function '
          'scope\n'
          'unless there’s an applicable "global" or "nonlocal" statement.\n'
          ...
          'A sequence pattern contains several subpatterns to be matched '
          'against\n'
          'sequence elements. The syntax is similar to the unpacking of a list '
          'or\n'
          'tuple.\n'
          '\n'
          '   sequence_pattern       ::= "[" [maybe_sequence_pattern] "]"\n'
          ...
          'wildcard_pattern)\n'
          '\n'
          'There is no difference if parentheses  or square brackets are used '
          'for\n'
          'sequence patterns (i.e. "(...)" vs "[...]" ).\n'
          '\n'
          'Note:\n'
          ...
          '     The length of the subject sequence is obtained via "len()" '
          '(i.e.\n'
          '     via the "__len__()" protocol).  This length may be cached by '
          'the\n'
          '     interpreter in a similar manner as value patterns.\n'
          '\n'
          ...
          'Duplicate keys in mapping patterns are disallowed. Duplicate '
          'literal\n'
          'keys will raise a "SyntaxError". Two keys that otherwise have the '
          'same\n'
          'value will raise a "ValueError" at runtime.\n'
          '\n'
 ...
 'types': 'The standard type hierarchy\n'
          ...
          '\n'
          '   * "end" (an "int") represents the offset (inclusive) of the end '
          'of\n'
          '     the *bytecode* range\n'
          '\n'
          ...
          '\n'
          '   * The "tuple" yielded will have "end" equal to the size of the\n'
          '     *bytecode*.\n'
          '\n'
