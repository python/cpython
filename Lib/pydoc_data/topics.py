# -*- coding: utf-8 -*-
# Autogenerated by Sphinx on Sun Jul 23 19:35:51 2017
topics = {'assert': '\n'
 ...
 'calls': '\n'
          ...
          '"expression"\n'
          'must evaluate to an *iterable*.  Elements from these iterables '
          'are\n'
 ...
 'comparisons': '\n'
                ...
                'operators\n'
                'implement a particular notion of what the value of an '
                'object is.  One\n'
                ...
                'equality\n'
                'comparison of instances with different identities results '
                'in\n'
                ...
                '== y").\n'
                '\n'
                'A default order comparison ("<", ">", "<=", and ">=") is '
                'not provided;\n'
                'an attempt raises "TypeError".  A motivation for this '
                'default behavior\n'
                ...
                'their\n'
                'comparison behavior, and in fact, a number of built-in '
                'types have done\n'
                'that.\n'
                '\n'
                ...
                'order\n'
                '  comparison.  Within the limits of the types involved, '
                'they compare\n'
                ...
                '"False".\n'
                '  For example, both "3 < float(\'NaN\')" and '
                '"float(\'NaN\') < 3" will\n'
                '  return "False".\n'
                '\n'
                ...
                'comparison across\n'
                '  these types results in unequality, and ordering '
                'comparison across\n'
                ...
                'behavior of NaN\n'
                '     >>> [nan] == [nan]\n'
                '     True                  <-- list enforces reflexivity '
                'and tests identity first\n'
                '\n'
                '  Lexicographical comparison between built-in collections '
                'works as\n'
                '  follows:\n'
                '\n'
                '  * For two collections to compare equal, they must be of '
                'the same\n'
                ...
                '\n'
                '  * Collections that support order comparison are ordered '
                'the same\n'
                ...
                '    "[1,2] < [1,2,3]" is true).\n'
                '\n'
                '* Mappings (instances of "dict") compare equal if and only '
                'if they\n'
                '  have equal *(key, value)* pairs. Equality comparison of '
                'the keys and\n'
                ...
                'superset\n'
                '  tests.  Those relations do not define total orderings '
                '(for example,\n'
                '  the two sets "{1,2}" and "{2,3}" are not equal, nor '
                'subsets of one\n'
                ...
                'otherwise.\n'
                '"x not in s" returns the negation of "x in s".  All '
                'built-in sequences\n'
                ...
                '-1".\n'
                'Empty strings are always considered to be a substring of '
                'any other\n'
                ...
                'with "x ==\n'
                'z" is produced while iterating over "y".  If an exception '
                'is raised\n'
                ...
                'class defines\n'
                '"__getitem__()", "x in y" is "True" if and only if there is '
                'a non-\n'
                ...
                'Object identity\n'
                'is determined using the "id()" function.  "x is not y" '
                'yields the\n'
 ...
 'compound': '\n'
             ...
             'bodies.\n'
             '\n'
             'Functions defined with "async def" syntax are always '
             'coroutine\n'
             'functions, even if they do not contain "await" or "async" '
             'keywords.\n'
             '\n'
             'It is a "SyntaxError" to use "yield" expressions in "async '
             'def"\n'
             'coroutines.\n'
             '\n'
             ...
             '\n'
             'An *asynchronous iterable* is able to call asynchronous code '
             'in its\n'
             ...
             '\n'
             'An *asynchronous context manager* is a *context manager* that '
             'is able\n'
             ...
             '"async def" function.\n'
             '\n'
             'See also: **PEP 492** - Coroutines with async and await '
             'syntax\n'
             '\n'
             '-[ Footnotes ]-\n'
             '\n'
 ...
 'customization': '\n'
                  ...
                  '   "super().__new__(cls[, ...])" with appropriate '
                  'arguments and then\n'
                  ...
                  'to the\n'
                  '     traceback object when it is no longer useful, and '
                  'the third can\n'
                  '     be resolved by storing "None" in '
                  '"sys.last_traceback". Circular\n'
                  '     references which are garbage are detected and '
                  'cleaned up when the\n'
                  ...
                  'type is a\n'
                  "   direct or indirect subclass of the left operand's "
                  'type, the\n'
                  ...
                  'components of the\n'
                  '   object that also play a part in comparison of objects '
                  'by packing\n'
 ...
 'dict': '\n'
         ...
         '\n'
         'A double asterisk "**" denotes *dictionary unpacking*. Its '
         'operand\n'
 ...
 'execmodel': '\n'
              ...
              '======================\n'
              '\n'
              'A Python program is constructed from code blocks. A *block* '
              'is a piece\n'
              'of Python program text that is executed as a unit. The '
              'following are\n'
              'blocks: a module, a function body, and a class definition. '
              'Each\n'
              'command typed interactively is a block.  A script file (a '
              'file given\n'
              ...
              'block,\n'
              'unless declared as "nonlocal" or "global".  If a name is '
              'bound at the\n'
              ...
              'raised. If\n'
              'the current scope is a function scope, and the name refers to '
              'a local\n'
              ...
              'scope.\n'
              '"SyntaxError" is raised at compile time if the given name '
              'does not\n'
              ...
              '"__main__".\n'
              '\n'
              'Class definition blocks and arguments to "exec()" and '
              '"eval()" are\n'
 ...
 'exprlists': '\n'
              ...
              '\n'
              'Except when part of a list or set display, an expression '
              'list\n'
              'containing at least one comma yields a tuple.  The length of '
              'the tuple\n'
              'is the number of expressions in the list.  The expressions '
              'are\n'
              'evaluated from left to right.\n'
              '\n'
              'An asterisk "*" denotes *iterable unpacking*.  Its operand '
              'must be an\n'
              '*iterable*.  The iterable is expanded into a sequence of '
              'items, which\n'
 ...
 'formatstrings': '\n'
                  ...
                  'decimal point. The   |\n'
                  '   |           | default precision is as high as needed '
                  'to represent the    |\n'
                  '   |           | particular value. The overall effect is '
                  'to match the       |\n'
                  '   |           | output of "str()" as altered by the '
                  'other format           |\n'
                  '   |           | '
                  'modifiers.                                                 '
                  '|\n'
 ...
 'in': '\n'
       ...
       '"x\n'
       'in y" returns "True" if "y.__contains__(x)" returns a true value, '
       'and\n'
       '"False" otherwise.\n'
       '\n'
 ...
 'numeric-types': '\n'
                  ...
                  'instance of a\n'
                  '   class that has an "__add__()" method, "x.__add__(y)" '
                  'is called.\n'
                  ...
                  'defined to accept\n'
                  '   an optional third argument if the ternary version of '
                  'the built-in\n'
                  ...
                  'return the result\n'
                  '   (which could be, but does not have to be, *self*).  If '
                  'a specific\n'
                  '   method is not defined, the augmented assignment falls '
                  'back to the\n'
                  '   normal methods.  For instance, if *x* is an instance '
                  'of a class\n'
                  ...
                  'exception when the\n'
                  '   addition works?*), but this behavior is in fact part '
                  'of the data\n'
                  '   model.\n'
                  '\n'
                  'object.__neg__(self)\n'
 ...
 'operator-summary': '\n'
                     ...
                     'character "LATIN\n'
                     '    CAPITAL LETTER C WITH CEDILLA" can be represented '
                     'as a single\n'
                     '    *precomposed character* at code position U+00C7, '
                     'or as a sequence\n'
                     '    of a *base character* at code position U+0043 '
                     '(LATIN CAPITAL\n'
                     ...
                     'to humans.  For\n'
                     '    example, ""\\u00C7" == "\\u0043\\u0327"" is '
                     '"False", even though both\n'
                     '    strings represent the same abstract character '
                     '"LATIN CAPITAL\n'
 ...
 'raise': '\n'
          ...
          'inside\n'
          'an exception handler or a "finally" clause: the previous '
          'exception is\n'
 ...
 'sequence-types': '\n'
                   ...
                   'length is\n'
                   '   required to be at most "sys.maxsize". If the length '
                   'is larger than\n'
                   '   "sys.maxsize" some features (such as "len()") may '
                   'raise\n'
                   '   "OverflowError".  To prevent raising "OverflowError" '
                   'by truth value\n'
                   '   testing, an object must define a "__bool__()" '
                   'method.\n'
                   '\n'
 ...
 'slicings': '\n'
             ...
             'with a\n'
             'key that is constructed from the slice list, as follows.  If '
             'the slice\n'
             ...
             'an\n'
             'expression is that expression.  The conversion of a proper '
             'slice is a\n'
 ...
 'specialnames': '\n'
                 ...
                 '\n'
                 'The class creation process can be customized by passing '
                 'the\n'
 ...
 'string-methods': '\n'
                   ...
                   'objects.  The\n'
                   '   separator between elements is the string providing '
                   'this method.\n'
                   '\n'
                   ...
                   'Unicode ordinal\n'
                   '   or a string, to map the character to one or more '
                   'other characters;\n'
                   '   return "None", to delete the character from the '
                   'return string; or\n'
 ...
 'strings': '\n'
            ...
            '\n'
            'New in version 3.3: The "\'rb\'" prefix of raw bytes literals '
            'has been\n'
            ...
            'row\n'
            'terminate the literal.  (A "quote" is the character used to '
            'open the\n'
 ...
 'typesseq': '\n'
             ...
             '*t* | (6)(7)     |\n'
             '+----------------------------+----------------------------------+------------+\n'
             '| "s * n" or "n * s"         | equivalent to adding *s* '
             'to      | (2)(7)     |\n'
             '|                            | itself *n* '
             'times                 |            |\n'
             '+----------------------------+----------------------------------+------------+\n'
             ...
             'use\n'
             '     "str.join()" at the end or else write to an '
             '"io.StringIO"\n'
             ...
             '   step\n'
             '\n'
             '      The value of the *step* parameter (or "1" if the '
             'parameter was\n'
             '      not supplied)\n'
             '\n'
 ...
 'typesseq-mutable': '\n'
                     ...
                     '"s[:]")                 |                       |\n'
                     '+--------------------------------+----------------------------------+-----------------------+\n'
                     '| "s.extend(t)" or "s += t"      | extends *s* with '
                     'the contents of |                       |\n'
                     '|                                | *t* (for the most '
                     'part the same  |                       |\n'
                     '|                                | as '
