# Autogenerated by Sphinx on Tue Sep  1 12:14:28 2026
...
Changed in version 3.15: The "__cached__" attribute is no longer set
on modules or taken into consideration by the import system or
standard library.
...
and "tuple" classes, and the "collections" module.) See Time
complexity of operations on built-in types for the costs of the
