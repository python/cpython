...
def _process_class(cls, init, repr, eq, order, unsafe_hash, frozen, slots):
...
def dataclass(cls=None, /, *, init=True, repr=True, eq=True, order=False,
              unsafe_hash=False, frozen=False, slots=False):
    ...
    not be assigned to after instance creation. If slots is true, an
    __slots__ attribute is added.
    """

    def wrap(cls):
        return _process_class(cls, init, repr, eq, order, unsafe_hash, frozen, slots)
