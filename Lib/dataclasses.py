...
def _make_annotate_function(__class__, method_name, annotation_fields, return_type):
    ...
    # Mark the function as generated by dataclasses, for introspection.
...
def _process_class(cls, init, repr, eq, order, unsafe_hash, frozen,
    ...
    if slots:
        # Create the slotted class before generating any methods, so that
        # the generated methods are bound to the final class from the start
        # and the __class__ cell fix-up in _add_slots only has to look at
