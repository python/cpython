...
pseudo_op('DELETE_DEREF_NOERROR', 266, ['DELETE_DEREF'])
pseudo_op('DELETE_GLOBAL_NOERROR', 267, ['DELETE_GLOBAL'])
pseudo_op('DELETE_NAME_NOERROR', 268, ['DELETE_NAME'])
pseudo_op('DEL_PLACEHOLDER', 269, ['DEL_PLACEHOLDER'])
