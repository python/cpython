...
def btop(x): return ((u_int)((x) >> PAGESHIFT))

def btopr(x): return ((u_int)(((x) + PAGEOFFSET) >> PAGESHIFT))
...
D_MTPERMOD = 0x6000
D_MTOUTPERIM = 0x8000
D_MTINNER_MOD = (D_MTPUTSHARED|_D_MTOCSHARED)
