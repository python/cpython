...
class ConfigDialog(Toplevel):
    ...
    def create_widgets(self):
        ...
        note.add(self.highpage, text='Highlights', underline=0)
        note.add(self.keyspage, text=' Keys ', underline=1)
        note.add(self.genpage, text=' General ', underline=1)
        note.add(self.extpage, text='Extensions', underline=0)
