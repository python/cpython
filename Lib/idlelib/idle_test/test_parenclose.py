...
class ParenCloseTest(unittest.TestCase):
    def test_parenClose(self):
        ...
        for paren_close_set, tick_close_set, skip_closures_set, mutual_set, \
            insert, func, pos, char, result, posend in [
              (1, 1, 1, 1, 'def abuse', p_open, '1.9', '(',
               'def abuse()', '1.10'),
              (1, 1, 1, 1, 'spam = ', p_open, '1.7', '[',
               'spam = []', '1.8'),
              (1, 1, 1, 1, 'eggs = ', p_open, '1.7', '{',
               'eggs = {}', '1.8'),
              (1, 1, 1, 1, 'def abuse2()', p_close, '1.11', ')',
               'def abuse2()', '1.12'),
              (1, 1, 1, 1, 'spam2 = []', p_close, '1.9', ']',
               'spam2 = []', '1.10'),
              (1, 1, 1, 1, 'eggs2 = {}', p_close, '1.9', '}',
               'eggs2 = {}', '1.10'),
              (1, 1, 1, 1, "color = ", t_open, '1.8', "'",
               "color = ''", '1.9'),
              (1, 1, 1, 1, "velocity = ", t_open, '1.11', '"',
               'velocity = ""', '1.12'),
              (1, 1, 1, 1, "more_spam = ''", t_open, '1.14', "'",
               "more_spam = ''''''", '1.15'),
              (1, 1, 1, 1, 'more_eggs = ""', t_open, '1.14', '"',
               'more_eggs = """"""', '1.15'),
              (1, 1, 1, 1, "more_spam2 = ''''''", t_open, '1.16', "'",
               "more_spam2 = ''''''", '1.17'),
              (1, 1, 1, 1, 'more_eggs2 = """"""', t_open, '1.16', '"',
               'more_eggs2 = """"""', '1.17'),
              (0, 1, 1, 1, 'no_spam = ', p_open, '1.10', '(',
               'no_spam = (', '1.11'),
              (1, 0, 1, 1, 'no_velocity = ', t_open, '1.14', "'",
               "no_velocity = '", '1.15'),
              (1, 0, 1, 1, 'no_more_eggs = ""', t_open, '1.17', '"',
               'no_more_eggs = """', '1.18'),
              (1, 1, 0, 1, 'tinny = []', p_close, '1.9', ']',
               'tinny = []]', '1.10'),
              (1, 1, 0, 1, 'gone = ""', t_open, '1.8', '"',
               'gone = """"', '1.9'),
              (0, 0, 0, 1, 'nurb = ""', back, '1.8', '',
               'nurb = "', '1.8'),
              (0, 0, 0, 0, "honk = ''", back, '1.8', '',
               "honk = ''", '1.8'),
              (0, 0, 0, 1, 'chiz = []', delete, '1.8', '',
               'chiz = ]', '1.7'),
