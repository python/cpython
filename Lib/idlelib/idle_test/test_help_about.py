    ...
    def test_printer_buttons(self):
        ...
        for button, printer in button_sources:
            ...
            self.assertEqual(
                    ...
                    dialog._current_textview.textframe.text.get('1.0', '1.end'))
            self.assertEqual(
                    printer._Printer__lines[1],
                    dialog._current_textview.textframe.text.get('2.0', '2.end'))
    ...
    def test_file_buttons(self):
        ...
        for button, filename in button_sources:
            ...
            with open(fn) as f:
                ...
                self.assertEqual(
                    f.readline().strip(),
                    dialog._current_textview.textframe.text.get('3.0', '3.end'))
            dialog._current_textview.destroy()
