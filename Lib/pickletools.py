...
>>> dis(pkl1)
   ...
   14: }        EMPTY_DICT
   15: q        BINPUT     1
   17: c        GLOBAL     '_codecs encode'
   33: q        BINPUT     2
   35: (        MARK
   36: X            BINUNICODE 'abc'
   44: X            BINUNICODE 'latin1'
   55: q            BINPUT     3
   57: t            TUPLE      (MARK at 35)
   58: R        REDUCE
   59: X        BINUNICODE 'def'
   67: q        BINPUT     4
   69: s        SETITEM
   70: e        APPENDS    (MARK at 3)
   71: .    STOP
...
>>> dis(pickle.dumps(x, 1))
   ...
   83: }        EMPTY_DICT
   84: q        BINPUT     5
   86: X        BINUNICODE 'value'
   96: q        BINPUT     6
   98: K        BININT1    42
  100: s        SETITEM
  101: b        BUILD
  102: h        BINGET     4
  104: e        APPENDS    (MARK at 3)
  105: .    STOP
highest protocol among opcodes = 1
