...
_specialized_opmap = frozendict(
    ...
    CALL_LIST_APPEND_SUBTYPE=159,
    CALL_METHOD_DESCRIPTOR_FAST=160,
    CALL_METHOD_DESCRIPTOR_FAST_WITH_KEYWORDS=161,
    CALL_METHOD_DESCRIPTOR_NOARGS=162,
    CALL_METHOD_DESCRIPTOR_O=163,
    CALL_NON_PY_GENERAL=164,
    CALL_PY_EXACT_ARGS=165,
    CALL_PY_GENERAL=166,
    CALL_STR_1=167,
    CALL_TUPLE_1=168,
    CALL_TYPE_1=169,
    COMPARE_OP_FLOAT=170,
    COMPARE_OP_INT=171,
    COMPARE_OP_STR=172,
    CONTAINS_OP_DICT=173,
    CONTAINS_OP_SET=174,
    FOR_ITER_GEN=175,
    FOR_ITER_LIST=176,
    FOR_ITER_RANGE=177,
    FOR_ITER_TUPLE=178,
    FOR_ITER_VIRTUAL=179,
    GET_ITER_SELF=180,
    GET_ITER_VIRTUAL=181,
    JUMP_BACKWARD_JIT=182,
    JUMP_BACKWARD_NO_JIT=183,
    LOAD_ATTR_CLASS=184,
    LOAD_ATTR_CLASS_WITH_METACLASS_CHECK=185,
    LOAD_ATTR_GETATTRIBUTE_OVERRIDDEN=186,
    LOAD_ATTR_INSTANCE_VALUE=187,
    LOAD_ATTR_METHOD_LAZY_DICT=188,
    LOAD_ATTR_METHOD_NO_DICT=189,
    LOAD_ATTR_METHOD_WITH_VALUES=190,
    LOAD_ATTR_MODULE=191,
    LOAD_ATTR_NONDESCRIPTOR_NO_DICT=192,
    LOAD_ATTR_NONDESCRIPTOR_WITH_VALUES=193,
    LOAD_ATTR_PROPERTY=194,
    LOAD_ATTR_SLOT=195,
    LOAD_ATTR_WITH_HINT=196,
    LOAD_GLOBAL_BUILTIN=197,
    LOAD_GLOBAL_MODULE=198,
    LOAD_SUPER_ATTR_ATTR=199,
    LOAD_SUPER_ATTR_METHOD=200,
    RESUME_CHECK=201,
    RESUME_CHECK_JIT=202,
    SEND_ASYNC_GEN=203,
    SEND_GEN=204,
    SEND_VIRTUAL=205,
    STORE_ATTR_INSTANCE_VALUE=206,
    STORE_ATTR_SLOT=207,
    STORE_ATTR_WITH_HINT=208,
    STORE_SUBSCR_DICT=209,
    STORE_SUBSCR_LIST_INT=210,
    TO_BOOL_ALWAYS_TRUE=211,
    TO_BOOL_BOOL=212,
    TO_BOOL_INT=213,
    TO_BOOL_LIST=214,
    TO_BOOL_NONE=215,
    TO_BOOL_STR=216,
    UNPACK_SEQUENCE_LIST=217,
    UNPACK_SEQUENCE_TUPLE=218,
    UNPACK_SEQUENCE_TWO_TUPLE=219,
)
