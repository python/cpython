...
_specialized_opmap = frozendict(
    ...
    BINARY_OP_MULTIPLY_INT_WIDE=136,
    BINARY_OP_SUBSCR_DICT=137,
    BINARY_OP_SUBSCR_GETITEM=138,
    BINARY_OP_SUBSCR_LIST_INT=139,
    BINARY_OP_SUBSCR_LIST_SLICE=140,
    BINARY_OP_SUBSCR_STR_INT=141,
    BINARY_OP_SUBSCR_TUPLE_INT=142,
    BINARY_OP_SUBSCR_USTR_INT=143,
    BINARY_OP_SUBTRACT_FLOAT=144,
    BINARY_OP_SUBTRACT_INT=145,
    BINARY_OP_SUBTRACT_INT_WIDE=146,
    CALL_ALLOC_AND_ENTER_INIT=147,
    CALL_BOUND_METHOD_EXACT_ARGS=148,
    CALL_BOUND_METHOD_GENERAL=149,
    CALL_BUILTIN_CLASS=150,
    CALL_BUILTIN_FAST=151,
    CALL_BUILTIN_FAST_WITH_KEYWORDS=152,
    CALL_BUILTIN_O=153,
    CALL_EX_NON_PY_GENERAL=154,
    CALL_EX_PY=155,
    CALL_ISINSTANCE=156,
    CALL_KW_BOUND_METHOD=157,
    CALL_KW_NON_PY=158,
    CALL_KW_PY=159,
    CALL_LEN=160,
    CALL_LIST_APPEND=161,
    CALL_METHOD_DESCRIPTOR_FAST=162,
    CALL_METHOD_DESCRIPTOR_FAST_WITH_KEYWORDS=163,
    CALL_METHOD_DESCRIPTOR_NOARGS=164,
    CALL_METHOD_DESCRIPTOR_O=165,
    CALL_NON_PY_GENERAL=166,
    CALL_PY_EXACT_ARGS=167,
    CALL_PY_GENERAL=168,
    CALL_STR_1=169,
    CALL_TUPLE_1=170,
    CALL_TYPE_1=171,
    COMPARE_OP_FLOAT=172,
    COMPARE_OP_INT=173,
    COMPARE_OP_STR=174,
    CONTAINS_OP_DICT=175,
    CONTAINS_OP_SET=176,
    FOR_ITER_GEN=177,
    FOR_ITER_LIST=178,
    FOR_ITER_RANGE=179,
    FOR_ITER_TUPLE=180,
    FOR_ITER_VIRTUAL=181,
    GET_ITER_SELF=182,
    GET_ITER_VIRTUAL=183,
    JUMP_BACKWARD_JIT=184,
    JUMP_BACKWARD_NO_JIT=185,
    LOAD_ATTR_CLASS=186,
    LOAD_ATTR_CLASS_WITH_METACLASS_CHECK=187,
