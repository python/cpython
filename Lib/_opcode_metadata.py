...
_specialized_opmap = {
    ...
    'TO_BOOL_NONE': 62,
    'TO_BOOL_STR': 63,
    'CALL_ALLOC_AND_ENTER_INIT': 77,
    'CALL_BOUND_METHOD_EXACT_ARGS': 78,
    'CALL_BUILTIN_CLASS': 79,
    'CALL_BUILTIN_FAST': 80,
    'CALL_BUILTIN_FAST_WITH_KEYWORDS': 81,
    'CALL_BUILTIN_O': 82,
    'CALL_ISINSTANCE': 86,
    'CALL_LEN': 88,
    'CALL_LIST_APPEND': 89,
    'CALL_METHOD_DESCRIPTOR_FAST': 90,
    'CALL_METHOD_DESCRIPTOR_FAST_WITH_KEYWORDS': 91,
    'CALL_METHOD_DESCRIPTOR_NOARGS': 92,
    'CALL_METHOD_DESCRIPTOR_O': 93,
    'CALL_PY_EXACT_ARGS': 94,
    'CALL_PY_WITH_DEFAULTS': 95,
    'CALL_STR_1': 96,
    'CALL_TUPLE_1': 97,
    'CALL_TYPE_1': 98,
