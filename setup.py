...
class PyBuildExt(build_ext):
    ...
    def detect_modules(self):
        ...
        MIN_SQLITE_VERSION = ".".join(
            [str(x) for x in MIN_SQLITE_VERSION_NUMBER])
        ...
        exts.append(Extension(
            '_multiprocessing', multiprocessing_srcs,
            define_macros=[macros.itemsms()],
