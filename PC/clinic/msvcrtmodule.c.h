...
msvcrt_putch(PyObject *module, PyObject *arg)
{
    ...
    if (PyBytes_Check(arg) && PyBytes_GET_SIZE(arg) == 1) {
        ...
        _PyArg_BadArgument("putch", 0, "argument", "a byte string of length 1", arg);
        goto exit;
    }
...
msvcrt_putwch(PyObject *module, PyObject *arg)
{
    ...
    if (!PyUnicode_Check(arg)) {
        _PyArg_BadArgument("putwch", 0, "argument", "a unicode character", arg);
        goto exit;
    }
...
msvcrt_ungetch(PyObject *module, PyObject *arg)
{
    ...
    if (PyBytes_Check(arg) && PyBytes_GET_SIZE(arg) == 1) {
        ...
        _PyArg_BadArgument("ungetch", 0, "argument", "a byte string of length 1", arg);
        goto exit;
    }
...
msvcrt_ungetwch(PyObject *module, PyObject *arg)
{
    ...
    if (!PyUnicode_Check(arg)) {
        _PyArg_BadArgument("ungetwch", 0, "argument", "a unicode character", arg);
        goto exit;
    }
    if (PyUnicode_READY(arg)) {
        goto exit;
...
/*[clinic end generated code: output=7c498a598dc9a5a5 input=a9049054013a1b77]*/
