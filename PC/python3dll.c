...
EXPORT_DATA(PyDeepFreezeBytes_Type)
EXPORT_DATA(PyDeepFreezeCode_Type)
EXPORT_DATA(PyDeepFreezeComplex_Type)
EXPORT_DATA(PyDeepFreezeFloat_Type)
EXPORT_DATA(PyDeepFreezeLong_Type)
EXPORT_DATA(PyDeepFreezeTuple_Type)
