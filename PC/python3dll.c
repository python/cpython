...
EXPORT_FUNC(PyMonitoring_EnterScope)
EXPORT_FUNC(PyMonitoring_ExitScope)
EXPORT_FUNC(PyMonitoring_FireBranchEvent)
EXPORT_FUNC(PyMonitoring_FireCallEvent)
EXPORT_FUNC(PyMonitoring_FireCRaiseEvent)
EXPORT_FUNC(PyMonitoring_FireCReturnEvent)
EXPORT_FUNC(PyMonitoring_FireExceptionHandledEvent)
EXPORT_FUNC(PyMonitoring_FireInstructionEvent)
EXPORT_FUNC(PyMonitoring_FireJumpEvent)
EXPORT_FUNC(PyMonitoring_FireLineEvent)
EXPORT_FUNC(PyMonitoring_FirePyResumeEvent)
EXPORT_FUNC(PyMonitoring_FirePyReturnEvent)
EXPORT_FUNC(PyMonitoring_FirePyStartEvent)
EXPORT_FUNC(PyMonitoring_FirePyThrowEvent)
EXPORT_FUNC(PyMonitoring_FirePyUnwindEvent)
EXPORT_FUNC(PyMonitoring_FirePyYieldEvent)
EXPORT_FUNC(PyMonitoring_FireRaiseEvent)
EXPORT_FUNC(PyMonitoring_FireReraiseEvent)
EXPORT_FUNC(PyMonitoring_FireStopIterationEvent)
