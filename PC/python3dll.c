...
EXPORT_FUNC(PyImport_GetLazyImportsFilter)
EXPORT_FUNC(PyImport_GetLazyImportsMode)
EXPORT_FUNC(PyImport_SetLazyImportsFilter)
EXPORT_FUNC(PyImport_SetLazyImportsMode)
