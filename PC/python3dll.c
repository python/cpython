...
EXPORT_FUNC(Py_Exit)
EXPORT_FUNC(Py_ExitWithInitConfig)
...
EXPORT_FUNC(Py_InitializeFromInitConfig)
EXPORT_FUNC(Py_Is)
...
EXPORT_FUNC(PyInitConfig_Exception)
EXPORT_FUNC(PyInitConfig_Free)
EXPORT_FUNC(PyInitConfig_GetError)
EXPORT_FUNC(PyInitConfig_GetExitCode)
EXPORT_FUNC(PyInitConfig_Isolated_New)
EXPORT_FUNC(PyInitConfig_Python_New)
EXPORT_FUNC(PyInitConfig_SetInt)
EXPORT_FUNC(PyInitConfig_SetStr)
EXPORT_FUNC(PyInitConfig_SetStrList)
EXPORT_FUNC(PyInitConfig_SetWStr)
EXPORT_FUNC(PyInitConfig_SetWStrList)
