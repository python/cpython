...
.. c:function:: void function__entry(str filename, str funcname, int lineno)
...
.. c:function:: void function__return(str filename, str funcname, int lineno)
...
.. c:function:: void line(str filename, str funcname, int lineno)
...
.. c:function:: void gc__start(int generation)

   Fires when the Python interpreter starts a garbage collection cycle.
   ``arg0`` is the generation to scan, like :func:`gc.collect()`.

.. c:function:: void gc__done(long collected)

   Fires when the Python interpreter finishes a garbage collection
   cycle. ``arg0`` is the number of collected objects.

.. c:function:: void import__find__load__start(str modulename)
...
.. c:function:: void import__find__load__done(str modulename, int found)
...
.. c:function:: void audit(str event, void *tuple)
...
.. c:function:: void python.function.entry(str filename, str funcname, int lineno, frameptr)

   This probe point indicates that execution of a Python function has begun.
   It is only triggered for pure-Python (bytecode) functions.

.. c:function:: void python.function.return(str filename, str funcname, int lineno, frameptr)
