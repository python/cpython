...
2.0.1 and its alpha and beta releases, and Python 2.1.1, is owned by
the Python Software Foundation (PSF), a non-profit modeled after the
Apache Software Foundation.  See \url{http://www.python.org/psf/} for
more information about the PSF.
