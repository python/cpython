...
.. function:: isqrt(n)
   ...
   For some applications, it's convenient to have the ceiling of the
   square root of *n* rather than the floor. For a positive *n*, the
   ceiling of the square of *n* can be computed with `1 + isqrt(n - 1)`.
