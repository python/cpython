...
.. function:: hex(number,/)
   ...
   "0x". If *number* is not a Python :class:`int` object, it has to define an
...
.. function:: min(iterable, *[, default=obj, key=func]) 
...
.. function:: oct(number, /)
  ...
  is a valid Python expression. If *number* is not a Python :class:`int` object, it
