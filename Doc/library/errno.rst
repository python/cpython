...
borrowed from :file:`linux/include/errno.h`, (`an archive <https://kernel.googlesource.com/pub/scm/linux/kernel/git/nico/archive/+/v0.97/include/linux/errno.h>`_ which contains error codes) which should be
all-inclusive. 
