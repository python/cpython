...
.. seealso::
   ...
   :ref:`Guide to typing features <typing-features-guide>`
      The page you're currently viewing is the API reference for the typing
      module. See the "Guide to typing features" for more in-depth guides and
      tutorials on specific features in the typing module.
