...
.. class:: c_size_t
   ...
   Represents the C :c:expr:`size_t` datatype.


.. class:: c_ssize_t

   Represents the C :c:expr:`ssize_t` datatype.
...
.. class:: HRESULT
   ...
   Windows only: Represents a :c:expr:`HRESULT` value, which contains success or
