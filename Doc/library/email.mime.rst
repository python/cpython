...
.. class:: MIMEImage(_imagedata, _subtype=None, \
   ...
   this data can be decoded by the standard Python module :mod:`imghdr`
   (which is deprecated), then the subtype will be automatically included in the
   ...
   *_params* are passed straight through to the :class:`~email.mime.base.MIMEBase`
   ...
   .. versionchanged:: 3.11
      Deprecated the default value for *_subtype* due :mod:`imghdr` being
      deprecated.
