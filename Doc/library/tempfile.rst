...
.. function:: TemporaryFile(mode='w+b', buffering=-1, encoding=None, newline=None, suffix=None, prefix=None, dir=None)
   ...
   The default value of the *buffering* parameter is -1, to prevent any kind of buffering pass 0, for *buffering* as -1 means a fixed buffer based on OS properties and is interpreted as for the :func:`open`.
