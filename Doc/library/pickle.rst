...
.. class:: Pickler(file, protocol=None, \*, fix_imports=True, buffer_callback=None)
   ...
   If *fix_imports* is a truthy value and *protocol* is less than 3, pickle will try to
...
.. class:: Unpickler(file, \*, fix_imports=True, encoding="ASCII", errors="strict", buffers=None)
   ...
   If *fix_imports* is a truthy value, pickle will try to map the old Python 2 names
