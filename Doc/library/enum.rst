...
---------------
   ...
   :class:`EnumCheck`
      ...
      An enumeration with the values ``UNIQUE``, ``CONTINUOUS``, and
      ``COMPOSITE`` for use with :func:`verify` to ensure various constraints
      are met by other enumerations.
   ...
   *EnumCheck* contains the options used by the :func:`verify` decorator to ensure
   ...
   .. attribute:: COMPOSITE
      ...
      values are specified instead of being generated by :func:`auto`
         ...
         >>> from enum import Flag, verify, COMPOSITE
         >>> @verify(COMPOSITE)
         ... class Color(Flag):
         ...     RED = 1
         ...     GREEN = 2
...
.. note::
   ...
   CONTINUOUS and COMPOSITE are designed to work with integer-valued members.
