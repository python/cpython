...
.. class:: ThreadedChildWatcher
   ...
   There is no noticeable overhead when handling a big number of children (:math:`O(1)` each
...
.. class:: MultiLoopChildWatcher
   ...
   handling a big number of processes (:math:`O(n)` each time a
...
.. class:: SafeChildWatcher
   ...
   This solution is as safe as :class:`MultiLoopChildWatcher` and has the same :math:`O(n)`
...
.. class:: FastChildWatcher
   ...
   children (:math:`O(1)` each time a child terminates).
