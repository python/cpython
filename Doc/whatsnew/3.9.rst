...
Added the *omit_defaults* option to :func:`~ast.dump` which allows it to
produce a representation with omitting default values.
...
Added default values to AST node classes for thier initialization.
