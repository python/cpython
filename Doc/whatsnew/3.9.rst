...
Scoped IPv6 could be parsed to :class:`ipaddress.IPv6Address` constructor:
...
If present, scope zone ID is avalaible through :attr:`scope_id` attribute.

(Contributed by Oleksand Pavliuk in :issue:`34788`.)
