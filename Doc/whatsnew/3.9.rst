...
* :func:`resource.setrlimit` now raises :exc:`PermissionError` instead of
  :exc:`ValueError` if the user doesn't have enough privileges.
  (contributed by Giampaolo Rodola in :issue:`38480`)
