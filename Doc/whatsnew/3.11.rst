...
* Add :attr:`__parameters__` and :meth:`__getitem__` to :class:`types.Union`.
  Fix various :class:`types.Union` compatibility issues with :mod:`typing`
  module.
...
.. code-block:: python
  ...
  (Contributed by Yurii Karabas in :issue:`44490`.)
