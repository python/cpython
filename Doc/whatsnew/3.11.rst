...
* The :c:type:`PyFrameObject` structure members have been removed from the
  ...
  * ``f_valuestack``: removed.
  ...
  whether a "call" event is starting or resuming a generator can use the
  :c:func:`PyFrame_GetState` which is equivalent to the new `f_state`
  attribute for frame objects.
