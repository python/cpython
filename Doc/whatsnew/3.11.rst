...
* The default argument for *_subtype* for :class:`email.mime.MIMEImage`
  has been deprecated due to the deprecation of :mod:`imghdr`. Please
  explicitly provide a an image subtype.
