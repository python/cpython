...
* Add a new :c:func:`PyErr_ChainExceptions` function that allows to chain exceptions
  using the C-API. See :ref:`tut-exception-chaining` for more information
  regarding the semantics of exception chaining. (Contributed by Pablo Galindo in :issue:`44938`.)
