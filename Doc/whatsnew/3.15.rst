...
* More color in
  ...
  stdlib (ast, compileall, doctest, gzip, inspect, json.tool, pdb, profiling.sampling, random, regrtest, sqlite3, timeit, tokenize, trace, unittest, uuid, zipapp, zipfile) CLI help.
...
* Add more color to calendar CLI output: bold months and highlighted day names.
  (Hugo van Kemenade in :gh:`148352`.)
