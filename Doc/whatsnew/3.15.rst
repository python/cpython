...
Python 3.15 was released on 1 October 2026.
...
Python 3.15 is the latest stable release of the Python programming
...
:ref:`UTF-8 as the default encoding <whatsnew315-utf8-default>`,
:ref:`unpacking in comprehensions <whatsnew315-unpacking-in-comprehensions>`,
and a :ref:`stable ABI for free-threaded builds <whatsnew315-abi3t>`.

The library changes include a new
:ref:`profiling package <whatsnew315-profiling-package>` with
:ref:`Tachyon <whatsnew315-sampling-profiler>`,
a high-frequency statistical sampling profiler,
:ref:`more color <whatsnew315-more-color>` in command-line output,
...
See `Porting to Python 3.15`_ for guidance on upgrading from
...
* :ref:`The experimental JIT compiler has been significantly upgraded <whatsnew315-jit>`
...
(Contributed by Jelle Zijlstra in :gh:`148829`; PEP 661 written by Tal Einat.)
...
* Annotations for generated ``__init__`` methods no longer include internal
  type names.
  (Contributed by David Ellis in :gh:`137530`.)
...
* Python 3.14.0-3.14.4 shipped with a new incremental garbage collector.
  ...
  (Contributed by Sergey Miryanov in :gh:`148726`.)
...
* Add a :option:`-H/--header <http.server --header>` option to the :program:`python -m http.server`
...
* Add the *array_hook* parameter to :func:`~json.load` and
  ...
  *object_pairs_hook* parameter and :class:`tuple` to *array_hook* will yield a
...
* The :ref:`command-line interface <sqlite3-cli>` has several new features:
  ...
  * SQL keyword completion on :kbd:`Tab`.
  ...
  * Table, index, trigger, view, column, function, and schema completion on :kbd:`Tab`.
...
* :func:`~tarfile.TarFile.gettarinfo` now replaces backslashes with slashes in
  ...
  (Contributed by Daniele Nicolodi in :gh:`151669`.)
...
* Expose the write-through :func:`locals` proxy type
  ...
  (Contributed by Peter Bierma in :gh:`136492`.)
...
* The Unicode database has been updated to Unicode 17.0.0.
  (Contributed by Benjamin Peterson in :gh:`138706`.)
...
* :class:`collections.abc.ByteString` has been removed from
  ...
  (Contributed by Alex Waygood in :gh:`118803`.)
...
* :mod:`imaplib`:
  ...
  * Altering :attr:`IMAP4.file <imaplib.IMAP4.file>` is now deprecated
    ...
    (Contributed by Bénédikt Tran in :gh:`142307`.)
...
* :c:type:`PyCriticalSection` and related functions are added to the Stable
  ABI.
  (Contributed by Petr Viktorin in :gh:`149225`.)
...
* :c:func:`!_PyObject_CallMethodId`, :c:func:`!_PyObject_GetAttrId` and
  :c:func:`!_PyUnicode_FromId` are deprecated since Python 3.15 and will be removed in
  Python 3.20. Instead, use :c:func:`PyUnicode_InternFromString()` and cache the result in
...
* :c:member:`~PyConfig.bytes_warning` is deprecated
  since Python 3.15 and will be removed in Python 3.17.
  (Contributed by Nikita Sobolev in :gh:`136355`.)
...
* :c:macro:`!Py_MATH_El` and :c:macro:`!Py_MATH_PIl` are deprecated
  since Python 3.15 and will be removed in Python 3.20.
  (Contributed by Sergey B Kirpichev in :gh:`141004`.)
...
* The new configure option :option:`--with-pymalloc-hugepages` enables huge
  ...
  (Contributed by Pablo Galindo Salgado in :gh:`144319`.)
...
* :meth:`mmap.mmap.resize` has been removed on platforms that don't support the
  ...
  (Contributed by An Long in :gh:`138205`.)
