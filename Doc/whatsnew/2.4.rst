...
program executed as the subprocess.  (If the *shell* argument is a truthy value, *args*
...
* Three keyword parameters, *cmp*, *key*, and *reverse*, were added to the
  ...
  *key* should be a single-parameter function that takes a list element and
  ...
  Finally, the *reverse* parameter takes a Boolean value.  If the value is a truthy value,
