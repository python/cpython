...
* :meth:`~object.__get__` is a method that retrieves the attribute value from
  *object*.

* :meth:`~object.__set__` sets the attribute on *object* to *value*.

* :meth:`~object.__delete__` deletes the *value*  attribute of *object*.
