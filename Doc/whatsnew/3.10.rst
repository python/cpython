...
:data:`TypeGuard` is a new addition to the :mod:`typing` module to annotate
type guard functions and improve information provided to static type checkers
for type narrowing.  For more information, please see :data:`TypeGuard`\ 's
documentation, and :pep:`647`.

(Contributed by Ken Jin in :issue:`43766`. PEP written by Eric Traut.)
