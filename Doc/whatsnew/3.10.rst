...
Added the new functions :func:`gc.track` and :func:`gc.untrack` to manually track
or untrack objects in the garbage collector. (Contributed by Pablo Galindo in
:issue:`42039`.)
