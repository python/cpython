...
* The :meth:`zipfile.ZipFile.open`, :meth:`zipfile.ZipFile.read`,
  :meth:`zipfile.ZipFile.write`, :meth:`zipfile.ZipFile.writestr`, and
  :class:`zipfile.ZipInfo` now accept :class:`os.PathLike` values such as
  :mod:`pathlib` provides as ``filename``, ``name``, or ``arcname``,
  parameters.
