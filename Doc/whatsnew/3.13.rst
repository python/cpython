...
* Add :meth:`dbm.gnu.gdbm.clear` and :meth:`dbm.ndbm.ndbm.clear`  methods that remove all items
  from the database.
  (Contributed by Donghee Na and Sylvie Liberman in :gh:`107122`.)
...
* The :class:`mmap.mmap` class now has an :meth:`~mmap.mmap.seekable` method
  ...
  the :meth:`~mmap.mmap.seek` method return the current position.
  (Contributed by Donghee Na in :gh:`111835`.)
