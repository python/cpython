...
* Added ``--durations`` command line option, showing the slowest test cases.
  If ``-v`` is used also shows the elapsed time of each individual test case::
    ...
    python3 -m unittest --durations=3 lib.tests.__main__
    .....
    Slowest test durations
    ----------------------------------------------------------------------
    0.151s     test_memory (lib.tests.test_memory.TestMemory)
    0.509s     test_system (lib.tests.test_system.TestSystem)
    1.414s     test_process (lib.tests.test_system.TestProcess)

    (0.000 durations hidden.  Use -v to show these durations.)
    ----------------------------------------------------------------------
    Ran 122 tests in 12.385s
