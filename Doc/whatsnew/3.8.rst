...
* :func:`shutil.copyfile`, :func:`shutil.copy`, :func:`shutil.copy2`,
  ...
  "zero-copy" syscalls such as :func:`os.sendfile` in order to copy the file
  more efficiently.
  "zero-copy" means that the copying operation occurs within the kernel,
  avoiding the use of userspace buffers as in "``outfd.write(infd.read())``".
