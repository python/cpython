...
The :func:`random.sample` function now accepts an optional *weights*
keyword argument to perform weighted sampling without replacement.
(Contributed by Piotr Jurkiewicz in :issue:`34227`.)
