...
* An optional keyword-only argument, *name*, was added to
  :func:`asyncio.create_task` and :meth:`asyncio.AbstractEventLoop.create_task`.
  The API for task factories was also changed accordingly to allow this argument
  to be passed.
