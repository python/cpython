...
* The :meth:`asyncio.Task.get_name` and :meth:`asyncio.Task.set_name` methods
  were added to the :class:`asyncio.Task` class. The name of the task was made
  visible in the ``repr()`` output of :class:`asyncio.Task` instances.
