...
* :func:`shutil.copyfile`, :func:`shutil.copy`, :func:`shutil.copy2`,
  ...
  zero-copy syscalls on Linux, OSX and Windows in order to copy the file more
  efficiently. The average speedup for copying a 512MB file is +24% on Linux,
  +50% on OSX and +48% on Windows.
