...
:func:`shutil.make_archive` now excludes '.' directory entries when adding
directories to a tar archive. The new behavior is inherited from the
corresponding change to the :mod:`tarfile` module.
Contributed by Jeffrey Kintscher in :issue:`35964`.)
...
The :mod:`tarfile` module now excludes '.' directory entries when adding
directories to a tar archive. (Contributed by Jeffrey Kintscher
in :issue:`35964`.)
