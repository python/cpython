...
* :func:`shutil.copyfile`, :func:`shutil.copy` and :func:`shutil.copy2` use
  platform specific zero-copy syscalls on Linux, OSX and Windows in order to
  copy the file more efficiently. The average speedup for copying a 512MB file
  is +24% on Linux, +50% on OSX and +48% on Windows.
