...
* :func:`shutil.copyfile`, :func:`shutil.copy` and :func:`shutil.copy2` use
  high-performance :func:`os.sendfile` if available and supports file-to-file
  copy (namely Linux) resulting in roughly a 20-25% speedup of the copying
  operation and a considerably lower CPU cycles consumption.
  (Contributed by Giampaolo Rodola' and desbma in :issue:`33639`)
