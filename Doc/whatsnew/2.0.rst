...
Backward compatibility with the 1.5 version of :mod:`httplib <http>` is provided,
...
* :mod:`_winreg <winreg>`: An interface to the Windows registry.  :mod:`_winreg <winreg>` is an
  ...
  :mod:`_winreg <winreg>` was written by Bill Tutt and Mark Hammond.
