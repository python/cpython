...
* Multiplication of large long integers is now much faster thanks to an
  ...
  the :math:`O(n^2)` required for the grade-school multiplication algorithm.  (Original
...
* The new :mod:`heapq` module contains an implementation of a heap queue
  ...
  :math:`O(\log{n})`.  (See https://xlinux.nist.gov/dads//HTML/priorityque.html for more
