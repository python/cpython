...
* Add the *validate* option to :class:`xml.sax.saxutils.XMLGenerator`,
  which makes it check that the generated document is well-formed.
  (Contributed by Serhiy Storchaka in :gh:`57092`.)
