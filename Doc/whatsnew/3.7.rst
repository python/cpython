...
A new command line option :samp:`--duplicate={D}` can be used to reduce the
overhead of the loop by duplicating statements.
(Contributed by Serhiy Storchaka in :issue:`30080`.)
