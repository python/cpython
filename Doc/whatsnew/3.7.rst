...
It was originally planned to become mandatory in Python 3.10, but was considered
too disruptive. :pep:`649` instead became the default in Python 3.14. You can
still override this by importing ``annotations``, but that's :term:`soft deprecated`
and may become a no-op or be removed in the future.
