...
* The output of the :func:`tokenize.tokenize` and :func:`tokenize.generate_tokens`
  ...
  * Incomplete single-line strings now also raise :exc:`tokenizer.TokenError` as incomplete
    multiline strings do.

  * Some incomplete or invalid Python code now raises :exc:`tokenizer.TokenError` instead of
