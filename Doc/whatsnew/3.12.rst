...
* :mod:`exceptions`: :exc:`DeprecationWarning` is now raised when ``__package__`` on a
...
* :mod:`distutils`: Remove the ``distutils`` package. It was deprecated in Python 3.10 by
