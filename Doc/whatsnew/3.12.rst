...
* :func:`logging.config.fileConfig` now raise :exc:`FileNotFoundError`
  if file doesn't exist and :exc:`ValueError` if file is invalid or
  empty. (Contributed by Prince Roshan in :gh:`103606`.)
