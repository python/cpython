...
* :pep:`683`: Introduced Immortal Objects to Python which allows objects
  ...
  - ``PyObject_HEAD_IMMORTAL_INIT`` A PyObject header initializer to immortal refcount
  - ``Py_MEMCPY`` A portable version of memcpy
  ...
  (Contributed by Eddie Elizondo in :gh:`19474`.)
