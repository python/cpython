...
constructor argument.  Use the ``source`` attribute and argument name instead.

:mod:`configparser` no longer has a ``SafeConfigParser`` class, use the shorter
:class:`~configparser.ConfigParser` name instead.
