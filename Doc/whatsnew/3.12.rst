...
* Add :attr:`~sqlite3.Connection.autocommit` attribute for :pep:`249`-compliant
...
* The :attr:`sqlite3.Connection.isolation_level` attribute is deprecated.
  Please use the new :attr:`sqlite3.Connection.autocommit` attribute instead.
