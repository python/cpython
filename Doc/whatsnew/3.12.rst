...
* Testing the truth value of an :class:`xml.etree.ElementTree.Element`,
  discouraged by :mod:`xml.etree.ElementTree` documentation since Python 2.6
  and by :exc:`FutureWarning` in the Python implementation since Python 2.7,
  is now deprecated in both Python and (default) C implementations by
  :exc:`DeprecationWarning` and will raise an exception in Python 3.14.
