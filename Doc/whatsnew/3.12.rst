...
* Add :c:func:`_PyErr_ChainExceptions1`, which takes an exception instance,
  to replace the legacy-api :c:func:`_PyErr_ChainExceptions`, which is now
...
* :c:func:`_PyErr_ChainExceptions` is deprecated. Use :c:func:`_PyErr_ChainExceptions1`
