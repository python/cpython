...
* The default :class:`HTTPResponse <http.client.HTTPResponse>` class used by the :mod:`httplib <http>` module now
  supports buffering, resulting in much faster reading of HTTP responses.
  (Contributed by Kristján Valur Jónsson; :issue:`4879`.)

  The :class:`HTTPConnection <http.client.HTTPConnection>` and :class:`HTTPSConnection <http.client.HTTPSConnection>` classes
...
* The :mod:`urlparse <urllib.parse>` module's :func:`urlsplit <urllib.parse.urlsplit>` now handles
...
* The :mod:`_winreg <winreg>` module for accessing the registry now implements
  the :func:`CreateKeyEx <winreg.CreateKeyEx>` and :func:`DeleteKeyEx <winreg.DeleteKeyEx>`
  functions, extended versions of previously supported functions that
  take several extra arguments.  The :func:`DisableReflectionKey <winreg.DisableReflectionKey>`,
  :func:`EnableReflectionKey <winreg.EnableReflectionKey>`, and :func:`QueryReflectionKey <winreg.QueryReflectionKey>`
