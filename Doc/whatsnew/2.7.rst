...
argument that defaults to ``True``.  If *last* is a truthy value, the most recently
...
* New class: the :class:`~collections.Counter` class in the :mod:`collections`
  ...
  If *rename* is a truthy value, field names that are invalid because they've
...
* New function: ``itertools.compress(data, selectors)`` takes two
  ...
  value in *selectors* is a truthy value::
...
* Deprecated: using an element as a Boolean (i.e., ``if elem:``) would
  ...
  no children.  This behaviour is confusing -- ``None`` is a falsey value, but
