...
* Add :func:`tracemalloc.dump_snapshot` and :func:`tracemalloc.load_snapshot`
  ...
  (Contributed by Victor Stinner in :gh:`121120`.)
...
* :mod:`tracemalloc`: The :meth:`~tracemalloc.Snapshot.dump` and
  :meth:`~tracemalloc.Snapshot.load` methods of :class:`tracemalloc.Snapshot`
  are deprecated. Use :func:`tracemalloc.dump_snapshot` and
  :func:`tracemalloc.load_snapshot` functions instead.
  (Contributed by Victor Stinner in :gh:`121120`.)
