...
* The :class:`multiprocessing.managers.SyncManager` now supports the :class:`set` type.
  :func:`multiprocessing.Manager.set` method is now available.
  (Contributed by Mingyu Park for :gh:`129949`.)
