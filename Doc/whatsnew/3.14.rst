...
* If a statement (:ref:`pass_stmt`, :ref:`del_stmt`, :ref:`return_stmt`,
  :ref:`yield_stmt`, :ref:`raise_stmt`, :ref:`break_stmt`, :ref:`continue_stmt`)
  is passed to the conditional expression (:ref:`Conditional expressions`),
  then the error message highlights where the :token:`~python-grammar:expression`
  is required.
