...
* When strings have incompatible prefixes, now error shows
  what prefixes are incompatible. (Contributed by
  Nikita Sobolev in :gh:`133202`.)
...
* Improved error messages when using ``as`` with incompatible targets in
  ...
  - Except hanlders: ``except ... as ...``
  - Pattern-match cases: ``case ... as ...``

  (Contributed by Nikita Sobolev in :gh:`123629`,
