...
Added :func:`colorsys.rgb_to_cmyk` and :func:`colorsys.cmyk_to_rgb` to convert from and into CMYK color system.
(Contributed by Albert Gorokhovskiy in :issue:`120120`.)
