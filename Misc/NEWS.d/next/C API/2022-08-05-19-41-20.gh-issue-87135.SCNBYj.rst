...
soon exit anyway, but in cases where a thread must avoid hanging, the new
API functions :c:func:`PyThread_TryAcquireFinalizeBlock` or
:c:func:`PyGILState_AcquireFinalizeBlockAndGIL` may be used.
