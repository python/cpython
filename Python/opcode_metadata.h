...
static const struct {
    ...
    [INSTRUMENTED_RETURN_VALUE] = { 0, 0, DIR_NONE, DIR_NONE, DIR_NONE, true, INSTR_FMT_IB },
    ...
    [INSTRUMENTED_YIELD_VALUE] = { 0, 0, DIR_NONE, DIR_NONE, DIR_NONE, true, INSTR_FMT_IB },
    ...
    [INSTRUMENTED_CALL_FUNCTION_EX] = { -1, -1, DIR_NONE, DIR_NONE, DIR_NONE, true, INSTR_FMT_IB },
    ...
    [INSTRUMENTED_LINE] = { 0, 0, DIR_NONE, DIR_NONE, DIR_NONE, true, INSTR_FMT_IB },
