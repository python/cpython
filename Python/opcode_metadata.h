...
const struct opcode_metadata _PyOpcode_opcode_metadata[256] = {
    ...
    [CALL] = { true, INSTR_FMT_IBC },
    [CALL_BOUND_METHOD_EXACT_ARGS] = { true, INSTR_FMT_IBC },
    [CALL_PY_EXACT_ARGS] = { true, INSTR_FMT_IBC },
    [CALL_PY_WITH_DEFAULTS] = { true, INSTR_FMT_IBC },
    [CALL_NO_KW_TYPE_1] = { true, INSTR_FMT_IBC },
    [CALL_NO_KW_STR_1] = { true, INSTR_FMT_IBC },
    [CALL_NO_KW_TUPLE_1] = { true, INSTR_FMT_IBC },
    [CALL_BUILTIN_CLASS] = { true, INSTR_FMT_IBC },
    [CALL_NO_KW_BUILTIN_O] = { true, INSTR_FMT_IBC },
    [CALL_NO_KW_BUILTIN_FAST] = { true, INSTR_FMT_IBC },
    [CALL_BUILTIN_FAST_WITH_KEYWORDS] = { true, INSTR_FMT_IBC },
    [CALL_NO_KW_LEN] = { true, INSTR_FMT_IBC },
    [CALL_NO_KW_ISINSTANCE] = { true, INSTR_FMT_IBC },
    [CALL_NO_KW_LIST_APPEND] = { true, INSTR_FMT_IBC },
    [CALL_NO_KW_METHOD_DESCRIPTOR_O] = { true, INSTR_FMT_IBC },
    [CALL_METHOD_DESCRIPTOR_FAST_WITH_KEYWORDS] = { true, INSTR_FMT_IBC },
    [CALL_NO_KW_METHOD_DESCRIPTOR_NOARGS] = { true, INSTR_FMT_IBC },
    [CALL_NO_KW_METHOD_DESCRIPTOR_FAST] = { true, INSTR_FMT_IBC },
