...
const struct opcode_metadata _PyOpcode_opcode_metadata[512] = {
    ...
    [LOAD_CLOSURE] = { true, INSTR_FMT_IB, HAS_ARG_FLAG | IS_UOP_FLAG },
    [LOAD_FAST_CHECK] = { true, INSTR_FMT_IB, HAS_ARG_FLAG | IS_UOP_FLAG },
    ...
    [BINARY_OP_MULTIPLY_INT] = { true, INSTR_FMT_IBC, IS_UOP_FLAG },
    [BINARY_OP_ADD_INT] = { true, INSTR_FMT_IBC, IS_UOP_FLAG },
    [BINARY_OP_SUBTRACT_INT] = { true, INSTR_FMT_IBC, IS_UOP_FLAG },
    ...
    [BINARY_OP_ADD_UNICODE] = { true, INSTR_FMT_IBC, IS_UOP_FLAG },
    ...
    [DELETE_FAST] = { true, INSTR_FMT_IB, HAS_ARG_FLAG | IS_UOP_FLAG },
