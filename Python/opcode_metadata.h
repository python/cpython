...
static const struct {
    ...
    [SET_ADD] = { -1, -1, DIR_NONE, DIR_NONE, DIR_NONE, true, "IB" },
    ...
    [CALL_INTRINSIC_1] = { 1, 1, DIR_NONE, DIR_NONE, DIR_NONE, true, "IB" },
    ...
    [SET_UPDATE] = { -1, -1, DIR_NONE, DIR_NONE, DIR_NONE, true, "IB" },
