...
const struct opcode_macro_expansion _PyOpcode_macro_expansion[256] = {
    ...
    [JUMP_FORWARD] = { .nuops = 1, .uops = { { JUMP_FORWARD, 0, 0 } } },
    [POP_JUMP_IF_FALSE] = { .nuops = 1, .uops = { { POP_JUMP_IF_FALSE, 0, 0 } } },
    ...
    [FOR_ITER_LIST] = { .nuops = 1, .uops = { { FOR_ITER_LIST, 0, 0 } } },
    [FOR_ITER_TUPLE] = { .nuops = 1, .uops = { { FOR_ITER_TUPLE, 0, 0 } } },
    [FOR_ITER_RANGE] = { .nuops = 1, .uops = { { FOR_ITER_RANGE, 0, 0 } } },
