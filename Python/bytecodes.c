...
// BEGIN BYTECODES //
        ...
        inst(CALL_TYPE_1, (unused/1, unused/2, callable, null, args[1] -- res)) {
            assert(oparg == 1);
            DEOPT_IF(null != NULL);
            PyObject *obj = args[0];
        ...
        inst(CALL_STR_1, (unused/1, unused/2, callable, null, args[1] -- res)) {
            assert(oparg == 1);
            DEOPT_IF(null != NULL);
        ...
        inst(CALL_TUPLE_1, (unused/1, unused/2, callable, null, args[1] -- res)) {
            assert(oparg == 1);
            DEOPT_IF(null != NULL);
