...
sys_intern(PyObject *module, PyObject *arg)
{
    ...
    if (!PyUnicode_Check(arg)) {
        _PyArg_BadArgument("intern", 0, NULL, "str", arg);
        goto exit;
    }
...
sys_call_tracing(PyObject *module, PyObject *const *args, Py_ssize_t nargs)
{
    ...
    if (!PyTuple_Check(args[1])) {
        _PyArg_BadArgument("call_tracing", 2, NULL, "tuple", args[1]);
        goto exit;
    }
    funcargs = args[1];
...
/*[clinic end generated code: output=223863edf9d0e4d9 input=a9049054013a1b77]*/
