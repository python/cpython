...
tb_new(PyTypeObject *type, PyObject *args, PyObject *kwargs)
{
    ...
    if (!PyObject_TypeCheck(fastargs[1], &PyFrame_Type)) {
        _PyArg_BadArgument("TracebackType", 2, "argument 'tb_frame'", (&PyFrame_Type)->tp_name, fastargs[1]);
        goto exit;
    }
...
/*[clinic end generated code: output=4574241b9fd9494c input=a9049054013a1b77]*/
