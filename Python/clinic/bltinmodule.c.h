...
builtin_format(PyObject *module, PyObject *const *args, Py_ssize_t nargs)
{
    ...
    if (!PyUnicode_Check(args[1])) {
        _PyArg_BadArgument("format", 2, NULL, "str", args[1]);
        goto exit;
    }
...
builtin_compile(PyObject *module, PyObject *const *args, Py_ssize_t nargs, PyObject *kwnames)
{
    ...
    if (!PyUnicode_Check(args[2])) {
        _PyArg_BadArgument("compile", 3, "mode", "str", args[2]);
        goto exit;
    }
...
/*[clinic end generated code: output=183d8cbb521432fe input=a9049054013a1b77]*/
