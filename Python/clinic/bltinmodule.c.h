...
#define BUILTIN_DIR_METHODDEF    \
    {"dir", (PyCFunction)(void(*)(void))builtin_dir, METH_FASTCALL, builtin_dir__doc__},
...
builtin_dir(PyObject *module, PyObject *const *args, Py_ssize_t nargs)
{
    ...
    object = args[0];
skip_optional:
    return_value = builtin_dir_impl(module, object);
...
#define BUILTIN_VARS_METHODDEF    \
    {"vars", (PyCFunction)(void(*)(void))builtin_vars, METH_FASTCALL, builtin_vars__doc__},
...
/*[clinic end generated code: output=544ea1b5aa222d05 input=a9049054013a1b77]*/
