...
PyInit__ast(void)
{
    ...
    if (PyModule_AddObject(m, "FunctionDef",
        astmodulestate_global->FunctionDef_type) < 0) goto error;
    Py_INCREF(astmodulestate(m)->FunctionDef_type);
    if (PyModule_AddObject(m, "AsyncFunctionDef",
        astmodulestate_global->AsyncFunctionDef_type) < 0) goto error;
    ...
    if (PyModule_AddObject(m, "AugAssign",
        astmodulestate_global->AugAssign_type) < 0) goto error;
    Py_INCREF(astmodulestate(m)->AugAssign_type);
    if (PyModule_AddObject(m, "AnnAssign",
        astmodulestate_global->AnnAssign_type) < 0) goto error;
    Py_INCREF(astmodulestate(m)->AnnAssign_type);
    if (PyModule_AddObject(m, "For", astmodulestate_global->For_type) < 0) goto
        error;
    ...
    if (PyModule_AddObject(m, "If", astmodulestate_global->If_type) < 0) goto
        error;
    ...
    if (PyModule_AddObject(m, "AsyncWith",
        astmodulestate_global->AsyncWith_type) < 0) goto error;
    ...
    if (PyModule_AddObject(m, "Try", astmodulestate_global->Try_type) < 0) goto
        error;
    ...
    if (PyModule_AddObject(m, "ImportFrom",
        astmodulestate_global->ImportFrom_type) < 0) goto error;
    ...
    if (PyModule_AddObject(m, "NamedExpr",
        astmodulestate_global->NamedExpr_type) < 0) goto error;
    ...
    if (PyModule_AddObject(m, "Set", astmodulestate_global->Set_type) < 0) goto
        error;
    ...
    if (PyModule_AddObject(m, "GeneratorExp",
        astmodulestate_global->GeneratorExp_type) < 0) goto error;
    ...
    if (PyModule_AddObject(m, "YieldFrom",
        astmodulestate_global->YieldFrom_type) < 0) goto error;
    ...
    if (PyModule_AddObject(m, "FormattedValue",
        astmodulestate_global->FormattedValue_type) < 0) goto error;
    Py_INCREF(astmodulestate(m)->FormattedValue_type);
    if (PyModule_AddObject(m, "JoinedStr",
        astmodulestate_global->JoinedStr_type) < 0) goto error;
    ...
    if (PyModule_AddObject(m, "Attribute",
        astmodulestate_global->Attribute_type) < 0) goto error;
    Py_INCREF(astmodulestate(m)->Attribute_type);
    if (PyModule_AddObject(m, "Subscript",
        astmodulestate_global->Subscript_type) < 0) goto error;
    ...
    if (PyModule_AddObject(m, "expr_context",
        astmodulestate_global->expr_context_type) < 0) goto error;
    ...
    if (PyModule_AddObject(m, "Del", astmodulestate_global->Del_type) < 0) goto
        error;
    ...
    if (PyModule_AddObject(m, "boolop", astmodulestate_global->boolop_type) <
        0) goto error;
    Py_INCREF(astmodulestate(m)->boolop_type);
    if (PyModule_AddObject(m, "And", astmodulestate_global->And_type) < 0) goto
        error;
    Py_INCREF(astmodulestate(m)->And_type);
    if (PyModule_AddObject(m, "Or", astmodulestate_global->Or_type) < 0) goto
        error;
    ...
    if (PyModule_AddObject(m, "Add", astmodulestate_global->Add_type) < 0) goto
        error;
    Py_INCREF(astmodulestate(m)->Add_type);
    if (PyModule_AddObject(m, "Sub", astmodulestate_global->Sub_type) < 0) goto
        error;
    ...
    if (PyModule_AddObject(m, "Div", astmodulestate_global->Div_type) < 0) goto
        error;
    Py_INCREF(astmodulestate(m)->Div_type);
    if (PyModule_AddObject(m, "Mod", astmodulestate_global->Mod_type) < 0) goto
        error;
    Py_INCREF(astmodulestate(m)->Mod_type);
    if (PyModule_AddObject(m, "Pow", astmodulestate_global->Pow_type) < 0) goto
        error;
    ...
    if (PyModule_AddObject(m, "Not", astmodulestate_global->Not_type) < 0) goto
        error;
    ...
    if (PyModule_AddObject(m, "Eq", astmodulestate_global->Eq_type) < 0) goto
        error;
    ...
    if (PyModule_AddObject(m, "Lt", astmodulestate_global->Lt_type) < 0) goto
        error;
    Py_INCREF(astmodulestate(m)->Lt_type);
    if (PyModule_AddObject(m, "LtE", astmodulestate_global->LtE_type) < 0) goto
        error;
    Py_INCREF(astmodulestate(m)->LtE_type);
    if (PyModule_AddObject(m, "Gt", astmodulestate_global->Gt_type) < 0) goto
        error;
    Py_INCREF(astmodulestate(m)->Gt_type);
    if (PyModule_AddObject(m, "GtE", astmodulestate_global->GtE_type) < 0) goto
        error;
    Py_INCREF(astmodulestate(m)->GtE_type);
    if (PyModule_AddObject(m, "Is", astmodulestate_global->Is_type) < 0) goto
        error;
    ...
    if (PyModule_AddObject(m, "In", astmodulestate_global->In_type) < 0) goto
        error;
    ...
    if (PyModule_AddObject(m, "comprehension",
        astmodulestate_global->comprehension_type) < 0) goto error;
    Py_INCREF(astmodulestate(m)->comprehension_type);
    if (PyModule_AddObject(m, "excepthandler",
        astmodulestate_global->excepthandler_type) < 0) goto error;
    Py_INCREF(astmodulestate(m)->excepthandler_type);
    if (PyModule_AddObject(m, "ExceptHandler",
        astmodulestate_global->ExceptHandler_type) < 0) goto error;
    Py_INCREF(astmodulestate(m)->ExceptHandler_type);
    if (PyModule_AddObject(m, "arguments",
        astmodulestate_global->arguments_type) < 0) goto error;
    Py_INCREF(astmodulestate(m)->arguments_type);
    if (PyModule_AddObject(m, "arg", astmodulestate_global->arg_type) < 0) goto
        error;
    ...
    if (PyModule_AddObject(m, "type_ignore",
        astmodulestate_global->type_ignore_type) < 0) goto error;
    Py_INCREF(astmodulestate(m)->type_ignore_type);
    if (PyModule_AddObject(m, "TypeIgnore",
        astmodulestate_global->TypeIgnore_type) < 0) goto error;
