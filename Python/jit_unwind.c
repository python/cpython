...
#  include "trampoline_ehframe.h"  // generated by Tools/build/generate_trampoline_ehframe.py
#endif
 ...
 *   Tools/build/generate_trampoline_ehframe.py. Compiling an equivalent C
 *   trampoline with "-O2 -fno-omit-frame-pointer -fno-optimize-sibling-calls"
 *   and running "readelf --debug-dump=frames" on it shows the CFI the
