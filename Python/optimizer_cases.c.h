...
// Do not edit!
        ...
        case _END_SEND: {
            _Py_UopsSymbol *value;
            value = (void *)sym_new_not_null(ctx);
        ...
        case _GET_AITER: {
            _Py_UopsSymbol *iter;
            iter = (void *)sym_new_not_null(ctx);
        ...
        case _GET_ANEXT: {
            ...
            awaitable = (void *)sym_new_not_null(ctx);
        ...
        case _UNPACK_SEQUENCE_TWO_TUPLE: {
            _Py_UopsSymbol *val1;
            _Py_UopsSymbol *val0;
            val1 = (void *)sym_new_not_null(ctx);
            if (val1 == NULL) goto out_of_space;
            val0 = (void *)sym_new_not_null(ctx);
        ...
        case _LOAD_LOCALS: {
            ...
            locals = (void *)sym_new_not_null(ctx);
        ...
        case _BUILD_LIST: {
            _Py_UopsSymbol *list;
            list = (void *)sym_new_not_null(ctx);
        ...
        case _LOAD_SUPER_ATTR_ATTR: {
            _Py_UopsSymbol *attr;
            attr = (void *)sym_new_not_null(ctx);
        ...
        case _LOAD_SUPER_ATTR_METHOD: {
            ...
            attr = (void *)sym_new_not_null(ctx);
            if (attr == NULL) goto out_of_space;
            self_or_null = (void *)sym_new_not_null(ctx);
        ...
        case _CHECK_EG_MATCH: {
            ...
            rest = (void *)sym_new_not_null(ctx);
            if (rest == NULL) goto out_of_space;
            match = (void *)sym_new_not_null(ctx);
        ...
        case _GET_LEN: {
            ...
            len_o = (void *)sym_new_not_null(ctx);
        ...
        case _MATCH_CLASS: {
            ...
            attrs = (void *)sym_new_not_null(ctx);
        ...
        case _MATCH_KEYS: {
            ...
            values_or_none = (void *)sym_new_not_null(ctx);
        ...
        case _FOR_ITER_TIER_TWO: {
            _Py_UopsSymbol *next;
            next = (void *)sym_new_not_null(ctx);
        ...
        case _PUSH_EXC_INFO: {
            ...
            prev_exc = (void *)sym_new_not_null(ctx);
            if (prev_exc == NULL) goto out_of_space;
            new_exc = (void *)sym_new_not_null(ctx);
        ...
        case _MAKE_FUNCTION: {
            _Py_UopsSymbol *func;
            func = (void *)sym_new_not_null(ctx);
        ...
        case _BUILD_SLICE: {
            ...
            slice = (void *)sym_new_not_null(ctx);
        ...
        case _CONVERT_VALUE: {
            ...
            result = (void *)sym_new_not_null(ctx);
