...
// Do not edit!
        ...
        case _INIT_CALL_BOUND_METHOD_EXACT_ARGS: {
            ...
            stack_pointer[-2 - oparg] = Py_OBJ_PACK(func);
            stack_pointer[-1 - oparg] = Py_OBJ_PACK(self);
            break;
        }
        ...
        case _INIT_CALL_PY_EXACT_ARGS: {
            ...
            stack_pointer[-2 - oparg] = Py_OBJ_PACK((_Py_UopsSymbol *)new_frame);
            stack_pointer += -1 - oparg;
            break;
        }
        ...
        case _PUSH_FRAME: {
            _Py_UOpsAbstractFrame *new_frame;
            new_frame = (_Py_UOpsAbstractFrame *)Py_CLEAR_TAG(stack_pointer[-1]);
            stack_pointer += -1;
            ctx->frame->stack_pointer = stack_pointer;
            ctx->frame = new_frame;
        ...
        case _GUARD_IS_TRUE_POP: {
            _Py_UopsSymbol *flag;
            flag = Py_CLEAR_TAG(stack_pointer[-1]);
        ...
        case _LOAD_CONST_INLINE_WITH_NULL: {
            ...
            OUT_OF_SPACE_IF_NULL(null = sym_new_null(ctx));
            stack_pointer[0] = Py_OBJ_PACK(value);
            stack_pointer[1] = Py_OBJ_PACK(null);
            stack_pointer += 2;
            break;
        }
