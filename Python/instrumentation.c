...
static const uint8_t INSTRUMENTED_OPCODES[256] = {
    ...
    [JUMP_BACKWARD_INTO_TRACE] = INSTRUMENTED_JUMP_BACKWARD,  // XXX: Why?
    [JUMP_BACKWARD_QUICK] = INSTRUMENTED_JUMP_BACKWARD,  // XXX: Why?
    [JUMP_BACKWARD_RECORDING] = INSTRUMENTED_JUMP_BACKWARD,  // XXX: Why?
