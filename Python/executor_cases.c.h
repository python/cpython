...
#define TIER_TWO 2
        ...
        /* _TO_BOOL_ALWAYS_TRUE is not a viable micro-op for tier 2 */
        ...
        /* _CHECK_ATTR_CLASS is not a viable micro-op for tier 2 */
        ...
        /* _CHECK_ATTR_MODULE is not a viable micro-op for tier 2 */
        ...
        /* _CHECK_FUNCTION_EXACT_ARGS is not a viable micro-op for tier 2 */
        ...
        /* _GUARD_BUILTINS_VERSION is not a viable micro-op for tier 2 */
        ...
        /* _GUARD_GLOBALS_VERSION is not a viable micro-op for tier 2 */
        ...
        /* _GUARD_KEYS_VERSION is not a viable micro-op for tier 2 */
        ...
        /* _GUARD_TYPE_VERSION is not a viable micro-op for tier 2 */
        ...
        /* _LOAD_ATTR_CLASS is not a viable micro-op for tier 2 */

        /* _LOAD_ATTR_INSTANCE_VALUE is not a viable micro-op for tier 2 */

        /* _LOAD_ATTR_METHOD_LAZY_DICT is not a viable micro-op for tier 2 */

        /* _LOAD_ATTR_METHOD_NO_DICT is not a viable micro-op for tier 2 */

        /* _LOAD_ATTR_METHOD_WITH_VALUES is not a viable micro-op for tier 2 */

        /* _LOAD_ATTR_MODULE is not a viable micro-op for tier 2 */

        /* _LOAD_ATTR_NONDESCRIPTOR_NO_DICT is not a viable micro-op for tier 2 */

        /* _LOAD_ATTR_NONDESCRIPTOR_WITH_VALUES is not a viable micro-op for tier 2 */

        /* _LOAD_ATTR_SLOT is not a viable micro-op for tier 2 */

        /* _LOAD_ATTR_WITH_HINT is not a viable micro-op for tier 2 */
        ...
        /* _LOAD_GLOBAL_BUILTINS is not a viable micro-op for tier 2 */

        /* _LOAD_GLOBAL_MODULE is not a viable micro-op for tier 2 */
        ...
        /* _STORE_ATTR_INSTANCE_VALUE is not a viable micro-op for tier 2 */

        /* _STORE_ATTR_SLOT is not a viable micro-op for tier 2 */
