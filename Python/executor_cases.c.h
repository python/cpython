...
#define TIER_TWO 2
        ...
        case _STORE_NAME: {
            int result = _STORE_NAME_func(tstate, frame, &stack_pointer, CURRENT_OPARG());
            switch (result) {
                case 0:
                break;
                case 1:
        ...
        case _BUILD_STRING: {
            int result = _BUILD_STRING_func(tstate, frame, &stack_pointer, CURRENT_OPARG());
            switch (result) {
                case 0:
                break;
                case 1:
        ...
        case _BUILD_MAP: {
            int result = _BUILD_MAP_func(tstate, frame, &stack_pointer, CURRENT_OPARG());
            switch (result) {
                case 0:
                break;
                case 1:
        ...
        case _BUILD_CONST_KEY_MAP: {
            int result = _BUILD_CONST_KEY_MAP_func(tstate, frame, &stack_pointer, CURRENT_OPARG());
            switch (result) {
                case 0:
                break;
                case 1:
        ...
        case _LOAD_SUPER_ATTR_METHOD: {
            int result = _LOAD_SUPER_ATTR_METHOD_func(tstate, frame, &stack_pointer, CURRENT_OPARG());
            switch (result) {
                case 0:
                break;
                case 1:
        ...
        case _CALL_BUILTIN_FAST_WITH_KEYWORDS: {
            int result = _CALL_BUILTIN_FAST_WITH_KEYWORDS_func(tstate, frame, &stack_pointer, CURRENT_OPARG());
            switch (result) {
                case 0:
                break;
                case 1:
        ...
        case _CALL_METHOD_DESCRIPTOR_O: {
            int result = _CALL_METHOD_DESCRIPTOR_O_func(tstate, frame, &stack_pointer, CURRENT_OPARG());
            switch (result) {
                case 0:
                break;
                case 1:
