...
// Do not edit!
        ...
        case COMPARE_OP: {
            ...
            #line 1690 "Python/executor_cases.c.h"
            STACK_SHRINK(1);
            stack_pointer[-1] = res;
            break;
        }
        ...
        case COMPARE_OP_INT: {
            ...
            res = (sign_ish & oparg) ? Py_True : Py_False;
            // It's always a bool, so we don't care about oparg & 16.
            #line 1738 "Python/executor_cases.c.h"
            STACK_SHRINK(1);
            stack_pointer[-1] = res;
            break;
        }
        ...
        case COMPARE_OP_STR: {
            ...
            // It's always a bool, so we don't care about oparg & 16.
            #line 1761 "Python/executor_cases.c.h"
            STACK_SHRINK(1);
            stack_pointer[-1] = res;
            break;
        }
        ...
        case IS_OP: {
            ...
            #line 1773 "Python/executor_cases.c.h"
            Py_DECREF(left);
            Py_DECREF(right);
        ...
        case CONTAINS_OP: {
            ...
            #line 1790 "Python/executor_cases.c.h"
            Py_DECREF(left);
            Py_DECREF(right);
            #line 2124 "Python/bytecodes.c"
            if (res < 0) goto pop_2_error;
            b = (res ^ oparg) ? Py_True : Py_False;
            #line 1796 "Python/executor_cases.c.h"
            STACK_SHRINK(1);
            stack_pointer[-1] = b;
            break;
        }
        ...
        case CHECK_EG_MATCH: {
            ...
            #line 1809 "Python/executor_cases.c.h"
                Py_DECREF(exc_value);
        ...
        case CHECK_EXC_MATCH: {
            ...
            #line 1845 "Python/executor_cases.c.h"
                 Py_DECREF(right);
            ...
            #line 1852 "Python/executor_cases.c.h"
            Py_DECREF(right);
            #line 2158 "Python/bytecodes.c"
            b = res ? Py_True : Py_False;
            #line 1856 "Python/executor_cases.c.h"
            stack_pointer[-1] = b;
            break;
        }
        ...
        case GET_LEN: {
            ...
            #line 1888 "Python/executor_cases.c.h"
            STACK_GROW(1);
        ...
        case MATCH_CLASS: {
            ...
            #line 1904 "Python/executor_cases.c.h"
            Py_DECREF(subject);
            Py_DECREF(type);
            Py_DECREF(names);
        ...
        case MATCH_KEYS: {
            ...
            #line 1954 "Python/executor_cases.c.h"
            STACK_GROW(1);
        ...
        case _ITER_CHECK_RANGE: {
            ...
            #line 2015 "Python/executor_cases.c.h"
            break;
        }
        ...
        case _ITER_EXHAUSTED_RANGE: {
            ...
            #line 2026 "Python/executor_cases.c.h"
            STACK_GROW(1);
        ...
        case _ITER_NEXT_RANGE: {
            ...
            #line 2044 "Python/executor_cases.c.h"
            STACK_GROW(1);
        ...
        case WITH_EXCEPT_START: {
            ...
            */
            ...
            #line 2076 "Python/executor_cases.c.h"
            STACK_GROW(1);
            stack_pointer[-1] = res;
            break;
        }
        ...
        case PUSH_EXC_INFO: {
            ...
            #line 2095 "Python/executor_cases.c.h"
            STACK_GROW(1);
        ...
        case MAKE_FUNCTION: {
            ...
            #line 2132 "Python/executor_cases.c.h"
        ...
        case SET_FUNCTION_ATTRIBUTE: {
            ...
            #line 2165 "Python/executor_cases.c.h"
            STACK_SHRINK(1);
            stack_pointer[-1] = func;
            break;
        }
        ...
        case BUILD_SLICE: {
            ...
            #line 2178 "Python/executor_cases.c.h"
            Py_DECREF(start);
            Py_DECREF(stop);
            Py_XDECREF(step);
            #line 3498 "Python/bytecodes.c"
            if (slice == NULL) { STACK_SHRINK(((oparg == 3) ? 1 : 0)); goto pop_2_error; }
            #line 2184 "Python/executor_cases.c.h"
        ...
        case CONVERT_VALUE: {
            ...
            #line 2201 "Python/executor_cases.c.h"
        ...
        case BINARY_OP: {
            ...
            if (res == NULL) goto pop_2_error;
            #line 2277 "Python/executor_cases.c.h"
            STACK_SHRINK(1);
            stack_pointer[-1] = res;
            break;
        }
        ...
        case SWAP: {
            ...
            assert(oparg >= 2);
            #line 2288 "Python/executor_cases.c.h"
