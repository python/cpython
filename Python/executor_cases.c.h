...
#define TIER_TWO 2
        ...
        case _BINARY_OP_MULTIPLY_FLOAT_r10: {
            CHECK_CURRENT_CACHED_VALUES(1);
            _PyStackRef right;
            _PyStackRef left;
            _PyStackRef res;
        ...
        case _BINARY_OP_SUBTRACT_FLOAT_r10: {
            CHECK_CURRENT_CACHED_VALUES(1);
            _PyStackRef right;
            _PyStackRef left;
            _PyStackRef res;
        ...
        case _BINARY_OP_ADD_UNICODE_r10: {
            CHECK_CURRENT_CACHED_VALUES(1);
            _PyStackRef right;
            _PyStackRef left;
            _PyStackRef res;
        ...
        case _BINARY_OP_SUBSCR_STR_INT_r11: {
            CHECK_CURRENT_CACHED_VALUES(1);
            _PyStackRef sub_st;
            _PyStackRef str_st;
            _PyStackRef res;
        ...
        case _BINARY_OP_SUBSCR_TUPLE_INT_r11: {
            CHECK_CURRENT_CACHED_VALUES(1);
            _PyStackRef sub_st;
        ...
        case _BINARY_OP_SUBSCR_CHECK_FUNC_r22: {
            CHECK_CURRENT_CACHED_VALUES(2);
            _PyStackRef container;
            _PyStackRef getitem;
            _PyStackRef _stack_item_0 = _tos_cache0;
        ...
        case _STORE_SUBSCR_LIST_INT_r00: {
            CHECK_CURRENT_CACHED_VALUES(0);
            _PyStackRef sub_st;
            _PyStackRef list_st;
            _PyStackRef value;
        ...
        case _UNPACK_SEQUENCE_TWO_TUPLE_r11: {
            CHECK_CURRENT_CACHED_VALUES(1);
            _PyStackRef seq;
            _PyStackRef val1;
            _PyStackRef val0;
        ...
        case _UNPACK_SEQUENCE_TUPLE_r00: {
            CHECK_CURRENT_CACHED_VALUES(0);
            _PyStackRef seq;
            _PyStackRef *values;
            oparg = CURRENT_OPARG();
        ...
        case _UNPACK_SEQUENCE_LIST_r00: {
            CHECK_CURRENT_CACHED_VALUES(0);
            _PyStackRef seq;
            _PyStackRef *values;
            oparg = CURRENT_OPARG();
        ...
        case _LOAD_GLOBAL_BUILTINS_r00: {
            CHECK_CURRENT_CACHED_VALUES(0);
            _PyStackRef res;
            uint16_t version = (uint16_t)CURRENT_OPERAND0();
            uint16_t index = (uint16_t)CURRENT_OPERAND1();
        ...
        case _LOAD_ATTR_PROPERTY_FRAME_r00: {
            CHECK_CURRENT_CACHED_VALUES(0);
            _PyStackRef owner;
            _PyStackRef new_frame;
            oparg = CURRENT_OPARG();
        ...
        case _SET_FUNCTION_ATTRIBUTE_r10: {
            CHECK_CURRENT_CACHED_VALUES(1);
            _PyStackRef func_in;
            _PyStackRef attr_st;
            _PyStackRef func_out;
        ...
        case _GUARD_IS_NOT_NONE_POP_r00: {
            CHECK_CURRENT_CACHED_VALUES(0);
            _PyStackRef val;
            val = stack_pointer[-1];
            int is_none = PyStackRef_IsNone(val);
