...
#define TIER_TWO 2
        ...
        /* _CHECK_PERIODIC_AT_END_PENDING is not a viable micro-op for tier 2 because it is replaced */
        ...
        case _CALL_METHOD_DESCRIPTOR_O_INLINE_r03: {
            ...
            oparg = CURRENT_OPARG();
            args = &stack_pointer[-(CALL_ARGCOUNT(oparg))];
            callable = stack_pointer[-1 - (CALL_ARGCOUNT(oparg))];
            PyObject *cfunc = (PyObject *)CURRENT_OPERAND0_64();
            assert(CALL_ARGCOUNT(oparg) == 2);
            STAT_INC(CALL, hit);
        ...
        case _CALL_METHOD_DESCRIPTOR_FAST_WITH_KEYWORDS_INLINE_r00: {
            ...
            oparg = CURRENT_OPARG();
            args = &stack_pointer[-(CALL_ARGCOUNT(oparg))];
            self_st = stack_pointer[-1 - (CALL_ARGCOUNT(oparg))];
            callable = stack_pointer[-2 - (CALL_ARGCOUNT(oparg))];
            PyObject *cfunc = (PyObject *)CURRENT_OPERAND0_64();
            PyObject *self = PyStackRef_AsPyObjectBorrow(self_st);
            STAT_INC(CALL, hit);
