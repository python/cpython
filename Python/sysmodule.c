...
static PyObject *_PySys_GetObject(PyInterpreterState *interp,
                                  const char *name) {
...
static int sys_set_object(PyInterpreterState *interp, PyObject *key,
                          PyObject *v) {
  if (key == NULL) {
    return -1;
  }
...
int _PySys_SetAttr(PyObject *key, PyObject *v) {
  PyInterpreterState *interp = _PyInterpreterState_GET();
  return sys_set_object(interp, key, v);
}

static int sys_set_object_str(PyInterpreterState *interp, const char *name,
                              PyObject *v) {
  PyObject *key =
      v ? PyUnicode_InternFromString(name) : PyUnicode_FromString(name);
...
int _PySys_ClearAttrString(PyInterpreterState *interp, const char *name,
                           int verbose) {
  if (verbose) {
...
static int should_audit(PyInterpreterState *interp) {
  /* interp must not be NULL, but test it just in case for extra safety */
  assert(interp != NULL);
  if (!interp) {
    return 0;
  }
  return (interp->runtime->audit_hooks.head || interp->audit_hooks ||
          PyDTrace_AUDIT_ENABLED());
}

static int sys_audit_tstate(PyThreadState *ts, const char *event,
...
static void add_audit_hook_entry_unlocked(_PyRuntimeState *runtime,
...
static PyObject *sys_addaudithook_impl(PyObject *module, PyObject *hook)
...
PyDoc_STRVAR(audit_doc, "audit($module, event, /, *args)\n\
--\n\
\n\
Passes the event to any audit hooks that are attached.");

static PyObject *sys_audit(PyObject *self, PyObject *const *args,
                           Py_ssize_t argc) {
  PyThreadState *tstate = _PyThreadState_GET();
...
static PyObject *sys_breakpointhook(PyObject *self, PyObject *const *args,
...
static int sys_displayhook_unencodable(PyObject *outf, PyObject *o) {
  ...
  if (repr_str == NULL)
    goto error;
  encoded = PyUnicode_AsEncodedString(repr_str, stdout_encoding_str,
                                      "backslashreplace");
  Py_DECREF(repr_str);
  if (encoded == NULL)
    goto error;
...
static PyObject *sys_excepthook_impl(PyObject *module, PyObject *exctype,
...
static PyObject *sys_exception_impl(PyObject *module)
...
static PyObject *sys_exc_info_impl(PyObject *module)
...
static PyObject *sys_unraisablehook(PyObject *module, PyObject *unraisable)
...
static PyObject *sys_exit_impl(PyObject *module, PyObject *status)
...
static PyObject *get_utf8_unicode(void) {
...
static PyObject *sys_getdefaultencoding_impl(PyObject *module)
...
static PyObject *sys_getfilesystemencoding_impl(PyObject *module)
...
static PyObject *sys_getfilesystemencodeerrors_impl(PyObject *module)
...
static int sys__is_interned_impl(PyObject *module, PyObject *string)
...
static PyObject *whatstrings[8] = {
    &_Py_ID(call),   &_Py_ID(exception),   &_Py_ID(line),     &_Py_ID(return),
    &_Py_ID(c_call), &_Py_ID(c_exception), &_Py_ID(c_return), &_Py_ID(opcode),
};
...
static PyObject *call_trampoline(PyThreadState *tstate, PyObject *callback,
  ...
  PyObject *result =
      _PyObject_VectorcallTstate(tstate, callback, args, 3, NULL);

  return result;
}

static int profile_trampoline(PyObject *self, PyFrameObject *frame, int what,
                              PyObject *arg) {
  PyThreadState *tstate = _PyThreadState_GET();
...
static int trace_trampoline(PyObject *self, PyFrameObject *frame, int what,
                            PyObject *arg) {
  PyObject *callback;
...
static PyObject *sys_settrace(PyObject *module, PyObject *function)
...
static PyObject *sys__settraceallthreads(PyObject *module, PyObject *arg)
...
static PyObject *sys_gettrace_impl(PyObject *module)
...
static PyObject *sys_setprofile(PyObject *module, PyObject *function)
...
static PyObject *sys__setprofileallthreads(PyObject *module, PyObject *arg)
...
static PyObject *sys_getprofile_impl(PyObject *module)
...
static PyObject *sys_setswitchinterval_impl(PyObject *module, double interval)
...
static double sys_getswitchinterval_impl(PyObject *module)
...
static PyObject *sys_setrecursionlimit_impl(PyObject *module, int new_limit)
...
static PyObject *sys_set_coroutine_origin_tracking_depth_impl(PyObject *module,
                                                              int depth)
...
static int sys_get_coroutine_origin_tracking_depth_impl(PyObject *module)
...
PyDoc_STRVAR(asyncgen_hooks_doc, "asyncgen_hooks\n\
\n\
...
static PyObject *sys_set_asyncgen_hooks(PyObject *self, PyObject *args,
                                        PyObject *kw) {
  static char *keywords[] = {"firstiter", "finalizer", NULL};
  PyObject *firstiter = NULL;
  PyObject *finalizer = NULL;

  if (!PyArg_ParseTupleAndKeywords(args, kw, "|OO", keywords, &firstiter,
                                   &finalizer)) {
    return NULL;
  }
  ...
  if (finalizer && finalizer != Py_None) {
    if (!PyCallable_Check(finalizer)) {
      PyErr_Format(PyExc_TypeError, "callable finalizer expected, got %.50s",
  ...
  if (firstiter && firstiter != Py_None) {
    if (!PyCallable_Check(firstiter)) {
      PyErr_Format(PyExc_TypeError, "callable firstiter expected, got %.50s",
...
static PyObject *sys_get_asyncgen_hooks_impl(PyObject *module)
...
static PyObject *get_hash_info(PyThreadState *tstate) {
  PyObject *hash_info;
  int field = 0;
...
static PyObject *sys_getrecursionlimit_impl(PyObject *module)
...
static PyObject *_sys_getwindowsversion_from_kernel32(void) {
  ...
  Py_END_ALLOW_THREADS if (!hKernel32 ||
                           !GetModuleFileNameW(hKernel32, kernel32_path,
                                               MAX_PATH)) {
...
static PyObject *sys_getwindowsversion_impl(PyObject *module)
...
#define SET_VERSION_INFO(CALL)                                                 \
  ...
  if (!realVersion) {
    ...
    PyErr_Clear();
    realVersion = Py_BuildValue("(kkk)", ver.dwMajorVersion, ver.dwMinorVersion,
                                ver.dwBuildNumber);
  }
...
static PyObject *sys__enablelegacywindowsfsencoding_impl(PyObject *module)
...
static PyObject *sys_setdlopenflags_impl(PyObject *module, int new_val)
...
static PyObject *sys_getdlopenflags_impl(PyObject *module)
...
static PyObject *sys_mdebug_impl(PyObject *module, int flag)
...
static PyObject *sys_get_int_max_str_digits_impl(PyObject *module)
...
static PyObject *sys_set_int_max_str_digits_impl(PyObject *module,
                                                 int maxdigits)
...
static PyObject *sys_getsizeof(PyObject *self, PyObject *args, PyObject *kwds) {
  static char *kwlist[] = {"object", "default", 0};
  size_t size;
  PyObject *o, *dflt = NULL;
  PyThreadState *tstate = _PyThreadState_GET();

  if (!PyArg_ParseTupleAndKeywords(args, kwds, "O|O:getsizeof", kwlist, &o,
                                   &dflt)) {
    return NULL;
  }
...
static Py_ssize_t sys_getrefcount_impl(PyObject *module, PyObject *object)
...
static Py_ssize_t sys_gettotalrefcount_impl(PyObject *module)
...
static Py_ssize_t sys_getallocatedblocks_impl(PyObject *module)
...
static Py_ssize_t sys_getunicodeinternedsize_impl(PyObject *module,
                                                  int _only_immortal)
...
static PyObject *sys__current_frames_impl(PyObject *module)
...
static PyObject *sys__current_exceptions_impl(PyObject *module)
...
static PyObject *sys_call_tracing_impl(PyObject *module, PyObject *func,
                                       PyObject *funcargs)
...
static PyObject *sys__debugmallocstats_impl(PyObject *module)
...
static PyObject *sys__clear_type_cache_impl(PyObject *module)
...
static PyObject *sys__clear_internal_caches_impl(PyObject *module)
...
static PyObject *sys_is_finalizing_impl(PyObject *module)
...
static PyObject *sys__stats_on_impl(PyObject *module)
...
static PyObject *sys__stats_off_impl(PyObject *module)
...
static PyObject *sys__stats_clear_impl(PyObject *module)
...
static int sys__stats_dump_impl(PyObject *module)
...
static PyObject *sys_getandroidapilevel_impl(PyObject *module)
...
static PyObject *sys_activate_stack_trampoline_impl(PyObject *module,
                                                    const char *backend)
/*[clinic end generated code: output=5783cdeb51874b43 input=a12df928758a82b4]*/
{
  ...
  if (optimizer != NULL) {
    PyErr_SetString(PyExc_ValueError,
                    "Cannot activate the perf trampoline if the JIT is active");
    Py_DECREF(optimizer);
    return NULL;
  }
#endif
    ...
    if (cur_cb.write_state != _Py_perfmap_callbacks.write_state) {
      ...
      if (cur_cb.write_state != _Py_perfmap_jit_callbacks.write_state) {
        if (_PyPerfTrampoline_SetCallbacks(&_Py_perfmap_jit_callbacks) < 0) {
          PyErr_SetString(PyExc_ValueError,
                          "can't activate perf jit trampoline");
          return NULL;
        }
      }
    }
...
static PyObject *sys_deactivate_stack_trampoline_impl(PyObject *module)
...
static PyObject *sys_is_stack_trampoline_active_impl(PyObject *module)
...
static PyObject *sys__getframemodulename_impl(PyObject *module, int depth)
...
static int sys__get_cpu_count_config_impl(PyObject *module)
...
static PyObject *sys__baserepl_impl(PyObject *module)
...
static int sys__is_gil_enabled_impl(PyObject *module)
...
PyAPI_FUNC(int)
    PyUnstable_WritePerfMapEntry(const void *code_addr, unsigned int code_size,
...
static PyMethodDef sys_methods[] = {
    ...
    SYS_ADDAUDITHOOK_METHODDEF{"audit", _PyCFunction_CAST(sys_audit),
                               METH_FASTCALL, audit_doc},
    ...
    SYS__CLEAR_INTERNAL_CACHES_METHODDEF SYS__CLEAR_TYPE_CACHE_METHODDEF
        SYS__CURRENT_FRAMES_METHODDEF SYS__CURRENT_EXCEPTIONS_METHODDEF
            SYS_DISPLAYHOOK_METHODDEF SYS_EXCEPTION_METHODDEF
                SYS_EXC_INFO_METHODDEF SYS_EXCEPTHOOK_METHODDEF
                    SYS_EXIT_METHODDEF SYS_GETDEFAULTENCODING_METHODDEF
                        ...
                        SYS__SETPROFILEALLTHREADS_METHODDEF SYS_GETPROFILE_METHODDEF
                            SYS_SETRECURSIONLIMIT_METHODDEF SYS_SETTRACE_METHODDEF
                                SYS__SETTRACEALLTHREADS_METHODDEF
                                    SYS_GETTRACE_METHODDEF SYS_CALL_TRACING_METHODDEF
        ...
        SYS_ACTIVATE_STACK_TRAMPOLINE_METHODDEF
            SYS_DEACTIVATE_STACK_TRAMPOLINE_METHODDEF
                SYS_IS_STACK_TRAMPOLINE_ACTIVE_METHODDEF
                    SYS_UNRAISABLEHOOK_METHODDEF SYS_GET_INT_MAX_STR_DIGITS_METHODDEF
...
static PyObject *list_stdlib_module_names(void) {
  ...
  PyObject *set =
      PyObject_CallFunction((PyObject *)&PyFrozenSet_Type, "(O)", names);
  Py_DECREF(names);
  return set;
}
...
static _Py_PreInitEntry _alloc_preinit_entry(const wchar_t *value) {
...
static int _append_preinit_entry(_Py_PreInitEntry *optionlist,
                                 const wchar_t *value) {
...
static void _clear_preinit_entries(_Py_PreInitEntry *optionlist) {
...
PyStatus _PySys_ReadPreinitWarnOptions(PyWideStringList *options) {
  PyStatus status;
...
PyStatus _PySys_ReadPreinitXOptions(PyConfig *config) {
  PyStatus status;
  _Py_PreInitEntry entry;
...
static PyObject *get_warnoptions(PyThreadState *tstate) {
...
static int _PySys_AddWarnOptionWithError(PyThreadState *tstate,
                                         PyObject *option) {
...
static PyObject *get_xoptions(PyThreadState *tstate) {
...
static int _PySys_AddXOptionWithError(const wchar_t *s) {
...
#ifdef MS_COREDLL
    /* concatenating string here */
    PyDoc_STR("dllhandle -- [Windows only] integer handle of the Python DLL\n\
winver -- [Windows only] version number of the Python DLL\n\
")
#endif /* MS_COREDLL */
#ifdef MS_WINDOWS
    /* concatenating string here */
    PyDoc_STR("_enablelegacywindowsfsencoding -- [Windows only]\n\
")
#endif
        PyDoc_STR("__stdin__ -- the original stdin; don't touch!\n\
...
static void sys_set_flag(PyObject *flags, Py_ssize_t pos, PyObject *value) {
...
int _PySys_SetFlagObj(Py_ssize_t pos, PyObject *value) {
...
static int _PySys_SetFlagInt(Py_ssize_t pos, int value) {
...
static int set_flags_from_config(PyInterpreterState *interp, PyObject *flags) {
...
static PyObject *make_flags(PyInterpreterState *interp) {
...
static PyObject *make_version_info(PyThreadState *tstate) {
...
PyDoc_STRVAR(emscripten_info__doc__, "sys._emscripten_info\n\
\n\
...
static PyObject *make_emscripten_info(void) {
  ...
  version = Py_BuildValue("(iii)", __EMSCRIPTEN_major__, __EMSCRIPTEN_minor__,
                          __EMSCRIPTEN_tiny__);
  if (version == NULL) {
    goto error;
  }
...
static struct PyModuleDef sysmodule = {
    PyModuleDef_HEAD_INIT, "sys", sys_doc, -1, /* multiple "initialization" just
                                                  copies the module dict. */
    sys_methods,           NULL,  NULL,    NULL, NULL};
...
static PyStatus _PySys_InitCore(PyThreadState *tstate, PyObject *sysdict) {
  PyObject *version_info;
  int res;
  PyInterpreterState *interp = tstate->interp;
...
#undef COPY_SYS_ATTR
  ...
  if (_PyStructSequence_InitBuiltin(interp, &Hash_InfoType, &hash_info_desc) <
      0) {
...
PyStatus _PySys_Create(PyThreadState *tstate, PyObject **sysmod_p) {
  assert(!_PyErr_Occurred(tstate));
  ...
  PyObject *sysmod =
      _PyModule_CreateInitialized(&sysmodule, PYTHON_API_VERSION);
  if (sysmod == NULL) {
...
void _PySys_FiniTypes(PyInterpreterState *interp) {
...
static PyObject *makepathobject(const wchar_t *path, wchar_t delim) {
  int i, n;
  const wchar_t *p;
  PyObject *v, *w;
...
static PyObject *make_sys_argv(int argc, wchar_t *const *argv) {
...
static void sys_write(PyObject *key, FILE *fp, const char *format, va_list va) {
  PyObject *file;
  char buffer[1001];
  int written;
  PyThreadState *tstate = _PyThreadState_GET();
...
static void sys_format(PyObject *key, FILE *fp, const char *format,
                       va_list va) {
...
int _PySys_SetIntMaxStrDigits(int maxdigits) {
  if (maxdigits != 0 && maxdigits < _PY_LONG_MAX_STR_DIGITS_THRESHOLD) {
    PyErr_Format(PyExc_ValueError, "maxdigits must be 0 or larger than %d",
