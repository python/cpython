...
/* PyInterpreterConfig
   ...
   This isn't exactly the right place for API related to PyInterpreterConfig,
   but neither pylifecycle.c nor pystate.c are quite right either.
   For now, this is as good a place as any.
*/
