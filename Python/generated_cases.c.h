...
// Do not edit!
        ...
        TARGET(INSTRUMENTED_RETURN_VALUE) {
            ...
            _PyFrame_StackPush(frame, retval);
            goto resume_frame;
            #line 953 "Python/generated_cases.c.h"
        }
        ...
        TARGET(GET_AITER) {
            ...
            if (getter == NULL) {
                _PyErr_Format(tstate, PyExc_TypeError,
                              ...
                              type->tp_name);
            #line 1014 "Python/generated_cases.c.h"
                Py_DECREF(obj);
        ...
        TARGET(GET_AWAITABLE) {
            ...
            #line 1126 "Python/generated_cases.c.h"
            stack_pointer[-1] = iter;
            PREDICT(LOAD_CONST);
            DISPATCH();
        }
        ...
        TARGET(INSTRUMENTED_YIELD_VALUE) {
            ...
            _PyFrame_StackPush(frame, retval);
            goto resume_frame;
            #line 1230 "Python/generated_cases.c.h"
        }
        ...
        TARGET(UNPACK_SEQUENCE_LIST) {
            ...
            #line 1504 "Python/generated_cases.c.h"
            Py_DECREF(seq);
            STACK_SHRINK(1);
            STACK_GROW(oparg);
            next_instr += 1;
        ...
        TARGET(DELETE_DEREF) {
            ...
            Py_DECREF(oldobj);
            #line 1828 "Python/generated_cases.c.h"
            DISPATCH();
        }
        ...
        TARGET(LOAD_CLASSDEREF) {
            ...
            #line 1866 "Python/generated_cases.c.h"
            STACK_GROW(1);
            stack_pointer[-1] = value;
            DISPATCH();
        }
        ...
        TARGET(BUILD_TUPLE) {
            ...
            #line 1940 "Python/generated_cases.c.h"
            STACK_SHRINK(oparg);
            STACK_GROW(1);
            stack_pointer[-1] = tup;
            DISPATCH();
        ...
        TARGET(BUILD_MAP) {
            ...
            #line 2042 "Python/generated_cases.c.h"
        ...
        TARGET(CHECK_EXC_MATCH) {
            ...
            #line 2744 "Python/generated_cases.c.h"
            Py_DECREF(right);
        ...
        TARGET(INSTRUMENTED_POP_JUMP_IF_NOT_NONE) {
            ...
            INSTRUMENTED_JUMP(here, next_instr + offset, PY_MONITORING_EVENT_BRANCH);
            #line 4549 "Python/generated_cases.c.h"
            DISPATCH();
        }
