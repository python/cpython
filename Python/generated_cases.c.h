...
// Do not edit!
        ...
        TARGET(INTERPRETER_EXIT) {
            ...
            return retval;
            #line 1054 "Python/generated_cases.c.h"
        }
        ...
        TARGET(RETURN_VALUE) {
            ...
            goto resume_frame;
            #line 1072 "Python/generated_cases.c.h"
        }
        ...
        TARGET(INSTRUMENTED_RETURN_CONST) {
            ...
            _PyFrame_StackPush(frame, retval);
            goto resume_frame;
            #line 1134 "Python/generated_cases.c.h"
        }
        ...
        TARGET(GET_AITER) {
            ...
            iter = (*getter)(obj);
            #line 1160 "Python/generated_cases.c.h"
            Py_DECREF(obj);
        ...
        TARGET(SEND) {
            ...
            Py_DECREF(v);
            #line 1319 "Python/generated_cases.c.h"
        ...
        TARGET(INSTRUMENTED_YIELD_VALUE) {
            ...
            _PyFrame_StackPush(frame, retval);
            goto resume_frame;
            #line 1367 "Python/generated_cases.c.h"
        }
        ...
        TARGET(LOAD_ATTR_MODULE) {
            ...
            Py_INCREF(res);
            res2 = NULL;
            #line 2673 "Python/generated_cases.c.h"
            Py_DECREF(owner);
            STACK_GROW(((oparg & 1) ? 1 : 0));
            stack_pointer[-1] = res;
            if (oparg & 1) { stack_pointer[-(1 + ((oparg & 1) ? 1 : 0))] = res2; }
        ...
        TARGET(CHECK_EXC_MATCH) {
            ...
            #line 3138 "Python/generated_cases.c.h"
            Py_DECREF(right);
        ...
        TARGET(POP_JUMP_IF_NOT_NONE) {
            PyObject *_tmp_1 = stack_pointer[-1];
            {
                ...
                if (Py_IsNone(value)) {
                    ...
                    b = Py_False;
                #line 3288 "Python/generated_cases.c.h"
                    Py_DECREF(value);
                #line 2293 "Python/bytecodes.c"
                }
        ...
        TARGET(MATCH_CLASS) {
            ...
            #line 3355 "Python/generated_cases.c.h"
            STACK_SHRINK(2);
        ...
        TARGET(GET_YIELD_FROM_ITER) {
            ...
            #line 3440 "Python/generated_cases.c.h"
                Py_DECREF(iterable);
        ...
        TARGET(BEFORE_WITH) {
            ...
            #line 3718 "Python/generated_cases.c.h"
            STACK_GROW(1);
            stack_pointer[-1] = res;
            stack_pointer[-2] = exit;
            DISPATCH();
        ...
        TARGET(PUSH_EXC_INFO) {
            ...
            #line 3770 "Python/generated_cases.c.h"
            STACK_GROW(1);
        ...
        TARGET(LOAD_ATTR_NONDESCRIPTOR_WITH_VALUES) {
            ...
            res = Py_NewRef(descr);
            #line 3857 "Python/generated_cases.c.h"
            STACK_GROW((0 ? 1 : 0));
            stack_pointer[-1] = res;
        ...
        TARGET(KW_NAMES) {
            ...
            #line 3924 "Python/generated_cases.c.h"
            DISPATCH();
        }
        ...
        TARGET(CALL_NO_KW_BUILTIN_FAST) {
            ...
            if (res == NULL) { STACK_SHRINK(oparg); goto pop_2_error; }
                /* Not deopting because this doesn't mean our optimization was
                   ...
                   handle it.
                */
            #line 4403 "Python/generated_cases.c.h"
            STACK_SHRINK(oparg);
            STACK_SHRINK(1);
            stack_pointer[-1] = res;
            next_instr += 3;
        ...
        TARGET(BUILD_SLICE) {
            ...
            #line 4917 "Python/generated_cases.c.h"
            Py_DECREF(start);
            Py_DECREF(stop);
            Py_XDECREF(step);
        ...
        TARGET(FORMAT_WITH_SPEC) {
            ...
            PyObject *value = stack_pointer[-2];
            PyObject *res;
            #line 3571 "Python/bytecodes.c"
            res = PyObject_Format(value, fmt_spec);
            Py_DECREF(value);
            Py_DECREF(fmt_spec);
            if (res == NULL) goto pop_2_error;
            #line 4973 "Python/generated_cases.c.h"
            STACK_SHRINK(1);
            stack_pointer[-1] = res;
            DISPATCH();
        }
        ...
        TARGET(INSTRUMENTED_JUMP_FORWARD) {
            ...
            #line 5054 "Python/generated_cases.c.h"
            DISPATCH();
        }

        TARGET(INSTRUMENTED_JUMP_BACKWARD) {
            #line 3625 "Python/bytecodes.c"
            CHECK_EVAL_BREAKER();
            INSTRUMENTED_JUMP(next_instr-1, next_instr+1-oparg, PY_MONITORING_EVENT_JUMP);
            #line 5062 "Python/generated_cases.c.h"
            DISPATCH();
        }
        ...
        TARGET(INSTRUMENTED_POP_JUMP_IF_NOT_NONE) {
            ...
            INSTRUMENTED_JUMP(here, next_instr + offset, PY_MONITORING_EVENT_BRANCH);
            #line 5118 "Python/generated_cases.c.h"
            DISPATCH();
        }

        TARGET(EXTENDED_ARG) {
            #line 3674 "Python/bytecodes.c"
            assert(oparg);
            opcode = next_instr->op.code;
            oparg = oparg << 8 | next_instr->op.arg;
            PRE_DISPATCH_GOTO();
            DISPATCH_GOTO();
            #line 5129 "Python/generated_cases.c.h"
        }

        TARGET(CACHE) {
            #line 3682 "Python/bytecodes.c"
            assert(0 && "Executing a cache.");
            Py_UNREACHABLE();
            #line 5136 "Python/generated_cases.c.h"
        }

        TARGET(RESERVED) {
            #line 3687 "Python/bytecodes.c"
            assert(0 && "Executing RESERVED instruction.");
            Py_UNREACHABLE();
            #line 5143 "Python/generated_cases.c.h"
        }
