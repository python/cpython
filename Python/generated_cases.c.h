...
// Do not edit!
        ...
        TARGET(LOAD_GLOBAL_BUILTIN) {
            ...
            STAT_INC(LOAD_GLOBAL, hit);
            null = NULL;
            #line 1774 "Python/generated_cases.c.h"
            STACK_GROW(1);
            STACK_GROW(((oparg & 1) ? 1 : 0));
            stack_pointer[-1] = res;
            if (oparg & 1) { stack_pointer[-(1 + ((oparg & 1) ? 1 : 0))] = null; }
        ...
        TARGET(DELETE_FAST) {
            ...
            SETLOCAL(oparg, NULL);
            #line 1788 "Python/generated_cases.c.h"
            DISPATCH();
        }

        TARGET(MAKE_CELL) {
            #line 1258 "Python/bytecodes.c"
            ...
            SETLOCAL(oparg, cell);
            #line 1802 "Python/generated_cases.c.h"
            DISPATCH();
        }
        ...
        TARGET(DELETE_DEREF) {
            ...
            Py_DECREF(oldobj);
            #line 1818 "Python/generated_cases.c.h"
            DISPATCH();
        }
        ...
        TARGET(LOAD_CLASSDEREF) {
            ...
            #line 1856 "Python/generated_cases.c.h"
            STACK_GROW(1);
            stack_pointer[-1] = value;
            DISPATCH();
        }
        ...
        TARGET(BUILD_STRING) {
            ...
            #line 1911 "Python/generated_cases.c.h"
        ...
        TARGET(BUILD_MAP) {
            ...
            #line 2032 "Python/generated_cases.c.h"
        ...
        TARGET(STORE_ATTR_WITH_HINT) {
            ...
            Py_DECREF(owner);
            #line 2517 "Python/generated_cases.c.h"
            STACK_SHRINK(2);
            next_instr += 4;
            DISPATCH();
        }
        ...
        TARGET(COMPARE_OP) {
            ...
            if (res == NULL) goto pop_2_error;
            #line 2568 "Python/generated_cases.c.h"
            STACK_SHRINK(1);
            stack_pointer[-1] = res;
            next_instr += 1;
            DISPATCH();
        ...
        TARGET(COMPARE_OP_FLOAT) {
            ...
            Py_INCREF(res);
            #line 2591 "Python/generated_cases.c.h"
            STACK_SHRINK(1);
            stack_pointer[-1] = res;
            next_instr += 1;
            DISPATCH();
        ...
        TARGET(CHECK_EG_MATCH) {
            ...
            int res = exception_group_match(exc_value, match_type,
                                            &match, &rest);
            #line 2702 "Python/generated_cases.c.h"
            Py_DECREF(exc_value);
            Py_DECREF(match_type);
        ...
        TARGET(CHECK_EXC_MATCH) {
            ...
            #line 2727 "Python/generated_cases.c.h"
                 Py_DECREF(right);
        ...
        TARGET(POP_JUMP_IF_NOT_NONE) {
            ...
            #line 2858 "Python/generated_cases.c.h"
            STACK_SHRINK(1);
            DISPATCH();
        }
        ...
        TARGET(JUMP_BACKWARD_NO_INTERRUPT) {
             ...
             */
            JUMPBY(-oparg);
            #line 2888 "Python/generated_cases.c.h"
            DISPATCH();
        }
        ...
        TARGET(MATCH_CLASS) {
            ...
            #line 2917 "Python/generated_cases.c.h"
            Py_DECREF(subject);
            Py_DECREF(type);
            Py_DECREF(names);
        ...
        TARGET(BEFORE_ASYNC_WITH) {
            ...
            #line 3235 "Python/generated_cases.c.h"
            Py_DECREF(mgr);
        ...
        TARGET(CALL_NO_KW_TYPE_1) {
            ...
            #line 3661 "Python/generated_cases.c.h"
            STACK_SHRINK(oparg);
            STACK_SHRINK(1);
            stack_pointer[-1] = res;
            next_instr += 4;
        ...
        TARGET(CALL_BUILTIN_FAST_WITH_KEYWORDS) {
            ...
            Py_DECREF(callable);
            if (res == NULL) { STACK_SHRINK(oparg); goto pop_2_error; }
            #line 3880 "Python/generated_cases.c.h"
            STACK_SHRINK(oparg);
            STACK_SHRINK(1);
            stack_pointer[-1] = res;
            next_instr += 4;
        ...
        TARGET(CALL_NO_KW_LEN) {
            ...
            Py_DECREF(arg);
            if (res == NULL) { STACK_SHRINK(oparg); goto pop_2_error; }
            #line 3919 "Python/generated_cases.c.h"
            STACK_SHRINK(oparg);
            STACK_SHRINK(1);
            stack_pointer[-1] = res;
            next_instr += 4;
        ...
        TARGET(CALL_NO_KW_METHOD_DESCRIPTOR_NOARGS) {
            ...
            Py_DECREF(callable);
            if (res == NULL) { STACK_SHRINK(oparg); goto pop_2_error; }
            #line 4111 "Python/generated_cases.c.h"
            STACK_SHRINK(oparg);
            STACK_SHRINK(1);
            stack_pointer[-1] = res;
            next_instr += 4;
        ...
        TARGET(RETURN_GENERATOR) {
            ...
            goto resume_frame;
            #line 4295 "Python/generated_cases.c.h"
        }
        ...
        TARGET(BINARY_OP) {
            ...
            if (res == NULL) goto pop_2_error;
            #line 4401 "Python/generated_cases.c.h"
            STACK_SHRINK(1);
            stack_pointer[-1] = res;
            next_instr += 1;
            DISPATCH();
        ...
        TARGET(INSTRUMENTED_LINE) {
            ...
            DISPATCH_GOTO();
            #line 4440 "Python/generated_cases.c.h"
        }
        ...
        TARGET(INSTRUMENTED_POP_JUMP_IF_NONE) {
            ...
            INSTRUMENTED_JUMP(here, next_instr + offset, PY_MONITORING_EVENT_BRANCH);
            #line 4516 "Python/generated_cases.c.h"
            DISPATCH();
        }
