...
// Do not edit!
        ...
        TARGET(BINARY_OP_MULTIPLY_FLOAT) {
            ...
            #line 392 "Python/generated_cases.c.h"
            STACK_SHRINK(1);
            stack_pointer[-1] = prod;
            next_instr += 1;
            DISPATCH();
        ...
        TARGET(BINARY_OP_ADD_UNICODE) {
            ...
            #line 447 "Python/generated_cases.c.h"
            STACK_SHRINK(1);
            stack_pointer[-1] = res;
            next_instr += 1;
            DISPATCH();
        ...
        TARGET(LIST_APPEND) {
            ...
            #line 714 "Python/generated_cases.c.h"
            STACK_SHRINK(1);
        ...
        TARGET(SET_ADD) {
            ...
            #line 725 "Python/generated_cases.c.h"
            Py_DECREF(v);
        ...
        TARGET(STORE_SUBSCR_DICT) {
            ...
            Py_DECREF(dict);
            if (err) goto pop_3_error;
            #line 806 "Python/generated_cases.c.h"
            STACK_SHRINK(3);
            next_instr += 1;
            DISPATCH();
        }
        ...
        TARGET(DELETE_SUBSCR) {
            ...
            #line 823 "Python/generated_cases.c.h"
            STACK_SHRINK(2);
            DISPATCH();
        }
        ...
        TARGET(RETURN_CONST) {
            ...
            _PyFrame_StackPush(frame, retval);
            goto resume_frame;
            #line 955 "Python/generated_cases.c.h"
        }
        ...
        TARGET(GET_AWAITABLE) {
            ...
            #line 1088 "Python/generated_cases.c.h"
            Py_DECREF(iterable);
        ...
        TARGET(INSTRUMENTED_YIELD_VALUE) {
            ...
            _PyFrame_StackPush(frame, retval);
            goto resume_frame;
            #line 1214 "Python/generated_cases.c.h"
        }
        ...
        TARGET(UNPACK_EX) {
            ...
            #line 1501 "Python/generated_cases.c.h"
            Py_DECREF(seq);
        ...
        TARGET(LOAD_NAME) {
            PyObject *_tmp_1;
            {
                ...
                Py_INCREF(locals);
                #line 1620 "Python/generated_cases.c.h"
                _tmp_1 = locals;
            }
            {
        ...
        TARGET(LOAD_GLOBAL_MODULE) {
            ...
            null = NULL;
            #line 1842 "Python/generated_cases.c.h"
            STACK_GROW(1);
            STACK_GROW(((oparg & 1) ? 1 : 0));
            stack_pointer[-1] = res;
            if (oparg & 1) { stack_pointer[-(1 + ((oparg & 1) ? 1 : 0))] = null; }
        ...
        TARGET(DELETE_FAST) {
            ...
            SETLOCAL(oparg, NULL);
            #line 1886 "Python/generated_cases.c.h"
            DISPATCH();
        }

        TARGET(MAKE_CELL) {
            #line 1353 "Python/bytecodes.c"
        ...
        TARGET(LOAD_FROM_DICT_OR_DEREF) {
            ...
            #line 1958 "Python/generated_cases.c.h"
            stack_pointer[-1] = value;
            DISPATCH();
        }
        ...
        TARGET(LOAD_SUPER_ATTR_ATTR) {
            ...
            if (res == NULL) goto pop_3_error;
            #line 2364 "Python/generated_cases.c.h"
            STACK_SHRINK(2);
            STACK_GROW(((oparg & 1) ? 1 : 0));
            stack_pointer[-1] = res;
            if (oparg & 1) { stack_pointer[-(1 + ((oparg & 1) ? 1 : 0))] = res2; }
        ...
        TARGET(LOAD_SUPER_ATTR_METHOD) {
            ...
            #line 2400 "Python/generated_cases.c.h"
            STACK_SHRINK(1);
            stack_pointer[-1] = res;
        ...
        TARGET(POP_JUMP_IF_NOT_NONE) {
            ...
            if (!Py_IsNone(value)) {
            #line 3083 "Python/generated_cases.c.h"
                Py_DECREF(value);
        ...
        TARGET(FOR_ITER_GEN) {
            ...
            DISPATCH_INLINED(gen_frame);
            #line 3435 "Python/generated_cases.c.h"
        }
        ...
        TARGET(BEFORE_WITH) {
            ...
            #line 3512 "Python/generated_cases.c.h"
            Py_DECREF(mgr);
        ...
        TARGET(WITH_EXCEPT_START) {
            ...
            */
            ...
            if (res == NULL) goto error;
            #line 3554 "Python/generated_cases.c.h"
            STACK_GROW(1);
            stack_pointer[-1] = res;
            DISPATCH();
        }
        ...
        TARGET(CALL) {
            ...
            #line 3779 "Python/generated_cases.c.h"
            STACK_SHRINK(oparg);
            STACK_SHRINK(1);
            stack_pointer[-1] = res;
            next_instr += 3;
        ...
        TARGET(CALL_BOUND_METHOD_EXACT_ARGS) {
            ...
            #line 3801 "Python/generated_cases.c.h"
        }
        ...
        TARGET(CALL_PY_EXACT_ARGS) {
            ...
            frame->return_offset = 0;
            DISPATCH_INLINED(new_frame);
            #line 3836 "Python/generated_cases.c.h"
        }
        ...
        TARGET(CALL_NO_KW_ISINSTANCE) {
            ...
            Py_DECREF(callable);
            if (res == NULL) { STACK_SHRINK(oparg); goto pop_2_error; }
            #line 4196 "Python/generated_cases.c.h"
            STACK_SHRINK(oparg);
            STACK_SHRINK(1);
            stack_pointer[-1] = res;
            next_instr += 3;
        ...
        TARGET(COPY) {
            ...
            #line 4625 "Python/generated_cases.c.h"
            STACK_GROW(1);
            stack_pointer[-1] = top;
            DISPATCH();
        }
