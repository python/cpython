...
#define TIER_ONE 1
        ...
        TARGET(BINARY_OP) {
            ...
            rhs = stack_pointer[-1];
            lhs = stack_pointer[-2];
            counter = read_u16(&this_instr[1].cache);
        ...
        TARGET(BINARY_SUBSCR) {
            ...
            
            {
                ...
                Py_DECREF(container); Py_DECREF(sub);  ;
                if (res == NULL) goto pop_2_error;
                ;
            }
            stack_pointer[-2] = res;
        ...
        TARGET(BUILD_CONST_KEY_MAP) {
            ...
            
            {
                ...
                PyTuple_GET_SIZE(keys) != (Py_ssize_t)oparg) {
                    ...
                    GOTO_ERROR(error);
                    // Pop the keys and values.
                }
                map = _PyDict_FromItems(
                &PyTuple_GET_ITEM(keys, 0), 1,
                values, 1, oparg);
                Py_DECREF(values); Py_DECREF(keys);  ;
        ...
        TARGET(BUILD_SLICE) {
            ...
            PyObject *stop;
            // _BUILD_SLICE
            step = stack_pointer[-1];
            stop = stack_pointer[-2];
            start = stack_pointer[-3];
            
            {
                slice = PySlice_New(start, stop, step);
                Py_DECREF(start); Py_DECREF(stop); Py_DECREF(step);  ;
                if (slice == NULL) goto pop_3_error;
                ;
            }
            stack_pointer[-3] = slice;
            stack_pointer += -2;
            DISPATCH();
        }
        ...
        TARGET(CALL_BOUND_METHOD_EXACT_ARGS) {
            ...
            
            {
                ...
                // Patch stack as it is used by _INIT_CALL_PY_EXACT_ARGS
                func = Py_NewRef(((PyMethodObject *)callable)->im_func);
                stack_pointer[-2 - oparg] = func;
                // This is used by CALL, upon deoptimization
                Py_DECREF(callable);
            }
            // _CHECK_FUNCTION_EXACT_ARGS
            self_or_null = self;
            callable = func;
            func_version = read_u32(&this_instr[2].cache);
        ...
        TARGET(CALL_FUNCTION_EX) {
            ...
            
            {
                ...
                Py_DECREF(func); Py_DECREF(callargs); Py_DECREF(kwargs);  ;
            ...
            value2 = stack_pointer[-2];
             {
                ...
                Py_DECREF(value2); Py_DECREF(value1);  ;
                if (res == NULL) goto pop_2_error;
                ;
            }
            stack_pointer[-2] = res;
        ...
        TARGET(CALL_LIST_APPEND) {
            ...
            
            {
                ...
                if (_PyList_AppendTakeRef((PyListObject *)self, args[0]) < 0) {
                    goto pop_1_error;
                    // Since arg is DECREF'ed already
                }
                Py_DECREF(self);
                Py_DECREF(callable);
                STACK_SHRINK(3);
            ...
            exc_value = stack_pointer[-2];
             {
                if (_PyEval_CheckExceptStarTypeValid(tstate, match_type) < 0) {
                    Py_DECREF(exc_value); Py_DECREF(match_type);  ;
            ...
            sub_iter = stack_pointer[-3];
             {
                ...
                if (PyErr_GivenExceptionMatches(exc_value, PyExc_StopIteration)) {
                    ...
                    Py_DECREF(sub_iter); Py_DECREF(last_sent_val); Py_DECREF(exc_value);  ;
                    none = Py_None;
                }
                else {
            ...
            left = stack_pointer[-2];
             {
                ...
                res = ((COMPARISON_NOT_EQUALS + eq) & oparg) ? Py_True :
                Py_False;
                // It's always a bool, so we don't care about oparg & 16.
            }
            stack_pointer[-2] = res;
        ...
        TARGET(COPY) {
            ...
            stack_pointer[+(-oparg-1)+(oparg-1)] = top;
            stack_pointer += 1+(-oparg-1)+(oparg-1);
            DISPATCH();
        }
        ...
        TARGET(DICT_MERGE) {
            ...
            
            {
                if (_PyDict_MergeEx(dict, update, 2) < 0) {
                    ...
                    Py_DECREF(callable); Py_DECREF(dict); Py_DECREF(update);  ;
                    if (true) { stack_pointer += -5+(-oparg - 1); goto error;
                    }
                    ;
                }
                Py_DECREF(callable); Py_DECREF(dict); Py_DECREF(update);  ;
            }
            stack_pointer[-5+(-oparg - 1)] = callable;
            stack_pointer[-2+(-oparg - 1)] = dict;
            stack_pointer += -1+(-oparg - 1)+(oparg - 1);
            DISPATCH();
        }
            ...
            dict = stack_pointer[-2+(-oparg - 1)];
             {
                if (PyDict_Update(dict, update) < 0) {
                    ...
                    Py_DECREF(dict); Py_DECREF(update);  ;
                    if (true) { stack_pointer += -2+(-oparg - 1); goto error;
                    }
                    ;
                }
                Py_DECREF(dict); Py_DECREF(update);  ;
        ...
        TARGET(END_ASYNC_FOR) {
            ...
            awaitable = stack_pointer[-2];
            {
                ...
                if (PyErr_GivenExceptionMatches(exc, PyExc_StopAsyncIteration)) {
                    Py_DECREF(awaitable); Py_DECREF(exc);  ;
                }
                else {
                    Py_INCREF(exc);
            ...
            level = stack_pointer[-2];
             {
                ...
                Py_DECREF(level); Py_DECREF(fromlist);  ;
                if (res == NULL) goto pop_2_error;
                ;
            }
            stack_pointer[-2] = res;
        ...
        TARGET(INSTRUMENTED_END_FOR) {
             ...
             * to conform to PEP 380 */
                ...
                Py_DECREF(receiver); Py_DECREF(value);  ;
            }
            stack_pointer += -2;
            DISPATCH();
        }
        ...
        TARGET(LIST_APPEND) {
            ...
            list = stack_pointer[-2+(-oparg-1)];
             {
                if (_PyList_AppendTakeRef((PyListObject *)list, v) < 0) { stack_pointer += -2+(-oparg-1); goto error;
                }
                ;
            }
            stack_pointer[-2+(-oparg-1)] = list;
            stack_pointer += -1+(-oparg-1)+(oparg-1);
            DISPATCH();
        }
        ...
        TARGET(LIST_EXTEND) {
            ...
            
            {
                ...
                if (none_val == NULL) {
                    ...
                    Py_DECREF(list); Py_DECREF(iterable);  ;
                    if (true) { stack_pointer += -2+(-oparg-1); goto error;
                    }
                    ;
                }
        ...
        TARGET(LOAD_ATTR_CLASS) {
            ...
            // _CHECK_ATTR_CLASS
            owner = stack_pointer[-1];
            type_version = read_u32(&this_instr[2].cache);
            ...
            /* Skip 2 cache entrie(s) */
            // _LOAD_ATTR_CLASS
            descr = (PyObject *)read_u64(&this_instr[6].cache);
            {
        ...
        TARGET(LOAD_ATTR_GETATTRIBUTE_OVERRIDDEN) {
            ...
            owner = stack_pointer[-1];
            type_version = read_u32(&this_instr[2].cache);
            func_version = read_u32(&this_instr[4].cache);
            getattribute = (PyObject *)read_u64(&this_instr[6].cache);
        ...
        TARGET(LOAD_ATTR_PROPERTY) {
            ...
            type_version = read_u32(&this_instr[2].cache);
            func_version = read_u32(&this_instr[4].cache);
            fget = (PyObject *)read_u64(&this_instr[6].cache);
            {
                assert((oparg & 1) == 0);
                DEOPT_IF(tstate->interp->eval_frame, LOAD_ATTR) ;
        ...
        TARGET(LOAD_ATTR_WITH_HINT) {
            ...
            hint = read_u16(&this_instr[4].cache);
            {
                PyDictOrValues dorv = *_PyObject_DictOrValuesPointer(owner);
                PyDictObject *dict = (PyDictObject *)_PyDictOrValues_GetDict(dorv);
        ...
        TARGET(LOAD_GLOBAL_BUILTIN) {
            ...
            version = read_u16(&this_instr[2].cache);
            {
            ...
            version = read_u16(&this_instr[3].cache);
            {
            ...
            self = stack_pointer[-1];
             {
                ...
                Py_DECREF(global_super); Py_DECREF(class); Py_DECREF(self);  ;
            ...
            global_super = stack_pointer[-3];
             {
                ...
                Py_TYPE(self)->tp_getattro == PyObject_GenericGetAttr ? &method_found :
                NULL);
            ...
            dict = stack_pointer[-3+(-oparg - 1)];
             {
                ...
                if (_PyDict_SetItem_Take2((PyDictObject *)dict, key, value) != 0) { stack_pointer += -3+(-oparg - 1); goto error;
                }
                ;
            }
            stack_pointer[-3+(-oparg - 1)] = dict;
            stack_pointer += -2+(-oparg - 1)+(oparg - 1);
            DISPATCH();
        }
        ...
        TARGET(MATCH_CLASS) {
            ...
            
            {
                ...
                Py_DECREF(subject); Py_DECREF(type); Py_DECREF(names);  ;
                if (attrs) {
            ...
            set = stack_pointer[-2+(-oparg-1)];
             {
                ...
                Py_DECREF(set); Py_DECREF(v);  ;
                if (err) { stack_pointer += -2+(-oparg-1); goto error;
                }
                ;
            }
            stack_pointer[-2+(-oparg-1)] = set;
            stack_pointer += -1+(-oparg-1)+(oparg-1);
            DISPATCH();
        }
            ...
            set = stack_pointer[-2+(-oparg-1)];
             {
                ...
                Py_DECREF(set); Py_DECREF(iterable);  ;
                if (err < 0) { stack_pointer += -2+(-oparg-1); goto error;
                }
                ;
            }
            stack_pointer[-2+(-oparg-1)] = set;
        ...
        TARGET(STORE_SUBSCR) {
            ...
            v = stack_pointer[-3];
            {
                ...
                Py_DECREF(v); Py_DECREF(container); Py_DECREF(sub);  ;
                if (err) goto pop_3_error;
                ;
            }
            stack_pointer += -3;
        ...
        TARGET(SWAP) {
            ...
            stack_pointer[-1+(-oparg-2)+(oparg-2)] = bottom;
            stack_pointer += +(-oparg-2)+(oparg-2);
            DISPATCH();
        }
        ...
        TARGET(TO_BOOL_ALWAYS_TRUE) {
            ...
            value = stack_pointer[-1];
            version = read_u32(&this_instr[2].cache);
        ...
        TARGET(WITH_EXCEPT_START) {
            ...
            */
                ...
                assert(PyLong_Check(lasti));
                (void)lasti;
                // Shut up compiler warning if asserts are off
                PyObject *stack[4] = {
                    NULL, exc, val, tb}
                ;
            ...
            stack_pointer[-4] = exit_func;
            stack_pointer[-3] = lasti;
            stack_pointer[-1] = val;
            stack_pointer[0] = res;
            stack_pointer += 1;
            DISPATCH();
