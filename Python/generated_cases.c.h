...
// Do not edit!
        ...
        TARGET(RETURN_CONST) {
            ...
            _PyFrame_StackPush(frame, retval);
            goto resume_frame;
            #line 983 "Python/generated_cases.c.h"
        }
        ...
        TARGET(GET_AWAITABLE) {
            ...
            #line 1136 "Python/generated_cases.c.h"
            stack_pointer[-1] = iter;
            PREDICT(LOAD_CONST);
            DISPATCH();
        }
        ...
        TARGET(YIELD_VALUE) {
            ...
            _PyFrame_StackPush(frame, retval);
            goto resume_frame;
            #line 1263 "Python/generated_cases.c.h"
        }
        ...
        TARGET(CLEANUP_THROW) {
            ...
            #line 1332 "Python/generated_cases.c.h"
                Py_DECREF(sub_iter);
        ...
        TARGET(LOAD_LOCALS) {
            ...
            Py_INCREF(locals);
            #line 1400 "Python/generated_cases.c.h"
            STACK_GROW(1);
        ...
        TARGET(LOAD_CLASSDICT_OR_GLOBAL) {
            PyObject *_tmp_1;
        ...
        TARGET(LOAD_GLOBAL_MODULE) {
            ...
            null = NULL;
            #line 1880 "Python/generated_cases.c.h"
            STACK_GROW(1);
            STACK_GROW(((oparg & 1) ? 1 : 0));
            stack_pointer[-1] = res;
            if (oparg & 1) { stack_pointer[-(1 + ((oparg & 1) ? 1 : 0))] = null; }
        ...
        TARGET(LOAD_CLASSDICT_OR_DEREF) {
            PyObject *_tmp_1 = stack_pointer[-1];
            {
                PyObject *class_dict = _tmp_1;
                _tmp_1 = class_dict;
        ...
        TARGET(STORE_DEREF) {
            ...
            PyCell_SET(cell, v);
            Py_XDECREF(oldobj);
            #line 2087 "Python/generated_cases.c.h"
            STACK_SHRINK(1);
            DISPATCH();
        }
        ...
        TARGET(DICT_UPDATE) {
            ...
            #line 2328 "Python/generated_cases.c.h"
            Py_DECREF(update);
            STACK_SHRINK(1);
            DISPATCH();
        }
        ...
        TARGET(DICT_MERGE) {
            ...
            #line 2341 "Python/generated_cases.c.h"
                Py_DECREF(update);
