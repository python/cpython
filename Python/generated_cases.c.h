...
// Do not edit!
        ...
        TARGET(COPY_FREE_VARS) {
            ...
            #line 2188 "Python/generated_cases.c.h"
            DISPATCH();
        }
        ...
        TARGET(BUILD_CONST_KEY_MAP) {
            ...
            map = _PyDict_FromItems(
                    ...
                    values, 1, oparg);
            #line 2384 "Python/generated_cases.c.h"
            for (int _i = oparg; --_i >= 0;) {
                Py_DECREF(values[_i]);
            }
            Py_DECREF(keys);
        ...
        TARGET(DICT_MERGE) {
            ...
            #line 2430 "Python/generated_cases.c.h"
            Py_DECREF(update);
            STACK_SHRINK(1);
            DISPATCH();
        }
        ...
        TARGET(INSTRUMENTED_LOAD_SUPER_ATTR) {
            ...
            #line 2457 "Python/generated_cases.c.h"
        }
        ...
        TARGET(CALL_METHOD_DESCRIPTOR_FAST_WITH_KEYWORDS) {
            ...
            Py_DECREF(callable);
            if (res == NULL) { STACK_SHRINK(oparg); goto pop_2_error; }
            #line 4665 "Python/generated_cases.c.h"
            STACK_SHRINK(oparg);
            STACK_SHRINK(1);
            stack_pointer[-1] = res;
            next_instr += 3;
        ...
        TARGET(BUILD_SLICE) {
            ...
            #line 4932 "Python/generated_cases.c.h"
            Py_DECREF(start);
            Py_DECREF(stop);
            Py_XDECREF(step);
        ...
        TARGET(SWAP) {
            ...
            assert(oparg >= 2);
            #line 5044 "Python/generated_cases.c.h"
        ...
        TARGET(INSTRUMENTED_INSTRUCTION) {
            ...
            opcode = next_opcode;
            DISPATCH_GOTO();
            #line 5063 "Python/generated_cases.c.h"
        }

        TARGET(INSTRUMENTED_JUMP_FORWARD) {
            #line 3615 "Python/bytecodes.c"
            INSTRUMENTED_JUMP(next_instr-1, next_instr+oparg, PY_MONITORING_EVENT_JUMP);
            #line 5069 "Python/generated_cases.c.h"
            DISPATCH();
        }

        TARGET(INSTRUMENTED_JUMP_BACKWARD) {
            #line 3619 "Python/bytecodes.c"
            CHECK_EVAL_BREAKER();
            INSTRUMENTED_JUMP(next_instr-1, next_instr+1-oparg, PY_MONITORING_EVENT_JUMP);
            #line 5077 "Python/generated_cases.c.h"
            DISPATCH();
        }
        ...
        TARGET(INSTRUMENTED_POP_JUMP_IF_TRUE) {
            ...
            #line 5088 "Python/generated_cases.c.h"
            DISPATCH();
        }

        TARGET(INSTRUMENTED_POP_JUMP_IF_FALSE) {
            #line 3632 "Python/bytecodes.c"
            PyObject *cond = POP();
            assert(PyBool_Check(cond));
            _Py_CODEUNIT *here = next_instr - 1;
            int offset = Py_IsFalse(cond) * oparg;
            INSTRUMENTED_JUMP(here, next_instr + offset, PY_MONITORING_EVENT_BRANCH);
            #line 5099 "Python/generated_cases.c.h"
            DISPATCH();
        }
        ...
        TARGET(INSTRUMENTED_POP_JUMP_IF_NONE) {
            ...
            INSTRUMENTED_JUMP(here, next_instr + offset, PY_MONITORING_EVENT_BRANCH);
            #line 5116 "Python/generated_cases.c.h"
            DISPATCH();
        }

        TARGET(INSTRUMENTED_POP_JUMP_IF_NOT_NONE) {
            #line 3654 "Python/bytecodes.c"
            PyObject *value = POP();
            _Py_CODEUNIT *here = next_instr-1;
            int offset;
            if (Py_IsNone(value)) {
            ...
            INSTRUMENTED_JUMP(here, next_instr + offset, PY_MONITORING_EVENT_BRANCH);
            #line 5133 "Python/generated_cases.c.h"
            DISPATCH();
        }

        TARGET(EXTENDED_ARG) {
            #line 3668 "Python/bytecodes.c"
            assert(oparg);
            opcode = next_instr->op.code;
            oparg = oparg << 8 | next_instr->op.arg;
            PRE_DISPATCH_GOTO();
            DISPATCH_GOTO();
            #line 5144 "Python/generated_cases.c.h"
        }

        TARGET(CACHE) {
            #line 3676 "Python/bytecodes.c"
            assert(0 && "Executing a cache.");
            Py_UNREACHABLE();
            #line 5151 "Python/generated_cases.c.h"
        }

        TARGET(RESERVED) {
            #line 3681 "Python/bytecodes.c"
            assert(0 && "Executing RESERVED instruction.");
            Py_UNREACHABLE();
            #line 5158 "Python/generated_cases.c.h"
        }
