...
// Do not edit!
        ...
        TARGET(LOAD_CLASS_DICT) {
            ...
            assert(v != NULL);
            #line 1712 "Python/generated_cases.c.h"
            STACK_GROW(1);
            stack_pointer[-1] = v;
            DISPATCH();
        }
        ...
        TARGET(BUILD_SET) {
            ...
            #line 2064 "Python/generated_cases.c.h"
            STACK_SHRINK(oparg);
            STACK_GROW(1);
            stack_pointer[-1] = set;
            DISPATCH();
        ...
        TARGET(DICT_UPDATE) {
            ...
            #line 2182 "Python/generated_cases.c.h"
            Py_DECREF(update);
            STACK_SHRINK(1);
            DISPATCH();
        }
        ...
        TARGET(CALL_NO_KW_LEN) {
            ...
            Py_DECREF(arg);
            if (res == NULL) { STACK_SHRINK(oparg); goto pop_2_error; }
            #line 3984 "Python/generated_cases.c.h"
            STACK_SHRINK(oparg);
            STACK_SHRINK(1);
            stack_pointer[-1] = res;
            next_instr += 3;
        ...
        TARGET(CALL_FUNCTION_EX) {
            ...
            #line 4288 "Python/generated_cases.c.h"
        ...
        TARGET(COPY) {
            ...
            #line 4434 "Python/generated_cases.c.h"
            STACK_GROW(1);
            stack_pointer[-1] = top;
            DISPATCH();
        }
