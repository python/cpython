...
// Do not edit!
        ...
        TARGET(TO_BOOL) {
            ...
            #line 306 "Python/generated_cases.c.h"
            Py_DECREF(value);
        ...
        TARGET(TO_BOOL_BOOL) {
            ...
            #line 328 "Python/generated_cases.c.h"
            next_instr += 3;
            DISPATCH();
        }
        ...
        TARGET(TO_BOOL_INT) {
            ...
            #line 344 "Python/generated_cases.c.h"
                Py_DECREF(value);
        ...
        TARGET(BINARY_OP_MULTIPLY_INT) {
            ...
            }
            {
                ...
                #line 469 "Python/generated_cases.c.h"
                _tmp_2 = res;
            }
            next_instr += 1;
            STACK_SHRINK(1);
        ...
        TARGET(BINARY_OP_ADD_INT) {
            ...
            }
            {
                ...
                _Py_DECREF_SPECIALIZED(left, (destructor)PyObject_Free);
                if (res == NULL) goto pop_2_error;
                #line 501 "Python/generated_cases.c.h"
                _tmp_2 = res;
            }
            next_instr += 1;
            STACK_SHRINK(1);
        ...
        TARGET(BINARY_OP_SUBTRACT_INT) {
            ...
            PyObject *_tmp_2 = stack_pointer[-2];
            {
                ...
                DEOPT_IF(!PyLong_CheckExact(left), BINARY_OP);
                DEOPT_IF(!PyLong_CheckExact(right), BINARY_OP);
                #line 519 "Python/generated_cases.c.h"
                _tmp_2 = left;
                _tmp_1 = right;
            }
            {
                ...
                PyObject *left = _tmp_2;
                PyObject *res;
                #line 431 "Python/bytecodes.c"
                STAT_INC(BINARY_OP, hit);
                res = _PyLong_Subtract((PyLongObject *)left, (PyLongObject *)right);
                _Py_DECREF_SPECIALIZED(right, (destructor)PyObject_Free);
                _Py_DECREF_SPECIALIZED(left, (destructor)PyObject_Free);
                if (res == NULL) goto pop_2_error;
                #line 533 "Python/generated_cases.c.h"
                _tmp_2 = res;
            }
            next_instr += 1;
            STACK_SHRINK(1);
        ...
        TARGET(BINARY_OP_MULTIPLY_FLOAT) {
            ...
            PyObject *_tmp_2 = stack_pointer[-2];
            {
                ...
                #line 551 "Python/generated_cases.c.h"
                _tmp_2 = left;
                _tmp_1 = right;
            }
            {
                ...
                #line 565 "Python/generated_cases.c.h"
                _tmp_2 = res;
            }
            next_instr += 1;
            STACK_SHRINK(1);
        ...
        TARGET(BINARY_OP_ADD_FLOAT) {
            ...
            PyObject *_tmp_2 = stack_pointer[-2];
            {
                ...
                DEOPT_IF(!PyFloat_CheckExact(left), BINARY_OP);
                DEOPT_IF(!PyFloat_CheckExact(right), BINARY_OP);
                #line 583 "Python/generated_cases.c.h"
                _tmp_2 = left;
                _tmp_1 = right;
            }
            {
                ...
                double dres =
                    ...
                    ((PyFloatObject *)right)->ob_fval;
                DECREF_INPUTS_AND_REUSE_FLOAT(left, right, dres, res);
                #line 597 "Python/generated_cases.c.h"
                _tmp_2 = res;
            }
            next_instr += 1;
            STACK_SHRINK(1);
        ...
        TARGET(BINARY_OP_SUBTRACT_FLOAT) {
            ...
            }
            {
                ...
                double dres =
                    ...
                    ((PyFloatObject *)right)->ob_fval;
                DECREF_INPUTS_AND_REUSE_FLOAT(left, right, dres, res);
                #line 629 "Python/generated_cases.c.h"
                _tmp_2 = res;
            }
            next_instr += 1;
            STACK_SHRINK(1);
        ...
        TARGET(BINARY_SLICE) {
            ...
            #line 764 "Python/generated_cases.c.h"
            STACK_SHRINK(2);
            stack_pointer[-1] = res;
            DISPATCH();
        }
        ...
        TARGET(STORE_SLICE) {
            ...
            #line 788 "Python/generated_cases.c.h"
            STACK_SHRINK(4);
            DISPATCH();
        }
        ...
        TARGET(BINARY_SUBSCR_LIST_INT) {
            ...
            Py_DECREF(list);
            #line 811 "Python/generated_cases.c.h"
            STACK_SHRINK(1);
            stack_pointer[-1] = res;
            next_instr += 1;
            DISPATCH();
        ...
        TARGET(BINARY_SUBSCR_TUPLE_INT) {
            ...
            _Py_DECREF_SPECIALIZED(sub, (destructor)PyObject_Free);
            Py_DECREF(tuple);
            #line 836 "Python/generated_cases.c.h"
            STACK_SHRINK(1);
            stack_pointer[-1] = res;
            next_instr += 1;
            DISPATCH();
        ...
        TARGET(SET_ADD) {
            ...
            #line 919 "Python/generated_cases.c.h"
            STACK_SHRINK(1);
            DISPATCH();
        }
        ...
        TARGET(STORE_SUBSCR_LIST_INT) {
            ...
            _Py_DECREF_SPECIALIZED(sub, (destructor)PyObject_Free);
            Py_DECREF(list);
            #line 979 "Python/generated_cases.c.h"
            STACK_SHRINK(3);
            next_instr += 1;
            DISPATCH();
        }
        ...
        TARGET(STORE_SUBSCR_DICT) {
            ...
            Py_DECREF(dict);
            if (err) goto pop_3_error;
            #line 995 "Python/generated_cases.c.h"
            STACK_SHRINK(3);
            next_instr += 1;
            DISPATCH();
        }
        ...
        TARGET(DELETE_SUBSCR) {
            ...
            #line 1007 "Python/generated_cases.c.h"
            Py_DECREF(container);
            Py_DECREF(sub);
        ...
        TARGET(RAISE_VARARGS) {
            ...
            #line 1070 "Python/generated_cases.c.h"
        }
        ...
        TARGET(RETURN_VALUE) {
            ...
            goto resume_frame;
            #line 1102 "Python/generated_cases.c.h"
        }
        ...
        TARGET(INSTRUMENTED_RETURN_VALUE) {
            ...
            _PyFrame_StackPush(frame, retval);
            goto resume_frame;
            #line 1124 "Python/generated_cases.c.h"
        }
        ...
        TARGET(INSTRUMENTED_RETURN_CONST) {
            ...
            _PyFrame_StackPush(frame, retval);
            goto resume_frame;
            #line 1164 "Python/generated_cases.c.h"
        }
        ...
        TARGET(GET_AITER) {
            ...
            if (getter == NULL) {
                _PyErr_Format(tstate, PyExc_TypeError,
                              ...
                              type->tp_name);
            #line 1183 "Python/generated_cases.c.h"
                Py_DECREF(obj);
            ...
            iter = (*getter)(obj);
            #line 1190 "Python/generated_cases.c.h"
            Py_DECREF(obj);
            #line 861 "Python/bytecodes.c"
            ...
            #line 1205 "Python/generated_cases.c.h"
        ...
        TARGET(GET_ANEXT) {
            ...
            #line 1256 "Python/generated_cases.c.h"
            STACK_GROW(1);
        ...
        TARGET(GET_AWAITABLE) {
            ...
            #line 1272 "Python/generated_cases.c.h"
            Py_DECREF(iterable);
        ...
        TARGET(SEND_GEN) {
            ...
            SKIP_OVER(INLINE_CACHE_ENTRIES_SEND);
            DISPATCH_INLINED(gen_frame);
            #line 1374 "Python/generated_cases.c.h"
        }
        ...
        TARGET(INSTRUMENTED_YIELD_VALUE) {
            ...
            _PyFrame_StackPush(frame, retval);
            goto resume_frame;
            #line 1397 "Python/generated_cases.c.h"
        }
        ...
        TARGET(RERAISE) {
            ...
            #line 1453 "Python/generated_cases.c.h"
        }
        ...
        TARGET(END_ASYNC_FOR) {
            ...
            #line 1472 "Python/generated_cases.c.h"
            STACK_SHRINK(2);
            DISPATCH();
        }
        ...
        TARGET(CLEANUP_THROW) {
            ...
            #line 1488 "Python/generated_cases.c.h"
                Py_DECREF(sub_iter);
        ...
        TARGET(LOAD_BUILD_CLASS) {
            ...
            #line 1540 "Python/generated_cases.c.h"
            STACK_GROW(1);
            stack_pointer[-1] = bc;
            DISPATCH();
        }
        ...
        TARGET(STORE_NAME) {
            ...
            if (err) goto pop_1_error;
            #line 1568 "Python/generated_cases.c.h"
            STACK_SHRINK(1);
            DISPATCH();
        }
        ...
        TARGET(UNPACK_SEQUENCE_TWO_TUPLE) {
            ...
            #line 1633 "Python/generated_cases.c.h"
            Py_DECREF(seq);
            STACK_SHRINK(1);
            STACK_GROW(oparg);
            next_instr += 1;
        ...
        TARGET(UNPACK_EX) {
            PyObject *seq = stack_pointer[-1];
            #line 1231 "Python/bytecodes.c"
            int totalargs = 1 + (oparg & 0xFF) + (oparg >> 8);
            PyObject **top = stack_pointer + totalargs - 1;
            int res = unpack_iterable(tstate, seq, oparg & 0xFF, oparg >> 8, top);
            #line 1685 "Python/generated_cases.c.h"
            Py_DECREF(seq);
            #line 1235 "Python/bytecodes.c"
            if (res == 0) goto pop_1_error;
            #line 1689 "Python/generated_cases.c.h"
        ...
        TARGET(STORE_ATTR) {
            ...
            #line 1716 "Python/generated_cases.c.h"
            Py_DECREF(v);
            Py_DECREF(owner);
            #line 1262 "Python/bytecodes.c"
            if (err) goto pop_2_error;
        ...
        TARGET(DELETE_ATTR) {
            ...
            #line 1732 "Python/generated_cases.c.h"
            Py_DECREF(owner);
            #line 1269 "Python/bytecodes.c"
            if (err) goto pop_1_error;
        ...
        TARGET(STORE_GLOBAL) {
            ...
            if (err) goto pop_1_error;
            #line 1750 "Python/generated_cases.c.h"
            STACK_SHRINK(1);
            DISPATCH();
        }
        ...
        TARGET(DELETE_GLOBAL) {
            ...
            #line 1768 "Python/generated_cases.c.h"
            DISPATCH();
        }
        ...
        TARGET(LOAD_LOCALS) {
            PyObject *_tmp_1;
            {
                ...
                Py_INCREF(locals);
                #line 1784 "Python/generated_cases.c.h"
                _tmp_1 = locals;
            }
            STACK_GROW(1);
        ...
        TARGET(LOAD_NAME) {
            ...
            }
            {
                ...
                #line 1867 "Python/generated_cases.c.h"
                _tmp_1 = v;
            }
            STACK_GROW(1);
            stack_pointer[-1] = _tmp_1;
        ...
        TARGET(LOAD_FROM_DICT_OR_GLOBALS) {
            PyObject *_tmp_1 = stack_pointer[-1];
            {
                ...
                #line 1937 "Python/generated_cases.c.h"
                _tmp_1 = v;
            }
            stack_pointer[-1] = _tmp_1;
            DISPATCH();
        ...
        TARGET(LOAD_GLOBAL_MODULE) {
            ...
            null = NULL;
            #line 2026 "Python/generated_cases.c.h"
            STACK_GROW(1);
            STACK_GROW(((oparg & 1) ? 1 : 0));
            stack_pointer[-1] = res;
            if (oparg & 1) { stack_pointer[-(1 + ((oparg & 1) ? 1 : 0))] = null; }
        ...
        TARGET(LOAD_GLOBAL_BUILTIN) {
            ...
            STAT_INC(LOAD_GLOBAL, hit);
            null = NULL;
            #line 2056 "Python/generated_cases.c.h"
            STACK_GROW(1);
            STACK_GROW(((oparg & 1) ? 1 : 0));
            stack_pointer[-1] = res;
            if (oparg & 1) { stack_pointer[-(1 + ((oparg & 1) ? 1 : 0))] = null; }
        ...
        TARGET(DELETE_FAST) {
            ...
            SETLOCAL(oparg, NULL);
            #line 2070 "Python/generated_cases.c.h"
            DISPATCH();
        }
        ...
        TARGET(LOAD_DEREF) {
            ...
            Py_INCREF(value);
            #line 2157 "Python/generated_cases.c.h"
            STACK_GROW(1);
            stack_pointer[-1] = value;
            DISPATCH();
        }
        ...
        TARGET(COPY_FREE_VARS) {
            ...
            #line 2187 "Python/generated_cases.c.h"
            DISPATCH();
        }
        ...
        TARGET(BUILD_STRING) {
            ...
            #line 2196 "Python/generated_cases.c.h"
        ...
        TARGET(BUILD_SET) {
            ...
            #line 2293 "Python/generated_cases.c.h"
            STACK_SHRINK(oparg);
            STACK_GROW(1);
            stack_pointer[-1] = set;
            DISPATCH();
        ...
        TARGET(SETUP_ANNOTATIONS) {
            ...
            #line 2365 "Python/generated_cases.c.h"
            DISPATCH();
        }
        ...
        TARGET(BUILD_CONST_KEY_MAP) {
            ...
            map = _PyDict_FromItems(
                    ...
                    values, 1, oparg);
            #line 2383 "Python/generated_cases.c.h"
            for (int _i = oparg; --_i >= 0;) {
                Py_DECREF(values[_i]);
            }
            Py_DECREF(keys);
            ...
            #line 2390 "Python/generated_cases.c.h"
            STACK_SHRINK(oparg);
            stack_pointer[-1] = map;
            DISPATCH();
        }
        ...
        TARGET(MAP_ADD) {
            ...
            #line 2444 "Python/generated_cases.c.h"
            STACK_SHRINK(2);
            DISPATCH();
        }
        ...
        TARGET(INSTRUMENTED_LOAD_SUPER_ATTR) {
            ...
            #line 2456 "Python/generated_cases.c.h"
        }
            ...
            if (oparg & 1) {
                ...
                if (_PyObject_GetMethod(owner, name, &meth)) {
                    ...
                    /* meth is not an unbound method (but a regular attr, or
                       ...
                       NULL | meth | arg1 | ... | argN
                    */
            #line 2632 "Python/generated_cases.c.h"
                    Py_DECREF(owner);
        ...
        TARGET(LOAD_ATTR_INSTANCE_VALUE) {
            ...
            Py_INCREF(res);
            res2 = NULL;
            #line 2675 "Python/generated_cases.c.h"
            Py_DECREF(owner);
            STACK_GROW(((oparg & 1) ? 1 : 0));
            stack_pointer[-1] = res;
            if (oparg & 1) { stack_pointer[-(1 + ((oparg & 1) ? 1 : 0))] = res2; }
        ...
        TARGET(LOAD_ATTR_MODULE) {
            ...
            Py_INCREF(res);
            res2 = NULL;
            #line 2703 "Python/generated_cases.c.h"
            Py_DECREF(owner);
            STACK_GROW(((oparg & 1) ? 1 : 0));
            stack_pointer[-1] = res;
            if (oparg & 1) { stack_pointer[-(1 + ((oparg & 1) ? 1 : 0))] = res2; }
        ...
        TARGET(LOAD_ATTR_GETATTRIBUTE_OVERRIDDEN) {
            ...
            frame->return_offset = 0;
            DISPATCH_INLINED(new_frame);
            #line 2869 "Python/generated_cases.c.h"
        }
        ...
        TARGET(CHECK_EXC_MATCH) {
            ...
            #line 3168 "Python/generated_cases.c.h"
            Py_DECREF(right);
        ...
        TARGET(JUMP_FORWARD) {
            ...
            JUMPBY(oparg);
            #line 3211 "Python/generated_cases.c.h"
            DISPATCH();
        }
        ...
        TARGET(MATCH_KEYS) {
            ...
            #line 3390 "Python/generated_cases.c.h"
            STACK_GROW(1);
        ...
        TARGET(GET_ITER) {
            ...
            #line 3402 "Python/generated_cases.c.h"
            Py_DECREF(iterable);
        ...
        TARGET(FOR_ITER_RANGE) {
            ...
            #line 3605 "Python/generated_cases.c.h"
            STACK_GROW(1);
            stack_pointer[-1] = next;
            next_instr += 1;
            DISPATCH();
        ...
        TARGET(LOAD_ATTR_METHOD_NO_DICT) {
            ...
            res = self;
            assert(oparg & 1);
            #line 3822 "Python/generated_cases.c.h"
            STACK_GROW(((oparg & 1) ? 1 : 0));
            stack_pointer[-1] = res;
            if (oparg & 1) { stack_pointer[-(1 + ((oparg & 1) ? 1 : 0))] = res2; }
            next_instr += 9;
        ...
        TARGET(INSTRUMENTED_CALL) {
            ...
            #line 3881 "Python/generated_cases.c.h"
        }
        ...
        TARGET(CALL_NO_KW_STR_1) {
            ...
            if (res == NULL) { STACK_SHRINK(oparg); goto pop_2_error; }
            #line 4116 "Python/generated_cases.c.h"
            STACK_SHRINK(oparg);
            STACK_SHRINK(1);
            stack_pointer[-1] = res;
            next_instr += 3;
        ...
        TARGET(CALL_NO_KW_TUPLE_1) {
            ...
            if (res == NULL) { STACK_SHRINK(oparg); goto pop_2_error; }
            #line 4141 "Python/generated_cases.c.h"
            STACK_SHRINK(oparg);
            STACK_SHRINK(1);
            stack_pointer[-1] = res;
            next_instr += 3;
        ...
        TARGET(EXIT_INIT_CHECK) {
            ...
            #line 4217 "Python/generated_cases.c.h"
            STACK_SHRINK(1);
            DISPATCH();
        }
        ...
        TARGET(CALL_NO_KW_METHOD_DESCRIPTOR_NOARGS) {
            ...
            Py_DECREF(callable);
            if (res == NULL) { STACK_SHRINK(oparg); goto pop_2_error; }
            #line 4614 "Python/generated_cases.c.h"
            STACK_SHRINK(oparg);
            STACK_SHRINK(1);
            stack_pointer[-1] = res;
            next_instr += 3;
        ...
        TARGET(CALL_NO_KW_METHOD_DESCRIPTOR_FAST) {
            ...
            Py_DECREF(callable);
            if (res == NULL) { STACK_SHRINK(oparg); goto pop_2_error; }
            #line 4655 "Python/generated_cases.c.h"
            STACK_SHRINK(oparg);
            STACK_SHRINK(1);
            stack_pointer[-1] = res;
            next_instr += 3;
        ...
        TARGET(BUILD_SLICE) {
            ...
            #line 4839 "Python/generated_cases.c.h"
            Py_DECREF(start);
            Py_DECREF(stop);
            Py_XDECREF(step);
            #line 3517 "Python/bytecodes.c"
            if (slice == NULL) { STACK_SHRINK(((oparg == 3) ? 1 : 0)); goto pop_2_error; }
            #line 4845 "Python/generated_cases.c.h"
        ...
        TARGET(BINARY_OP) {
            ...
            #line 4934 "Python/generated_cases.c.h"
            Py_DECREF(lhs);
            Py_DECREF(rhs);
        ...
        TARGET(INSTRUMENTED_JUMP_FORWARD) {
            #line 3593 "Python/bytecodes.c"
            INSTRUMENTED_JUMP(next_instr-1, next_instr+oparg, PY_MONITORING_EVENT_JUMP);
            #line 4976 "Python/generated_cases.c.h"
            DISPATCH();
        }

        TARGET(INSTRUMENTED_JUMP_BACKWARD) {
            #line 3597 "Python/bytecodes.c"
            INSTRUMENTED_JUMP(next_instr-1, next_instr+1-oparg, PY_MONITORING_EVENT_JUMP);
            #line 4983 "Python/generated_cases.c.h"
            CHECK_EVAL_BREAKER();
            DISPATCH();
        }

        TARGET(INSTRUMENTED_POP_JUMP_IF_TRUE) {
            #line 3602 "Python/bytecodes.c"
            PyObject *cond = POP();
        ...
        TARGET(INSTRUMENTED_POP_JUMP_IF_NONE) {
            ...
            INSTRUMENTED_JUMP(here, next_instr + offset, PY_MONITORING_EVENT_BRANCH);
            #line 5029 "Python/generated_cases.c.h"
            DISPATCH();
        }

        TARGET(INSTRUMENTED_POP_JUMP_IF_NOT_NONE) {
            #line 3638 "Python/bytecodes.c"
            PyObject *value = POP();
            _Py_CODEUNIT *here = next_instr-1;
            int offset;
            if (Py_IsNone(value)) {
            ...
            INSTRUMENTED_JUMP(here, next_instr + offset, PY_MONITORING_EVENT_BRANCH);
            #line 5046 "Python/generated_cases.c.h"
            DISPATCH();
        }

        TARGET(EXTENDED_ARG) {
            #line 3652 "Python/bytecodes.c"
            assert(oparg);
            opcode = next_instr->op.code;
            oparg = oparg << 8 | next_instr->op.arg;
            PRE_DISPATCH_GOTO();
            DISPATCH_GOTO();
            #line 5057 "Python/generated_cases.c.h"
        }

        TARGET(CACHE) {
            #line 3660 "Python/bytecodes.c"
            assert(0 && "Executing a cache.");
            Py_UNREACHABLE();
            #line 5064 "Python/generated_cases.c.h"
        }
        ...
        TARGET(RESERVED) {
            ...
            Py_UNREACHABLE();
            #line 5071 "Python/generated_cases.c.h"
        }
