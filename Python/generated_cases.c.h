...
// Do not edit!
        ...
        TARGET(UNARY_NOT) {
            ...
            #line 279 "Python/generated_cases.c.h"
            stack_pointer[-1] = res;
            DISPATCH();
        }
        ...
        TARGET(TO_BOOL_INT) {
            ...
            #line 339 "Python/generated_cases.c.h"
            stack_pointer[-1] = res;
            next_instr += 3;
            DISPATCH();
        }
        ...
        TARGET(TO_BOOL_STR) {
            ...
            #line 386 "Python/generated_cases.c.h"
                Py_DECREF(value);
            #line 362 "Python/bytecodes.c"
                res = Py_True;
            }
        ...
        TARGET(BINARY_OP_MULTIPLY_INT) {
            ...
            PyObject *_tmp_2 = stack_pointer[-2];
            {
                ...
                #line 440 "Python/generated_cases.c.h"
                _tmp_2 = left;
                _tmp_1 = right;
            }
            {
        ...
        TARGET(BINARY_OP_ADD_INT) {
            ...
            PyObject *_tmp_2 = stack_pointer[-2];
            {
                ...
                DEOPT_IF(!PyLong_CheckExact(left), BINARY_OP);
                DEOPT_IF(!PyLong_CheckExact(right), BINARY_OP);
                #line 472 "Python/generated_cases.c.h"
                _tmp_2 = left;
                _tmp_1 = right;
            }
            {
        ...
        TARGET(BINARY_OP_SUBTRACT_INT) {
            ...
            PyObject *_tmp_2 = stack_pointer[-2];
            {
                ...
                DEOPT_IF(!PyLong_CheckExact(left), BINARY_OP);
                DEOPT_IF(!PyLong_CheckExact(right), BINARY_OP);
                #line 504 "Python/generated_cases.c.h"
                _tmp_2 = left;
                _tmp_1 = right;
            }
            {
                ...
                _Py_DECREF_SPECIALIZED(left, (destructor)PyObject_Free);
                if (res == NULL) goto pop_2_error;
                #line 518 "Python/generated_cases.c.h"
                _tmp_2 = res;
            }
            next_instr += 1;
            STACK_SHRINK(1);
        ...
        TARGET(BINARY_OP_MULTIPLY_FLOAT) {
            ...
            }
            {
                ...
                #line 550 "Python/generated_cases.c.h"
                _tmp_2 = res;
            }
            next_instr += 1;
            STACK_SHRINK(1);
        ...
        TARGET(BINARY_OP_SUBTRACT_FLOAT) {
            ...
            }
            {
                ...
                double dres =
                    ...
                    ((PyFloatObject *)right)->ob_fval;
                DECREF_INPUTS_AND_REUSE_FLOAT(left, right, dres, res);
                #line 614 "Python/generated_cases.c.h"
                _tmp_2 = res;
            }
            next_instr += 1;
            STACK_SHRINK(1);
        ...
        TARGET(BINARY_OP_ADD_UNICODE) {
            ...
            PyObject *_tmp_2 = stack_pointer[-2];
            {
                ...
                #line 632 "Python/generated_cases.c.h"
                _tmp_2 = left;
                _tmp_1 = right;
            }
            {
        ...
        TARGET(BINARY_OP_INPLACE_ADD_UNICODE) {
            ...
            PyObject *_tmp_2 = stack_pointer[-2];
            {
                ...
                DEOPT_IF(!PyUnicode_CheckExact(left), BINARY_OP);
                DEOPT_IF(!PyUnicode_CheckExact(right), BINARY_OP);
                #line 664 "Python/generated_cases.c.h"
                _tmp_2 = left;
                _tmp_1 = right;
            }
            {
                ...
                #line 695 "Python/generated_cases.c.h"
            }
            STACK_SHRINK(2);
            DISPATCH();
        }
        ...
        TARGET(BINARY_SUBSCR) {
            ...
            #line 719 "Python/generated_cases.c.h"
            Py_DECREF(container);
            Py_DECREF(sub);
            #line 538 "Python/bytecodes.c"
            if (res == NULL) goto pop_2_error;
            #line 724 "Python/generated_cases.c.h"
            STACK_SHRINK(1);
            stack_pointer[-1] = res;
            next_instr += 1;
            DISPATCH();
        ...
        TARGET(STORE_SLICE) {
            ...
            #line 773 "Python/generated_cases.c.h"
            STACK_SHRINK(4);
            DISPATCH();
        }
        ...
        TARGET(BINARY_SUBSCR_LIST_INT) {
            ...
            Py_DECREF(list);
            #line 796 "Python/generated_cases.c.h"
            STACK_SHRINK(1);
            stack_pointer[-1] = res;
            next_instr += 1;
            DISPATCH();
        ...
        TARGET(LIST_APPEND) {
            ...
            #line 890 "Python/generated_cases.c.h"
            STACK_SHRINK(1);
            DISPATCH();
        }
        ...
        TARGET(SET_ADD) {
            ...
            #line 904 "Python/generated_cases.c.h"
            STACK_SHRINK(1);
            DISPATCH();
        }
        ...
        TARGET(STORE_SUBSCR) {
            ...
            #line 937 "Python/generated_cases.c.h"
            STACK_SHRINK(3);
            next_instr += 1;
            DISPATCH();
        }
        ...
        TARGET(STORE_SUBSCR_DICT) {
            ...
            Py_DECREF(dict);
            if (err) goto pop_3_error;
            #line 980 "Python/generated_cases.c.h"
            STACK_SHRINK(3);
            next_instr += 1;
            DISPATCH();
        }
        ...
        TARGET(DELETE_SUBSCR) {
            ...
            #line 997 "Python/generated_cases.c.h"
            STACK_SHRINK(2);
            DISPATCH();
        }
        ...
        TARGET(CALL_INTRINSIC_2) {
            ...
            if (res == NULL) goto pop_2_error;
            #line 1029 "Python/generated_cases.c.h"
            STACK_SHRINK(1);
            stack_pointer[-1] = res;
            DISPATCH();
        }
        ...
        TARGET(RAISE_VARARGS) {
            ...
            #line 1055 "Python/generated_cases.c.h"
        }

        TARGET(INTERPRETER_EXIT) {
            PyObject *retval = stack_pointer[-1];
            #line 747 "Python/bytecodes.c"
            ...
            return retval;
            #line 1069 "Python/generated_cases.c.h"
        }
        ...
        TARGET(RETURN_VALUE) {
            ...
            goto resume_frame;
            #line 1087 "Python/generated_cases.c.h"
        }
        ...
        TARGET(INSTRUMENTED_RETURN_VALUE) {
            ...
            _PyFrame_StackPush(frame, retval);
            goto resume_frame;
            #line 1109 "Python/generated_cases.c.h"
        }

        TARGET(RETURN_CONST) {
            #line 792 "Python/bytecodes.c"
            ...
            _PyFrame_StackPush(frame, retval);
            goto resume_frame;
            #line 1127 "Python/generated_cases.c.h"
        }
        ...
        TARGET(GET_AITER) {
            ...
            if (getter == NULL) {
                _PyErr_Format(tstate, PyExc_TypeError,
                              ...
                              type->tp_name);
            #line 1168 "Python/generated_cases.c.h"
                Py_DECREF(obj);
            #line 841 "Python/bytecodes.c"
        ...
        TARGET(INSTRUMENTED_YIELD_VALUE) {
            ...
            _PyFrame_StackPush(frame, retval);
            goto resume_frame;
            #line 1382 "Python/generated_cases.c.h"
        }
        ...
        TARGET(END_ASYNC_FOR) {
            ...
            #line 1447 "Python/generated_cases.c.h"
                Py_DECREF(awaitable);
                Py_DECREF(exc);
        ...
        TARGET(CLEANUP_THROW) {
            ...
            #line 1484 "Python/generated_cases.c.h"
            STACK_SHRINK(1);
            stack_pointer[-1] = value;
        ...
        TARGET(STORE_NAME) {
            ...
            if (err) goto pop_1_error;
            #line 1553 "Python/generated_cases.c.h"
            STACK_SHRINK(1);
            DISPATCH();
        }
        ...
        TARGET(UNPACK_SEQUENCE) {
            ...
            #line 1601 "Python/generated_cases.c.h"
            STACK_SHRINK(1);
            STACK_GROW(oparg);
            next_instr += 1;
            DISPATCH();
        ...
        TARGET(UNPACK_SEQUENCE_TUPLE) {
            ...
            #line 1637 "Python/generated_cases.c.h"
            Py_DECREF(seq);
            STACK_SHRINK(1);
            STACK_GROW(oparg);
            next_instr += 1;
        ...
        TARGET(UNPACK_EX) {
            ...
            if (res == 0) goto pop_1_error;
            #line 1674 "Python/generated_cases.c.h"
        ...
        TARGET(STORE_GLOBAL) {
            ...
            #line 1731 "Python/generated_cases.c.h"
            Py_DECREF(v);
            #line 1261 "Python/bytecodes.c"
            if (err) goto pop_1_error;
            #line 1735 "Python/generated_cases.c.h"
            STACK_SHRINK(1);
            DISPATCH();
        }
        ...
        TARGET(LOAD_GLOBAL_MODULE) {
            ...
            null = NULL;
            #line 2011 "Python/generated_cases.c.h"
            STACK_GROW(1);
            STACK_GROW(((oparg & 1) ? 1 : 0));
            stack_pointer[-1] = res;
            if (oparg & 1) { stack_pointer[-(1 + ((oparg & 1) ? 1 : 0))] = null; }
        ...
        TARGET(LOAD_GLOBAL_BUILTIN) {
            ...
            STAT_INC(LOAD_GLOBAL, hit);
            null = NULL;
            #line 2041 "Python/generated_cases.c.h"
            STACK_GROW(1);
            STACK_GROW(((oparg & 1) ? 1 : 0));
            stack_pointer[-1] = res;
            if (oparg & 1) { stack_pointer[-(1 + ((oparg & 1) ? 1 : 0))] = null; }
        ...
        TARGET(DELETE_FAST) {
            ...
            SETLOCAL(oparg, NULL);
            #line 2055 "Python/generated_cases.c.h"
            DISPATCH();
        }
        ...
        TARGET(BUILD_TUPLE) {
            ...
            #line 2200 "Python/generated_cases.c.h"
            STACK_SHRINK(oparg);
            STACK_GROW(1);
            stack_pointer[-1] = tup;
            DISPATCH();
        ...
        TARGET(BUILD_MAP) {
            ...
            #line 2302 "Python/generated_cases.c.h"
        ...
        TARGET(LOAD_SUPER_ATTR_METHOD) {
            ...
            #line 2569 "Python/generated_cases.c.h"
            STACK_SHRINK(1);
            stack_pointer[-1] = res;
        ...
        TARGET(LOAD_ATTR) {
            ...
            #line 2628 "Python/generated_cases.c.h"
                Py_DECREF(owner);
        ...
        TARGET(MATCH_CLASS) {
            ...
            #line 3325 "Python/generated_cases.c.h"
            Py_DECREF(subject);
            Py_DECREF(type);
            Py_DECREF(names);
        ...
        TARGET(MATCH_MAPPING) {
            ...
            #line 3349 "Python/generated_cases.c.h"
            STACK_GROW(1);
            stack_pointer[-1] = res;
            DISPATCH();
        }
        ...
        TARGET(GET_ITER) {
            ...
            #line 3387 "Python/generated_cases.c.h"
            Py_DECREF(iterable);
        ...
        TARGET(FOR_ITER) {
            ...
            #line 3468 "Python/generated_cases.c.h"
            STACK_GROW(1);
        ...
        TARGET(BEFORE_ASYNC_WITH) {
            ...
            #line 3654 "Python/generated_cases.c.h"
            STACK_GROW(1);
            stack_pointer[-1] = res;
        ...
        TARGET(INSTRUMENTED_CALL) {
            ...
            #line 3866 "Python/generated_cases.c.h"
        }
        ...
        TARGET(CALL_PY_WITH_DEFAULTS) {
            ...
            frame->return_offset = 0;
            DISPATCH_INLINED(new_frame);
            #line 4059 "Python/generated_cases.c.h"
        }
        ...
        TARGET(CALL_NO_KW_STR_1) {
            ...
            if (res == NULL) { STACK_SHRINK(oparg); goto pop_2_error; }
            #line 4101 "Python/generated_cases.c.h"
            STACK_SHRINK(oparg);
            STACK_SHRINK(1);
            stack_pointer[-1] = res;
            next_instr += 3;
        ...
        TARGET(CALL_BUILTIN_CLASS) {
            ...
            Py_DECREF(tp);
            if (res == NULL) { STACK_SHRINK(oparg); goto pop_2_error; }
            #line 4234 "Python/generated_cases.c.h"
            STACK_SHRINK(oparg);
            STACK_SHRINK(1);
            stack_pointer[-1] = res;
            next_instr += 3;
        ...
        TARGET(CALL_NO_KW_LIST_APPEND) {
            ...
            DISPATCH();
            #line 4477 "Python/generated_cases.c.h"
        }
        ...
        TARGET(FORMAT_WITH_SPEC) {
            ...
            Py_DECREF(fmt_spec);
            if (res == NULL) goto pop_2_error;
            #line 4880 "Python/generated_cases.c.h"
            STACK_SHRINK(1);
            stack_pointer[-1] = res;
            DISPATCH();
        }
        ...
        TARGET(COPY) {
            ...
            PyObject *top;
            #line 3535 "Python/bytecodes.c"
            assert(oparg > 0);
            top = Py_NewRef(bottom);
            #line 4892 "Python/generated_cases.c.h"
            STACK_GROW(1);
            stack_pointer[-1] = top;
            DISPATCH();
        }
        ...
        TARGET(BINARY_OP) {
            ...
            #line 4919 "Python/generated_cases.c.h"
            Py_DECREF(lhs);
            Py_DECREF(rhs);
        ...
        TARGET(INSTRUMENTED_INSTRUCTION) {
            ...
            opcode = next_opcode;
            DISPATCH_GOTO();
            #line 4955 "Python/generated_cases.c.h"
        }

        TARGET(INSTRUMENTED_JUMP_FORWARD) {
            #line 3578 "Python/bytecodes.c"
            INSTRUMENTED_JUMP(next_instr-1, next_instr+oparg, PY_MONITORING_EVENT_JUMP);
            #line 4961 "Python/generated_cases.c.h"
            DISPATCH();
        }

        TARGET(INSTRUMENTED_JUMP_BACKWARD) {
            #line 3582 "Python/bytecodes.c"
        ...
        TARGET(INSTRUMENTED_POP_JUMP_IF_FALSE) {
            ...
            INSTRUMENTED_JUMP(here, next_instr + offset, PY_MONITORING_EVENT_BRANCH);
            #line 4991 "Python/generated_cases.c.h"
            DISPATCH();
        }

        TARGET(INSTRUMENTED_POP_JUMP_IF_NONE) {
            #line 3603 "Python/bytecodes.c"
            PyObject *value = POP();
            _Py_CODEUNIT *here = next_instr-1;
            int offset;
            if (Py_IsNone(value)) {
            ...
            INSTRUMENTED_JUMP(here, next_instr + offset, PY_MONITORING_EVENT_BRANCH);
            #line 5008 "Python/generated_cases.c.h"
            DISPATCH();
        }

        TARGET(INSTRUMENTED_POP_JUMP_IF_NOT_NONE) {
            #line 3617 "Python/bytecodes.c"
            PyObject *value = POP();
            _Py_CODEUNIT *here = next_instr-1;
            int offset;
            if (Py_IsNone(value)) {
        ...
        TARGET(EXTENDED_ARG) {
            ...
            PRE_DISPATCH_GOTO();
            DISPATCH_GOTO();
            #line 5036 "Python/generated_cases.c.h"
        }

        TARGET(CACHE) {
            #line 3639 "Python/bytecodes.c"
            assert(0 && "Executing a cache.");
            Py_UNREACHABLE();
            #line 5043 "Python/generated_cases.c.h"
        }

        TARGET(RESERVED) {
            #line 3644 "Python/bytecodes.c"
            assert(0 && "Executing RESERVED instruction.");
            Py_UNREACHABLE();
            #line 5050 "Python/generated_cases.c.h"
        }
