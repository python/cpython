...
// Do not edit!
        ...
        TARGET(LOAD_SUPER_ATTR_ATTR) {
            ...
            #line 2386 "Python/generated_cases.c.h"
            Py_DECREF(global_super);
            Py_DECREF(class);
            Py_DECREF(self);
        ...
        TARGET(JUMP_BACKWARD_RECORDING) {
        ...
        TARGET(JUMP_BACKWARD_INTO_TRACE) {
            PyObject *trace = read_obj(&next_instr[1].cache);
        ...
        TARGET(KW_NAMES) {
            ...
            #line 3774 "Python/generated_cases.c.h"
            DISPATCH();
        }
        ...
        TARGET(CALL_NO_KW_METHOD_DESCRIPTOR_FAST) {
            ...
            Py_DECREF(callable);
            if (res == NULL) { STACK_SHRINK(oparg); goto pop_2_error; }
            #line 4494 "Python/generated_cases.c.h"
            STACK_SHRINK(oparg);
            STACK_SHRINK(1);
            stack_pointer[-1] = res;
            next_instr += 3;
