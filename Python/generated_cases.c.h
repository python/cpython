...
// Do not edit!
        ...
        TARGET(INSTRUMENTED_RESUME) {
            ...
            #line 36 "Python/generated_cases.c.h"
            DISPATCH();
        }
        ...
        TARGET(LOAD_CLOSURE) {
            PyObject *value;
            #line 130 "Python/bytecodes.c"
            /* We keep LOAD_CLOSURE so that the bytecode stays more readable. */
            value = GETLOCAL(oparg);
            if (value == NULL) goto unbound_local_error;
            Py_INCREF(value);
            #line 64 "Python/generated_cases.c.h"
            STACK_GROW(1);
        ...
        TARGET(LOAD_FAST_CHECK) {
            ...
            if (value == NULL) goto unbound_local_error;
            Py_INCREF(value);
            #line 76 "Python/generated_cases.c.h"
            STACK_GROW(1);
            stack_pointer[-1] = value;
            DISPATCH();
        }
        ...
        TARGET(LOAD_FAST) {
            ...
            assert(value != NULL);
            Py_INCREF(value);
            #line 88 "Python/generated_cases.c.h"
            STACK_GROW(1);
            stack_pointer[-1] = value;
            DISPATCH();
        }
        ...
        TARGET(LOAD_CONST) {
            ...
            Py_INCREF(value);
            #line 100 "Python/generated_cases.c.h"
            STACK_GROW(1);
            stack_pointer[-1] = value;
            DISPATCH();
        }
        ...
        TARGET(STORE_FAST) {
            ...
            #line 154 "Python/bytecodes.c"
            SETLOCAL(oparg, value);
            #line 110 "Python/generated_cases.c.h"
            STACK_SHRINK(1);
            DISPATCH();
        }
        ...
        TARGET(LOAD_FAST__LOAD_FAST) {
            ...
            oparg = (next_instr++)->op.arg;
            {
                ...
                assert(value != NULL);
                Py_INCREF(value);
                #line 134 "Python/generated_cases.c.h"
                _tmp_1 = value;
            }
            STACK_GROW(2);
        ...
        TARGET(LOAD_FAST__LOAD_CONST) {
            ...
            PyObject *_tmp_2;
            {
                ...
                assert(value != NULL);
                Py_INCREF(value);
                #line 152 "Python/generated_cases.c.h"
                _tmp_2 = value;
            }
            oparg = (next_instr++)->op.arg;
            {
                ...
                value = GETITEM(frame->f_code->co_consts, oparg);
                Py_INCREF(value);
                #line 161 "Python/generated_cases.c.h"
                _tmp_1 = value;
            }
            STACK_GROW(2);
            stack_pointer[-1] = _tmp_1;
        ...
        TARGET(STORE_FAST__LOAD_FAST) {
            PyObject *_tmp_1 = stack_pointer[-1];
            {
                ...
                #line 154 "Python/bytecodes.c"
                SETLOCAL(oparg, value);
                #line 176 "Python/generated_cases.c.h"
            }
            oparg = (next_instr++)->op.arg;
            {
                PyObject *value;
        ...
        TARGET(STORE_FAST__STORE_FAST) {
            ...
            oparg = (next_instr++)->op.arg;
            {
                ...
                #line 154 "Python/bytecodes.c"
                SETLOCAL(oparg, value);
                #line 206 "Python/generated_cases.c.h"
            }
            STACK_SHRINK(2);
            DISPATCH();
        }
        ...
        TARGET(LOAD_CONST__LOAD_FAST) {
            ...
            oparg = (next_instr++)->op.arg;
            {
                ...
                assert(value != NULL);
                Py_INCREF(value);
                #line 230 "Python/generated_cases.c.h"
                _tmp_1 = value;
            }
            STACK_GROW(2);
            stack_pointer[-1] = _tmp_1;
        ...
        TARGET(POP_TOP) {
            PyObject *value = stack_pointer[-1];
            #line 164 "Python/bytecodes.c"
            #line 242 "Python/generated_cases.c.h"
            Py_DECREF(value);
            STACK_SHRINK(1);
            DISPATCH();
        }
        ...
        TARGET(PUSH_NULL) {
            PyObject *res;
            #line 168 "Python/bytecodes.c"
            res = NULL;
            #line 252 "Python/generated_cases.c.h"
            STACK_GROW(1);
            stack_pointer[-1] = res;
            DISPATCH();
        }
        ...
        TARGET(END_FOR) {
            ...
            }
            {
                PyObject *value = _tmp_2;
                #line 164 "Python/bytecodes.c"
                #line 270 "Python/generated_cases.c.h"
                Py_DECREF(value);
            }
            STACK_SHRINK(2);
            DISPATCH();
        ...
        TARGET(INSTRUMENTED_END_FOR) {
            ...
            #line 290 "Python/generated_cases.c.h"
            Py_DECREF(receiver);
            Py_DECREF(value);
            STACK_SHRINK(2);
            DISPATCH();
        ...
        TARGET(UNARY_NEGATIVE) {
            ...
            #line 331 "Python/generated_cases.c.h"
            Py_DECREF(value);
        ...
        TARGET(UNARY_INVERT) {
            ...
            #line 366 "Python/generated_cases.c.h"
            Py_DECREF(value);
        ...
        TARGET(BINARY_OP_MULTIPLY_INT) {
            ...
            #line 387 "Python/generated_cases.c.h"
            STACK_SHRINK(1);
        ...
        TARGET(BINARY_OP_MULTIPLY_FLOAT) {
            ...
            #line 405 "Python/generated_cases.c.h"
            STACK_SHRINK(1);
            stack_pointer[-1] = prod;
            next_instr += 1;
            DISPATCH();
        ...
        TARGET(BINARY_OP_SUBTRACT_FLOAT) {
            ...
            #line 441 "Python/generated_cases.c.h"
            STACK_SHRINK(1);
            stack_pointer[-1] = sub;
            next_instr += 1;
            DISPATCH();
        ...
        TARGET(BINARY_OP_ADD_UNICODE) {
            ...
            #line 460 "Python/generated_cases.c.h"
            STACK_SHRINK(1);
            stack_pointer[-1] = res;
            next_instr += 1;
            DISPATCH();
        ...
        TARGET(BINARY_OP_INPLACE_ADD_UNICODE) {
            ...
            #line 497 "Python/generated_cases.c.h"
            STACK_SHRINK(2);
            DISPATCH();
        }
        ...
        TARGET(BINARY_OP_ADD_FLOAT) {
            ...
            #line 513 "Python/generated_cases.c.h"
            STACK_SHRINK(1);
            stack_pointer[-1] = sum;
            next_instr += 1;
            DISPATCH();
        ...
        TARGET(BINARY_OP_ADD_INT) {
            ...
            #line 532 "Python/generated_cases.c.h"
            STACK_SHRINK(1);
            stack_pointer[-1] = sum;
            next_instr += 1;
            DISPATCH();
        ...
        TARGET(STORE_SLICE) {
            ...
            #line 611 "Python/generated_cases.c.h"
            STACK_SHRINK(4);
            DISPATCH();
        }
        ...
        TARGET(BINARY_SUBSCR_LIST_INT) {
            ...
            Py_DECREF(list);
            #line 634 "Python/generated_cases.c.h"
            STACK_SHRINK(1);
            stack_pointer[-1] = res;
            next_instr += 4;
            DISPATCH();
        ...
        TARGET(BINARY_SUBSCR_DICT) {
            ...
            #line 678 "Python/generated_cases.c.h"
                Py_DECREF(dict);
                Py_DECREF(sub);
            ...
            #line 685 "Python/generated_cases.c.h"
            Py_DECREF(dict);
            Py_DECREF(sub);
            STACK_SHRINK(1);
            stack_pointer[-1] = res;
        ...
        TARGET(BINARY_SUBSCR_GETITEM) {
            ...
            #line 718 "Python/generated_cases.c.h"
        }
        ...
        TARGET(SET_ADD) {
            ...
            #line 468 "Python/bytecodes.c"
            int err = PySet_Add(set, v);
            #line 737 "Python/generated_cases.c.h"
            Py_DECREF(v);
        ...
        TARGET(STORE_SUBSCR) {
            ...
            #line 769 "Python/generated_cases.c.h"
            Py_DECREF(v);
            Py_DECREF(container);
            Py_DECREF(sub);
            #line 496 "Python/bytecodes.c"
            if (err) goto pop_3_error;
            #line 775 "Python/generated_cases.c.h"
            STACK_SHRINK(3);
            next_instr += 1;
            DISPATCH();
        }
        ...
        TARGET(STORE_SUBSCR_LIST_INT) {
            ...
            _Py_DECREF_SPECIALIZED(sub, (destructor)PyObject_Free);
            Py_DECREF(list);
            #line 802 "Python/generated_cases.c.h"
            STACK_SHRINK(3);
            next_instr += 1;
            DISPATCH();
        }
        ...
        TARGET(STORE_SUBSCR_DICT) {
            ...
            Py_DECREF(dict);
            if (err) goto pop_3_error;
            #line 818 "Python/generated_cases.c.h"
            STACK_SHRINK(3);
            next_instr += 1;
            DISPATCH();
        }
        ...
        TARGET(DELETE_SUBSCR) {
            ...
            #line 835 "Python/generated_cases.c.h"
            STACK_SHRINK(2);
            DISPATCH();
        }
        ...
        TARGET(RAISE_VARARGS) {
            ...
            #line 893 "Python/generated_cases.c.h"
        }
        ...
        TARGET(INTERPRETER_EXIT) {
            ...
            return retval;
            #line 909 "Python/generated_cases.c.h"
        }
        ...
        TARGET(RETURN_VALUE) {
            ...
            goto resume_frame;
            #line 926 "Python/generated_cases.c.h"
        }
        ...
        TARGET(GET_AITER) {
            ...
            #line 1026 "Python/generated_cases.c.h"
        ...
        TARGET(GET_ANEXT) {
            ...
            #line 1078 "Python/generated_cases.c.h"
            STACK_GROW(1);
        ...
        TARGET(GET_AWAITABLE) {
            ...
            #line 1096 "Python/generated_cases.c.h"
            Py_DECREF(iterable);
            #line 734 "Python/bytecodes.c"
        ...
        TARGET(INSTRUMENTED_YIELD_VALUE) {
            ...
            _PyFrame_StackPush(frame, retval);
            goto resume_frame;
            #line 1220 "Python/generated_cases.c.h"
        }
        ...
        TARGET(POP_EXCEPT) {
            ...
            #line 1250 "Python/generated_cases.c.h"
            STACK_SHRINK(1);
            DISPATCH();
        }
        ...
        TARGET(RERAISE) {
            ...
            #line 1276 "Python/generated_cases.c.h"
        }
        ...
        TARGET(END_ASYNC_FOR) {
            ...
            #line 1285 "Python/generated_cases.c.h"
                Py_DECREF(awaitable);
                Py_DECREF(exc);
            ...
            #line 1295 "Python/generated_cases.c.h"
            STACK_SHRINK(2);
            DISPATCH();
        }
        ...
        TARGET(CLEANUP_THROW) {
            ...
            PyObject *none;
            PyObject *value;
            #line 901 "Python/bytecodes.c"
            assert(throwflag);
            assert(exc_value && PyExceptionInstance_Check(exc_value));
            if (PyErr_GivenExceptionMatches(exc_value, PyExc_StopIteration)) {
                value = Py_NewRef(((PyStopIterationObject *)exc_value)->value);
            #line 1311 "Python/generated_cases.c.h"
                Py_DECREF(sub_iter);
            ...
            #line 1322 "Python/generated_cases.c.h"
            STACK_SHRINK(1);
            stack_pointer[-1] = value;
        ...
        TARGET(LOAD_BUILD_CLASS) {
            ...
            #line 1363 "Python/generated_cases.c.h"
            STACK_GROW(1);
            stack_pointer[-1] = bc;
            DISPATCH();
        }
        ...
        TARGET(STORE_NAME) {
            ...
            #line 1378 "Python/generated_cases.c.h"
                Py_DECREF(v);
            #line 950 "Python/bytecodes.c"
                if (true) goto pop_1_error;
            }
            ...
            Py_DECREF(v);
            #line 957 "Python/bytecodes.c"
            if (err) goto pop_1_error;
            #line 1391 "Python/generated_cases.c.h"
            STACK_SHRINK(1);
            DISPATCH();
        }
        ...
        TARGET(UNPACK_EX) {
            PyObject *seq = stack_pointer[-1];
            #line 1036 "Python/bytecodes.c"
            int totalargs = 1 + (oparg & 0xFF) + (oparg >> 8);
            PyObject **top = stack_pointer + totalargs - 1;
            int res = unpack_iterable(tstate, seq, oparg & 0xFF, oparg >> 8, top);
            #line 1508 "Python/generated_cases.c.h"
            Py_DECREF(seq);
            #line 1040 "Python/bytecodes.c"
            if (res == 0) goto pop_1_error;
            #line 1512 "Python/generated_cases.c.h"
        ...
        TARGET(DELETE_ATTR) {
            ...
            #line 1555 "Python/generated_cases.c.h"
            Py_DECREF(owner);
        ...
        TARGET(STORE_GLOBAL) {
            ...
            Py_DECREF(v);
            #line 1081 "Python/bytecodes.c"
            if (err) goto pop_1_error;
            #line 1573 "Python/generated_cases.c.h"
            STACK_SHRINK(1);
            DISPATCH();
        }
        ...
        TARGET(DELETE_GLOBAL) {
            ...
            #line 1591 "Python/generated_cases.c.h"
            DISPATCH();
        }
        ...
        TARGET(LOAD_GLOBAL_MODULE) {
            ...
            null = NULL;
            #line 1744 "Python/generated_cases.c.h"
            STACK_GROW(1);
            STACK_GROW(((oparg & 1) ? 1 : 0));
            stack_pointer[-1] = res;
            if (oparg & 1) { stack_pointer[-(1 + ((oparg & 1) ? 1 : 0))] = null; }
        ...
        TARGET(MAKE_CELL) {
            ...
            SETLOCAL(oparg, cell);
            #line 1801 "Python/generated_cases.c.h"
            DISPATCH();
        }

        TARGET(DELETE_DEREF) {
            #line 1266 "Python/bytecodes.c"
        ...
        TARGET(LOAD_DEREF) {
            ...
            Py_INCREF(value);
            #line 1871 "Python/generated_cases.c.h"
            STACK_GROW(1);
            stack_pointer[-1] = value;
            DISPATCH();
        }
        ...
        TARGET(STORE_DEREF) {
            PyObject *v = stack_pointer[-1];
            #line 1323 "Python/bytecodes.c"
            PyObject *cell = GETLOCAL(oparg);
            PyObject *oldobj = PyCell_GET(cell);
            PyCell_SET(cell, v);
            Py_XDECREF(oldobj);
            #line 1884 "Python/generated_cases.c.h"
            STACK_SHRINK(1);
            DISPATCH();
        }
        ...
        TARGET(BUILD_STRING) {
            ...
            #line 1910 "Python/generated_cases.c.h"
            for (int _i = oparg; --_i >= 0;) {
                Py_DECREF(pieces[_i]);
            }
            #line 1345 "Python/bytecodes.c"
        ...
        TARGET(BUILD_TUPLE) {
            ...
            #line 1929 "Python/generated_cases.c.h"
            STACK_SHRINK(oparg);
            STACK_GROW(1);
            stack_pointer[-1] = tup;
            DISPATCH();
        ...
        TARGET(BUILD_LIST) {
            ...
            #line 1942 "Python/generated_cases.c.h"
            STACK_SHRINK(oparg);
            STACK_GROW(1);
        ...
        TARGET(SET_UPDATE) {
            ...
            if (err < 0) goto pop_1_error;
            #line 1984 "Python/generated_cases.c.h"
            STACK_SHRINK(1);
            DISPATCH();
        }
        ...
        TARGET(SETUP_ANNOTATIONS) {
            ...
            #line 2079 "Python/generated_cases.c.h"
            DISPATCH();
        }
        ...
        TARGET(BUILD_CONST_KEY_MAP) {
            ...
            #line 2104 "Python/generated_cases.c.h"
            STACK_SHRINK(oparg);
            stack_pointer[-1] = map;
            DISPATCH();
        }
        ...
        TARGET(LOAD_ATTR) {
            ...
            #line 2221 "Python/generated_cases.c.h"
            STACK_GROW(((oparg & 1) ? 1 : 0));
            stack_pointer[-1] = res;
        ...
        TARGET(LOAD_ATTR_MODULE) {
            ...
            Py_INCREF(res);
            res2 = NULL;
            #line 2276 "Python/generated_cases.c.h"
            Py_DECREF(owner);
            STACK_GROW(((oparg & 1) ? 1 : 0));
            stack_pointer[-1] = res;
            if (oparg & 1) { stack_pointer[-(1 + ((oparg & 1) ? 1 : 0))] = res2; }
        ...
        TARGET(LOAD_ATTR_WITH_HINT) {
            ...
            Py_INCREF(res);
            res2 = NULL;
            #line 2318 "Python/generated_cases.c.h"
            Py_DECREF(owner);
            STACK_GROW(((oparg & 1) ? 1 : 0));
            stack_pointer[-1] = res;
            if (oparg & 1) { stack_pointer[-(1 + ((oparg & 1) ? 1 : 0))] = res2; }
        ...
        TARGET(LOAD_ATTR_SLOT) {
            ...
            Py_INCREF(res);
            res2 = NULL;
            #line 2343 "Python/generated_cases.c.h"
            Py_DECREF(owner);
            STACK_GROW(((oparg & 1) ? 1 : 0));
            stack_pointer[-1] = res;
            if (oparg & 1) { stack_pointer[-(1 + ((oparg & 1) ? 1 : 0))] = res2; }
        ...
        TARGET(LOAD_ATTR_GETATTRIBUTE_OVERRIDDEN) {
            ...
            JUMPBY(INLINE_CACHE_ENTRIES_LOAD_ATTR);
            DISPATCH_INLINED(new_frame);
            #line 2440 "Python/generated_cases.c.h"
        }
        ...
        TARGET(STORE_ATTR_INSTANCE_VALUE) {
            ...
            Py_DECREF(owner);
            #line 2466 "Python/generated_cases.c.h"
            STACK_SHRINK(2);
            next_instr += 4;
            DISPATCH();
        }
        ...
        TARGET(STORE_ATTR_WITH_HINT) {
            ...
            Py_DECREF(owner);
            #line 2516 "Python/generated_cases.c.h"
            STACK_SHRINK(2);
            next_instr += 4;
            DISPATCH();
        }
        ...
        TARGET(COMPARE_OP) {
            ...
            if (res == NULL) goto pop_2_error;
            #line 2556 "Python/generated_cases.c.h"
            STACK_SHRINK(1);
            stack_pointer[-1] = res;
            next_instr += 1;
            DISPATCH();
        ...
        TARGET(INSTRUMENTED_COMPARE_AND_BRANCH) {
        ...
        TARGET(COMPARE_AND_BRANCH_FLOAT) {
            ...
            #line 2643 "Python/generated_cases.c.h"
            STACK_SHRINK(2);
            next_instr += 2;
            DISPATCH();
        }
        ...
        TARGET(COMPARE_AND_BRANCH_STR) {
            ...
            #line 2694 "Python/generated_cases.c.h"
            STACK_SHRINK(2);
            next_instr += 2;
            DISPATCH();
        }
        ...
        TARGET(IS_OP) {
            ...
            #line 2706 "Python/generated_cases.c.h"
            Py_DECREF(left);
            Py_DECREF(right);
            #line 1902 "Python/bytecodes.c"
            b = Py_NewRef(res ? Py_True : Py_False);
            #line 2711 "Python/generated_cases.c.h"
            STACK_SHRINK(1);
            stack_pointer[-1] = b;
            DISPATCH();
        }
        ...
        TARGET(JUMP_FORWARD) {
            ...
            JUMPBY(oparg);
            #line 2828 "Python/generated_cases.c.h"
            DISPATCH();
        }
        ...
        TARGET(BEFORE_ASYNC_WITH) {
            ...
            #line 3295 "Python/generated_cases.c.h"
            STACK_GROW(1);
            stack_pointer[-1] = res;
        ...
        TARGET(CALL_BUILTIN_CLASS) {
            ...
            Py_DECREF(tp);
            if (res == NULL) { STACK_SHRINK(oparg); goto pop_2_error; }
            #line 3797 "Python/generated_cases.c.h"
            STACK_SHRINK(oparg);
            STACK_SHRINK(1);
            stack_pointer[-1] = res;
            next_instr += 4;
        ...
        TARGET(CALL_NO_KW_BUILTIN_O) {
            ...
            Py_DECREF(callable);
            if (res == NULL) { STACK_SHRINK(oparg); goto pop_2_error; }
            #line 3839 "Python/generated_cases.c.h"
            STACK_SHRINK(oparg);
            STACK_SHRINK(1);
            stack_pointer[-1] = res;
            next_instr += 4;
        ...
        TARGET(CALL_NO_KW_METHOD_DESCRIPTOR_O) {
            ...
            Py_DECREF(callable);
            if (res == NULL) { STACK_SHRINK(oparg); goto pop_2_error; }
            #line 4078 "Python/generated_cases.c.h"
            STACK_SHRINK(oparg);
            STACK_SHRINK(1);
            stack_pointer[-1] = res;
            next_instr += 4;
        ...
        TARGET(CALL_METHOD_DESCRIPTOR_FAST_WITH_KEYWORDS) {
            ...
            Py_DECREF(callable);
            if (res == NULL) { STACK_SHRINK(oparg); goto pop_2_error; }
            #line 4120 "Python/generated_cases.c.h"
            STACK_SHRINK(oparg);
            STACK_SHRINK(1);
            stack_pointer[-1] = res;
            next_instr += 4;
        ...
        TARGET(CALL_NO_KW_METHOD_DESCRIPTOR_NOARGS) {
            ...
            Py_DECREF(callable);
            if (res == NULL) { STACK_SHRINK(oparg); goto pop_2_error; }
            #line 4162 "Python/generated_cases.c.h"
            STACK_SHRINK(oparg);
            STACK_SHRINK(1);
            stack_pointer[-1] = res;
            next_instr += 4;
        ...
        TARGET(CALL_NO_KW_METHOD_DESCRIPTOR_FAST) {
            ...
            Py_DECREF(callable);
            if (res == NULL) { STACK_SHRINK(oparg); goto pop_2_error; }
            #line 4203 "Python/generated_cases.c.h"
            STACK_SHRINK(oparg);
            STACK_SHRINK(1);
            stack_pointer[-1] = res;
            next_instr += 4;
        ...
        TARGET(RETURN_GENERATOR) {
            ...
            goto resume_frame;
            #line 4345 "Python/generated_cases.c.h"
        }
        ...
        TARGET(BUILD_SLICE) {
            ...
            #line 4361 "Python/generated_cases.c.h"
        ...
        TARGET(BINARY_OP) {
            ...
            Py_DECREF(lhs);
            Py_DECREF(rhs);
            #line 3178 "Python/bytecodes.c"
            if (res == NULL) goto pop_2_error;
            #line 4451 "Python/generated_cases.c.h"
            STACK_SHRINK(1);
            stack_pointer[-1] = res;
            next_instr += 1;
            DISPATCH();
        ...
        TARGET(SWAP) {
            ...
            #line 3183 "Python/bytecodes.c"
            assert(oparg >= 2);
            #line 4463 "Python/generated_cases.c.h"
        ...
        TARGET(INSTRUMENTED_JUMP_BACKWARD) {
            ...
            INSTRUMENTED_JUMP(next_instr-1, next_instr-oparg, PY_MONITORING_EVENT_JUMP);
            #line 4519 "Python/generated_cases.c.h"
            CHECK_EVAL_BREAKER();
            DISPATCH();
        }
        ...
        TARGET(INSTRUMENTED_POP_JUMP_IF_NOT_NONE) {
            ...
            INSTRUMENTED_JUMP(here, next_instr + offset, PY_MONITORING_EVENT_BRANCH);
            #line 4582 "Python/generated_cases.c.h"
            DISPATCH();
        }
