...
// Do not edit!
        ...
        TARGET(END_FOR) {
            ...
            }
            {
                PyObject *value = _tmp_2;
                #line 213 "Python/bytecodes.c"
                #line 281 "Python/generated_cases.c.h"
                Py_DECREF(value);
            }
            STACK_SHRINK(2);
            DISPATCH();
        ...
        TARGET(INSTRUMENTED_END_FOR) {
            ...
            #line 301 "Python/generated_cases.c.h"
            Py_DECREF(receiver);
            Py_DECREF(value);
            STACK_SHRINK(2);
            DISPATCH();
        ...
        TARGET(END_SEND) {
            ...
            Py_DECREF(receiver);
            #line 313 "Python/generated_cases.c.h"
            STACK_SHRINK(1);
            stack_pointer[-1] = value;
            DISPATCH();
        }
        ...
        TARGET(UNARY_INVERT) {
            ...
            #line 377 "Python/generated_cases.c.h"
            Py_DECREF(value);
        ...
        TARGET(BINARY_OP_MULTIPLY_INT) {
            ...
            #line 398 "Python/generated_cases.c.h"
            STACK_SHRINK(1);
        ...
        TARGET(BINARY_OP_SUBTRACT_INT) {
            ...
            #line 435 "Python/generated_cases.c.h"
            STACK_SHRINK(1);
            stack_pointer[-1] = sub;
            next_instr += 1;
            DISPATCH();
        ...
        TARGET(BINARY_OP_SUBTRACT_FLOAT) {
            ...
            #line 452 "Python/generated_cases.c.h"
            STACK_SHRINK(1);
            stack_pointer[-1] = sub;
            next_instr += 1;
            DISPATCH();
        ...
        TARGET(BINARY_OP_ADD_UNICODE) {
            ...
            #line 471 "Python/generated_cases.c.h"
            STACK_SHRINK(1);
            stack_pointer[-1] = res;
            next_instr += 1;
            DISPATCH();
        ...
        TARGET(BINARY_OP_ADD_FLOAT) {
            ...
            #line 524 "Python/generated_cases.c.h"
            STACK_SHRINK(1);
            stack_pointer[-1] = sum;
            next_instr += 1;
            DISPATCH();
        ...
        TARGET(BINARY_OP_ADD_INT) {
            ...
            #line 543 "Python/generated_cases.c.h"
            STACK_SHRINK(1);
            stack_pointer[-1] = sum;
            next_instr += 1;
            DISPATCH();
        ...
        TARGET(BINARY_SUBSCR) {
            ...
            #line 568 "Python/generated_cases.c.h"
            Py_DECREF(container);
            Py_DECREF(sub);
            #line 414 "Python/bytecodes.c"
            if (res == NULL) goto pop_2_error;
            #line 573 "Python/generated_cases.c.h"
            STACK_SHRINK(1);
            stack_pointer[-1] = res;
            next_instr += 1;
            DISPATCH();
        ...
        TARGET(STORE_SLICE) {
            ...
            #line 622 "Python/generated_cases.c.h"
            STACK_SHRINK(4);
            DISPATCH();
        }
        ...
        TARGET(BINARY_SUBSCR_LIST_INT) {
            ...
            Py_DECREF(list);
            #line 645 "Python/generated_cases.c.h"
            STACK_SHRINK(1);
            stack_pointer[-1] = res;
            next_instr += 1;
            DISPATCH();
        ...
        TARGET(BINARY_SUBSCR_TUPLE_INT) {
            ...
            _Py_DECREF_SPECIALIZED(sub, (destructor)PyObject_Free);
            Py_DECREF(tuple);
            #line 670 "Python/generated_cases.c.h"
            STACK_SHRINK(1);
            stack_pointer[-1] = res;
            next_instr += 1;
            DISPATCH();
        ...
        TARGET(BINARY_SUBSCR_DICT) {
            ...
            #line 689 "Python/generated_cases.c.h"
                Py_DECREF(dict);
                Py_DECREF(sub);
            ...
            #line 696 "Python/generated_cases.c.h"
            Py_DECREF(dict);
            Py_DECREF(sub);
            STACK_SHRINK(1);
            stack_pointer[-1] = res;
        ...
        TARGET(BINARY_SUBSCR_GETITEM) {
            ...
            #line 730 "Python/generated_cases.c.h"
        }
        ...
        TARGET(LIST_APPEND) {
            ...
            #line 738 "Python/generated_cases.c.h"
            STACK_SHRINK(1);
        ...
        TARGET(STORE_SUBSCR) {
            ...
            #line 787 "Python/generated_cases.c.h"
            STACK_SHRINK(3);
            next_instr += 1;
            DISPATCH();
        }
        ...
        TARGET(STORE_SUBSCR_LIST_INT) {
            ...
            _Py_DECREF_SPECIALIZED(sub, (destructor)PyObject_Free);
            Py_DECREF(list);
            #line 814 "Python/generated_cases.c.h"
            STACK_SHRINK(3);
            next_instr += 1;
            DISPATCH();
        }
        ...
        TARGET(DELETE_SUBSCR) {
            PyObject *sub = stack_pointer[-1];
            PyObject *container = stack_pointer[-2];
            #line 583 "Python/bytecodes.c"
            /* del container[sub] */
            int err = PyObject_DelItem(container, sub);
            #line 842 "Python/generated_cases.c.h"
            Py_DECREF(container);
            Py_DECREF(sub);
            #line 586 "Python/bytecodes.c"
            if (err) goto pop_2_error;
            #line 847 "Python/generated_cases.c.h"
            STACK_SHRINK(2);
            DISPATCH();
        }
        ...
        TARGET(CALL_INTRINSIC_1) {
            ...
            #line 858 "Python/generated_cases.c.h"
            Py_DECREF(value);
        ...
        TARGET(RETURN_VALUE) {
            ...
            goto resume_frame;
            #line 939 "Python/generated_cases.c.h"
        }
        ...
        TARGET(INSTRUMENTED_RETURN_VALUE) {
            ...
            _PyFrame_StackPush(frame, retval);
            goto resume_frame;
            #line 961 "Python/generated_cases.c.h"
        }
        ...
        TARGET(GET_AITER) {
            ...
            if (getter == NULL) {
                _PyErr_Format(tstate, PyExc_TypeError,
                              ...
                              type->tp_name);
            #line 1020 "Python/generated_cases.c.h"
                Py_DECREF(obj);
            ...
            #line 1042 "Python/generated_cases.c.h"
        ...
        TARGET(GET_ANEXT) {
            ...
            #line 1094 "Python/generated_cases.c.h"
            STACK_GROW(1);
        ...
        TARGET(GET_AWAITABLE) {
            ...
            #line 1112 "Python/generated_cases.c.h"
            Py_DECREF(iterable);
            #line 794 "Python/bytecodes.c"
            ...
            #line 1132 "Python/generated_cases.c.h"
            stack_pointer[-1] = iter;
            PREDICT(LOAD_CONST);
            DISPATCH();
        }
        ...
        TARGET(SEND_GEN) {
            ...
            JUMPBY(INLINE_CACHE_ENTRIES_SEND);
            DISPATCH_INLINED(gen_frame);
            #line 1213 "Python/generated_cases.c.h"
        }

        TARGET(INSTRUMENTED_YIELD_VALUE) {
            PyObject *retval = stack_pointer[-1];
            #line 885 "Python/bytecodes.c"
            assert(frame != &entry_frame);
        ...
        TARGET(POP_EXCEPT) {
            ...
            #line 1264 "Python/generated_cases.c.h"
            STACK_SHRINK(1);
            DISPATCH();
        }
        ...
        TARGET(END_ASYNC_FOR) {
            ...
            #line 1299 "Python/generated_cases.c.h"
                Py_DECREF(awaitable);
                Py_DECREF(exc);
            ...
            #line 1309 "Python/generated_cases.c.h"
            STACK_SHRINK(2);
            DISPATCH();
        }
        ...
        TARGET(STORE_NAME) {
            ...
            #line 1417 "Python/generated_cases.c.h"
            Py_DECREF(v);
        ...
        TARGET(UNPACK_SEQUENCE) {
            ...
            #line 1465 "Python/generated_cases.c.h"
            Py_DECREF(seq);
            #line 1068 "Python/bytecodes.c"
            if (res == 0) goto pop_1_error;
            #line 1469 "Python/generated_cases.c.h"
            STACK_SHRINK(1);
            STACK_GROW(oparg);
            next_instr += 1;
            DISPATCH();
        ...
        TARGET(UNPACK_SEQUENCE_TWO_TUPLE) {
            ...
            #line 1486 "Python/generated_cases.c.h"
            Py_DECREF(seq);
            STACK_SHRINK(1);
            STACK_GROW(oparg);
            next_instr += 1;
        ...
        TARGET(UNPACK_EX) {
            ...
            #line 1538 "Python/generated_cases.c.h"
            Py_DECREF(seq);
            #line 1108 "Python/bytecodes.c"
            if (res == 0) goto pop_1_error;
            #line 1542 "Python/generated_cases.c.h"
        ...
        TARGET(STORE_GLOBAL) {
            ...
            if (err) goto pop_1_error;
            #line 1603 "Python/generated_cases.c.h"
            STACK_SHRINK(1);
            DISPATCH();
        }
        ...
        TARGET(LOAD_GLOBAL) {
            ...
            null = NULL;
            #line 1816 "Python/generated_cases.c.h"
            STACK_GROW(1);
        ...
        TARGET(LOAD_GLOBAL_MODULE) {
            ...
            null = NULL;
            #line 1841 "Python/generated_cases.c.h"
            STACK_GROW(1);
            STACK_GROW(((oparg & 1) ? 1 : 0));
            stack_pointer[-1] = res;
            if (oparg & 1) { stack_pointer[-(1 + ((oparg & 1) ? 1 : 0))] = null; }
        ...
        TARGET(DELETE_FAST) {
            ...
            SETLOCAL(oparg, NULL);
            #line 1885 "Python/generated_cases.c.h"
            DISPATCH();
        }
        ...
        TARGET(LOAD_CLASSDEREF) {
            ...
            #line 1953 "Python/generated_cases.c.h"
            STACK_GROW(1);
            stack_pointer[-1] = value;
            DISPATCH();
        }
        ...
        TARGET(BUILD_STRING) {
            ...
            #line 2008 "Python/generated_cases.c.h"
            for (int _i = oparg; --_i >= 0;) {
                Py_DECREF(pieces[_i]);
            }
            #line 1475 "Python/bytecodes.c"
        ...
        TARGET(LIST_EXTEND) {
            ...
            #line 2061 "Python/generated_cases.c.h"
                Py_DECREF(iterable);
        ...
        TARGET(BUILD_CONST_KEY_MAP) {
            ...
            map = _PyDict_FromItems(
                    ...
                    values, 1, oparg);
            #line 2195 "Python/generated_cases.c.h"
            for (int _i = oparg; --_i >= 0;) {
                Py_DECREF(values[_i]);
            }
            Py_DECREF(keys);
        ...
        TARGET(DICT_MERGE) {
            ...
            #line 2241 "Python/generated_cases.c.h"
            Py_DECREF(update);
            STACK_SHRINK(1);
        ...
        TARGET(LOAD_ATTR) {
            ...
            if (oparg & 1) {
                ...
                if (_PyObject_GetMethod(owner, name, &meth)) {
                    ...
                    /* meth is not an unbound method (but a regular attr, or
                       ...
                       NULL | meth | arg1 | ... | argN
                    */
            #line 2303 "Python/generated_cases.c.h"
                    Py_DECREF(owner);
            ...
            #line 2314 "Python/generated_cases.c.h"
                Py_DECREF(owner);
        ...
        TARGET(LOAD_ATTR_WITH_HINT) {
            ...
            Py_INCREF(res);
            res2 = NULL;
            #line 2416 "Python/generated_cases.c.h"
            Py_DECREF(owner);
            STACK_GROW(((oparg & 1) ? 1 : 0));
            stack_pointer[-1] = res;
            if (oparg & 1) { stack_pointer[-(1 + ((oparg & 1) ? 1 : 0))] = res2; }
        ...
        TARGET(LOAD_ATTR_CLASS) {
            ...
            assert(res != NULL);
            Py_INCREF(res);
            #line 2468 "Python/generated_cases.c.h"
            Py_DECREF(cls);
            STACK_GROW(((oparg & 1) ? 1 : 0));
            stack_pointer[-1] = res;
            if (oparg & 1) { stack_pointer[-(1 + ((oparg & 1) ? 1 : 0))] = res2; }
        ...
        TARGET(STORE_ATTR_WITH_HINT) {
            ...
            Py_DECREF(owner);
            #line 2616 "Python/generated_cases.c.h"
            STACK_SHRINK(2);
            next_instr += 4;
            DISPATCH();
        }
        ...
        TARGET(IS_OP) {
            ...
            #line 2759 "Python/generated_cases.c.h"
            STACK_SHRINK(1);
            stack_pointer[-1] = b;
            DISPATCH();
        }
        ...
        TARGET(CONTAINS_OP) {
            ...
            #line 2777 "Python/generated_cases.c.h"
            STACK_SHRINK(1);
            stack_pointer[-1] = b;
            DISPATCH();
        }
        ...
        TARGET(MATCH_CLASS) {
            ...
            #line 3016 "Python/generated_cases.c.h"
            Py_DECREF(subject);
            Py_DECREF(type);
            Py_DECREF(names);
        ...
        TARGET(FOR_ITER_GEN) {
            ...
            DISPATCH_INLINED(gen_frame);
            #line 3304 "Python/generated_cases.c.h"
        }
        ...
        TARGET(BEFORE_ASYNC_WITH) {
            ...
            #line 3343 "Python/generated_cases.c.h"
            STACK_GROW(1);
            stack_pointer[-1] = res;
        ...
        TARGET(PUSH_EXC_INFO) {
            ...
            #line 3442 "Python/generated_cases.c.h"
            STACK_GROW(1);
        ...
        TARGET(CALL_NO_KW_TUPLE_1) {
            ...
            if (res == NULL) { STACK_SHRINK(oparg); goto pop_2_error; }
            #line 3816 "Python/generated_cases.c.h"
            STACK_SHRINK(oparg);
            STACK_SHRINK(1);
            stack_pointer[-1] = res;
            next_instr += 3;
        ...
        TARGET(CALL_NO_KW_BUILTIN_FAST) {
            ...
            if (res == NULL) { STACK_SHRINK(oparg); goto pop_2_error; }
                /* Not deopting because this doesn't mean our optimization was
                   ...
                   handle it.
                */
            #line 3940 "Python/generated_cases.c.h"
            STACK_SHRINK(oparg);
            STACK_SHRINK(1);
            stack_pointer[-1] = res;
            next_instr += 3;
        ...
        TARGET(CALL_NO_KW_LEN) {
            ...
            Py_DECREF(arg);
            if (res == NULL) { STACK_SHRINK(oparg); goto pop_2_error; }
            #line 4025 "Python/generated_cases.c.h"
            STACK_SHRINK(oparg);
            STACK_SHRINK(1);
            stack_pointer[-1] = res;
            next_instr += 3;
        ...
        TARGET(CALL_NO_KW_ISINSTANCE) {
            ...
            Py_DECREF(callable);
            if (res == NULL) { STACK_SHRINK(oparg); goto pop_2_error; }
            #line 4065 "Python/generated_cases.c.h"
            STACK_SHRINK(oparg);
            STACK_SHRINK(1);
            stack_pointer[-1] = res;
            next_instr += 3;
        ...
        TARGET(CALL_NO_KW_METHOD_DESCRIPTOR_FAST) {
            ...
            Py_DECREF(callable);
            if (res == NULL) { STACK_SHRINK(oparg); goto pop_2_error; }
            #line 4258 "Python/generated_cases.c.h"
            STACK_SHRINK(oparg);
            STACK_SHRINK(1);
            stack_pointer[-1] = res;
            next_instr += 3;
        ...
        TARGET(INSTRUMENTED_CALL_FUNCTION_EX) {
            ...
            #line 4270 "Python/generated_cases.c.h"
        }
        ...
        TARGET(MAKE_FUNCTION) {
            ...
            PyObject *typevars = (oparg & 0x10) ? stack_pointer[-(1 + ((oparg & 0x08) ? 1 : 0) + ((oparg & 0x04) ? 1 : 0) + ((oparg & 0x10) ? 1 : 0))] : NULL;
            PyObject *kwdefaults = (oparg & 0x02) ? stack_pointer[-(1 + ((oparg & 0x08) ? 1 : 0) + ((oparg & 0x04) ? 1 : 0) + ((oparg & 0x10) ? 1 : 0) + ((oparg & 0x02) ? 1 : 0))] : NULL;
            PyObject *defaults = (oparg & 0x01) ? stack_pointer[-(1 + ((oparg & 0x08) ? 1 : 0) + ((oparg & 0x04) ? 1 : 0) + ((oparg & 0x10) ? 1 : 0) + ((oparg & 0x02) ? 1 : 0) + ((oparg & 0x01) ? 1 : 0))] : NULL;
            PyObject *func;
            ...
            STACK_SHRINK(((oparg & 0x01) ? 1 : 0) + ((oparg & 0x02) ? 1 : 0) + ((oparg & 0x10) ? 1 : 0) + ((oparg & 0x04) ? 1 : 0) + ((oparg & 0x08) ? 1 : 0));
        ...
        TARGET(COPY) {
            ...
            #line 4480 "Python/generated_cases.c.h"
            STACK_GROW(1);
            stack_pointer[-1] = top;
            DISPATCH();
        }
        ...
        TARGET(SWAP) {
            ...
            assert(oparg >= 2);
            #line 4524 "Python/generated_cases.c.h"
        ...
        TARGET(EXTENDED_ARG) {
            ...
            PRE_DISPATCH_GOTO();
            DISPATCH_GOTO();
            #line 4656 "Python/generated_cases.c.h"
        }
        ...
        TARGET(RESERVED) {
            ...
            Py_UNREACHABLE();
            #line 4670 "Python/generated_cases.c.h"
        }
