...
// Do not edit!
        ...
        TARGET(UNARY_INVERT) {
            ...
            if (res == NULL) goto pop_1_error;
            #line 420 "Python/generated_cases.c.h"
            stack_pointer[-1] = res;
            DISPATCH();
        }
        ...
        TARGET(BINARY_OP_ADD_UNICODE) {
            ...
            }
            {
                ...
                if (res == NULL) goto pop_2_error;
                #line 640 "Python/generated_cases.c.h"
                _tmp_2 = res;
            }
            next_instr += 1;
            STACK_SHRINK(1);
        ...
        TARGET(BINARY_SUBSCR_TUPLE_INT) {
            ...
            _Py_DECREF_SPECIALIZED(sub, (destructor)PyObject_Free);
            Py_DECREF(tuple);
            #line 815 "Python/generated_cases.c.h"
            STACK_SHRINK(1);
            stack_pointer[-1] = res;
            next_instr += 1;
            DISPATCH();
        ...
        TARGET(DELETE_SUBSCR) {
            ...
            #line 991 "Python/generated_cases.c.h"
            STACK_SHRINK(2);
            DISPATCH();
        }
        ...
        TARGET(CALL_INTRINSIC_1) {
            ...
            #line 1002 "Python/generated_cases.c.h"
            Py_DECREF(value);
        ...
        TARGET(INTERPRETER_EXIT) {
            ...
            return retval;
            #line 1063 "Python/generated_cases.c.h"
        }
        ...
        TARGET(INSTRUMENTED_RETURN_CONST) {
            ...
            _PyFrame_StackPush(frame, retval);
            goto resume_frame;
            #line 1143 "Python/generated_cases.c.h"
        }
        ...
        TARGET(GET_AITER) {
            ...
            if (getter == NULL) {
                _PyErr_Format(tstate, PyExc_TypeError,
                              ...
                              type->tp_name);
            #line 1162 "Python/generated_cases.c.h"
                Py_DECREF(obj);
            ...
            iter = (*getter)(obj);
            #line 1169 "Python/generated_cases.c.h"
            Py_DECREF(obj);
        ...
        TARGET(POP_EXCEPT) {
            ...
            #line 1406 "Python/generated_cases.c.h"
            STACK_SHRINK(1);
            DISPATCH();
        }
        ...
        TARGET(CLEANUP_THROW) {
            ...
            #line 1467 "Python/generated_cases.c.h"
                Py_DECREF(sub_iter);
        ...
        TARGET(STORE_NAME) {
            ...
            #line 1543 "Python/generated_cases.c.h"
            Py_DECREF(v);
        ...
        TARGET(UNPACK_SEQUENCE_LIST) {
            ...
            #line 1650 "Python/generated_cases.c.h"
            Py_DECREF(seq);
            STACK_SHRINK(1);
            STACK_GROW(oparg);
            next_instr += 1;
        ...
        TARGET(UNPACK_EX) {
            ...
            #line 1664 "Python/generated_cases.c.h"
            Py_DECREF(seq);
        ...
        TARGET(STORE_GLOBAL) {
            ...
            #line 1725 "Python/generated_cases.c.h"
            Py_DECREF(v);
        ...
        TARGET(LOAD_NAME) {
            PyObject *_tmp_1;
            {
                ...
                Py_INCREF(locals);
                #line 1783 "Python/generated_cases.c.h"
                _tmp_1 = locals;
            }
            {
                ...
                #line 1846 "Python/generated_cases.c.h"
                _tmp_1 = v;
            }
            STACK_GROW(1);
            stack_pointer[-1] = _tmp_1;
        ...
        TARGET(BUILD_STRING) {
            ...
            #line 2175 "Python/generated_cases.c.h"
        ...
        TARGET(BUILD_LIST) {
            ...
            #line 2207 "Python/generated_cases.c.h"
            STACK_SHRINK(oparg);
            STACK_GROW(1);
            ...
            if (oparg & 1) {
                ...
                if (_PyObject_GetMethod(owner, name, &meth)) {
                    ...
                    /* meth is not an unbound method (but a regular attr, or
                       ...
                       NULL | meth | arg1 | ... | argN
                    */
            #line 2611 "Python/generated_cases.c.h"
                    Py_DECREF(owner);
        ...
        TARGET(INSTRUMENTED_FOR_ITER) {
            ...
            #line 3487 "Python/generated_cases.c.h"
            DISPATCH();
        }
        ...
        TARGET(CALL) {
            ...
            #line 3943 "Python/generated_cases.c.h"
            STACK_SHRINK(oparg);
            STACK_SHRINK(1);
            stack_pointer[-1] = res;
            next_instr += 3;
        ...
        TARGET(CALL_NO_KW_STR_1) {
            ...
            if (res == NULL) { STACK_SHRINK(oparg); goto pop_2_error; }
            #line 4086 "Python/generated_cases.c.h"
            STACK_SHRINK(oparg);
            STACK_SHRINK(1);
            stack_pointer[-1] = res;
            next_instr += 3;
        ...
        TARGET(CALL_BUILTIN_CLASS) {
            ...
            Py_DECREF(tp);
            if (res == NULL) { STACK_SHRINK(oparg); goto pop_2_error; }
            #line 4147 "Python/generated_cases.c.h"
            STACK_SHRINK(oparg);
            STACK_SHRINK(1);
            stack_pointer[-1] = res;
            next_instr += 3;
        ...
        TARGET(CALL_NO_KW_LEN) {
            ...
            Py_DECREF(arg);
            if (res == NULL) { STACK_SHRINK(oparg); goto pop_2_error; }
            #line 4320 "Python/generated_cases.c.h"
            STACK_SHRINK(oparg);
            STACK_SHRINK(1);
            stack_pointer[-1] = res;
            next_instr += 3;
        ...
        TARGET(SWAP) {
            ...
            assert(oparg >= 2);
            #line 4849 "Python/generated_cases.c.h"
        ...
        TARGET(INSTRUMENTED_JUMP_FORWARD) {
            ...
            #line 4874 "Python/generated_cases.c.h"
            DISPATCH();
        }
        ...
        TARGET(INSTRUMENTED_POP_JUMP_IF_TRUE) {
            ...
            #line 4896 "Python/generated_cases.c.h"
            DISPATCH();
        }
        ...
        TARGET(INSTRUMENTED_POP_JUMP_IF_FALSE) {
            ...
            INSTRUMENTED_JUMP(here, next_instr + offset, PY_MONITORING_EVENT_BRANCH);
            #line 4910 "Python/generated_cases.c.h"
            DISPATCH();
        }
        ...
        TARGET(CACHE) {
            #line 3576 "Python/bytecodes.c"
            assert(0 && "Executing a cache.");
            Py_UNREACHABLE();
            #line 4962 "Python/generated_cases.c.h"
        }
