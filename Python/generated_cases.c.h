...
// Do not edit!
        ...
        TARGET(UNARY_NOT) {
            ...
            #line 365 "Python/generated_cases.c.h"
            stack_pointer[-1] = res;
            DISPATCH();
        }
        ...
        TARGET(TO_BOOL) {
            PREDICTED(TO_BOOL);
            static_assert(INLINE_CACHE_ENTRIES_TO_BOOL == 1, "incorrect cache size");
            PyObject *value = stack_pointer[-1];
            PyObject *res;
        ...
        TARGET(TO_BOOL_BOOL) {
            ...
            #line 409 "Python/generated_cases.c.h"
            next_instr += 1;
            DISPATCH();
        }
        ...
        TARGET(TO_BOOL_INT) {
            ...
            #line 425 "Python/generated_cases.c.h"
                Py_DECREF(value);
            #line 319 "Python/bytecodes.c"
                res = Py_True;
            }
            #line 430 "Python/generated_cases.c.h"
            stack_pointer[-1] = res;
            next_instr += 1;
            DISPATCH();
        }
        ...
        TARGET(TO_BOOL_STR) {
            ...
            #line 481 "Python/generated_cases.c.h"
                Py_DECREF(value);
            #line 352 "Python/bytecodes.c"
                res = Py_True;
            }
            #line 486 "Python/generated_cases.c.h"
            stack_pointer[-1] = res;
            next_instr += 1;
            DISPATCH();
        }
        ...
        TARGET(BINARY_OP_MULTIPLY_INT) {
            ...
            }
            {
                ...
                #line 529 "Python/generated_cases.c.h"
                _tmp_2 = res;
            }
            next_instr += 1;
            STACK_SHRINK(1);
        ...
        TARGET(BINARY_OP_ADD_INT) {
            ...
            PyObject *_tmp_2 = stack_pointer[-2];
            {
                ...
                DEOPT_IF(!PyLong_CheckExact(left), BINARY_OP);
                DEOPT_IF(!PyLong_CheckExact(right), BINARY_OP);
                #line 547 "Python/generated_cases.c.h"
                _tmp_2 = left;
                _tmp_1 = right;
            }
            {
        ...
        TARGET(BINARY_OP_SUBTRACT_INT) {
            ...
            PyObject *_tmp_2 = stack_pointer[-2];
            {
                ...
                DEOPT_IF(!PyLong_CheckExact(left), BINARY_OP);
                DEOPT_IF(!PyLong_CheckExact(right), BINARY_OP);
                #line 579 "Python/generated_cases.c.h"
                _tmp_2 = left;
                _tmp_1 = right;
            }
            {
                ...
                PyObject *left = _tmp_2;
                PyObject *res;
                #line 396 "Python/bytecodes.c"
                STAT_INC(BINARY_OP, hit);
                res = _PyLong_Subtract((PyLongObject *)left, (PyLongObject *)right);
                _Py_DECREF_SPECIALIZED(right, (destructor)PyObject_Free);
                _Py_DECREF_SPECIALIZED(left, (destructor)PyObject_Free);
                if (res == NULL) goto pop_2_error;
                #line 593 "Python/generated_cases.c.h"
                _tmp_2 = res;
            }
            next_instr += 1;
            STACK_SHRINK(1);
        ...
        TARGET(BINARY_OP_ADD_FLOAT) {
            ...
            PyObject *_tmp_2 = stack_pointer[-2];
            {
                ...
                DEOPT_IF(!PyFloat_CheckExact(left), BINARY_OP);
                DEOPT_IF(!PyFloat_CheckExact(right), BINARY_OP);
                #line 643 "Python/generated_cases.c.h"
                _tmp_2 = left;
                _tmp_1 = right;
            }
            {
                ...
                double dres =
                    ...
                    ((PyFloatObject *)right)->ob_fval;
                DECREF_INPUTS_AND_REUSE_FLOAT(left, right, dres, res);
                #line 657 "Python/generated_cases.c.h"
                _tmp_2 = res;
            }
            next_instr += 1;
            STACK_SHRINK(1);
        ...
        TARGET(BINARY_OP_SUBTRACT_FLOAT) {
            ...
            PyObject *_tmp_2 = stack_pointer[-2];
            {
                ...
                DEOPT_IF(!PyFloat_CheckExact(left), BINARY_OP);
                DEOPT_IF(!PyFloat_CheckExact(right), BINARY_OP);
                #line 675 "Python/generated_cases.c.h"
                _tmp_2 = left;
                _tmp_1 = right;
            }
            {
        ...
        TARGET(BINARY_SLICE) {
            ...
            #line 825 "Python/generated_cases.c.h"
            STACK_SHRINK(2);
            stack_pointer[-1] = res;
            DISPATCH();
        }
        ...
        TARGET(BINARY_SUBSCR_LIST_INT) {
            ...
            Py_DECREF(list);
            #line 872 "Python/generated_cases.c.h"
            STACK_SHRINK(1);
            stack_pointer[-1] = res;
            next_instr += 1;
            DISPATCH();
        ...
        TARGET(BINARY_SUBSCR_DICT) {
            ...
            #line 916 "Python/generated_cases.c.h"
                Py_DECREF(dict);
                Py_DECREF(sub);
            ...
            #line 923 "Python/generated_cases.c.h"
            Py_DECREF(dict);
            Py_DECREF(sub);
            STACK_SHRINK(1);
            stack_pointer[-1] = res;
        ...
        TARGET(BINARY_SUBSCR_GETITEM) {
            ...
            #line 958 "Python/generated_cases.c.h"
        }
        ...
        TARGET(SET_ADD) {
            ...
            #line 977 "Python/generated_cases.c.h"
            Py_DECREF(v);
        ...
        TARGET(STORE_SUBSCR) {
            ...
            #line 1009 "Python/generated_cases.c.h"
            Py_DECREF(v);
            Py_DECREF(container);
            Py_DECREF(sub);
        ...
        TARGET(STORE_SUBSCR_DICT) {
            ...
            Py_DECREF(dict);
            if (err) goto pop_3_error;
            #line 1058 "Python/generated_cases.c.h"
            STACK_SHRINK(3);
            next_instr += 1;
            DISPATCH();
        }
        ...
        TARGET(DELETE_SUBSCR) {
            ...
            Py_DECREF(container);
            Py_DECREF(sub);
            #line 692 "Python/bytecodes.c"
            if (err) goto pop_2_error;
            #line 1075 "Python/generated_cases.c.h"
            STACK_SHRINK(2);
            DISPATCH();
        }
        ...
        TARGET(CALL_INTRINSIC_1) {
            ...
            #line 1086 "Python/generated_cases.c.h"
            Py_DECREF(value);
            #line 699 "Python/bytecodes.c"
            if (res == NULL) goto pop_1_error;
            #line 1090 "Python/generated_cases.c.h"
            stack_pointer[-1] = res;
            DISPATCH();
        }
        ...
        TARGET(RETURN_VALUE) {
            ...
            goto resume_frame;
            #line 1167 "Python/generated_cases.c.h"
        }
        ...
        TARGET(RETURN_CONST) {
            ...
            _PyFrame_StackPush(frame, retval);
            goto resume_frame;
            #line 1207 "Python/generated_cases.c.h"
        }
        ...
        TARGET(YIELD_VALUE) {
            ...
            _PyFrame_StackPush(frame, retval);
            goto resume_frame;
            #line 1487 "Python/generated_cases.c.h"
        }
        ...
        TARGET(END_ASYNC_FOR) {
            ...
            #line 1530 "Python/generated_cases.c.h"
                Py_DECREF(awaitable);
                Py_DECREF(exc);
        ...
        TARGET(STORE_NAME) {
            ...
            #line 1623 "Python/generated_cases.c.h"
                Py_DECREF(v);
        ...
        TARGET(DELETE_NAME) {
            ...
            #line 1659 "Python/generated_cases.c.h"
            DISPATCH();
        }
        ...
        TARGET(UNPACK_SEQUENCE) {
            ...
            #line 1680 "Python/generated_cases.c.h"
            Py_DECREF(seq);
            #line 1167 "Python/bytecodes.c"
            if (res == 0) goto pop_1_error;
            #line 1684 "Python/generated_cases.c.h"
            STACK_SHRINK(1);
            STACK_GROW(oparg);
            next_instr += 1;
            DISPATCH();
        ...
        TARGET(UNPACK_SEQUENCE_TUPLE) {
            ...
            #line 1720 "Python/generated_cases.c.h"
            Py_DECREF(seq);
            STACK_SHRINK(1);
            STACK_GROW(oparg);
            next_instr += 1;
        ...
        TARGET(UNPACK_SEQUENCE_LIST) {
            ...
            #line 1739 "Python/generated_cases.c.h"
            Py_DECREF(seq);
            STACK_SHRINK(1);
            STACK_GROW(oparg);
            next_instr += 1;
        ...
        TARGET(UNPACK_EX) {
            ...
            if (res == 0) goto pop_1_error;
            #line 1757 "Python/generated_cases.c.h"
        ...
        TARGET(STORE_ATTR) {
            ...
            Py_DECREF(v);
            Py_DECREF(owner);
            #line 1234 "Python/bytecodes.c"
            if (err) goto pop_2_error;
            #line 1789 "Python/generated_cases.c.h"
            STACK_SHRINK(2);
            next_instr += 4;
            DISPATCH();
        }
        ...
        TARGET(STORE_GLOBAL) {
            ...
            #line 1814 "Python/generated_cases.c.h"
            Py_DECREF(v);
            #line 1248 "Python/bytecodes.c"
            if (err) goto pop_1_error;
        ...
        TARGET(LOAD_GLOBAL_MODULE) {
            ...
            null = NULL;
            #line 2094 "Python/generated_cases.c.h"
            STACK_GROW(1);
            STACK_GROW(((oparg & 1) ? 1 : 0));
            stack_pointer[-1] = res;
            if (oparg & 1) { stack_pointer[-(1 + ((oparg & 1) ? 1 : 0))] = null; }
        ...
        TARGET(DELETE_DEREF) {
            ...
            Py_DECREF(oldobj);
            #line 2168 "Python/generated_cases.c.h"
            DISPATCH();
        }
        ...
        TARGET(LOAD_DEREF) {
            ...
            Py_INCREF(value);
            #line 2225 "Python/generated_cases.c.h"
            STACK_GROW(1);
            stack_pointer[-1] = value;
            DISPATCH();
        }
        ...
        TARGET(BUILD_STRING) {
            ...
            #line 2264 "Python/generated_cases.c.h"
        ...
        TARGET(BUILD_LIST) {
            ...
            #line 2296 "Python/generated_cases.c.h"
            STACK_SHRINK(oparg);
            STACK_GROW(1);
        ...
        TARGET(BUILD_CONST_KEY_MAP) {
            ...
            map = _PyDict_FromItems(
                    ...
                    values, 1, oparg);
            #line 2451 "Python/generated_cases.c.h"
            for (int _i = oparg; --_i >= 0;) {
                Py_DECREF(values[_i]);
            }
            Py_DECREF(keys);
        ...
        TARGET(DICT_UPDATE) {
            ...
            #line 2479 "Python/generated_cases.c.h"
            Py_DECREF(update);
            STACK_SHRINK(1);
            DISPATCH();
        }
        ...
        TARGET(LOAD_SUPER_ATTR) {
            ...
            #line 2579 "Python/generated_cases.c.h"
        ...
        TARGET(ENTER_EXECUTOR) {
            ...
            goto resume_frame;
            #line 3310 "Python/generated_cases.c.h"
        }
        ...
        TARGET(MATCH_CLASS) {
            ...
            #line 3417 "Python/generated_cases.c.h"
            STACK_SHRINK(2);
        ...
        TARGET(MATCH_MAPPING) {
            ...
            #line 3429 "Python/generated_cases.c.h"
            STACK_GROW(1);
            stack_pointer[-1] = res;
        ...
        TARGET(BEFORE_ASYNC_WITH) {
            ...
            #line 3733 "Python/generated_cases.c.h"
            STACK_GROW(1);
            stack_pointer[-1] = res;
        ...
        TARGET(BEFORE_WITH) {
            ...
            #line 3780 "Python/generated_cases.c.h"
            STACK_GROW(1);
            stack_pointer[-1] = res;
            stack_pointer[-2] = exit;
            DISPATCH();
        ...
        TARGET(LOAD_ATTR_METHOD_NO_DICT) {
            ...
            res = self;
            assert(oparg & 1);
            #line 3887 "Python/generated_cases.c.h"
            STACK_GROW(((oparg & 1) ? 1 : 0));
            stack_pointer[-1] = res;
            if (oparg & 1) { stack_pointer[-(1 + ((oparg & 1) ? 1 : 0))] = res2; }
            next_instr += 9;
        ...
        TARGET(KW_NAMES) {
            ...
            #line 3928 "Python/generated_cases.c.h"
            DISPATCH();
        }
        ...
        TARGET(CALL) {
            ...
            #line 4038 "Python/generated_cases.c.h"
            STACK_SHRINK(oparg);
            STACK_SHRINK(1);
            stack_pointer[-1] = res;
            next_instr += 3;
        ...
        TARGET(CALL_NO_KW_STR_1) {
            ...
            if (res == NULL) { STACK_SHRINK(oparg); goto pop_2_error; }
            #line 4181 "Python/generated_cases.c.h"
            STACK_SHRINK(oparg);
            STACK_SHRINK(1);
            stack_pointer[-1] = res;
            next_instr += 3;
        ...
        TARGET(CALL_NO_KW_TUPLE_1) {
            ...
            if (res == NULL) { STACK_SHRINK(oparg); goto pop_2_error; }
            #line 4206 "Python/generated_cases.c.h"
            STACK_SHRINK(oparg);
            STACK_SHRINK(1);
            stack_pointer[-1] = res;
            next_instr += 3;
        ...
        TARGET(CALL_NO_KW_METHOD_DESCRIPTOR_FAST) {
            ...
            Py_DECREF(callable);
            if (res == NULL) { STACK_SHRINK(oparg); goto pop_2_error; }
            #line 4648 "Python/generated_cases.c.h"
            STACK_SHRINK(oparg);
            STACK_SHRINK(1);
            stack_pointer[-1] = res;
            next_instr += 3;
        ...
        TARGET(INSTRUMENTED_CALL_FUNCTION_EX) {
            ...
            #line 4660 "Python/generated_cases.c.h"
        }
        ...
        TARGET(BINARY_OP) {
            ...
            if (res == NULL) goto pop_2_error;
            #line 4916 "Python/generated_cases.c.h"
            STACK_SHRINK(1);
            stack_pointer[-1] = res;
            next_instr += 1;
            DISPATCH();
        ...
        TARGET(INSTRUMENTED_INSTRUCTION) {
            ...
            opcode = next_opcode;
            DISPATCH_GOTO();
            #line 4947 "Python/generated_cases.c.h"
        }

        TARGET(INSTRUMENTED_JUMP_FORWARD) {
            #line 3457 "Python/bytecodes.c"
            INSTRUMENTED_JUMP(next_instr-1, next_instr+oparg, PY_MONITORING_EVENT_JUMP);
            #line 4953 "Python/generated_cases.c.h"
            DISPATCH();
        }
        ...
        TARGET(INSTRUMENTED_JUMP_BACKWARD) {
            ...
            #line 4960 "Python/generated_cases.c.h"
            CHECK_EVAL_BREAKER();
            DISPATCH();
        }
        ...
        TARGET(INSTRUMENTED_POP_JUMP_IF_FALSE) {
            ...
            INSTRUMENTED_JUMP(here, next_instr + offset, PY_MONITORING_EVENT_BRANCH);
            #line 4989 "Python/generated_cases.c.h"
            DISPATCH();
        }
        ...
        TARGET(INSTRUMENTED_POP_JUMP_IF_NONE) {
            ...
            INSTRUMENTED_JUMP(here, next_instr + offset, PY_MONITORING_EVENT_BRANCH);
            #line 5006 "Python/generated_cases.c.h"
            DISPATCH();
        }
        ...
        TARGET(INSTRUMENTED_POP_JUMP_IF_NOT_NONE) {
            ...
            INSTRUMENTED_JUMP(here, next_instr + offset, PY_MONITORING_EVENT_BRANCH);
            #line 5023 "Python/generated_cases.c.h"
            DISPATCH();
        }
        ...
        TARGET(CACHE) {
            ...
            Py_UNREACHABLE();
            #line 5041 "Python/generated_cases.c.h"
        }

        TARGET(RESERVED) {
            #line 3529 "Python/bytecodes.c"
            assert(0 && "Executing RESERVED instruction.");
            Py_UNREACHABLE();
            #line 5048 "Python/generated_cases.c.h"
        }
