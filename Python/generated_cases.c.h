...
// Do not edit!
        ...
        TARGET(LOAD_SUPER_ATTR) {
            ...
            #line 2291 "Python/generated_cases.c.h"
                Py_DECREF(global_super);
                Py_DECREF(class);
                Py_DECREF(self);
        ...
        TARGET(LOAD_ATTR_MODULE) {
            ...
            Py_INCREF(res);
            res2 = NULL;
            #line 2420 "Python/generated_cases.c.h"
            Py_DECREF(owner);
            STACK_GROW(((oparg & 1) ? 1 : 0));
            stack_pointer[-1] = res;
            if (oparg & 1) { stack_pointer[-(1 + ((oparg & 1) ? 1 : 0))] = res2; }
        ...
        TARGET(LOAD_ATTR_PROPERTY) {
            ...
            frame->return_offset = 0;
            DISPATCH_INLINED(new_frame);
            #line 2552 "Python/generated_cases.c.h"
        }
        ...
        TARGET(LOAD_ATTR_GETATTRIBUTE_OVERRIDDEN) {
            ...
            frame->return_offset = 0;
            DISPATCH_INLINED(new_frame);
            #line 2586 "Python/generated_cases.c.h"
        }
        ...
        TARGET(BEFORE_WITH) {
            ...
            #line 3436 "Python/generated_cases.c.h"
            STACK_GROW(1);
            stack_pointer[-1] = res;
            stack_pointer[-2] = exit;
            DISPATCH();
        ...
        TARGET(CALL_PY_EXACT_ARGS) {
            ...
            frame->return_offset = 0;
            DISPATCH_INLINED(new_frame);
            #line 3751 "Python/generated_cases.c.h"
        }
        ...
        TARGET(CALL_NO_KW_TUPLE_1) {
            ...
            if (res == NULL) { STACK_SHRINK(oparg); goto pop_2_error; }
            #line 3862 "Python/generated_cases.c.h"
            STACK_SHRINK(oparg);
            STACK_SHRINK(1);
            stack_pointer[-1] = res;
            next_instr += 3;
        ...
        TARGET(CALL_BUILTIN_CLASS) {
            ...
            Py_DECREF(tp);
            if (res == NULL) { STACK_SHRINK(oparg); goto pop_2_error; }
            #line 3898 "Python/generated_cases.c.h"
            STACK_SHRINK(oparg);
            STACK_SHRINK(1);
            stack_pointer[-1] = res;
            next_instr += 3;
        ...
        TARGET(CALL_NO_KW_LEN) {
            ...
            Py_DECREF(arg);
            if (res == NULL) { STACK_SHRINK(oparg); goto pop_2_error; }
            #line 4071 "Python/generated_cases.c.h"
            STACK_SHRINK(oparg);
            STACK_SHRINK(1);
            stack_pointer[-1] = res;
            next_instr += 3;
        ...
        TARGET(INSTRUMENTED_JUMP_FORWARD) {
            ...
            #line 4619 "Python/generated_cases.c.h"
            DISPATCH();
        }
        ...
        TARGET(INSTRUMENTED_JUMP_BACKWARD) {
            ...
            INSTRUMENTED_JUMP(next_instr-1, next_instr-oparg, PY_MONITORING_EVENT_JUMP);
            #line 4626 "Python/generated_cases.c.h"
            CHECK_EVAL_BREAKER();
            DISPATCH();
        }
        ...
        TARGET(EXTENDED_ARG) {
            ...
            PRE_DISPATCH_GOTO();
            DISPATCH_GOTO();
            #line 4702 "Python/generated_cases.c.h"
        }
