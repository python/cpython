...
// Do not edit!
        ...
        TARGET(SEND_GEN) {
            ...
            JUMPBY(INLINE_CACHE_ENTRIES_SEND);
            DISPATCH_INLINED(gen_frame);
            #line 1218 "Python/generated_cases.c.h"
        }
        ...
        TARGET(INSTRUMENTED_YIELD_VALUE) {
            ...
            _PyFrame_StackPush(frame, retval);
            goto resume_frame;
            #line 1240 "Python/generated_cases.c.h"
        }
        ...
        TARGET(CLEANUP_THROW) {
            ...
            #line 1330 "Python/generated_cases.c.h"
                Py_DECREF(sub_iter);
        ...
        TARGET(MAKE_CELL) {
            ...
            SETLOCAL(oparg, cell);
            #line 1821 "Python/generated_cases.c.h"
            DISPATCH();
        }
        ...
        TARGET(LOAD_CLASSDEREF) {
            ...
            #line 1875 "Python/generated_cases.c.h"
            STACK_GROW(1);
            stack_pointer[-1] = value;
            DISPATCH();
        }
        ...
        TARGET(BUILD_LIST) {
            ...
            #line 1962 "Python/generated_cases.c.h"
            STACK_SHRINK(oparg);
            STACK_GROW(1);
        ...
        TARGET(SET_UPDATE) {
            ...
            if (err < 0) goto pop_1_error;
            #line 2004 "Python/generated_cases.c.h"
            STACK_SHRINK(1);
            DISPATCH();
        }
        ...
        TARGET(DICT_MERGE) {
            ...
            #line 2158 "Python/generated_cases.c.h"
                Py_DECREF(update);
            #line 1556 "Python/bytecodes.c"
                if (true) goto pop_1_error;
            }
            #line 2163 "Python/generated_cases.c.h"
            Py_DECREF(update);
            STACK_SHRINK(1);
            ...
            if (oparg & 1) {
                ...
                if (_PyObject_GetMethod(owner, name, &meth)) {
                    ...
                    /* meth is not an unbound method (but a regular attr, or
                       ...
                       NULL | meth | arg1 | ... | argN
                    */
            #line 2297 "Python/generated_cases.c.h"
                    Py_DECREF(owner);
        ...
        TARGET(LOAD_ATTR_GETATTRIBUTE_OVERRIDDEN) {
            ...
            frame->return_offset = 0;
            DISPATCH_INLINED(new_frame);
            #line 2534 "Python/generated_cases.c.h"
        }
        ...
        TARGET(STORE_ATTR_INSTANCE_VALUE) {
            ...
            Py_DECREF(owner);
            #line 2560 "Python/generated_cases.c.h"
            STACK_SHRINK(2);
            next_instr += 4;
            DISPATCH();
        }
        ...
        TARGET(COMPARE_OP) {
            ...
            #line 2656 "Python/generated_cases.c.h"
            Py_DECREF(left);
            Py_DECREF(right);
        ...
        TARGET(COMPARE_OP_FLOAT) {
            ...
            Py_INCREF(res);
            #line 2684 "Python/generated_cases.c.h"
            STACK_SHRINK(1);
            stack_pointer[-1] = res;
            next_instr += 1;
            DISPATCH();
        ...
        TARGET(CALL_PY_WITH_DEFAULTS) {
            ...
            frame->return_offset = 0;
            DISPATCH_INLINED(new_frame);
            #line 3743 "Python/generated_cases.c.h"
        }
        ...
        TARGET(CALL_NO_KW_STR_1) {
            ...
            if (res == NULL) { STACK_SHRINK(oparg); goto pop_2_error; }
            #line 3785 "Python/generated_cases.c.h"
            STACK_SHRINK(oparg);
            STACK_SHRINK(1);
            stack_pointer[-1] = res;
            next_instr += 3;
        ...
        TARGET(CALL_NO_KW_METHOD_DESCRIPTOR_NOARGS) {
            ...
            Py_DECREF(callable);
            if (res == NULL) { STACK_SHRINK(oparg); goto pop_2_error; }
            #line 4211 "Python/generated_cases.c.h"
            STACK_SHRINK(oparg);
            STACK_SHRINK(1);
            stack_pointer[-1] = res;
            next_instr += 3;
        ...
        TARGET(MAKE_FUNCTION) {
            ...
            #line 4386 "Python/generated_cases.c.h"
