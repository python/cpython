...
// Do not edit!
        ...
        TARGET(LOAD_ATTR_NONDESCRIPTOR_NO_DICT) {
            ...
            STAT_INC(LOAD_ATTR, hit);
            assert(descr != NULL);
            #line 3870 "Python/generated_cases.c.h"
            Py_DECREF(self);
        ...
        TARGET(CONVERT_VALUE) {
            ...
            #line 4915 "Python/generated_cases.c.h"
            stack_pointer[-1] = result;
            DISPATCH();
        }
        ...
        TARGET(SWAP) {
            ...
            assert(oparg >= 2);
            #line 5004 "Python/generated_cases.c.h"
        ...
        TARGET(INSTRUMENTED_POP_JUMP_IF_FALSE) {
            ...
            INSTRUMENTED_JUMP(here, next_instr + offset, PY_MONITORING_EVENT_BRANCH);
            #line 5059 "Python/generated_cases.c.h"
            DISPATCH();
        }

        TARGET(INSTRUMENTED_POP_JUMP_IF_NONE) {
            #line 3651 "Python/bytecodes.c"
            PyObject *value = POP();
            _Py_CODEUNIT *here = next_instr-1;
            int offset;
            if (Py_IsNone(value)) {
            ...
            INSTRUMENTED_JUMP(here, next_instr + offset, PY_MONITORING_EVENT_BRANCH);
            #line 5076 "Python/generated_cases.c.h"
            DISPATCH();
        }
        ...
        TARGET(INSTRUMENTED_POP_JUMP_IF_NOT_NONE) {
            ...
            INSTRUMENTED_JUMP(here, next_instr + offset, PY_MONITORING_EVENT_BRANCH);
            #line 5093 "Python/generated_cases.c.h"
            DISPATCH();
        }

        TARGET(EXTENDED_ARG) {
            #line 3679 "Python/bytecodes.c"
            assert(oparg);
            opcode = next_instr->op.code;
            oparg = oparg << 8 | next_instr->op.arg;
            PRE_DISPATCH_GOTO();
            DISPATCH_GOTO();
            #line 5104 "Python/generated_cases.c.h"
        }
        ...
        TARGET(CACHE) {
            ...
            Py_UNREACHABLE();
            #line 5111 "Python/generated_cases.c.h"
        }

        TARGET(RESERVED) {
            #line 3692 "Python/bytecodes.c"
