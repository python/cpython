...
// Do not edit!
        ...
        TARGET(INSTRUMENTED_RETURN_CONST) {
            ...
            PyObject *retval = GETITEM(_PyFrame_GetCode(frame)->co_consts, oparg);
            int err = _Py_call_instrumentation_arg(
                    tstate, PY_MONITORING_EVENT_PY_RETURN,
                    frame, next_instr-1, retval);
            if (err) goto error;
        ...
        TARGET(GET_AITER) {
            ...
            iter = (*getter)(obj);
            #line 1016 "Python/generated_cases.c.h"
            Py_DECREF(obj);
        ...
        TARGET(GET_ANEXT) {
            ...
            #line 1083 "Python/generated_cases.c.h"
            STACK_GROW(1);
        ...
        TARGET(SEND) {
            ...
            Py_DECREF(v);
            #line 1178 "Python/generated_cases.c.h"
        ...
        TARGET(END_ASYNC_FOR) {
            ...
            #line 1298 "Python/generated_cases.c.h"
            STACK_SHRINK(2);
            DISPATCH();
        }
        ...
        TARGET(STORE_NAME) {
            ...
            #line 1381 "Python/generated_cases.c.h"
                Py_DECREF(v);
        ...
        TARGET(UNPACK_SEQUENCE_LIST) {
            ...
            #line 1497 "Python/generated_cases.c.h"
            Py_DECREF(seq);
            STACK_SHRINK(1);
            STACK_GROW(oparg);
            next_instr += 1;
        ...
        TARGET(LOAD_GLOBAL_BUILTIN) {
            ...
            STAT_INC(LOAD_GLOBAL, hit);
            null = NULL;
            #line 1777 "Python/generated_cases.c.h"
            STACK_GROW(1);
            STACK_GROW(((oparg & 1) ? 1 : 0));
            stack_pointer[-1] = res;
            if (oparg & 1) { stack_pointer[-(1 + ((oparg & 1) ? 1 : 0))] = null; }
        ...
        TARGET(STORE_DEREF) {
            ...
            PyCell_SET(cell, v);
            Py_XDECREF(oldobj);
            #line 1888 "Python/generated_cases.c.h"
            STACK_SHRINK(1);
            DISPATCH();
        }
        ...
        TARGET(BUILD_LIST) {
            ...
            #line 1946 "Python/generated_cases.c.h"
            STACK_SHRINK(oparg);
            STACK_GROW(1);
        ...
        TARGET(SETUP_ANNOTATIONS) {
            ...
            #line 2083 "Python/generated_cases.c.h"
            DISPATCH();
        }
        ...
        TARGET(BUILD_CONST_KEY_MAP) {
            ...
            #line 2108 "Python/generated_cases.c.h"
            STACK_SHRINK(oparg);
            stack_pointer[-1] = map;
            DISPATCH();
        }
        ...
        TARGET(LOAD_SUPER_ATTR) {
            ...
            Py_DECREF(super);
            if (res == NULL) goto pop_3_error;
            #line 2204 "Python/generated_cases.c.h"
            STACK_SHRINK(2);
            STACK_GROW(((oparg & 1) ? 1 : 0));
            stack_pointer[-1] = res;
        ...
        TARGET(LOAD_ATTR_CLASS) {
            ...
            assert(res != NULL);
            Py_INCREF(res);
            #line 2446 "Python/generated_cases.c.h"
            Py_DECREF(cls);
            STACK_GROW(((oparg & 1) ? 1 : 0));
            stack_pointer[-1] = res;
            if (oparg & 1) { stack_pointer[-(1 + ((oparg & 1) ? 1 : 0))] = res2; }
        ...
        TARGET(STORE_ATTR_WITH_HINT) {
            ...
            Py_DECREF(owner);
            #line 2594 "Python/generated_cases.c.h"
            STACK_SHRINK(2);
            next_instr += 4;
            DISPATCH();
        }
        ...
        TARGET(BEFORE_WITH) {
            ...
            #line 3368 "Python/generated_cases.c.h"
            STACK_GROW(1);
            stack_pointer[-1] = res;
            stack_pointer[-2] = exit;
            DISPATCH();
        ...
        TARGET(LOAD_ATTR_METHOD_NO_DICT) {
            ...
            res = self;
            assert(oparg & 1);
            #line 3475 "Python/generated_cases.c.h"
            STACK_GROW(((oparg & 1) ? 1 : 0));
            stack_pointer[-1] = res;
            if (oparg & 1) { stack_pointer[-(1 + ((oparg & 1) ? 1 : 0))] = res2; }
            next_instr += 9;
        ...
        TARGET(KW_NAMES) {
            ...
            #line 3516 "Python/generated_cases.c.h"
            DISPATCH();
        }
        ...
        TARGET(CALL_NO_KW_LIST_APPEND) {
            ...
            DISPATCH();
            #line 4073 "Python/generated_cases.c.h"
        }
        ...
        TARGET(CALL_NO_KW_METHOD_DESCRIPTOR_NOARGS) {
            ...
            Py_DECREF(callable);
            if (res == NULL) { STACK_SHRINK(oparg); goto pop_2_error; }
            #line 4195 "Python/generated_cases.c.h"
            STACK_SHRINK(oparg);
            STACK_SHRINK(1);
            stack_pointer[-1] = res;
            next_instr += 3;
        ...
        TARGET(CALL_NO_KW_METHOD_DESCRIPTOR_FAST) {
            ...
            Py_DECREF(callable);
            if (res == NULL) { STACK_SHRINK(oparg); goto pop_2_error; }
            #line 4236 "Python/generated_cases.c.h"
            STACK_SHRINK(oparg);
            STACK_SHRINK(1);
            stack_pointer[-1] = res;
            next_instr += 3;
