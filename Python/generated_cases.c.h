...
// Do not edit!
        ...
        TARGET(RERAISE) {
            ...
            #line 1376 "Python/generated_cases.c.h"
        }
        ...
        TARGET(END_ASYNC_FOR) {
            ...
            #line 1385 "Python/generated_cases.c.h"
                Py_DECREF(awaitable);
                Py_DECREF(exc);
        ...
        TARGET(STORE_NAME) {
            ...
            if (err) goto pop_1_error;
            #line 1491 "Python/generated_cases.c.h"
            STACK_SHRINK(1);
            DISPATCH();
        }
        ...
        TARGET(DELETE_ATTR) {
            ...
            #line 1655 "Python/generated_cases.c.h"
            Py_DECREF(owner);
        ...
        TARGET(STORE_GLOBAL) {
            ...
            #line 1669 "Python/generated_cases.c.h"
            Py_DECREF(v);
        ...
        TARGET(DELETE_GLOBAL) {
            ...
            #line 1691 "Python/generated_cases.c.h"
            DISPATCH();
        }
        ...
        TARGET(LOAD_LOCALS) {
            PyObject *_tmp_1;
            {
                ...
                Py_INCREF(locals);
                #line 1707 "Python/generated_cases.c.h"
                _tmp_1 = locals;
            }
            STACK_GROW(1);
            stack_pointer[-1] = _tmp_1;
        ...
        TARGET(LOAD_NAME) {
            PyObject *_tmp_1;
            {
                ...
                Py_INCREF(locals);
                #line 1727 "Python/generated_cases.c.h"
                _tmp_1 = locals;
            }
            {
        ...
        TARGET(LOAD_FROM_DICT_OR_GLOBALS) {
            PyObject *_tmp_1 = stack_pointer[-1];
            {
                ...
                #line 1860 "Python/generated_cases.c.h"
                _tmp_1 = v;
            }
            stack_pointer[-1] = _tmp_1;
            DISPATCH();
        ...
        TARGET(LOAD_GLOBAL_MODULE) {
            ...
            null = NULL;
            #line 1949 "Python/generated_cases.c.h"
            STACK_GROW(1);
            STACK_GROW(((oparg & 1) ? 1 : 0));
            stack_pointer[-1] = res;
            if (oparg & 1) { stack_pointer[-(1 + ((oparg & 1) ? 1 : 0))] = null; }
        ...
        TARGET(DELETE_DEREF) {
            ...
            Py_DECREF(oldobj);
            #line 2023 "Python/generated_cases.c.h"
            DISPATCH();
        }
        ...
        TARGET(SET_UPDATE) {
            ...
            #line 2189 "Python/generated_cases.c.h"
            Py_DECREF(iterable);
        ...
        TARGET(DICT_UPDATE) {
            ...
            #line 2329 "Python/generated_cases.c.h"
                Py_DECREF(update);
        ...
        TARGET(LOAD_SUPER_ATTR) {
            ...
            #line 2434 "Python/generated_cases.c.h"
            ...
            if (oparg & 1) {
                ...
                if (_PyObject_GetMethod(owner, name, &meth)) {
                    ...
                    /* meth is not an unbound method (but a regular attr, or
                       ...
                       NULL | meth | arg1 | ... | argN
                    */
            #line 2557 "Python/generated_cases.c.h"
                    Py_DECREF(owner);
        ...
        TARGET(COMPARE_OP) {
            ...
            if (res == NULL) goto pop_2_error;
            #line 2921 "Python/generated_cases.c.h"
            STACK_SHRINK(1);
            stack_pointer[-1] = res;
            next_instr += 1;
            DISPATCH();
        ...
        TARGET(MATCH_KEYS) {
            ...
            #line 3307 "Python/generated_cases.c.h"
            STACK_GROW(1);
        ...
        TARGET(LOAD_ATTR_METHOD_LAZY_DICT) {
            ...
            res = self;
            assert(oparg & 1);
            #line 3765 "Python/generated_cases.c.h"
            STACK_GROW(((oparg & 1) ? 1 : 0));
            stack_pointer[-1] = res;
            if (oparg & 1) { stack_pointer[-(1 + ((oparg & 1) ? 1 : 0))] = res2; }
            next_instr += 9;
        ...
        TARGET(CALL) {
            ...
            #line 3888 "Python/generated_cases.c.h"
            STACK_SHRINK(oparg);
            STACK_SHRINK(1);
            stack_pointer[-1] = res;
            next_instr += 3;
        ...
        TARGET(CALL_NO_KW_BUILTIN_FAST) {
            ...
            if (res == NULL) { STACK_SHRINK(oparg); goto pop_2_error; }
                /* Not deopting because this doesn't mean our optimization was
                   ...
                   handle it.
                */
            #line 4180 "Python/generated_cases.c.h"
            STACK_SHRINK(oparg);
            STACK_SHRINK(1);
            stack_pointer[-1] = res;
            next_instr += 3;
        ...
        TARGET(CALL_BUILTIN_FAST_WITH_KEYWORDS) {
            ...
            Py_DECREF(callable);
            if (res == NULL) { STACK_SHRINK(oparg); goto pop_2_error; }
            #line 4226 "Python/generated_cases.c.h"
            STACK_SHRINK(oparg);
            STACK_SHRINK(1);
            stack_pointer[-1] = res;
            next_instr += 3;
        ...
        TARGET(INSTRUMENTED_CALL_FUNCTION_EX) {
            ...
            #line 4510 "Python/generated_cases.c.h"
        }
        ...
        TARGET(INSTRUMENTED_INSTRUCTION) {
            ...
            opcode = next_opcode;
            DISPATCH_GOTO();
            #line 4797 "Python/generated_cases.c.h"
        }
        ...
        TARGET(CACHE) {
            ...
            Py_UNREACHABLE();
            #line 4891 "Python/generated_cases.c.h"
        }
