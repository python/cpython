...
// Do not edit!
        ...
        TARGET(STORE_FAST_LOAD_FAST) {
            ...
            value2 = GETLOCAL(oparg2);
            Py_INCREF(value2);
            #line 155 "Python/generated_cases.c.h"
            stack_pointer[-1] = value2;
            DISPATCH();
        }
        ...
        TARGET(STORE_FAST_STORE_FAST) {
            ...
            #line 168 "Python/generated_cases.c.h"
            STACK_SHRINK(2);
            DISPATCH();
        }
        ...
        TARGET(PUSH_NULL) {
            ...
            res = NULL;
            #line 186 "Python/generated_cases.c.h"
            STACK_GROW(1);
            stack_pointer[-1] = res;
            DISPATCH();
        }
        ...
        TARGET(END_FOR) {
            ...
            PyObject *_tmp_2 = stack_pointer[-2];
            {
                ...
                #line 238 "Python/bytecodes.c"
                #line 198 "Python/generated_cases.c.h"
                Py_DECREF(value);
            }
            {
                PyObject *value = _tmp_2;
                #line 238 "Python/bytecodes.c"
                #line 204 "Python/generated_cases.c.h"
                Py_DECREF(value);
            }
            STACK_SHRINK(2);
            DISPATCH();
        ...
        TARGET(INSTRUMENTED_END_FOR) {
            ...
            #line 224 "Python/generated_cases.c.h"
            Py_DECREF(receiver);
            Py_DECREF(value);
            STACK_SHRINK(2);
            DISPATCH();
        ...
        TARGET(END_SEND) {
            ...
            Py_DECREF(receiver);
            #line 236 "Python/generated_cases.c.h"
            STACK_SHRINK(1);
            stack_pointer[-1] = value;
            DISPATCH();
        }
        ...
        TARGET(UNARY_NEGATIVE) {
            ...
            #line 269 "Python/generated_cases.c.h"
            stack_pointer[-1] = res;
            DISPATCH();
        }
        ...
        TARGET(UNARY_INVERT) {
            ...
            #line 299 "Python/generated_cases.c.h"
            Py_DECREF(value);
        ...
        TARGET(BINARY_OP_ADD_INT) {
            ...
            }
            {
                ...
                _Py_DECREF_SPECIALIZED(left, (destructor)PyObject_Free);
                if (res == NULL) goto pop_2_error;
                #line 363 "Python/generated_cases.c.h"
                _tmp_2 = res;
            }
            next_instr += 1;
            STACK_SHRINK(1);
        ...
        TARGET(BINARY_OP_MULTIPLY_FLOAT) {
            ...
            }
            {
                ...
                #line 427 "Python/generated_cases.c.h"
                _tmp_2 = res;
            }
            next_instr += 1;
            STACK_SHRINK(1);
        ...
        TARGET(BINARY_OP_ADD_FLOAT) {
            ...
            }
            {
                ...
                double dres =
                    ...
                    ((PyFloatObject *)right)->ob_fval;
                DECREF_INPUTS_AND_REUSE_FLOAT(left, right, dres, res);
                #line 459 "Python/generated_cases.c.h"
                _tmp_2 = res;
            }
            next_instr += 1;
            STACK_SHRINK(1);
        ...
        TARGET(BINARY_OP_SUBTRACT_FLOAT) {
            ...
            }
            {
                ...
                double dres =
                    ...
                    ((PyFloatObject *)right)->ob_fval;
                DECREF_INPUTS_AND_REUSE_FLOAT(left, right, dres, res);
                #line 491 "Python/generated_cases.c.h"
                _tmp_2 = res;
            }
            next_instr += 1;
            STACK_SHRINK(1);
        ...
        TARGET(BINARY_OP_ADD_UNICODE) {
            ...
            }
            {
                ...
                if (res == NULL) goto pop_2_error;
                #line 523 "Python/generated_cases.c.h"
                _tmp_2 = res;
            }
            next_instr += 1;
            STACK_SHRINK(1);
        ...
        TARGET(BINARY_OP_INPLACE_ADD_UNICODE) {
            ...
            PyObject *_tmp_2 = stack_pointer[-2];
            {
                ...
                DEOPT_IF(!PyUnicode_CheckExact(left), BINARY_OP);
                DEOPT_IF(!PyUnicode_CheckExact(right), BINARY_OP);
                #line 541 "Python/generated_cases.c.h"
                _tmp_2 = left;
                _tmp_1 = right;
            }
            {
                ...
                #line 572 "Python/generated_cases.c.h"
            }
            STACK_SHRINK(2);
            DISPATCH();
        }
        ...
        TARGET(BINARY_SUBSCR) {
            ...
            #line 596 "Python/generated_cases.c.h"
            Py_DECREF(container);
            Py_DECREF(sub);
        ...
        TARGET(BINARY_SLICE) {
            ...
            #line 626 "Python/generated_cases.c.h"
            STACK_SHRINK(2);
            stack_pointer[-1] = res;
            DISPATCH();
        }
        ...
        TARGET(STORE_SLICE) {
            ...
            #line 650 "Python/generated_cases.c.h"
            STACK_SHRINK(4);
            DISPATCH();
        }
        ...
        TARGET(BINARY_SUBSCR_DICT) {
            ...
            #line 717 "Python/generated_cases.c.h"
                Py_DECREF(dict);
                Py_DECREF(sub);
        ...
        TARGET(BINARY_SUBSCR_GETITEM) {
            ...
            #line 759 "Python/generated_cases.c.h"
        }
        ...
        TARGET(SET_ADD) {
            ...
            #line 782 "Python/generated_cases.c.h"
            STACK_SHRINK(1);
            PREDICT(JUMP_BACKWARD);
            DISPATCH();
        }
        ...
        TARGET(STORE_SUBSCR) {
            ...
            #line 810 "Python/generated_cases.c.h"
            Py_DECREF(v);
            Py_DECREF(container);
            Py_DECREF(sub);
            #line 594 "Python/bytecodes.c"
            if (err) goto pop_3_error;
            #line 816 "Python/generated_cases.c.h"
            STACK_SHRINK(3);
            next_instr += 1;
            DISPATCH();
        }
        ...
        TARGET(DELETE_SUBSCR) {
            ...
            #line 876 "Python/generated_cases.c.h"
            STACK_SHRINK(2);
            DISPATCH();
        }
        ...
        TARGET(CALL_INTRINSIC_2) {
            ...
            #line 903 "Python/generated_cases.c.h"
            Py_DECREF(value2);
            Py_DECREF(value1);
        ...
        TARGET(GET_AITER) {
            ...
            iter = (*getter)(obj);
            #line 1056 "Python/generated_cases.c.h"
            Py_DECREF(obj);
        ...
        TARGET(GET_AWAITABLE) {
            ...
            #line 1141 "Python/generated_cases.c.h"
            Py_DECREF(iterable);
        ...
        TARGET(END_ASYNC_FOR) {
            ...
            #line 1341 "Python/generated_cases.c.h"
            STACK_SHRINK(2);
            DISPATCH();
        }
        ...
        TARGET(CLEANUP_THROW) {
            ...
            #line 1357 "Python/generated_cases.c.h"
                Py_DECREF(sub_iter);
        ...
        TARGET(STORE_NAME) {
            ...
            #line 1424 "Python/generated_cases.c.h"
                Py_DECREF(v);
            ...
            #line 1433 "Python/generated_cases.c.h"
            Py_DECREF(v);
        ...
        TARGET(UNPACK_SEQUENCE) {
            ...
            #line 1485 "Python/generated_cases.c.h"
            STACK_SHRINK(1);
            STACK_GROW(oparg);
            next_instr += 1;
            DISPATCH();
        ...
        TARGET(UNPACK_EX) {
            ...
            #line 1554 "Python/generated_cases.c.h"
            Py_DECREF(seq);
            #line 1143 "Python/bytecodes.c"
            if (res == 0) goto pop_1_error;
            #line 1558 "Python/generated_cases.c.h"
        ...
        TARGET(DELETE_ATTR) {
            ...
            if (err) goto pop_1_error;
            #line 1605 "Python/generated_cases.c.h"
            STACK_SHRINK(1);
            DISPATCH();
        }
        ...
        TARGET(STORE_GLOBAL) {
            ...
            if (err) goto pop_1_error;
            #line 1619 "Python/generated_cases.c.h"
            STACK_SHRINK(1);
            DISPATCH();
        }

        TARGET(DELETE_GLOBAL) {
            #line 1188 "Python/bytecodes.c"
            PyObject *name = GETITEM(frame->f_code->co_names, oparg);
            int err;
        ...
        TARGET(LOAD_FROM_DICT_OR_GLOBALS) {
            PyObject *_tmp_1 = stack_pointer[-1];
            {
                ...
                #line 1806 "Python/generated_cases.c.h"
                _tmp_1 = v;
            }
            stack_pointer[-1] = _tmp_1;
            DISPATCH();
        ...
        TARGET(DELETE_FAST) {
            ...
            SETLOCAL(oparg, NULL);
            #line 1939 "Python/generated_cases.c.h"
            DISPATCH();
        }
        ...
        TARGET(SET_UPDATE) {
            ...
            #line 2135 "Python/generated_cases.c.h"
            Py_DECREF(iterable);
        ...
        TARGET(BUILD_MAP) {
            ...
            #line 2186 "Python/generated_cases.c.h"
        ...
        TARGET(INSTRUMENTED_LOAD_SUPER_ATTR) {
            ...
            #line 2327 "Python/generated_cases.c.h"
        }
        ...
        TARGET(LOAD_SUPER_ATTR) {
            ...
            Py_DECREF(super);
            if (res == NULL) goto pop_3_error;
            #line 2389 "Python/generated_cases.c.h"
            STACK_SHRINK(2);
            STACK_GROW(((oparg & 1) ? 1 : 0));
            stack_pointer[-1] = res;
        ...
        TARGET(COMPARE_OP) {
            ...
            #line 2862 "Python/generated_cases.c.h"
            Py_DECREF(left);
            Py_DECREF(right);
        ...
        TARGET(MATCH_SEQUENCE) {
            ...
            res = match ? Py_True : Py_False;
            #line 3265 "Python/generated_cases.c.h"
            STACK_GROW(1);
            stack_pointer[-1] = res;
            PREDICT(POP_JUMP_IF_FALSE);
            DISPATCH();
        ...
        TARGET(GET_ITER) {
            ...
            #line 3292 "Python/generated_cases.c.h"
            Py_DECREF(iterable);
        ...
        TARGET(INSTRUMENTED_FOR_ITER) {
            ...
            #line 3407 "Python/generated_cases.c.h"
            DISPATCH();
        }
        ...
        TARGET(BEFORE_WITH) {
            ...
            #line 3594 "Python/generated_cases.c.h"
            Py_DECREF(mgr);
        ...
        TARGET(LOAD_ATTR_METHOD_LAZY_DICT) {
            ...
            res = self;
            assert(oparg & 1);
            #line 3738 "Python/generated_cases.c.h"
            STACK_GROW(((oparg & 1) ? 1 : 0));
            stack_pointer[-1] = res;
            if (oparg & 1) { stack_pointer[-(1 + ((oparg & 1) ? 1 : 0))] = res2; }
            next_instr += 9;
        ...
        TARGET(CALL) {
            ...
            #line 3861 "Python/generated_cases.c.h"
            STACK_SHRINK(oparg);
            STACK_SHRINK(1);
            stack_pointer[-1] = res;
            next_instr += 3;
        ...
        TARGET(CALL_BOUND_METHOD_EXACT_ARGS) {
            ...
            #line 3883 "Python/generated_cases.c.h"
        }
        ...
        TARGET(CALL_PY_WITH_DEFAULTS) {
            ...
            frame->return_offset = 0;
            DISPATCH_INLINED(new_frame);
            #line 3962 "Python/generated_cases.c.h"
        }
        ...
        TARGET(CALL_NO_KW_TUPLE_1) {
            ...
            if (res == NULL) { STACK_SHRINK(oparg); goto pop_2_error; }
            #line 4029 "Python/generated_cases.c.h"
            STACK_SHRINK(oparg);
            STACK_SHRINK(1);
            stack_pointer[-1] = res;
            next_instr += 3;
        ...
        TARGET(CALL_NO_KW_LIST_APPEND) {
            ...
            DISPATCH();
            #line 4308 "Python/generated_cases.c.h"
        }
        ...
        TARGET(CALL_METHOD_DESCRIPTOR_FAST_WITH_KEYWORDS) {
            ...
            Py_DECREF(callable);
            if (res == NULL) { STACK_SHRINK(oparg); goto pop_2_error; }
            #line 4388 "Python/generated_cases.c.h"
            STACK_SHRINK(oparg);
            STACK_SHRINK(1);
            stack_pointer[-1] = res;
            next_instr += 3;
        ...
        TARGET(FORMAT_VALUE) {
            ...
            #line 4695 "Python/generated_cases.c.h"
        ...
        TARGET(BINARY_OP) {
            ...
            #line 4734 "Python/generated_cases.c.h"
            Py_DECREF(lhs);
            Py_DECREF(rhs);
        ...
        TARGET(SWAP) {
            ...
            assert(oparg >= 2);
            #line 4751 "Python/generated_cases.c.h"
        ...
        TARGET(INSTRUMENTED_POP_JUMP_IF_NOT_NONE) {
            ...
            INSTRUMENTED_JUMP(here, next_instr + offset, PY_MONITORING_EVENT_BRANCH);
            #line 4846 "Python/generated_cases.c.h"
            DISPATCH();
        }
        ...
        TARGET(EXTENDED_ARG) {
            ...
            PRE_DISPATCH_GOTO();
            DISPATCH_GOTO();
            #line 4857 "Python/generated_cases.c.h"
        }
        ...
        TARGET(RESERVED) {
            ...
            Py_UNREACHABLE();
            #line 4871 "Python/generated_cases.c.h"
        }
