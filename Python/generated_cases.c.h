...
// Do not edit!
        ...
        TARGET(LOAD_CONST) {
            ...
            Py_INCREF(value);
            #line 113 "Python/generated_cases.c.h"
            STACK_GROW(1);
            stack_pointer[-1] = value;
            DISPATCH();
        }
        ...
        TARGET(STORE_FAST) {
            ...
            #line 123 "Python/generated_cases.c.h"
            STACK_SHRINK(1);
            DISPATCH();
        }
        ...
        TARGET(LOAD_FAST__LOAD_FAST) {
            ...
            PyObject *_tmp_2;
            {
                ...
                assert(value != NULL);
                Py_INCREF(value);
                #line 137 "Python/generated_cases.c.h"
                _tmp_2 = value;
            }
            oparg = (next_instr++)->op.arg;
            {
                ...
                assert(value != NULL);
                Py_INCREF(value);
                #line 147 "Python/generated_cases.c.h"
                _tmp_1 = value;
            }
            STACK_GROW(2);
        ...
        TARGET(LOAD_FAST__LOAD_CONST) {
            ...
            PyObject *_tmp_2;
            {
                ...
                assert(value != NULL);
                Py_INCREF(value);
                #line 165 "Python/generated_cases.c.h"
                _tmp_2 = value;
            }
            oparg = (next_instr++)->op.arg;
            {
        ...
        TARGET(STORE_FAST__LOAD_FAST) {
            PyObject *_tmp_1 = stack_pointer[-1];
            {
                ...
                #line 208 "Python/bytecodes.c"
                SETLOCAL(oparg, value);
                #line 189 "Python/generated_cases.c.h"
            }
            oparg = (next_instr++)->op.arg;
            {
                PyObject *value;
        ...
        TARGET(STORE_FAST__STORE_FAST) {
            ...
            PyObject *_tmp_2 = stack_pointer[-2];
            {
                ...
                #line 208 "Python/bytecodes.c"
                SETLOCAL(oparg, value);
                #line 212 "Python/generated_cases.c.h"
            }
            oparg = (next_instr++)->op.arg;
            {
        ...
        TARGET(END_FOR) {
            ...
            }
            {
                PyObject *value = _tmp_2;
                #line 218 "Python/bytecodes.c"
                #line 283 "Python/generated_cases.c.h"
                Py_DECREF(value);
            }
            STACK_SHRINK(2);
            DISPATCH();
        ...
        TARGET(END_SEND) {
            ...
            Py_DECREF(receiver);
            #line 315 "Python/generated_cases.c.h"
            STACK_SHRINK(1);
            stack_pointer[-1] = value;
            DISPATCH();
        }
        ...
        TARGET(UNARY_INVERT) {
            ...
            #line 378 "Python/generated_cases.c.h"
            Py_DECREF(value);
            #line 276 "Python/bytecodes.c"
            if (res == NULL) goto pop_1_error;
            #line 382 "Python/generated_cases.c.h"
            stack_pointer[-1] = res;
            DISPATCH();
        }
        ...
        TARGET(BINARY_OP_SUBTRACT_FLOAT) {
            ...
            #line 453 "Python/generated_cases.c.h"
            STACK_SHRINK(1);
            stack_pointer[-1] = sub;
            next_instr += 1;
            DISPATCH();
        ...
        TARGET(BINARY_SUBSCR) {
            ...
            if (res == NULL) goto pop_2_error;
            #line 574 "Python/generated_cases.c.h"
            STACK_SHRINK(1);
            stack_pointer[-1] = res;
            next_instr += 1;
            DISPATCH();
        ...
        TARGET(BINARY_SLICE) {
            ...
            #line 599 "Python/generated_cases.c.h"
            STACK_SHRINK(2);
            stack_pointer[-1] = res;
            DISPATCH();
        }
        ...
        TARGET(STORE_SLICE) {
            ...
            #line 623 "Python/generated_cases.c.h"
            STACK_SHRINK(4);
            DISPATCH();
        }
        ...
        TARGET(BINARY_SUBSCR_DICT) {
            ...
            #line 690 "Python/generated_cases.c.h"
                Py_DECREF(dict);
                Py_DECREF(sub);
        ...
        TARGET(SET_ADD) {
            ...
            #line 750 "Python/generated_cases.c.h"
            Py_DECREF(v);
        ...
        TARGET(SEND_GEN) {
            ...
            JUMPBY(INLINE_CACHE_ENTRIES_SEND);
            DISPATCH_INLINED(gen_frame);
            #line 1211 "Python/generated_cases.c.h"
        }
        ...
        TARGET(END_ASYNC_FOR) {
            ...
            #line 1307 "Python/generated_cases.c.h"
            STACK_SHRINK(2);
            DISPATCH();
        }
        ...
        TARGET(LOAD_ASSERTION_ERROR) {
            ...
            #line 1345 "Python/generated_cases.c.h"
            STACK_GROW(1);
            stack_pointer[-1] = value;
            DISPATCH();
        }
        ...
        TARGET(DELETE_NAME) {
            ...
            #line 1426 "Python/generated_cases.c.h"
            DISPATCH();
        }
        ...
        TARGET(UNPACK_SEQUENCE) {
            ...
            #line 1451 "Python/generated_cases.c.h"
            STACK_SHRINK(1);
            STACK_GROW(oparg);
            next_instr += 1;
            DISPATCH();
        ...
        TARGET(UNPACK_EX) {
            PyObject *seq = stack_pointer[-1];
            #line 1092 "Python/bytecodes.c"
            int totalargs = 1 + (oparg & 0xFF) + (oparg >> 8);
            PyObject **top = stack_pointer + totalargs - 1;
            int res = unpack_iterable(tstate, seq, oparg & 0xFF, oparg >> 8, top);
            #line 1520 "Python/generated_cases.c.h"
            Py_DECREF(seq);
        ...
        TARGET(STORE_ATTR) {
            ...
            #line 1551 "Python/generated_cases.c.h"
            Py_DECREF(v);
            Py_DECREF(owner);
        ...
        TARGET(LOAD_NAME) {
            ...
            }
            {
                ...
                #line 1702 "Python/generated_cases.c.h"
                _tmp_1 = v;
            }
            STACK_GROW(1);
            stack_pointer[-1] = _tmp_1;
        ...
        TARGET(LOAD_GLOBAL_BUILTIN) {
            ...
            STAT_INC(LOAD_GLOBAL, hit);
            null = NULL;
            #line 1891 "Python/generated_cases.c.h"
            STACK_GROW(1);
            STACK_GROW(((oparg & 1) ? 1 : 0));
            stack_pointer[-1] = res;
            if (oparg & 1) { stack_pointer[-(1 + ((oparg & 1) ? 1 : 0))] = null; }
        ...
        TARGET(DELETE_FAST) {
            ...
            SETLOCAL(oparg, NULL);
            #line 1905 "Python/generated_cases.c.h"
            DISPATCH();
        }
        ...
        TARGET(LOAD_FROM_DICT_OR_DEREF) {
            ...
            #line 1977 "Python/generated_cases.c.h"
            stack_pointer[-1] = value;
            DISPATCH();
        }
        ...
        TARGET(LOAD_SUPER_ATTR) {
            ...
            Py_DECREF(super);
            if (res == NULL) goto pop_3_error;
            #line 2353 "Python/generated_cases.c.h"
            STACK_SHRINK(2);
            STACK_GROW(((oparg & 1) ? 1 : 0));
            stack_pointer[-1] = res;
        ...
        TARGET(LOAD_ATTR) {
            ...
            #line 2481 "Python/generated_cases.c.h"
            STACK_GROW(((oparg & 1) ? 1 : 0));
            stack_pointer[-1] = res;
            if (oparg & 1) { stack_pointer[-(1 + ((oparg & 1) ? 1 : 0))] = res2; }
            next_instr += 9;
        ...
        TARGET(LOAD_ATTR_INSTANCE_VALUE) {
            ...
            Py_INCREF(res);
            res2 = NULL;
            #line 2508 "Python/generated_cases.c.h"
            Py_DECREF(owner);
            STACK_GROW(((oparg & 1) ? 1 : 0));
            stack_pointer[-1] = res;
            if (oparg & 1) { stack_pointer[-(1 + ((oparg & 1) ? 1 : 0))] = res2; }
        ...
        TARGET(LOAD_ATTR_WITH_HINT) {
            ...
            Py_INCREF(res);
            res2 = NULL;
            #line 2578 "Python/generated_cases.c.h"
            Py_DECREF(owner);
            STACK_GROW(((oparg & 1) ? 1 : 0));
            stack_pointer[-1] = res;
            if (oparg & 1) { stack_pointer[-(1 + ((oparg & 1) ? 1 : 0))] = res2; }
        ...
        TARGET(LOAD_ATTR_SLOT) {
            ...
            Py_INCREF(res);
            res2 = NULL;
            #line 2603 "Python/generated_cases.c.h"
            Py_DECREF(owner);
            STACK_GROW(((oparg & 1) ? 1 : 0));
            stack_pointer[-1] = res;
            if (oparg & 1) { stack_pointer[-(1 + ((oparg & 1) ? 1 : 0))] = res2; }
        ...
        TARGET(STORE_ATTR_SLOT) {
            ...
            *(PyObject **)addr = value;
            ...
            Py_DECREF(owner);
            #line 2799 "Python/generated_cases.c.h"
            STACK_SHRINK(2);
            next_instr += 4;
            DISPATCH();
        }
        ...
        TARGET(JUMP_FORWARD) {
            ...
            JUMPBY(oparg);
            #line 3035 "Python/generated_cases.c.h"
            DISPATCH();
        }
