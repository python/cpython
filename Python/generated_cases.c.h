...
// Do not edit!
        ...
        TARGET(INTERPRETER_EXIT) {
            ...
            return retval;
            #line 839 "Python/generated_cases.c.h"
        }
        ...
        TARGET(CLEANUP_THROW) {
            ...
            #line 1176 "Python/generated_cases.c.h"
                Py_DECREF(sub_iter);
        ...
        TARGET(LOAD_BUILD_CLASS) {
            ...
            #line 1228 "Python/generated_cases.c.h"
            STACK_GROW(1);
            stack_pointer[-1] = bc;
            DISPATCH();
        }
        ...
        TARGET(DELETE_NAME) {
            ...
            #line 1279 "Python/generated_cases.c.h"
            DISPATCH();
        }
        ...
        TARGET(LOAD_NAME) {
            ...
            #line 1523 "Python/generated_cases.c.h"
            STACK_GROW(1);
            stack_pointer[-1] = v;
            DISPATCH();
        }
        ...
        TARGET(LOAD_GLOBAL) {
            ...
            null = NULL;
            #line 1587 "Python/generated_cases.c.h"
            STACK_GROW(1);
        ...
        TARGET(LOAD_GLOBAL_BUILTIN) {
            ...
            STAT_INC(LOAD_GLOBAL, hit);
            null = NULL;
            #line 1643 "Python/generated_cases.c.h"
            STACK_GROW(1);
            STACK_GROW(((oparg & 1) ? 1 : 0));
            stack_pointer[-1] = res;
            if (oparg & 1) { stack_pointer[-(1 + ((oparg & 1) ? 1 : 0))] = null; }
        ...
        TARGET(DELETE_DEREF) {
            ...
            Py_DECREF(oldobj);
            #line 1687 "Python/generated_cases.c.h"
            DISPATCH();
        }
        ...
        TARGET(LOAD_DEREF) {
            ...
            Py_INCREF(value);
            #line 1741 "Python/generated_cases.c.h"
            STACK_GROW(1);
            stack_pointer[-1] = value;
            DISPATCH();
        }
        ...
        TARGET(BUILD_TUPLE) {
            ...
            #line 1799 "Python/generated_cases.c.h"
            STACK_SHRINK(oparg);
            STACK_GROW(1);
            stack_pointer[-1] = tup;
            DISPATCH();
        ...
        TARGET(BUILD_LIST) {
            ...
            #line 1812 "Python/generated_cases.c.h"
            STACK_SHRINK(oparg);
            STACK_GROW(1);
        ...
        TARGET(LIST_EXTEND) {
            ...
            #line 1833 "Python/generated_cases.c.h"
                Py_DECREF(iterable);
        ...
        TARGET(SET_UPDATE) {
            ...
            if (err < 0) goto pop_1_error;
            #line 1854 "Python/generated_cases.c.h"
            STACK_SHRINK(1);
            DISPATCH();
        }
        ...
        TARGET(STORE_ATTR_SLOT) {
            ...
            *(PyObject **)addr = value;
            ...
            Py_DECREF(owner);
            #line 2418 "Python/generated_cases.c.h"
            STACK_SHRINK(2);
            next_instr += 4;
            DISPATCH();
        }
        ...
        TARGET(IS_OP) {
            ...
            #line 2539 "Python/generated_cases.c.h"
            Py_DECREF(left);
            Py_DECREF(right);
            #line 1771 "Python/bytecodes.c"
            b = Py_NewRef(res ? Py_True : Py_False);
            #line 2544 "Python/generated_cases.c.h"
            STACK_SHRINK(1);
            stack_pointer[-1] = b;
            DISPATCH();
        }
        ...
        TARGET(IMPORT_NAME) {
            ...
            #line 2634 "Python/generated_cases.c.h"
            Py_DECREF(level);
            Py_DECREF(fromlist);
        ...
        TARGET(IMPORT_FROM) {
            ...
            #line 2652 "Python/generated_cases.c.h"
            STACK_GROW(1);
            stack_pointer[-1] = res;
            DISPATCH();
        }
        ...
        TARGET(MATCH_KEYS) {
            ...
            #line 2853 "Python/generated_cases.c.h"
            STACK_GROW(1);
        ...
        TARGET(COPY) {
            ...
            #line 4187 "Python/generated_cases.c.h"
            STACK_GROW(1);
            stack_pointer[-1] = top;
            DISPATCH();
        }
