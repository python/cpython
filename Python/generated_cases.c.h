...
// Do not edit!
        ...
        TARGET(BUILD_SET) {
            ...
            #line 2096 "Python/generated_cases.c.h"
            STACK_SHRINK(oparg);
            STACK_GROW(1);
            stack_pointer[-1] = set;
            DISPATCH();
        ...
        TARGET(COMPARE_OP_INT) {
            ...
            res = (sign_ish & oparg) ? Py_True : Py_False;
            Py_INCREF(res);
            #line 2780 "Python/generated_cases.c.h"
            STACK_SHRINK(1);
            stack_pointer[-1] = res;
            next_instr += 1;
            DISPATCH();
        ...
        TARGET(LOAD_ATTR_METHOD_NO_DICT) {
            ...
            res = self;
            assert(oparg & 1);
            #line 3560 "Python/generated_cases.c.h"
            STACK_GROW(((oparg & 1) ? 1 : 0));
            stack_pointer[-1] = res;
            if (oparg & 1) { stack_pointer[-(1 + ((oparg & 1) ? 1 : 0))] = res2; }
            next_instr += 9;
        ...
        TARGET(CALL_FUNCTION_EX) {
            ...
            #line 4385 "Python/generated_cases.c.h"
            Py_DECREF(func);
            Py_DECREF(callargs);
            Py_XDECREF(kwargs);
            ...
            #line 4392 "Python/generated_cases.c.h"
        ...
        TARGET(INSTRUMENTED_POP_JUMP_IF_NONE) {
            ...
            INSTRUMENTED_JUMP(here, next_instr + offset, PY_MONITORING_EVENT_BRANCH);
            #line 4690 "Python/generated_cases.c.h"
            DISPATCH();
        }
