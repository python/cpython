...
// Do not edit!
        ...
        TARGET(POP_NULL) {
            ...
            assert(value == NULL);
            #line 227 "Python/generated_cases.c.h"
            STACK_SHRINK(1);
            DISPATCH();
        }
        ...
        TARGET(END_FOR) {
            ...
            PyObject *_tmp_2 = stack_pointer[-2];
            {
                PyObject *value = _tmp_1;
                #line 178 "Python/bytecodes.c"
                #line 238 "Python/generated_cases.c.h"
                Py_DECREF(value);
            }
            {
                PyObject *value = _tmp_2;
        ...
        TARGET(UNARY_NEGATIVE) {
            ...
            #line 260 "Python/generated_cases.c.h"
            stack_pointer[-1] = res;
            DISPATCH();
        }
        ...
        TARGET(UNARY_INVERT) {
            ...
            #line 291 "Python/generated_cases.c.h"
            Py_DECREF(value);
            #line 213 "Python/bytecodes.c"
            if (res == NULL) goto pop_1_error;
            #line 295 "Python/generated_cases.c.h"
            stack_pointer[-1] = res;
            DISPATCH();
        }
        ...
        TARGET(BINARY_OP_ADD_UNICODE) {
            ...
            #line 390 "Python/generated_cases.c.h"
            STACK_SHRINK(1);
            stack_pointer[-1] = res;
            next_instr += 1;
            DISPATCH();
        ...
        TARGET(BINARY_OP_INPLACE_ADD_UNICODE) {
            ...
            #line 428 "Python/generated_cases.c.h"
            STACK_SHRINK(2);
            DISPATCH();
        }
        ...
        TARGET(BINARY_OP_ADD_INT) {
            ...
            #line 465 "Python/generated_cases.c.h"
            STACK_SHRINK(1);
            stack_pointer[-1] = sum;
            next_instr += 1;
            DISPATCH();
        ...
        TARGET(BINARY_SUBSCR) {
            ...
            if (res == NULL) goto pop_2_error;
            #line 496 "Python/generated_cases.c.h"
            STACK_SHRINK(1);
            stack_pointer[-1] = res;
            next_instr += 1;
            DISPATCH();
        ...
        TARGET(BINARY_SLICE) {
            ...
            #line 521 "Python/generated_cases.c.h"
            STACK_SHRINK(2);
            stack_pointer[-1] = res;
            DISPATCH();
        }
        ...
        TARGET(BINARY_SUBSCR_LIST_INT) {
            ...
            Py_DECREF(list);
            #line 569 "Python/generated_cases.c.h"
            STACK_SHRINK(1);
            stack_pointer[-1] = res;
            next_instr += 1;
            DISPATCH();
        ...
        TARGET(BINARY_SUBSCR_GETITEM) {
            ...
            #line 655 "Python/generated_cases.c.h"
        }
        ...
        TARGET(LIST_APPEND) {
            ...
            #line 663 "Python/generated_cases.c.h"
            STACK_SHRINK(1);
        ...
        TARGET(SET_ADD) {
            ...
            #line 674 "Python/generated_cases.c.h"
            Py_DECREF(v);
        ...
        TARGET(STORE_SUBSCR) {
            ...
            Py_DECREF(container);
            Py_DECREF(sub);
            #line 501 "Python/bytecodes.c"
            if (err) goto pop_3_error;
            #line 713 "Python/generated_cases.c.h"
            STACK_SHRINK(3);
            next_instr += 1;
            DISPATCH();
        }
        ...
        TARGET(CALL_INTRINSIC_1) {
            ...
            #line 786 "Python/generated_cases.c.h"
            Py_DECREF(value);
        ...
        TARGET(GET_AITER) {
            ...
            iter = (*getter)(obj);
            #line 914 "Python/generated_cases.c.h"
            Py_DECREF(obj);
            ...
            #line 929 "Python/generated_cases.c.h"
        ...
        TARGET(GET_AWAITABLE) {
            ...
            #line 999 "Python/generated_cases.c.h"
            Py_DECREF(iterable);
        ...
        TARGET(SEND_GEN) {
            ...
            #line 1091 "Python/generated_cases.c.h"
        }
        ...
        TARGET(END_ASYNC_FOR) {
            ...
            #line 1158 "Python/generated_cases.c.h"
                Py_DECREF(awaitable);
                Py_DECREF(exc);
        ...
        TARGET(CLEANUP_THROW) {
            ...
            #line 1184 "Python/generated_cases.c.h"
                Py_DECREF(sub_iter);
            ...
            #line 1195 "Python/generated_cases.c.h"
            STACK_SHRINK(1);
            stack_pointer[-1] = value;
        ...
        TARGET(LOAD_ASSERTION_ERROR) {
            ...
            #line 1206 "Python/generated_cases.c.h"
            STACK_GROW(1);
            stack_pointer[-1] = value;
            DISPATCH();
        }
        ...
        TARGET(LOAD_BUILD_CLASS) {
            ...
            #line 1236 "Python/generated_cases.c.h"
            STACK_GROW(1);
            stack_pointer[-1] = bc;
            DISPATCH();
        }
        ...
        TARGET(DELETE_NAME) {
            ...
            #line 1303 "Python/generated_cases.c.h"
            DISPATCH();
        }
        ...
        TARGET(UNPACK_SEQUENCE) {
            ...
            #line 1329 "Python/generated_cases.c.h"
            STACK_SHRINK(1);
            STACK_GROW(oparg);
            next_instr += 1;
            DISPATCH();
        ...
        TARGET(UNPACK_SEQUENCE_LIST) {
            ...
            #line 1384 "Python/generated_cases.c.h"
            Py_DECREF(seq);
            STACK_SHRINK(1);
            STACK_GROW(oparg);
            next_instr += 1;
        ...
        TARGET(UNPACK_EX) {
            ...
            if (res == 0) goto pop_1_error;
            #line 1402 "Python/generated_cases.c.h"
        ...
        TARGET(STORE_ATTR) {
            ...
            #line 1430 "Python/generated_cases.c.h"
            Py_DECREF(v);
            Py_DECREF(owner);
        ...
        TARGET(DELETE_ATTR) {
            ...
            #line 1446 "Python/generated_cases.c.h"
            Py_DECREF(owner);
            #line 1034 "Python/bytecodes.c"
            if (err) goto pop_1_error;
            #line 1450 "Python/generated_cases.c.h"
            STACK_SHRINK(1);
            DISPATCH();
        }
        ...
        TARGET(DELETE_GLOBAL) {
            ...
            #line 1482 "Python/generated_cases.c.h"
            DISPATCH();
        }
        ...
        TARGET(LOAD_CLASS_OR_GLOBAL) {
            ...
            #line 1547 "Python/generated_cases.c.h"
            STACK_GROW(1);
            stack_pointer[-1] = v;
            DISPATCH();
        }
        ...
        TARGET(LOAD_GLOBAL) {
            ...
            null = NULL;
            #line 1678 "Python/generated_cases.c.h"
            STACK_GROW(1);
        ...
        TARGET(DELETE_FAST) {
            ...
            SETLOCAL(oparg, NULL);
            #line 1748 "Python/generated_cases.c.h"
            DISPATCH();
        }
        ...
        TARGET(MAKE_CELL) {
            ...
            SETLOCAL(oparg, cell);
            #line 1762 "Python/generated_cases.c.h"
            DISPATCH();
        }

        TARGET(DELETE_DEREF) {
            #line 1290 "Python/bytecodes.c"
            ...
            Py_DECREF(oldobj);
            #line 1778 "Python/generated_cases.c.h"
            DISPATCH();
        }
        ...
        TARGET(LIST_EXTEND) {
            ...
            #line 1924 "Python/generated_cases.c.h"
                Py_DECREF(iterable);
        ...
        TARGET(LOAD_ATTR) {
            ...
            #line 2183 "Python/generated_cases.c.h"
            STACK_GROW(((oparg & 1) ? 1 : 0));
            stack_pointer[-1] = res;
        ...
        TARGET(LOAD_ATTR_SLOT) {
            ...
            Py_INCREF(res);
            res2 = NULL;
            #line 2309 "Python/generated_cases.c.h"
            Py_DECREF(owner);
            STACK_GROW(((oparg & 1) ? 1 : 0));
            stack_pointer[-1] = res;
            if (oparg & 1) { stack_pointer[-(1 + ((oparg & 1) ? 1 : 0))] = res2; }
        ...
        TARGET(COMPARE_OP) {
            ...
            #line 2535 "Python/generated_cases.c.h"
            Py_DECREF(left);
            Py_DECREF(right);
        ...
        TARGET(CHECK_EG_MATCH) {
            ...
            #line 2689 "Python/generated_cases.c.h"
        ...
        TARGET(WITH_EXCEPT_START) {
            ...
            */
            ...
            if (res == NULL) goto error;
            #line 3273 "Python/generated_cases.c.h"
            STACK_GROW(1);
            stack_pointer[-1] = res;
            DISPATCH();
        }
        ...
        TARGET(CALL_NO_KW_STR_1) {
            ...
            if (res == NULL) { STACK_SHRINK(oparg); goto pop_2_error; }
            #line 3617 "Python/generated_cases.c.h"
            STACK_SHRINK(oparg);
            STACK_SHRINK(1);
            stack_pointer[-1] = res;
            next_instr += 3;
        ...
        TARGET(CALL_NO_KW_BUILTIN_O) {
            ...
            Py_DECREF(callable);
            if (res == NULL) { STACK_SHRINK(oparg); goto pop_2_error; }
            #line 3721 "Python/generated_cases.c.h"
            STACK_SHRINK(oparg);
            STACK_SHRINK(1);
            stack_pointer[-1] = res;
            next_instr += 3;
        ...
        TARGET(CALL_FUNCTION_EX) {
            ...
            #line 4132 "Python/generated_cases.c.h"
