...
// Do not edit!
        ...
        TARGET(CALL_NO_KW_METHOD_DESCRIPTOR_O) {
            ...
            Py_DECREF(callable);
            if (res == NULL) { STACK_SHRINK(oparg); goto pop_2_error; }
            #line 4458 "Python/generated_cases.c.h"
            STACK_SHRINK(oparg);
            STACK_SHRINK(1);
            stack_pointer[-1] = res;
            next_instr += 3;
        ...
        TARGET(CONVERT_VALUE) {
            ...
            #line 4790 "Python/generated_cases.c.h"
            stack_pointer[-1] = result;
            DISPATCH();
        }
        ...
        TARGET(SWAP) {
            ...
            assert(oparg >= 2);
            #line 4879 "Python/generated_cases.c.h"
        ...
        TARGET(INSTRUMENTED_INSTRUCTION) {
            ...
            opcode = next_opcode;
            DISPATCH_GOTO();
            #line 4898 "Python/generated_cases.c.h"
        }

        TARGET(INSTRUMENTED_JUMP_FORWARD) {
            #line 3530 "Python/bytecodes.c"
            INSTRUMENTED_JUMP(next_instr-1, next_instr+oparg, PY_MONITORING_EVENT_JUMP);
            #line 4904 "Python/generated_cases.c.h"
            DISPATCH();
        }
        ...
        TARGET(INSTRUMENTED_POP_JUMP_IF_NONE) {
            ...
            INSTRUMENTED_JUMP(here, next_instr + offset, PY_MONITORING_EVENT_BRANCH);
            #line 4957 "Python/generated_cases.c.h"
            DISPATCH();
        }
        ...
        TARGET(INSTRUMENTED_POP_JUMP_IF_NOT_NONE) {
            ...
            INSTRUMENTED_JUMP(here, next_instr + offset, PY_MONITORING_EVENT_BRANCH);
            #line 4974 "Python/generated_cases.c.h"
            DISPATCH();
        }

        TARGET(EXTENDED_ARG) {
            #line 3589 "Python/bytecodes.c"
            assert(oparg);
            opcode = next_instr->op.code;
            oparg = oparg << 8 | next_instr->op.arg;
            PRE_DISPATCH_GOTO();
            DISPATCH_GOTO();
            #line 4985 "Python/generated_cases.c.h"
        }
        ...
        TARGET(RESERVED) {
            ...
            Py_UNREACHABLE();
            #line 4999 "Python/generated_cases.c.h"
        }
