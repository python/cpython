...
// Do not edit!
        ...
        TARGET(FOR_ITER_RANGE) {
            ...
            #line 3562 "Python/generated_cases.c.h"
            STACK_GROW(1);
            stack_pointer[-1] = next;
            next_instr += 1;
            DISPATCH();
        ...
        TARGET(LOAD_ATTR_NONDESCRIPTOR_WITH_VALUES) {
            ...
            res = Py_NewRef(descr);
            #line 3811 "Python/generated_cases.c.h"
            STACK_GROW((0 ? 1 : 0));
            stack_pointer[-1] = res;
        ...
        TARGET(CALL_NO_KW_BUILTIN_O) {
            ...
            Py_DECREF(callable);
            if (res == NULL) { STACK_SHRINK(oparg); goto pop_2_error; }
            #line 4307 "Python/generated_cases.c.h"
            STACK_SHRINK(oparg);
            STACK_SHRINK(1);
            stack_pointer[-1] = res;
            next_instr += 3;
        ...
        TARGET(CALL_NO_KW_LEN) {
            ...
            Py_DECREF(arg);
            if (res == NULL) { STACK_SHRINK(oparg); goto pop_2_error; }
            #line 4438 "Python/generated_cases.c.h"
            STACK_SHRINK(oparg);
            STACK_SHRINK(1);
            stack_pointer[-1] = res;
            next_instr += 3;
        ...
        TARGET(CALL_NO_KW_ISINSTANCE) {
            ...
            Py_DECREF(callable);
            if (res == NULL) { STACK_SHRINK(oparg); goto pop_2_error; }
            #line 4478 "Python/generated_cases.c.h"
            STACK_SHRINK(oparg);
            STACK_SHRINK(1);
            stack_pointer[-1] = res;
            next_instr += 3;
        ...
        TARGET(INSTRUMENTED_CALL_FUNCTION_EX) {
            ...
            #line 4683 "Python/generated_cases.c.h"
        }
        ...
        TARGET(FORMAT_SIMPLE) {
            ...
            #line 4897 "Python/generated_cases.c.h"
            stack_pointer[-1] = res;
            DISPATCH();
        }
        ...
        TARGET(INSTRUMENTED_POP_JUMP_IF_TRUE) {
            ...
            #line 5011 "Python/generated_cases.c.h"
            DISPATCH();
        }
        ...
        TARGET(CACHE) {
            #line 3626 "Python/bytecodes.c"
            assert(0 && "Executing a cache.");
            Py_UNREACHABLE();
            #line 5074 "Python/generated_cases.c.h"
        }
        ...
        TARGET(RESERVED) {
            ...
            Py_UNREACHABLE();
            #line 5081 "Python/generated_cases.c.h"
        }
