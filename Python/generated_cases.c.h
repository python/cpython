...
// Do not edit!
        ...
        TARGET(BINARY_SUBSCR) {
            ...
            static_assert(INLINE_CACHE_ENTRIES_BINARY_SUBSCR == 2, "incorrect cache size");
        ...
        TARGET(BINARY_SUBSCR_GETITEM) {
            PyObject *sub = stack_pointer[-1];
            PyObject *container = stack_pointer[-2];
            uint16_t func_version = read_u16(&next_instr[1].cache);
        ...
        TARGET(STORE_SUBSCR_DICT) {
            ...
            Py_DECREF(dict);
            if (err) goto pop_3_error;
            #line 748 "Python/generated_cases.c.h"
            STACK_SHRINK(3);
            next_instr += 1;
            DISPATCH();
        }
        ...
        TARGET(DELETE_SUBSCR) {
            ...
            #line 760 "Python/generated_cases.c.h"
            Py_DECREF(container);
            Py_DECREF(sub);
            #line 484 "Python/bytecodes.c"
            if (err) goto pop_2_error;
            #line 765 "Python/generated_cases.c.h"
            STACK_SHRINK(2);
            DISPATCH();
        }
        ...
        TARGET(CALL_INTRINSIC_2) {
            ...
            #line 792 "Python/generated_cases.c.h"
            Py_DECREF(value2);
            Py_DECREF(value1);
            #line 498 "Python/bytecodes.c"
            if (res == NULL) goto pop_2_error;
            #line 797 "Python/generated_cases.c.h"
            STACK_SHRINK(1);
            stack_pointer[-1] = res;
            DISPATCH();
        }
        ...
        TARGET(GET_ANEXT) {
            ...
            #line 971 "Python/generated_cases.c.h"
            STACK_GROW(1);
        ...
        TARGET(YIELD_VALUE) {
            ...
            _PyFrame_StackPush(frame, retval);
            goto resume_frame;
            #line 1105 "Python/generated_cases.c.h"
        }
        ...
        TARGET(POP_EXCEPT) {
            ...
            #line 1113 "Python/generated_cases.c.h"
            STACK_SHRINK(1);
            DISPATCH();
        }
        ...
        TARGET(END_ASYNC_FOR) {
            ...
            #line 1148 "Python/generated_cases.c.h"
                Py_DECREF(awaitable);
                Py_DECREF(exc);
        ...
        TARGET(CLEANUP_THROW) {
            ...
            #line 1185 "Python/generated_cases.c.h"
            STACK_SHRINK(1);
            stack_pointer[-1] = value;
        ...
        TARGET(LOAD_ASSERTION_ERROR) {
            ...
            #line 1196 "Python/generated_cases.c.h"
            STACK_GROW(1);
            stack_pointer[-1] = value;
            DISPATCH();
        }
        ...
        TARGET(UNPACK_EX) {
            ...
            #line 1372 "Python/generated_cases.c.h"
            Py_DECREF(seq);
        ...
        TARGET(DELETE_ATTR) {
            ...
            #line 1420 "Python/generated_cases.c.h"
            Py_DECREF(owner);
        ...
        TARGET(STORE_DEREF) {
            ...
            PyCell_SET(cell, v);
            Py_XDECREF(oldobj);
            #line 1752 "Python/generated_cases.c.h"
            STACK_SHRINK(1);
            DISPATCH();
        }
        ...
        TARGET(BUILD_LIST) {
            ...
            #line 1810 "Python/generated_cases.c.h"
            STACK_SHRINK(oparg);
            STACK_GROW(1);
        ...
        TARGET(SET_UPDATE) {
            ...
            #line 1848 "Python/generated_cases.c.h"
            Py_DECREF(iterable);
        ...
        TARGET(LOAD_ATTR_GETATTRIBUTE_OVERRIDDEN) {
            ...
            JUMPBY(INLINE_CACHE_ENTRIES_LOAD_ATTR);
            DISPATCH_INLINED(new_frame);
            #line 2316 "Python/generated_cases.c.h"
        }
        ...
        TARGET(IMPORT_FROM) {
            ...
            #line 2650 "Python/generated_cases.c.h"
            STACK_GROW(1);
            stack_pointer[-1] = res;
            DISPATCH();
        }
