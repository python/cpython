...
// Do not edit!
        ...
        TARGET(LOAD_FAST__LOAD_CONST) {
            ...
            PyObject *_tmp_2;
            {
                ...
                assert(value != NULL);
                Py_INCREF(value);
                #line 182 "Python/generated_cases.c.h"
                _tmp_2 = value;
            }
        ...
        TARGET(LOAD_CONST__LOAD_FAST) {
            ...
            oparg = (next_instr++)->op.arg;
            {
                ...
                assert(value != NULL);
                Py_INCREF(value);
                #line 218 "Python/generated_cases.c.h"
                _tmp_1 = value;
            }
            STACK_GROW(2);
            stack_pointer[-1] = _tmp_1;
        ...
        TARGET(END_FOR) {
            ...
            }
            {
                ...
                #line 241 "Python/bytecodes.c"
                #line 258 "Python/generated_cases.c.h"
                Py_DECREF(value);
            }
            STACK_SHRINK(2);
            DISPATCH();
        ...
        TARGET(INSTRUMENTED_END_SEND) {
            ...
            Py_DECREF(receiver);
            #line 308 "Python/generated_cases.c.h"
            STACK_SHRINK(1);
            stack_pointer[-1] = value;
            DISPATCH();
        }
        ...
        TARGET(UNARY_NEGATIVE) {
            ...
            #line 319 "Python/generated_cases.c.h"
            Py_DECREF(value);
        ...
        TARGET(BINARY_OP_ADD_INT) {
            ...
            PyObject *_tmp_2 = stack_pointer[-2];
            {
                ...
                DEOPT_IF(!PyLong_CheckExact(left), BINARY_OP);
                DEOPT_IF(!PyLong_CheckExact(right), BINARY_OP);
                #line 403 "Python/generated_cases.c.h"
                _tmp_2 = left;
                _tmp_1 = right;
            }
            {
                ...
                _Py_DECREF_SPECIALIZED(left, (destructor)PyObject_Free);
                if (res == NULL) goto pop_2_error;
                #line 417 "Python/generated_cases.c.h"
                _tmp_2 = res;
            }
            next_instr += 1;
            STACK_SHRINK(1);
        ...
        TARGET(BINARY_OP_SUBTRACT_INT) {
            ...
            }
            {
                ...
                _Py_DECREF_SPECIALIZED(left, (destructor)PyObject_Free);
                if (res == NULL) goto pop_2_error;
                #line 449 "Python/generated_cases.c.h"
                _tmp_2 = res;
            }
            next_instr += 1;
            STACK_SHRINK(1);
        ...
        TARGET(BINARY_OP_MULTIPLY_FLOAT) {
            ...
            PyObject *_tmp_2 = stack_pointer[-2];
            {
                ...
                #line 467 "Python/generated_cases.c.h"
                _tmp_2 = left;
                _tmp_1 = right;
            }
            {
        ...
        TARGET(BINARY_OP_SUBTRACT_FLOAT) {
            ...
            PyObject *_tmp_2 = stack_pointer[-2];
            {
                ...
                DEOPT_IF(!PyFloat_CheckExact(left), BINARY_OP);
                DEOPT_IF(!PyFloat_CheckExact(right), BINARY_OP);
                #line 531 "Python/generated_cases.c.h"
                _tmp_2 = left;
                _tmp_1 = right;
            }
            {
        ...
        TARGET(BINARY_OP_ADD_UNICODE) {
            ...
            }
            {
                ...
                if (res == NULL) goto pop_2_error;
                #line 577 "Python/generated_cases.c.h"
                _tmp_2 = res;
            }
            next_instr += 1;
            STACK_SHRINK(1);
        ...
        TARGET(STORE_SUBSCR_DICT) {
            ...
            Py_DECREF(dict);
            if (err) goto pop_3_error;
            #line 913 "Python/generated_cases.c.h"
            STACK_SHRINK(3);
            next_instr += 1;
            DISPATCH();
        }
        ...
        TARGET(DELETE_SUBSCR) {
            ...
            #line 925 "Python/generated_cases.c.h"
            Py_DECREF(container);
            Py_DECREF(sub);
        ...
        TARGET(CALL_INTRINSIC_1) {
            ...
            #line 941 "Python/generated_cases.c.h"
            Py_DECREF(value);
        ...
        TARGET(CALL_INTRINSIC_2) {
            ...
            if (res == NULL) goto pop_2_error;
            #line 962 "Python/generated_cases.c.h"
            STACK_SHRINK(1);
            stack_pointer[-1] = res;
            DISPATCH();
        }
        ...
        TARGET(RAISE_VARARGS) {
            ...
            #line 988 "Python/generated_cases.c.h"
        }
        ...
        TARGET(RETURN_VALUE) {
            ...
            goto resume_frame;
            #line 1022 "Python/generated_cases.c.h"
        }
        ...
        TARGET(RETURN_CONST) {
            ...
            _PyFrame_StackPush(frame, retval);
            goto resume_frame;
            #line 1062 "Python/generated_cases.c.h"
        }
        ...
        TARGET(GET_AITER) {
            ...
            iter = (*getter)(obj);
            #line 1110 "Python/generated_cases.c.h"
            Py_DECREF(obj);
            ...
            #line 1125 "Python/generated_cases.c.h"
        ...
        TARGET(YIELD_VALUE) {
            ...
            _PyFrame_StackPush(frame, retval);
            goto resume_frame;
            #line 1344 "Python/generated_cases.c.h"
        }
        ...
        TARGET(POP_EXCEPT) {
            ...
            #line 1352 "Python/generated_cases.c.h"
            STACK_SHRINK(1);
            DISPATCH();
        }
        ...
        TARGET(CLEANUP_THROW) {
            ...
            #line 1413 "Python/generated_cases.c.h"
                Py_DECREF(sub_iter);
        ...
        TARGET(STORE_NAME) {
            ...
            if (err) goto pop_1_error;
            #line 1493 "Python/generated_cases.c.h"
            STACK_SHRINK(1);
            DISPATCH();
        }
        ...
        TARGET(DELETE_NAME) {
            ...
            #line 1516 "Python/generated_cases.c.h"
            DISPATCH();
        }
        ...
        TARGET(UNPACK_EX) {
            ...
            #line 1610 "Python/generated_cases.c.h"
            Py_DECREF(seq);
        ...
        TARGET(STORE_ATTR) {
            ...
            if (err) goto pop_2_error;
            #line 1646 "Python/generated_cases.c.h"
            STACK_SHRINK(2);
            next_instr += 4;
            DISPATCH();
        }
        ...
        TARGET(DELETE_GLOBAL) {
            ...
            #line 1693 "Python/generated_cases.c.h"
            DISPATCH();
        }
        ...
        TARGET(LOAD_LOCALS) {
            PyObject *_tmp_1;
            {
                ...
                Py_INCREF(locals);
                #line 1709 "Python/generated_cases.c.h"
                _tmp_1 = locals;
            }
            STACK_GROW(1);
            stack_pointer[-1] = _tmp_1;
        ...
        TARGET(LOAD_NAME) {
            PyObject *_tmp_1;
            {
                ...
                Py_INCREF(locals);
                #line 1729 "Python/generated_cases.c.h"
                _tmp_1 = locals;
            }
            {
                ...
                #line 1792 "Python/generated_cases.c.h"
                _tmp_1 = v;
            }
            STACK_GROW(1);
            stack_pointer[-1] = _tmp_1;
        ...
        TARGET(LOAD_GLOBAL) {
            ...
            null = NULL;
            #line 1926 "Python/generated_cases.c.h"
            STACK_GROW(1);
        ...
        TARGET(BUILD_TUPLE) {
            ...
            #line 2140 "Python/generated_cases.c.h"
            STACK_SHRINK(oparg);
            STACK_GROW(1);
            stack_pointer[-1] = tup;
            DISPATCH();
        ...
        TARGET(BUILD_LIST) {
            ...
            #line 2153 "Python/generated_cases.c.h"
            STACK_SHRINK(oparg);
            STACK_GROW(1);
        ...
        TARGET(BUILD_MAP) {
            ...
            #line 2242 "Python/generated_cases.c.h"
            ...
            if (oparg & 1) {
                ...
                if (_PyObject_GetMethod(owner, name, &meth)) {
                    ...
                    /* meth is not an unbound method (but a regular attr, or
                       ...
                       NULL | meth | arg1 | ... | argN
                    */
            #line 2559 "Python/generated_cases.c.h"
                    Py_DECREF(owner);
        ...
        TARGET(INSTRUMENTED_FOR_ITER) {
            ...
            #line 3463 "Python/generated_cases.c.h"
            DISPATCH();
        }
        ...
        TARGET(BEFORE_WITH) {
            ...
            #line 3659 "Python/generated_cases.c.h"
            STACK_GROW(1);
            stack_pointer[-1] = res;
            stack_pointer[-2] = exit;
            DISPATCH();
        ...
        TARGET(LOAD_ATTR_METHOD_WITH_VALUES) {
            ...
            res = self;
            assert(oparg & 1);
            #line 3742 "Python/generated_cases.c.h"
            STACK_GROW(((oparg & 1) ? 1 : 0));
            stack_pointer[-1] = res;
            if (oparg & 1) { stack_pointer[-(1 + ((oparg & 1) ? 1 : 0))] = res2; }
            next_instr += 9;
        ...
        TARGET(CALL_BUILTIN_CLASS) {
            ...
            Py_DECREF(tp);
            if (res == NULL) { STACK_SHRINK(oparg); goto pop_2_error; }
            #line 4121 "Python/generated_cases.c.h"
            STACK_SHRINK(oparg);
            STACK_SHRINK(1);
            stack_pointer[-1] = res;
            next_instr += 3;
        ...
        TARGET(CALL_NO_KW_METHOD_DESCRIPTOR_FAST) {
            ...
            Py_DECREF(callable);
            if (res == NULL) { STACK_SHRINK(oparg); goto pop_2_error; }
            #line 4527 "Python/generated_cases.c.h"
            STACK_SHRINK(oparg);
            STACK_SHRINK(1);
            stack_pointer[-1] = res;
            next_instr += 3;
        ...
        TARGET(INSTRUMENTED_JUMP_FORWARD) {
            ...
            #line 4832 "Python/generated_cases.c.h"
            DISPATCH();
        }
        ...
        TARGET(INSTRUMENTED_POP_JUMP_IF_NONE) {
            ...
            INSTRUMENTED_JUMP(here, next_instr + offset, PY_MONITORING_EVENT_BRANCH);
            #line 4885 "Python/generated_cases.c.h"
            DISPATCH();
        }
        ...
        TARGET(RESERVED) {
            ...
            Py_UNREACHABLE();
            #line 4927 "Python/generated_cases.c.h"
        }
