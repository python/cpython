...
// Do not edit!
        ...
        TARGET(IS_OP) {
            ...
            PyObject *left = stack_pointer[-2];
            PyObject *b;
            #line 1878 "Python/bytecodes.c"
            int res = Py_Is(left, right) ^ oparg;
            #line 2681 "Python/generated_cases.c.h"
            Py_DECREF(left);
            Py_DECREF(right);
        ...
        TARGET(CHECK_EG_MATCH) {
            ...
            int res = exception_group_match(exc_value, match_type,
                                            &match, &rest);
            #line 2728 "Python/generated_cases.c.h"
            Py_DECREF(exc_value);
            Py_DECREF(match_type);
        ...
        TARGET(CHECK_EXC_MATCH) {
            ...
            b = Py_NewRef(res ? Py_True : Py_False);
            #line 2764 "Python/generated_cases.c.h"
            stack_pointer[-1] = b;
            DISPATCH();
        }
        ...
        TARGET(JUMP_FORWARD) {
            ...
            JUMPBY(oparg);
            #line 2803 "Python/generated_cases.c.h"
            DISPATCH();
        }
        ...
        TARGET(POP_JUMP_IF_TRUE) {
            ...
            #line 2867 "Python/generated_cases.c.h"
            STACK_SHRINK(1);
            DISPATCH();
        }
        ...
        TARGET(POP_JUMP_IF_NOT_NONE) {
            ...
            if (!Py_IsNone(value)) {
            #line 2876 "Python/generated_cases.c.h"
                Py_DECREF(value);
        ...
        TARGET(GET_YIELD_FROM_ITER) {
            ...
            #line 3046 "Python/generated_cases.c.h"
            stack_pointer[-1] = iter;
            PREDICT(LOAD_CONST);
            DISPATCH();
        }
        ...
        TARGET(BEFORE_WITH) {
            ...
            #line 3308 "Python/generated_cases.c.h"
            Py_DECREF(mgr);
        ...
        TARGET(PUSH_EXC_INFO) {
            ...
            #line 3369 "Python/generated_cases.c.h"
            STACK_GROW(1);
        ...
        TARGET(CALL_BOUND_METHOD_EXACT_ARGS) {
            ...
            #line 3596 "Python/generated_cases.c.h"
        }
        ...
        TARGET(CALL_NO_KW_STR_1) {
            ...
            if (res == NULL) { STACK_SHRINK(oparg); goto pop_2_error; }
            #line 3711 "Python/generated_cases.c.h"
            STACK_SHRINK(oparg);
            STACK_SHRINK(1);
            stack_pointer[-1] = res;
            next_instr += 4;
        ...
        TARGET(CALL_NO_KW_BUILTIN_O) {
            ...
            Py_DECREF(callable);
            if (res == NULL) { STACK_SHRINK(oparg); goto pop_2_error; }
            #line 3814 "Python/generated_cases.c.h"
            STACK_SHRINK(oparg);
            STACK_SHRINK(1);
            stack_pointer[-1] = res;
            next_instr += 4;
        ...
        TARGET(CALL_BUILTIN_FAST_WITH_KEYWORDS) {
            ...
            Py_DECREF(callable);
            if (res == NULL) { STACK_SHRINK(oparg); goto pop_2_error; }
            #line 3906 "Python/generated_cases.c.h"
            STACK_SHRINK(oparg);
            STACK_SHRINK(1);
            stack_pointer[-1] = res;
            next_instr += 4;
        ...
        TARGET(CALL_NO_KW_LEN) {
            ...
            Py_DECREF(arg);
            if (res == NULL) { STACK_SHRINK(oparg); goto pop_2_error; }
            #line 3945 "Python/generated_cases.c.h"
            STACK_SHRINK(oparg);
            STACK_SHRINK(1);
            stack_pointer[-1] = res;
            next_instr += 4;
        ...
        TARGET(CALL_NO_KW_ISINSTANCE) {
            ...
            Py_DECREF(callable);
            if (res == NULL) { STACK_SHRINK(oparg); goto pop_2_error; }
            #line 3985 "Python/generated_cases.c.h"
            STACK_SHRINK(oparg);
            STACK_SHRINK(1);
            stack_pointer[-1] = res;
            next_instr += 4;
        ...
        TARGET(INSTRUMENTED_CALL_FUNCTION_EX) {
            ...
            #line 4190 "Python/generated_cases.c.h"
        }
        ...
        TARGET(SWAP) {
            ...
            assert(oparg >= 2);
            #line 4439 "Python/generated_cases.c.h"
        ...
        TARGET(CACHE) {
            ...
            Py_UNREACHABLE();
            #line 4575 "Python/generated_cases.c.h"
        }
