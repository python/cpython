...
// Do not edit!
        ...
        TARGET(STORE_FAST) {
            ...
            #line 127 "Python/bytecodes.c"
            SETLOCAL(oparg, value);
            #line 87 "Python/generated_cases.c.h"
            STACK_SHRINK(1);
            DISPATCH();
        }
        ...
        TARGET(LOAD_FAST__LOAD_FAST) {
            ...
            PyObject *_tmp_2;
            {
                ...
                assert(value != NULL);
                Py_INCREF(value);
                #line 101 "Python/generated_cases.c.h"
                _tmp_2 = value;
            }
            oparg = (next_instr++)->op.arg;
            {
                ...
                assert(value != NULL);
                Py_INCREF(value);
                #line 111 "Python/generated_cases.c.h"
                _tmp_1 = value;
            }
            STACK_GROW(2);
        ...
        TARGET(LOAD_FAST__LOAD_CONST) {
            ...
            PyObject *_tmp_2;
            {
                ...
                assert(value != NULL);
                Py_INCREF(value);
                #line 129 "Python/generated_cases.c.h"
                _tmp_2 = value;
            }
            oparg = (next_instr++)->op.arg;
            {
        ...
        TARGET(STORE_FAST__LOAD_FAST) {
            PyObject *_tmp_1 = stack_pointer[-1];
            {
                ...
                #line 127 "Python/bytecodes.c"
                SETLOCAL(oparg, value);
                #line 153 "Python/generated_cases.c.h"
            }
            oparg = (next_instr++)->op.arg;
            {
                PyObject *value;
        ...
        TARGET(STORE_FAST__STORE_FAST) {
            ...
            oparg = (next_instr++)->op.arg;
            {
                ...
                #line 127 "Python/bytecodes.c"
                SETLOCAL(oparg, value);
                #line 183 "Python/generated_cases.c.h"
            }
            STACK_SHRINK(2);
            DISPATCH();
        }
        ...
        TARGET(POP_TOP) {
            ...
            #line 219 "Python/generated_cases.c.h"
            Py_DECREF(value);
            STACK_SHRINK(1);
            DISPATCH();
        }
        ...
        TARGET(END_FOR) {
            ...
            PyObject *_tmp_2 = stack_pointer[-2];
            {
                PyObject *value = _tmp_1;
                #line 137 "Python/bytecodes.c"
                #line 241 "Python/generated_cases.c.h"
                Py_DECREF(value);
            }
            {
                PyObject *value = _tmp_2;
        ...
        TARGET(UNARY_NEGATIVE) {
            ...
            #line 259 "Python/generated_cases.c.h"
            Py_DECREF(value);
            #line 149 "Python/bytecodes.c"
            if (res == NULL) goto pop_1_error;
            #line 263 "Python/generated_cases.c.h"
            stack_pointer[-1] = res;
            DISPATCH();
        }
        ...
        TARGET(UNARY_NOT) {
            ...
            #line 273 "Python/generated_cases.c.h"
            Py_DECREF(value);
            #line 155 "Python/bytecodes.c"
        ...
        TARGET(UNARY_INVERT) {
            PyObject *value = stack_pointer[-1];
            PyObject *res;
            #line 166 "Python/bytecodes.c"
            res = PyNumber_Invert(value);
            #line 294 "Python/generated_cases.c.h"
            Py_DECREF(value);
        ...
        TARGET(BINARY_OP_SUBTRACT_INT) {
            ...
            #line 355 "Python/generated_cases.c.h"
            STACK_SHRINK(1);
            stack_pointer[-1] = sub;
            next_instr += 1;
            DISPATCH();
        ...
        TARGET(BINARY_OP_SUBTRACT_FLOAT) {
            ...
            #line 373 "Python/generated_cases.c.h"
            STACK_SHRINK(1);
            stack_pointer[-1] = sub;
            next_instr += 1;
            DISPATCH();
        ...
        TARGET(BINARY_OP_ADD_UNICODE) {
            ...
            #line 393 "Python/generated_cases.c.h"
            STACK_SHRINK(1);
            stack_pointer[-1] = res;
            next_instr += 1;
            DISPATCH();
        ...
        TARGET(BINARY_OP_ADD_INT) {
            ...
            #line 468 "Python/generated_cases.c.h"
            STACK_SHRINK(1);
            stack_pointer[-1] = sum;
            next_instr += 1;
            DISPATCH();
        ...
        TARGET(BINARY_SUBSCR) {
            ...
            #line 494 "Python/generated_cases.c.h"
            Py_DECREF(container);
            Py_DECREF(sub);
        ...
        TARGET(STORE_SLICE) {
            ...
            #line 548 "Python/generated_cases.c.h"
            STACK_SHRINK(4);
            DISPATCH();
        }
        ...
        TARGET(BINARY_SUBSCR_DICT) {
            ...
            #line 620 "Python/generated_cases.c.h"
                Py_DECREF(dict);
                Py_DECREF(sub);
            ...
            #line 627 "Python/generated_cases.c.h"
            Py_DECREF(dict);
            Py_DECREF(sub);
            STACK_SHRINK(1);
            stack_pointer[-1] = res;
        ...
        TARGET(BINARY_SUBSCR_GETITEM) {
            ...
            #line 660 "Python/generated_cases.c.h"
        }
        ...
        TARGET(LIST_APPEND) {
            ...
            #line 668 "Python/generated_cases.c.h"
            STACK_SHRINK(1);
        ...
        TARGET(SET_ADD) {
            ...
            #line 683 "Python/generated_cases.c.h"
            STACK_SHRINK(1);
            PREDICT(JUMP_BACKWARD);
            DISPATCH();
        }
        ...
        TARGET(STORE_SUBSCR) {
            ...
            #line 712 "Python/generated_cases.c.h"
            Py_DECREF(v);
            Py_DECREF(container);
            Py_DECREF(sub);
        ...
        TARGET(POP_EXCEPT) {
            ...
            #line 1128 "Python/generated_cases.c.h"
            STACK_SHRINK(1);
            DISPATCH();
        }
        ...
        TARGET(RERAISE) {
            ...
            #line 1156 "Python/generated_cases.c.h"
        }
        ...
        TARGET(CLEANUP_THROW) {
            ...
            #line 1193 "Python/generated_cases.c.h"
                Py_DECREF(sub_iter);
        ...
        TARGET(LOAD_ASSERTION_ERROR) {
            ...
            #line 1215 "Python/generated_cases.c.h"
            STACK_GROW(1);
            stack_pointer[-1] = value;
            DISPATCH();
        }
        ...
        TARGET(STORE_NAME) {
            ...
            #line 1269 "Python/generated_cases.c.h"
            Py_DECREF(v);
        ...
        TARGET(STORE_ATTR) {
            ...
            if (err) goto pop_2_error;
            #line 1428 "Python/generated_cases.c.h"
            STACK_SHRINK(2);
            next_instr += 4;
            DISPATCH();
        }
        ...
        TARGET(DELETE_ATTR) {
            ...
            if (err) goto pop_1_error;
            #line 1443 "Python/generated_cases.c.h"
            STACK_SHRINK(1);
            DISPATCH();
        }
        ...
        TARGET(LOAD_GLOBAL_BUILTIN) {
            ...
            STAT_INC(LOAD_GLOBAL, hit);
            null = NULL;
            #line 1660 "Python/generated_cases.c.h"
            STACK_GROW(1);
            STACK_GROW(((oparg & 1) ? 1 : 0));
            stack_pointer[-1] = res;
            if (oparg & 1) { stack_pointer[-(1 + ((oparg & 1) ? 1 : 0))] = null; }
        ...
        TARGET(DELETE_DEREF) {
            ...
            Py_DECREF(oldobj);
            #line 1704 "Python/generated_cases.c.h"
            DISPATCH();
        }
        ...
        TARGET(LOAD_DEREF) {
            ...
            Py_INCREF(value);
            #line 1758 "Python/generated_cases.c.h"
            STACK_GROW(1);
            stack_pointer[-1] = value;
            DISPATCH();
        }
        ...
        TARGET(BUILD_STRING) {
            ...
            #line 1797 "Python/generated_cases.c.h"
            for (int _i = oparg; --_i >= 0;) {
                Py_DECREF(pieces[_i]);
            }
            #line 1257 "Python/bytecodes.c"
            if (str == NULL) { STACK_SHRINK(oparg); goto error; }
            #line 1803 "Python/generated_cases.c.h"
            STACK_SHRINK(oparg);
            STACK_GROW(1);
            stack_pointer[-1] = str;
            DISPATCH();
        ...
        TARGET(BUILD_LIST) {
            ...
            #line 1829 "Python/generated_cases.c.h"
            STACK_SHRINK(oparg);
            STACK_GROW(1);
        ...
        TARGET(LIST_EXTEND) {
            ...
            #line 1850 "Python/generated_cases.c.h"
                Py_DECREF(iterable);
        ...
        TARGET(BUILD_MAP) {
            ...
            #line 1912 "Python/generated_cases.c.h"
        ...
        TARGET(LOAD_ATTR_CLASS) {
            ...
            assert(res != NULL);
            Py_INCREF(res);
            #line 2263 "Python/generated_cases.c.h"
            Py_DECREF(cls);
            STACK_GROW(((oparg & 1) ? 1 : 0));
            stack_pointer[-1] = res;
            if (oparg & 1) { stack_pointer[-(1 + ((oparg & 1) ? 1 : 0))] = res2; }
        ...
        TARGET(LOAD_ATTR_GETATTRIBUTE_OVERRIDDEN) {
            ...
            JUMPBY(INLINE_CACHE_ENTRIES_LOAD_ATTR);
            DISPATCH_INLINED(new_frame);
            #line 2335 "Python/generated_cases.c.h"
        }
        ...
        TARGET(COMPARE_OP) {
            ...
            #line 2449 "Python/generated_cases.c.h"
            Py_DECREF(left);
            Py_DECREF(right);
        ...
        TARGET(CONTAINS_OP) {
            ...
            #line 2599 "Python/generated_cases.c.h"
            Py_DECREF(left);
            Py_DECREF(right);
            #line 1812 "Python/bytecodes.c"
            if (res < 0) goto pop_2_error;
            b = Py_NewRef((res^oparg) ? Py_True : Py_False);
            #line 2605 "Python/generated_cases.c.h"
            STACK_SHRINK(1);
            stack_pointer[-1] = b;
            DISPATCH();
        }
        ...
        TARGET(IMPORT_FROM) {
            ...
            #line 2695 "Python/generated_cases.c.h"
            STACK_GROW(1);
            stack_pointer[-1] = res;
            DISPATCH();
        }
        ...
        TARGET(POP_JUMP_IF_FALSE) {
            ...
            if (Py_IsTrue(cond)) {
                ...
                int err = PyObject_IsTrue(cond);
            #line 2731 "Python/generated_cases.c.h"
                Py_DECREF(cond);
        ...
        TARGET(CALL_NO_KW_BUILTIN_FAST) {
            ...
            if (res == NULL) { STACK_SHRINK(oparg); goto pop_2_error; }
                /* Not deopting because this doesn't mean our optimization was
                   ...
                   handle it.
                */
            #line 3778 "Python/generated_cases.c.h"
            STACK_SHRINK(oparg);
            STACK_SHRINK(1);
            stack_pointer[-1] = res;
            next_instr += 4;
        ...
        TARGET(CACHE) {
            #line 3095 "Python/bytecodes.c"
            Py_UNREACHABLE();
            #line 4366 "Python/generated_cases.c.h"
        }
