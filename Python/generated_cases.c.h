...
// Do not edit!
        ...
        end_for_iter_tuple:
            // Common case: no jump, leave it to the code generator
            #line 3555 "Python/generated_cases.c.h"
            STACK_GROW(1);
            stack_pointer[-1] = next;
            next_instr += 1;
            DISPATCH();
        ...
        TARGET(LOAD_ATTR_METHOD_WITH_VALUES) {
            ...
            res = self;
            assert(oparg & 1);
            #line 3777 "Python/generated_cases.c.h"
            STACK_GROW(((oparg & 1) ? 1 : 0));
            stack_pointer[-1] = res;
            if (oparg & 1) { stack_pointer[-(1 + ((oparg & 1) ? 1 : 0))] = res2; }
            next_instr += 9;
        ...
        TARGET(CALL_PY_EXACT_ARGS) {
            ...
            frame->return_offset = 0;
            DISPATCH_INLINED(new_frame);
            #line 4009 "Python/generated_cases.c.h"
        }
        ...
        TARGET(CALL_NO_KW_BUILTIN_FAST) {
            ...
            if (res == NULL) { STACK_SHRINK(oparg); goto pop_2_error; }
                /* Not deopting because this doesn't mean our optimization was
                   ...
                   handle it.
                */
            #line 4244 "Python/generated_cases.c.h"
            STACK_SHRINK(oparg);
            STACK_SHRINK(1);
            stack_pointer[-1] = res;
            next_instr += 3;
        ...
        TARGET(INSTRUMENTED_POP_JUMP_IF_TRUE) {
            ...
            #line 4905 "Python/generated_cases.c.h"
            DISPATCH();
        }
        ...
        TARGET(RESERVED) {
            ...
            Py_UNREACHABLE();
            #line 4978 "Python/generated_cases.c.h"
        }
