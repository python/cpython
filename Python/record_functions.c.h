...
void _PyOpcode_RecordFunction_3OS(_PyInterpreterFrame *frame, _PyStackRef *stack_pointer, int oparg, PyObject **recorded_value) {
    _PyStackRef gen;
    gen = stack_pointer[-3];
    *recorded_value = (PyObject *)PyStackRef_AsPyObjectBorrow(gen);
    Py_INCREF(*recorded_value);
}
...
#define _RECORD_TOS_INDEX 1
#define _RECORD_NOS_INDEX 2
#define _RECORD_3OS_INDEX 3
#define _RECORD_TOS_TYPE_INDEX 4
...
const _PyOpcodeRecordEntry _PyOpcode_RecordEntries[256] = {
        [TO_BOOL_BOOL] = {1, {_RECORD_TOS_INDEX}},
        [TO_BOOL_NONE] = {1, {_RECORD_TOS_INDEX}},
        [LOAD_SUPER_ATTR_ATTR] = {1, {_RECORD_NOS_INDEX}},
        [TO_BOOL] = {1, {_RECORD_TOS_INDEX}},
        [TO_BOOL_INT] = {1, {_RECORD_TOS_INDEX}},
        [TO_BOOL_LIST] = {1, {_RECORD_TOS_INDEX}},
        [TO_BOOL_STR] = {1, {_RECORD_TOS_INDEX}},
        [TO_BOOL_ALWAYS_TRUE] = {1, {_RECORD_TOS_INDEX}},
        [BINARY_OP_MULTIPLY_INT] = {2, {_RECORD_TOS_INDEX, _RECORD_NOS_INDEX}},
        [BINARY_OP_ADD_INT] = {2, {_RECORD_TOS_INDEX, _RECORD_NOS_INDEX}},
        [BINARY_OP_SUBTRACT_INT] = {2, {_RECORD_TOS_INDEX, _RECORD_NOS_INDEX}},
        [BINARY_OP_MULTIPLY_FLOAT] = {2, {_RECORD_TOS_INDEX, _RECORD_NOS_INDEX}},
        [BINARY_OP_ADD_FLOAT] = {2, {_RECORD_TOS_INDEX, _RECORD_NOS_INDEX}},
        [BINARY_OP_SUBTRACT_FLOAT] = {2, {_RECORD_TOS_INDEX, _RECORD_NOS_INDEX}},
        [BINARY_OP_ADD_UNICODE] = {2, {_RECORD_TOS_INDEX, _RECORD_NOS_INDEX}},
        [BINARY_OP_EXTEND] = {2, {_RECORD_TOS_INDEX, _RECORD_NOS_INDEX}},
        [BINARY_OP_INPLACE_ADD_UNICODE] = {2, {_RECORD_TOS_INDEX, _RECORD_NOS_INDEX}},
        [BINARY_OP_SUBSCR_LIST_INT] = {2, {_RECORD_TOS_INDEX, _RECORD_NOS_INDEX}},
        [BINARY_OP_SUBSCR_LIST_SLICE] = {2, {_RECORD_TOS_INDEX, _RECORD_NOS_INDEX}},
        [BINARY_OP_SUBSCR_STR_INT] = {2, {_RECORD_TOS_INDEX, _RECORD_NOS_INDEX}},
        [BINARY_OP_SUBSCR_USTR_INT] = {2, {_RECORD_TOS_INDEX, _RECORD_NOS_INDEX}},
        [BINARY_OP_SUBSCR_TUPLE_INT] = {2, {_RECORD_TOS_INDEX, _RECORD_NOS_INDEX}},
        [BINARY_OP_SUBSCR_DICT] = {2, {_RECORD_TOS_INDEX, _RECORD_NOS_INDEX}},
        [BINARY_OP_SUBSCR_GETITEM] = {2, {_RECORD_TOS_INDEX, _RECORD_NOS_INDEX}},
        [SEND] = {1, {_RECORD_3OS_INDEX}},
        [SEND_GEN] = {1, {_RECORD_3OS_INDEX}},
        [STORE_ATTR] = {1, {_RECORD_TOS_INDEX}},
        ...
        [STORE_ATTR_INSTANCE_VALUE] = {1, {_RECORD_TOS_INDEX}},
        [STORE_ATTR_WITH_HINT] = {1, {_RECORD_TOS_INDEX}},
        [STORE_ATTR_SLOT] = {1, {_RECORD_TOS_INDEX}},
        [GET_ITER] = {1, {_RECORD_TOS_INDEX}},
        [GET_ITER_SELF] = {1, {_RECORD_TOS_INDEX}},
        [GET_ITER_VIRTUAL] = {1, {_RECORD_TOS_INDEX}},
...
const uint8_t _PyOpcode_RecordIsFamilyOverride[256] = {
        [TO_BOOL_BOOL] = 1,
        [TO_BOOL_NONE] = 1,
...
const _Py_RecordFuncPtr _PyOpcode_RecordFunctions[8] = {
        ...
        [_RECORD_3OS_INDEX] = _PyOpcode_RecordFunction_3OS,
