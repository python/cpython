...
const _PyOpcodeRecordSlotMap _PyOpcode_RecordSlotMaps[256] = {
        [TO_BOOL] = {1, 0, {0}},
        [TO_BOOL_ALWAYS_TRUE] = {1, 1, {0}},
        [BINARY_OP_SUBSCR_GETITEM] = {1, 0, {1}},
        [SEND] = {1, 0, {0}},
        [SEND_GEN] = {1, 1, {0}},
        [STORE_ATTR] = {1, 0, {0}},
        ...
        [LOAD_ATTR_CLASS_WITH_METACLASS_CHECK] = {1, 1, {0}},
        [LOAD_ATTR_PROPERTY] = {1, 1, {0}},
        [LOAD_ATTR_GETATTRIBUTE_OVERRIDDEN] = {1, 1, {0}},
        [STORE_ATTR_INSTANCE_VALUE] = {1, 1, {0}},
        [STORE_ATTR_WITH_HINT] = {1, 1, {0}},
        [STORE_ATTR_SLOT] = {1, 1, {0}},
        [GET_ITER] = {1, 0, {0}},
        [GET_ITER_SELF] = {1, 0, {0}},
