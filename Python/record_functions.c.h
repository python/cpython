...
const _PyOpcodeRecordEntry _PyOpcode_RecordEntries[256] = {
        ...
        [BINARY_OP_ADD_INT_WIDE] = {2, {_RECORD_NOS_INDEX, _RECORD_TOS_TYPE_INDEX}},
        [BINARY_OP_SUBTRACT_INT_WIDE] = {2, {_RECORD_NOS_INDEX, _RECORD_TOS_TYPE_INDEX}},
        [BINARY_OP_MULTIPLY_INT_WIDE] = {2, {_RECORD_NOS_INDEX, _RECORD_TOS_TYPE_INDEX}},
