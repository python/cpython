...
#define BASE_OPTS L"bBc:dEhiIJm:Oo:qRsStuvVW:xX:?"
    ...
    while ((c = _PyOS_GetOpt(argc, argv, PROGRAM_OPTS)) != EOF) {
        ...
        case 'o':
            if (wcslen(_PyOS_optarg) == 0
               ...
               || wcschr(_PyOS_optarg, SEP)
#ifdef ALTSEP
               || wcschr(_PyOS_optarg, ALTSEP)
#endif
               )
                Py_FatalError("invalid optimization tag");
            _Py_OptimTag = PyUnicode_FromWideChar(_PyOS_optarg, -1);
            break;
