...
_testinternalcapi_benchmark_locks(PyObject *module, PyObject *const *args, Py_ssize_t nargs)
{
    ...
    if (!_PyArg_CheckPositional("benchmark_locks", nargs, 1, 7)) {
        goto exit;
    }
    {
        Py_ssize_t ival = -1;
...
skip_optional:
    return_value = _testinternalcapi_benchmark_locks_impl(module, num_threads, work_inside, work_outside, time_ms, num_acquisitions, total_iters, num_locks);

exit:
    return return_value;
}
/*[clinic end generated code: output=cc7840dc567f6454 input=a9049054013a1b77]*/
