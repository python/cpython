...
unicodedata__iter_graphemes_impl(PyObject *module, PyObject *unistr,
                                 Py_ssize_t start, Py_ssize_t end)
/*[clinic end generated code: output=97db4b44168e30b6 input=64e8d7668792b74f]*/
{
...
/*[clinic input]
unicodedata._grapheme_cluster_break
...
/*[clinic end generated code: output=661ee2816108d719 input=cecf579cb9ed7b4a]*/
{
    Py_UCS4 c = (Py_UCS4)chr;
...
/*[clinic input]
unicodedata._indic_conjunct_break
...
/*[clinic end generated code: output=0bb7fb6c482f251b input=02222c64c2f4500f]*/
{
    Py_UCS4 c = (Py_UCS4)chr;
...
/*[clinic input]
unicodedata._extended_pictographic
...
/*[clinic end generated code: output=bcb5172f29a93f09 input=c67f1e3465f1b95a]*/
{
    Py_UCS4 c = (Py_UCS4)chr;
...
static PyMethodDef unicodedata_functions[] = {
    ...
    UNICODEDATA__GRAPHEME_CLUSTER_BREAK_METHODDEF
    UNICODEDATA__INDIC_CONJUNCT_BREAK_METHODDEF
    UNICODEDATA__EXTENDED_PICTOGRAPHIC_METHODDEF
    UNICODEDATA__ITER_GRAPHEMES_METHODDEF
