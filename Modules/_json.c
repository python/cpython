...
_json_scanstring_impl(PyObject *module, PyObject *pystr, Py_ssize_t end,
                      int strict)
/*[clinic end generated code: output=9f20d620966f1454 input=0afa14325d15360e]*/
{
    PyObject *rval;
...
static PyObject *
_json_encode_basestring(PyObject *module, PyObject *pystr)
/*[clinic end generated code: output=6178d2f18cdb540e input=222eb0810dbbd3a3]*/
{
    if (PyUnicode_Check(pystr)) {
...
encoder_new(PyTypeObject *type, PyObject *args, PyObject *kwds)
{
    ...
    if (PyCFunction_Check(s->encoder)) {
        ...
        else if (f == _json_encode_basestring) {
...
static PyMethodDef speedups_methods[] = {
    ...
    _JSON_ENCODE_BASESTRING_METHODDEF
    _JSON_SCANSTRING_METHODDEF
    {NULL, NULL, 0, NULL}
};
