...
/*[clinic end generated code: output=594757375714cda1 input=8d7fe470ff77f029]*/
{
    ...
    if (PyType_Check(self)) {
        ...
        PyObject *flags = PyDict_GetItemWithError(cls->tp_dict, _Py_ID(__abc_tpflags__));
        if (flags == NULL) {
            if (PyErr_Occurred()) {
                return NULL;
            }
...
/*[clinic end generated code: output=b8b5148f63b6b56f input=a4f4525679261084]*/
{
    ...
    if (subtype == subclass) {
        ...
        result = _PyObject_CallMethodOneArg(self, _Py_ID(__subclasscheck__),
                                              subclass);
        goto end;
    }
    result = _PyObject_CallMethodOneArg(self, _Py_ID(__subclasscheck__),
...
/*[clinic end generated code: output=b56c9e4a530e3894 input=1d947243409d10b8]*/
{
    ...
    ok = _PyObject_CallMethodOneArg((PyObject *)self, _Py_ID(__subclasshook__),
                                      subclass);
    if (ok == NULL) {
        goto end;
    }
