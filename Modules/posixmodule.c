...
posixmodule_exec(PyObject *m)
{
    ...
    if (PyModule_AddObjectRef(m, "waitid_result", WaitidResultType) < 0) {
        return -1;
    }
    ...
    if (PyModule_AddObjectRef(m, "stat_result", StatResultType) < 0) {
        return -1;
    }
    ...
    if (PyModule_AddObjectRef(m, "statvfs_result", StatVFSResultType) < 0) {
        return -1;
    }
    ...
    if (PyModule_AddObjectRef(m, "sched_param", SchedParamType) < 0) {
        return -1;
    }
    PyModule_AddObjectRef(m, "sched_param", SchedParamType);
    ...
    if (PyModule_AddObjectRef(m, "terminal_size", TerminalSizeType) < 0) {
        return -1;
    }
    ...
    if (PyModule_AddObjectRef(m, "DirEntry", DirEntryType) < 0) {
        return -1;
    }
    ...
    if (PyModule_AddObjectRef(m, "times_result", TimesResultType) < 0) {
        return -1;
    }
    state->TimesResultType = TimesResultType;

    PyTypeObject *UnameResultType = PyStructSequence_NewType(&uname_result_desc);
    if (PyModule_AddObjectRef(m, "uname_result", (PyObject *)UnameResultType) < 0) {
        return -1;
    }
