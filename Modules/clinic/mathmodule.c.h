...
math_dist(PyObject *module, PyObject *const *args, Py_ssize_t nargs)
{
    ...
    if (!PyTuple_Check(args[0])) {
        _PyArg_BadArgument("dist", "argument 1", "tuple", args[0]);
        goto exit;
    }
    p = args[0];
    if (!PyTuple_Check(args[1])) {
        _PyArg_BadArgument("dist", "argument 2", "tuple", args[1]);
        goto exit;
    }
    q = args[1];
...
/*[clinic end generated code: output=cc9982813b53328c input=a9049054013a1b77]*/
