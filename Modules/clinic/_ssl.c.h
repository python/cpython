...
_ssl__SSLSocket_get_channel_binding(PySSLSocket *self, PyObject *const *args, Py_ssize_t nargs, PyObject *kwnames)
{
    ...
    cb_type = PyUnicode_AsUTF8NoNUL(args[0]);
    if (cb_type == NULL) {
        goto exit;
    }
skip_optional_pos:
...
_ssl__SSLContext_set_ciphers(PySSLContext *self, PyObject *arg)
{
    ...
    cipherlist = PyUnicode_AsUTF8NoNUL(arg);
    if (cipherlist == NULL) {
        goto exit;
    }
...
_ssl_txt2obj(PyObject *module, PyObject *const *args, Py_ssize_t nargs, PyObject *kwnames)
{
    ...
    txt = PyUnicode_AsUTF8NoNUL(args[0]);
    if (txt == NULL) {
        goto exit;
    }
    if (!noptargs) {
...
_ssl_enum_certificates(PyObject *module, PyObject *const *args, Py_ssize_t nargs, PyObject *kwnames)
{
    ...
    store_name = PyUnicode_AsUTF8NoNUL(args[0]);
    if (store_name == NULL) {
        goto exit;
    }
...
/*[clinic end generated code: output=6306e45271b952d8 input=a9049054013a1b77]*/
