...
{
    return _ssl__SSLSocket_get_ech_status_impl((PySSLSocket *)self);
}
...
{
    return _ssl__SSLSocket_get_ech_retry_config_impl((PySSLSocket *)self);
}
...
/*[clinic end generated code: output=3b0e3cecf19da202 input=a9049054013a1b77]*/
