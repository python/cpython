...
_bisect_bisect_right(PyObject *module, PyObject *const *args, Py_ssize_t nargs, PyObject *kwnames)
{
    ...
    static struct {
        ...
        .ob_item = { _Py_LATIN1_CHAR_STRING('a'), _Py_LATIN1_CHAR_STRING('x'), &_Py_ID(lo), &_Py_ID(hi), &_Py_ID(key), },
    };
    #undef NUM_KEYWORDS
...
/*[clinic end generated code: output=79cb5f989511e190 input=a9049054013a1b77]*/
