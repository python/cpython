...
_pickle_Unpickler___init__(PyObject *self, PyObject *args, PyObject *kwargs)
{
    ...
    if (fastargs[3]) {
        ...
        errors = PyUnicode_AsUTF8NoNUL(fastargs[3]);
        if (errors == NULL) {
            goto exit;
        }
        if (!--noptargs) {
...
_pickle_load(PyObject *module, PyObject *const *args, Py_ssize_t nargs, PyObject *kwnames)
{
    ...
    if (args[2]) {
        ...
        encoding = PyUnicode_AsUTF8NoNUL(args[2]);
        if (encoding == NULL) {
            goto exit;
        }
        if (!--noptargs) {
    ...
    if (args[3]) {
        ...
        errors = PyUnicode_AsUTF8NoNUL(args[3]);
        if (errors == NULL) {
            goto exit;
        }
        if (!--noptargs) {
...
/*[clinic end generated code: output=26ef80b97b8f511a input=a9049054013a1b77]*/
