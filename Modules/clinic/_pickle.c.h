...
_pickle_dump(PyObject *module, PyObject *const *args, Py_ssize_t nargs, PyObject *kwnames)
{
    ...
    if (kwnames || 2 > nargs || nargs > 3 || !args) {
        PyObject *argsbuf[5];
...
/*[clinic end generated code: output=a6a2d465e969ca7f input=a9049054013a1b77]*/
