...
"_pystart_callback($self, code, obj, /)\n"
"--\n"
"\n");
...
_lsprof_Profiler__pystart_callback(ProfilerObject *self, PyObject *const *args, Py_ssize_t nargs)
{
    ...
    code = args[0];
    obj = args[1];
    return_value = _lsprof_Profiler__pystart_callback_impl(self, code, obj);
...
"_pyreturn_callback($self, code, obj, retval, /)\n"
"--\n"
"\n");
...
_lsprof_Profiler__pyreturn_callback(ProfilerObject *self, PyObject *const *args, Py_ssize_t nargs)
{
    ...
    obj = args[1];
    retval = args[2];
    return_value = _lsprof_Profiler__pyreturn_callback_impl(self, code, obj, retval);
...
_lsprof_Profiler__ccall_callback(ProfilerObject *self, PyObject *const *args, Py_ssize_t nargs)
{
    ...
    callable = args[2];
    self_arg = args[3];
    return_value = _lsprof_Profiler__ccall_callback_impl(self, code, obj, callable, self_arg);
...
"_creturn_callback($self, code, obj, callable, self_arg, /)\n"
"--\n"
"\n");
...
_lsprof_Profiler__creturn_callback(ProfilerObject *self, PyObject *const *args, Py_ssize_t nargs)
{
    ...
    callable = args[2];
    self_arg = args[3];
    return_value = _lsprof_Profiler__creturn_callback_impl(self, code, obj, callable, self_arg);
...
/*[clinic end generated code: output=787298ede73ff273 input=a9049054013a1b77]*/
