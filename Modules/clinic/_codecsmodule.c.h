...
_codecs_lookup(PyObject *module, PyObject *arg)
{
    ...
    if (!PyUnicode_Check(arg)) {
        _PyArg_BadArgument("lookup", 0, "argument", "str", arg);
        goto exit;
    }
...
_codecs_encode(PyObject *module, PyObject *const *args, Py_ssize_t nargs, PyObject *kwnames)
{
    ...
    if (args[1]) {
        if (!PyUnicode_Check(args[1])) {
            _PyArg_BadArgument("encode", 2, "argument 'encoding'", "str", args[1]);
            goto exit;
        }
        Py_ssize_t encoding_length;
    ...
    if (!PyUnicode_Check(args[2])) {
        _PyArg_BadArgument("encode", 3, "argument 'errors'", "str", args[2]);
        goto exit;
    }
...
_codecs_decode(PyObject *module, PyObject *const *args, Py_ssize_t nargs, PyObject *kwnames)
{
    ...
    if (args[1]) {
        if (!PyUnicode_Check(args[1])) {
            _PyArg_BadArgument("decode", 2, "argument 'encoding'", "str", args[1]);
            goto exit;
        }
        Py_ssize_t encoding_length;
        encoding = PyUnicode_AsUTF8AndSize(args[1], &encoding_length);
    ...
    if (!PyUnicode_Check(args[2])) {
        _PyArg_BadArgument("decode", 3, "argument 'errors'", "str", args[2]);
        goto exit;
    }
    Py_ssize_t errors_length;
    errors = PyUnicode_AsUTF8AndSize(args[2], &errors_length);
...
_codecs__forget_codec(PyObject *module, PyObject *arg)
{
    ...
    if (!PyUnicode_Check(arg)) {
        _PyArg_BadArgument("_forget_codec", 0, "argument", "str", arg);
        goto exit;
    }
    Py_ssize_t encoding_length;
    encoding = PyUnicode_AsUTF8AndSize(arg, &encoding_length);
...
_codecs_escape_decode(PyObject *module, PyObject *const *args, Py_ssize_t nargs)
{
    ...
    if (PyUnicode_Check(args[0])) {
        ...
        if (!PyBuffer_IsContiguous(&data, 'C')) {
            _PyArg_BadArgument("escape_decode", 1, "argument 1", "contiguous buffer", args[0]);
            goto exit;
        }
    }
    if (nargs < 2) {
    ...
    if (args[1] == Py_None) {
        ...
        _PyArg_BadArgument("escape_decode", 2, "argument 2", "str or None", args[1]);
        goto exit;
    }
skip_optional:
...
_codecs_escape_encode(PyObject *module, PyObject *const *args, Py_ssize_t nargs)
{
    ...
    if (!PyBytes_Check(args[0])) {
        _PyArg_BadArgument("escape_encode", 1, "argument 1", "bytes", args[0]);
        goto exit;
    }
    data = args[0];
    if (nargs < 2) {
    ...
    if (args[1] == Py_None) {
        ...
        _PyArg_BadArgument("escape_encode", 2, "argument 2", "str or None", args[1]);
        goto exit;
    }
skip_optional:
...
_codecs_utf_7_decode(PyObject *module, PyObject *const *args, Py_ssize_t nargs)
{
    ...
    if (!PyBuffer_IsContiguous(&data, 'C')) {
        _PyArg_BadArgument("utf_7_decode", 1, "argument 1", "contiguous buffer", args[0]);
        goto exit;
    }
    if (nargs < 2) {
        goto skip_optional;
    ...
    if (args[1] == Py_None) {
        ...
        _PyArg_BadArgument("utf_7_decode", 2, "argument 2", "str or None", args[1]);
        goto exit;
    }
    if (nargs < 3) {
        goto skip_optional;
...
_codecs_utf_8_decode(PyObject *module, PyObject *const *args, Py_ssize_t nargs)
{
    ...
    if (!PyBuffer_IsContiguous(&data, 'C')) {
        _PyArg_BadArgument("utf_8_decode", 1, "argument 1", "contiguous buffer", args[0]);
        goto exit;
    }
    if (nargs < 2) {
        goto skip_optional;
    ...
    if (args[1] == Py_None) {
        ...
        _PyArg_BadArgument("utf_8_decode", 2, "argument 2", "str or None", args[1]);
        goto exit;
    }
    if (nargs < 3) {
        goto skip_optional;
...
_codecs_utf_16_decode(PyObject *module, PyObject *const *args, Py_ssize_t nargs)
{
    ...
    if (!PyBuffer_IsContiguous(&data, 'C')) {
        _PyArg_BadArgument("utf_16_decode", 1, "argument 1", "contiguous buffer", args[0]);
        goto exit;
    }
    if (nargs < 2) {
        goto skip_optional;
    ...
    if (args[1] == Py_None) {
        ...
        _PyArg_BadArgument("utf_16_decode", 2, "argument 2", "str or None", args[1]);
        goto exit;
    }
    if (nargs < 3) {
        goto skip_optional;
...
_codecs_utf_16_le_decode(PyObject *module, PyObject *const *args, Py_ssize_t nargs)
{
    ...
    if (!PyBuffer_IsContiguous(&data, 'C')) {
        _PyArg_BadArgument("utf_16_le_decode", 1, "argument 1", "contiguous buffer", args[0]);
        goto exit;
    }
    if (nargs < 2) {
        goto skip_optional;
    ...
    if (args[1] == Py_None) {
        ...
        _PyArg_BadArgument("utf_16_le_decode", 2, "argument 2", "str or None", args[1]);
        goto exit;
    }
    if (nargs < 3) {
        goto skip_optional;
...
_codecs_utf_16_be_decode(PyObject *module, PyObject *const *args, Py_ssize_t nargs)
{
    ...
    if (!PyBuffer_IsContiguous(&data, 'C')) {
        _PyArg_BadArgument("utf_16_be_decode", 1, "argument 1", "contiguous buffer", args[0]);
        goto exit;
    }
    if (nargs < 2) {
        goto skip_optional;
    ...
    if (args[1] == Py_None) {
        ...
        _PyArg_BadArgument("utf_16_be_decode", 2, "argument 2", "str or None", args[1]);
        goto exit;
    }
    if (nargs < 3) {
        goto skip_optional;
...
_codecs_utf_16_ex_decode(PyObject *module, PyObject *const *args, Py_ssize_t nargs)
{
    ...
    if (!PyBuffer_IsContiguous(&data, 'C')) {
        _PyArg_BadArgument("utf_16_ex_decode", 1, "argument 1", "contiguous buffer", args[0]);
        goto exit;
    }
    if (nargs < 2) {
        goto skip_optional;
    ...
    if (args[1] == Py_None) {
        ...
        _PyArg_BadArgument("utf_16_ex_decode", 2, "argument 2", "str or None", args[1]);
        goto exit;
    }
    if (nargs < 3) {
        goto skip_optional;
...
_codecs_utf_32_decode(PyObject *module, PyObject *const *args, Py_ssize_t nargs)
{
    ...
    if (!PyBuffer_IsContiguous(&data, 'C')) {
        _PyArg_BadArgument("utf_32_decode", 1, "argument 1", "contiguous buffer", args[0]);
        goto exit;
    }
    if (nargs < 2) {
        goto skip_optional;
    ...
    if (args[1] == Py_None) {
        ...
        _PyArg_BadArgument("utf_32_decode", 2, "argument 2", "str or None", args[1]);
        goto exit;
    }
    if (nargs < 3) {
        goto skip_optional;
...
_codecs_utf_32_le_decode(PyObject *module, PyObject *const *args, Py_ssize_t nargs)
{
    ...
    if (!PyBuffer_IsContiguous(&data, 'C')) {
        _PyArg_BadArgument("utf_32_le_decode", 1, "argument 1", "contiguous buffer", args[0]);
        goto exit;
    }
    if (nargs < 2) {
        goto skip_optional;
    ...
    if (args[1] == Py_None) {
        ...
        _PyArg_BadArgument("utf_32_le_decode", 2, "argument 2", "str or None", args[1]);
        goto exit;
    }
    if (nargs < 3) {
        goto skip_optional;
...
_codecs_utf_32_be_decode(PyObject *module, PyObject *const *args, Py_ssize_t nargs)
{
    ...
    if (!PyBuffer_IsContiguous(&data, 'C')) {
        _PyArg_BadArgument("utf_32_be_decode", 1, "argument 1", "contiguous buffer", args[0]);
        goto exit;
    }
    if (nargs < 2) {
        goto skip_optional;
    ...
    if (args[1] == Py_None) {
        ...
        _PyArg_BadArgument("utf_32_be_decode", 2, "argument 2", "str or None", args[1]);
        goto exit;
    }
    if (nargs < 3) {
        goto skip_optional;
...
_codecs_utf_32_ex_decode(PyObject *module, PyObject *const *args, Py_ssize_t nargs)
{
    ...
    if (!PyBuffer_IsContiguous(&data, 'C')) {
        _PyArg_BadArgument("utf_32_ex_decode", 1, "argument 1", "contiguous buffer", args[0]);
        goto exit;
    }
    if (nargs < 2) {
        goto skip_optional;
    ...
    if (args[1] == Py_None) {
        ...
        _PyArg_BadArgument("utf_32_ex_decode", 2, "argument 2", "str or None", args[1]);
        goto exit;
    }
    if (nargs < 3) {
        goto skip_optional;
...
_codecs_unicode_escape_decode(PyObject *module, PyObject *const *args, Py_ssize_t nargs)
{
    ...
    if (PyUnicode_Check(args[0])) {
        ...
        if (!PyBuffer_IsContiguous(&data, 'C')) {
            _PyArg_BadArgument("unicode_escape_decode", 1, "argument 1", "contiguous buffer", args[0]);
            goto exit;
        }
    }
    if (nargs < 2) {
    ...
    if (args[1] == Py_None) {
        ...
        _PyArg_BadArgument("unicode_escape_decode", 2, "argument 2", "str or None", args[1]);
        goto exit;
    }
skip_optional:
...
_codecs_raw_unicode_escape_decode(PyObject *module, PyObject *const *args, Py_ssize_t nargs)
{
    ...
    if (PyUnicode_Check(args[0])) {
        ...
        if (!PyBuffer_IsContiguous(&data, 'C')) {
            _PyArg_BadArgument("raw_unicode_escape_decode", 1, "argument 1", "contiguous buffer", args[0]);
            goto exit;
        }
    }
    if (nargs < 2) {
    ...
    if (args[1] == Py_None) {
        ...
        _PyArg_BadArgument("raw_unicode_escape_decode", 2, "argument 2", "str or None", args[1]);
        goto exit;
    }
skip_optional:
...
_codecs_latin_1_decode(PyObject *module, PyObject *const *args, Py_ssize_t nargs)
{
    ...
    if (!PyBuffer_IsContiguous(&data, 'C')) {
        _PyArg_BadArgument("latin_1_decode", 1, "argument 1", "contiguous buffer", args[0]);
        goto exit;
    }
    if (nargs < 2) {
        goto skip_optional;
    ...
    if (args[1] == Py_None) {
        ...
        _PyArg_BadArgument("latin_1_decode", 2, "argument 2", "str or None", args[1]);
        goto exit;
    }
skip_optional:
...
_codecs_ascii_decode(PyObject *module, PyObject *const *args, Py_ssize_t nargs)
{
    ...
    if (!PyBuffer_IsContiguous(&data, 'C')) {
        _PyArg_BadArgument("ascii_decode", 1, "argument 1", "contiguous buffer", args[0]);
        goto exit;
    }
    if (nargs < 2) {
        goto skip_optional;
    ...
    if (args[1] == Py_None) {
        ...
        _PyArg_BadArgument("ascii_decode", 2, "argument 2", "str or None", args[1]);
        goto exit;
    }
skip_optional:
...
_codecs_charmap_decode(PyObject *module, PyObject *const *args, Py_ssize_t nargs)
{
    ...
    if (!PyBuffer_IsContiguous(&data, 'C')) {
        _PyArg_BadArgument("charmap_decode", 1, "argument 1", "contiguous buffer", args[0]);
        goto exit;
    }
    if (nargs < 2) {
        goto skip_optional;
    ...
    if (args[1] == Py_None) {
        ...
        _PyArg_BadArgument("charmap_decode", 2, "argument 2", "str or None", args[1]);
        goto exit;
    }
    if (nargs < 3) {
        goto skip_optional;
...
_codecs_mbcs_decode(PyObject *module, PyObject *const *args, Py_ssize_t nargs)
{
    ...
    if (!PyBuffer_IsContiguous(&data, 'C')) {
        _PyArg_BadArgument("mbcs_decode", 1, "argument 1", "contiguous buffer", args[0]);
        goto exit;
    }
    if (nargs < 2) {
        goto skip_optional;
    ...
    if (args[1] == Py_None) {
        ...
        _PyArg_BadArgument("mbcs_decode", 2, "argument 2", "str or None", args[1]);
        goto exit;
    }
    if (nargs < 3) {
        goto skip_optional;
...
_codecs_oem_decode(PyObject *module, PyObject *const *args, Py_ssize_t nargs)
{
    ...
    if (!PyBuffer_IsContiguous(&data, 'C')) {
        _PyArg_BadArgument("oem_decode", 1, "argument 1", "contiguous buffer", args[0]);
        goto exit;
    }
    if (nargs < 2) {
        goto skip_optional;
    ...
    if (args[1] == Py_None) {
        ...
        _PyArg_BadArgument("oem_decode", 2, "argument 2", "str or None", args[1]);
        goto exit;
    }
    if (nargs < 3) {
        goto skip_optional;
...
_codecs_code_page_decode(PyObject *module, PyObject *const *args, Py_ssize_t nargs)
{
    ...
    if (!PyBuffer_IsContiguous(&data, 'C')) {
        _PyArg_BadArgument("code_page_decode", 2, "argument 2", "contiguous buffer", args[1]);
        goto exit;
    }
    if (nargs < 3) {
        goto skip_optional;
    ...
    if (args[2] == Py_None) {
        ...
        _PyArg_BadArgument("code_page_decode", 3, "argument 3", "str or None", args[2]);
        goto exit;
    }
    if (nargs < 4) {
        goto skip_optional;
...
_codecs_readbuffer_encode(PyObject *module, PyObject *const *args, Py_ssize_t nargs)
{
    ...
    if (PyUnicode_Check(args[0])) {
        ...
        if (!PyBuffer_IsContiguous(&data, 'C')) {
            _PyArg_BadArgument("readbuffer_encode", 1, "argument 1", "contiguous buffer", args[0]);
            goto exit;
        }
    }
    if (nargs < 2) {
    ...
    if (args[1] == Py_None) {
        ...
        _PyArg_BadArgument("readbuffer_encode", 2, "argument 2", "str or None", args[1]);
        goto exit;
    }
skip_optional:
...
_codecs_utf_7_encode(PyObject *module, PyObject *const *args, Py_ssize_t nargs)
{
    ...
    if (!PyUnicode_Check(args[0])) {
        _PyArg_BadArgument("utf_7_encode", 1, "argument 1", "str", args[0]);
        goto exit;
    }
    ...
    if (args[1] == Py_None) {
        ...
        _PyArg_BadArgument("utf_7_encode", 2, "argument 2", "str or None", args[1]);
        goto exit;
    }
skip_optional:
...
_codecs_utf_8_encode(PyObject *module, PyObject *const *args, Py_ssize_t nargs)
{
    ...
    if (!PyUnicode_Check(args[0])) {
        _PyArg_BadArgument("utf_8_encode", 1, "argument 1", "str", args[0]);
        goto exit;
    }
    if (PyUnicode_READY(args[0]) == -1) {
        goto exit;
    ...
    if (args[1] == Py_None) {
        ...
        _PyArg_BadArgument("utf_8_encode", 2, "argument 2", "str or None", args[1]);
        goto exit;
    }
skip_optional:
...
_codecs_utf_16_encode(PyObject *module, PyObject *const *args, Py_ssize_t nargs)
{
    ...
    if (!PyUnicode_Check(args[0])) {
        _PyArg_BadArgument("utf_16_encode", 1, "argument 1", "str", args[0]);
        goto exit;
    }
    if (PyUnicode_READY(args[0]) == -1) {
        goto exit;
    ...
    if (args[1] == Py_None) {
        ...
        _PyArg_BadArgument("utf_16_encode", 2, "argument 2", "str or None", args[1]);
        goto exit;
    }
    if (nargs < 3) {
        goto skip_optional;
...
_codecs_utf_16_le_encode(PyObject *module, PyObject *const *args, Py_ssize_t nargs)
{
    ...
    if (!PyUnicode_Check(args[0])) {
        _PyArg_BadArgument("utf_16_le_encode", 1, "argument 1", "str", args[0]);
        goto exit;
    }
    if (PyUnicode_READY(args[0]) == -1) {
        goto exit;
    ...
    if (args[1] == Py_None) {
        ...
        _PyArg_BadArgument("utf_16_le_encode", 2, "argument 2", "str or None", args[1]);
        goto exit;
    }
skip_optional:
...
_codecs_utf_16_be_encode(PyObject *module, PyObject *const *args, Py_ssize_t nargs)
{
    ...
    if (!PyUnicode_Check(args[0])) {
        _PyArg_BadArgument("utf_16_be_encode", 1, "argument 1", "str", args[0]);
        goto exit;
    }
    if (PyUnicode_READY(args[0]) == -1) {
        goto exit;
    ...
    if (args[1] == Py_None) {
        ...
        _PyArg_BadArgument("utf_16_be_encode", 2, "argument 2", "str or None", args[1]);
        goto exit;
    }
skip_optional:
...
_codecs_utf_32_encode(PyObject *module, PyObject *const *args, Py_ssize_t nargs)
{
    ...
    if (!PyUnicode_Check(args[0])) {
        _PyArg_BadArgument("utf_32_encode", 1, "argument 1", "str", args[0]);
        goto exit;
    }
    if (PyUnicode_READY(args[0]) == -1) {
        goto exit;
    ...
    if (args[1] == Py_None) {
        ...
        _PyArg_BadArgument("utf_32_encode", 2, "argument 2", "str or None", args[1]);
        goto exit;
    }
    if (nargs < 3) {
        goto skip_optional;
...
_codecs_utf_32_le_encode(PyObject *module, PyObject *const *args, Py_ssize_t nargs)
{
    ...
    if (!PyUnicode_Check(args[0])) {
        _PyArg_BadArgument("utf_32_le_encode", 1, "argument 1", "str", args[0]);
        goto exit;
    }
    if (PyUnicode_READY(args[0]) == -1) {
        goto exit;
    ...
    if (args[1] == Py_None) {
        ...
        _PyArg_BadArgument("utf_32_le_encode", 2, "argument 2", "str or None", args[1]);
        goto exit;
    }
skip_optional:
...
_codecs_utf_32_be_encode(PyObject *module, PyObject *const *args, Py_ssize_t nargs)
{
    ...
    if (!PyUnicode_Check(args[0])) {
        _PyArg_BadArgument("utf_32_be_encode", 1, "argument 1", "str", args[0]);
        goto exit;
    }
    if (PyUnicode_READY(args[0]) == -1) {
        goto exit;
    ...
    if (args[1] == Py_None) {
        ...
        _PyArg_BadArgument("utf_32_be_encode", 2, "argument 2", "str or None", args[1]);
        goto exit;
    }
skip_optional:
...
_codecs_unicode_escape_encode(PyObject *module, PyObject *const *args, Py_ssize_t nargs)
{
    ...
    if (!PyUnicode_Check(args[0])) {
        _PyArg_BadArgument("unicode_escape_encode", 1, "argument 1", "str", args[0]);
        goto exit;
    }
    if (PyUnicode_READY(args[0]) == -1) {
        goto exit;
    ...
    if (args[1] == Py_None) {
        ...
        _PyArg_BadArgument("unicode_escape_encode", 2, "argument 2", "str or None", args[1]);
        goto exit;
    }
skip_optional:
...
_codecs_raw_unicode_escape_encode(PyObject *module, PyObject *const *args, Py_ssize_t nargs)
{
    ...
    if (!PyUnicode_Check(args[0])) {
        _PyArg_BadArgument("raw_unicode_escape_encode", 1, "argument 1", "str", args[0]);
        goto exit;
    }
    if (PyUnicode_READY(args[0]) == -1) {
        goto exit;
    ...
    if (args[1] == Py_None) {
        ...
        _PyArg_BadArgument("raw_unicode_escape_encode", 2, "argument 2", "str or None", args[1]);
        goto exit;
    }
skip_optional:
...
_codecs_latin_1_encode(PyObject *module, PyObject *const *args, Py_ssize_t nargs)
{
    ...
    if (!PyUnicode_Check(args[0])) {
        _PyArg_BadArgument("latin_1_encode", 1, "argument 1", "str", args[0]);
        goto exit;
    }
    if (PyUnicode_READY(args[0]) == -1) {
        goto exit;
    ...
    if (args[1] == Py_None) {
        ...
        _PyArg_BadArgument("latin_1_encode", 2, "argument 2", "str or None", args[1]);
        goto exit;
    }
skip_optional:
...
_codecs_ascii_encode(PyObject *module, PyObject *const *args, Py_ssize_t nargs)
{
    ...
    if (!PyUnicode_Check(args[0])) {
        _PyArg_BadArgument("ascii_encode", 1, "argument 1", "str", args[0]);
        goto exit;
    }
    if (PyUnicode_READY(args[0]) == -1) {
        goto exit;
    ...
    if (args[1] == Py_None) {
        ...
        _PyArg_BadArgument("ascii_encode", 2, "argument 2", "str or None", args[1]);
        goto exit;
    }
skip_optional:
...
_codecs_charmap_encode(PyObject *module, PyObject *const *args, Py_ssize_t nargs)
{
    ...
    if (!PyUnicode_Check(args[0])) {
        _PyArg_BadArgument("charmap_encode", 1, "argument 1", "str", args[0]);
        goto exit;
    }
    if (PyUnicode_READY(args[0]) == -1) {
        goto exit;
    ...
    if (args[1] == Py_None) {
        ...
        _PyArg_BadArgument("charmap_encode", 2, "argument 2", "str or None", args[1]);
        goto exit;
    }
    if (nargs < 3) {
        goto skip_optional;
...
_codecs_charmap_build(PyObject *module, PyObject *arg)
{
    ...
    if (!PyUnicode_Check(arg)) {
        _PyArg_BadArgument("charmap_build", 0, "argument", "str", arg);
        goto exit;
    }
...
_codecs_mbcs_encode(PyObject *module, PyObject *const *args, Py_ssize_t nargs)
{
    ...
    if (!PyUnicode_Check(args[0])) {
        _PyArg_BadArgument("mbcs_encode", 1, "argument 1", "str", args[0]);
        goto exit;
    }
    if (PyUnicode_READY(args[0]) == -1) {
        goto exit;
    ...
    if (args[1] == Py_None) {
        ...
        _PyArg_BadArgument("mbcs_encode", 2, "argument 2", "str or None", args[1]);
        goto exit;
    }
skip_optional:
...
_codecs_oem_encode(PyObject *module, PyObject *const *args, Py_ssize_t nargs)
{
    ...
    if (!PyUnicode_Check(args[0])) {
        _PyArg_BadArgument("oem_encode", 1, "argument 1", "str", args[0]);
        goto exit;
    }
    if (PyUnicode_READY(args[0]) == -1) {
        goto exit;
    ...
    if (args[1] == Py_None) {
        ...
        _PyArg_BadArgument("oem_encode", 2, "argument 2", "str or None", args[1]);
        goto exit;
    }
skip_optional:
...
_codecs_code_page_encode(PyObject *module, PyObject *const *args, Py_ssize_t nargs)
{
    ...
    if (!PyUnicode_Check(args[1])) {
        _PyArg_BadArgument("code_page_encode", 2, "argument 2", "str", args[1]);
        goto exit;
    }
    ...
    if (args[2] == Py_None) {
        ...
        _PyArg_BadArgument("code_page_encode", 3, "argument 3", "str or None", args[2]);
        goto exit;
    }
skip_optional:
...
_codecs_register_error(PyObject *module, PyObject *const *args, Py_ssize_t nargs)
{
    ...
    if (!PyUnicode_Check(args[0])) {
        _PyArg_BadArgument("register_error", 1, "argument 1", "str", args[0]);
        goto exit;
    }
    Py_ssize_t errors_length;
...
_codecs_lookup_error(PyObject *module, PyObject *arg)
{
    ...
    if (!PyUnicode_Check(arg)) {
        _PyArg_BadArgument("lookup_error", 0, "argument", "str", arg);
        goto exit;
    }
...
/*[clinic end generated code: output=421563186b21a798 input=a9049054013a1b77]*/
