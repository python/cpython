...
_codecs_escape_decode(PyObject *module, PyObject *const *args, Py_ssize_t nargs)
{
    ...
    if (PyUnicode_Check(args[0])) {
        ...
        if (!PyBuffer_IsContiguous(&data, 'C')) {
            _PyArg_BadArgument("escape_decode", "contiguous buffer", args[0]);
            goto exit;
        }
    }
    if (nargs < 2) {
    ...
    if (args[1] == NULL) {
        ...
        _PyArg_BadArgument("escape_decode", "str or None", args[1]);
        goto exit;
    }
skip_optional:
...
_codecs_escape_encode(PyObject *module, PyObject *const *args, Py_ssize_t nargs)
{
    ...
    if (!PyBytes_Check(args[0])) {
        _PyArg_BadArgument("escape_encode", "bytes", args[0]);
        goto exit;
    }
    data = args[0];
    if (nargs < 2) {
    ...
    if (args[1] == NULL) {
        ...
        _PyArg_BadArgument("escape_encode", "str or None", args[1]);
        goto exit;
    }
skip_optional:
...
_codecs_unicode_internal_decode(PyObject *module, PyObject *const *args, Py_ssize_t nargs)
{
    ...
    if (args[1] == NULL) {
        ...
        _PyArg_BadArgument("unicode_internal_decode", "str or None", args[1]);
        goto exit;
    }
skip_optional:
...
_codecs_utf_7_decode(PyObject *module, PyObject *const *args, Py_ssize_t nargs)
{
    ...
    if (!PyBuffer_IsContiguous(&data, 'C')) {
        _PyArg_BadArgument("utf_7_decode", "contiguous buffer", args[0]);
        goto exit;
    }
    if (nargs < 2) {
        goto skip_optional;
    ...
    if (args[1] == NULL) {
        ...
        _PyArg_BadArgument("utf_7_decode", "str or None", args[1]);
        goto exit;
    }
    if (nargs < 3) {
        goto skip_optional;
...
_codecs_utf_8_decode(PyObject *module, PyObject *const *args, Py_ssize_t nargs)
{
    ...
    if (!PyBuffer_IsContiguous(&data, 'C')) {
        _PyArg_BadArgument("utf_8_decode", "contiguous buffer", args[0]);
        goto exit;
    }
    if (nargs < 2) {
        goto skip_optional;
    ...
    if (args[1] == NULL) {
        ...
        _PyArg_BadArgument("utf_8_decode", "str or None", args[1]);
        goto exit;
    }
    if (nargs < 3) {
        goto skip_optional;
...
_codecs_utf_16_decode(PyObject *module, PyObject *const *args, Py_ssize_t nargs)
{
    ...
    if (!PyBuffer_IsContiguous(&data, 'C')) {
        _PyArg_BadArgument("utf_16_decode", "contiguous buffer", args[0]);
        goto exit;
    }
    if (nargs < 2) {
        goto skip_optional;
    ...
    if (args[1] == NULL) {
        ...
        _PyArg_BadArgument("utf_16_decode", "str or None", args[1]);
        goto exit;
    }
    if (nargs < 3) {
        goto skip_optional;
...
_codecs_utf_16_le_decode(PyObject *module, PyObject *const *args, Py_ssize_t nargs)
{
    ...
    if (!PyBuffer_IsContiguous(&data, 'C')) {
        _PyArg_BadArgument("utf_16_le_decode", "contiguous buffer", args[0]);
        goto exit;
    }
    if (nargs < 2) {
        goto skip_optional;
    ...
    if (args[1] == NULL) {
        ...
        _PyArg_BadArgument("utf_16_le_decode", "str or None", args[1]);
        goto exit;
    }
    if (nargs < 3) {
        goto skip_optional;
...
_codecs_utf_16_be_decode(PyObject *module, PyObject *const *args, Py_ssize_t nargs)
{
    ...
    if (!PyBuffer_IsContiguous(&data, 'C')) {
        _PyArg_BadArgument("utf_16_be_decode", "contiguous buffer", args[0]);
        goto exit;
    }
    if (nargs < 2) {
        goto skip_optional;
    ...
    if (args[1] == NULL) {
        ...
        _PyArg_BadArgument("utf_16_be_decode", "str or None", args[1]);
        goto exit;
    }
    if (nargs < 3) {
        goto skip_optional;
...
_codecs_utf_16_ex_decode(PyObject *module, PyObject *const *args, Py_ssize_t nargs)
{
    ...
    if (!PyBuffer_IsContiguous(&data, 'C')) {
        _PyArg_BadArgument("utf_16_ex_decode", "contiguous buffer", args[0]);
        goto exit;
    }
    if (nargs < 2) {
        goto skip_optional;
    ...
    if (args[1] == NULL) {
        ...
        _PyArg_BadArgument("utf_16_ex_decode", "str or None", args[1]);
        goto exit;
    }
    if (nargs < 3) {
        goto skip_optional;
...
_codecs_utf_32_decode(PyObject *module, PyObject *const *args, Py_ssize_t nargs)
{
    ...
    if (!PyBuffer_IsContiguous(&data, 'C')) {
        _PyArg_BadArgument("utf_32_decode", "contiguous buffer", args[0]);
        goto exit;
    }
    if (nargs < 2) {
        goto skip_optional;
    ...
    if (args[1] == NULL) {
        ...
        _PyArg_BadArgument("utf_32_decode", "str or None", args[1]);
        goto exit;
    }
    if (nargs < 3) {
        goto skip_optional;
...
_codecs_utf_32_le_decode(PyObject *module, PyObject *const *args, Py_ssize_t nargs)
{
    ...
    if (!PyBuffer_IsContiguous(&data, 'C')) {
        _PyArg_BadArgument("utf_32_le_decode", "contiguous buffer", args[0]);
        goto exit;
    }
    if (nargs < 2) {
        goto skip_optional;
    ...
    if (args[1] == NULL) {
        ...
        _PyArg_BadArgument("utf_32_le_decode", "str or None", args[1]);
        goto exit;
    }
    if (nargs < 3) {
        goto skip_optional;
...
_codecs_utf_32_be_decode(PyObject *module, PyObject *const *args, Py_ssize_t nargs)
{
    ...
    if (!PyBuffer_IsContiguous(&data, 'C')) {
        _PyArg_BadArgument("utf_32_be_decode", "contiguous buffer", args[0]);
        goto exit;
    }
    if (nargs < 2) {
        goto skip_optional;
    ...
    if (args[1] == NULL) {
        ...
        _PyArg_BadArgument("utf_32_be_decode", "str or None", args[1]);
        goto exit;
    }
    if (nargs < 3) {
        goto skip_optional;
...
_codecs_utf_32_ex_decode(PyObject *module, PyObject *const *args, Py_ssize_t nargs)
{
    ...
    if (!PyBuffer_IsContiguous(&data, 'C')) {
        _PyArg_BadArgument("utf_32_ex_decode", "contiguous buffer", args[0]);
        goto exit;
    }
    if (nargs < 2) {
        goto skip_optional;
    ...
    if (args[1] == NULL) {
        ...
        _PyArg_BadArgument("utf_32_ex_decode", "str or None", args[1]);
        goto exit;
    }
    if (nargs < 3) {
        goto skip_optional;
...
_codecs_unicode_escape_decode(PyObject *module, PyObject *const *args, Py_ssize_t nargs)
{
    ...
    if (PyUnicode_Check(args[0])) {
        ...
        if (!PyBuffer_IsContiguous(&data, 'C')) {
            _PyArg_BadArgument("unicode_escape_decode", "contiguous buffer", args[0]);
            goto exit;
        }
    }
    if (nargs < 2) {
    ...
    if (args[1] == NULL) {
        ...
        _PyArg_BadArgument("unicode_escape_decode", "str or None", args[1]);
        goto exit;
    }
skip_optional:
...
_codecs_raw_unicode_escape_decode(PyObject *module, PyObject *const *args, Py_ssize_t nargs)
{
    ...
    if (PyUnicode_Check(args[0])) {
        ...
        if (!PyBuffer_IsContiguous(&data, 'C')) {
            _PyArg_BadArgument("raw_unicode_escape_decode", "contiguous buffer", args[0]);
            goto exit;
        }
    }
    if (nargs < 2) {
    ...
    if (args[1] == NULL) {
        ...
        _PyArg_BadArgument("raw_unicode_escape_decode", "str or None", args[1]);
        goto exit;
    }
skip_optional:
...
_codecs_latin_1_decode(PyObject *module, PyObject *const *args, Py_ssize_t nargs)
{
    ...
    if (!PyBuffer_IsContiguous(&data, 'C')) {
        _PyArg_BadArgument("latin_1_decode", "contiguous buffer", args[0]);
        goto exit;
    }
    if (nargs < 2) {
        goto skip_optional;
    ...
    if (args[1] == NULL) {
        ...
        _PyArg_BadArgument("latin_1_decode", "str or None", args[1]);
        goto exit;
    }
skip_optional:
...
_codecs_ascii_decode(PyObject *module, PyObject *const *args, Py_ssize_t nargs)
{
    ...
    if (!PyBuffer_IsContiguous(&data, 'C')) {
        _PyArg_BadArgument("ascii_decode", "contiguous buffer", args[0]);
        goto exit;
    }
    if (nargs < 2) {
        goto skip_optional;
    ...
    if (args[1] == NULL) {
        ...
        _PyArg_BadArgument("ascii_decode", "str or None", args[1]);
        goto exit;
    }
skip_optional:
...
_codecs_charmap_decode(PyObject *module, PyObject *const *args, Py_ssize_t nargs)
{
    ...
    if (!PyBuffer_IsContiguous(&data, 'C')) {
        _PyArg_BadArgument("charmap_decode", "contiguous buffer", args[0]);
        goto exit;
    }
    if (nargs < 2) {
        goto skip_optional;
    ...
    if (args[1] == NULL) {
        ...
        _PyArg_BadArgument("charmap_decode", "str or None", args[1]);
        goto exit;
    }
    if (nargs < 3) {
        goto skip_optional;
...
_codecs_mbcs_decode(PyObject *module, PyObject *const *args, Py_ssize_t nargs)
{
    ...
    if (!PyBuffer_IsContiguous(&data, 'C')) {
        _PyArg_BadArgument("mbcs_decode", "contiguous buffer", args[0]);
        goto exit;
    }
    if (nargs < 2) {
        goto skip_optional;
    ...
    if (args[1] == NULL) {
        ...
        _PyArg_BadArgument("mbcs_decode", "str or None", args[1]);
        goto exit;
    }
    if (nargs < 3) {
        goto skip_optional;
...
_codecs_oem_decode(PyObject *module, PyObject *const *args, Py_ssize_t nargs)
{
    ...
    if (!PyBuffer_IsContiguous(&data, 'C')) {
        _PyArg_BadArgument("oem_decode", "contiguous buffer", args[0]);
        goto exit;
    }
    if (nargs < 2) {
        goto skip_optional;
    ...
    if (args[1] == NULL) {
        ...
        _PyArg_BadArgument("oem_decode", "str or None", args[1]);
        goto exit;
    }
    if (nargs < 3) {
        goto skip_optional;
...
_codecs_code_page_decode(PyObject *module, PyObject *const *args, Py_ssize_t nargs)
{
    ...
    if (!PyBuffer_IsContiguous(&data, 'C')) {
        _PyArg_BadArgument("code_page_decode", "contiguous buffer", args[1]);
        goto exit;
    }
    if (nargs < 3) {
        goto skip_optional;
    ...
    if (args[2] == NULL) {
        ...
        _PyArg_BadArgument("code_page_decode", "str or None", args[2]);
        goto exit;
    }
    if (nargs < 4) {
        goto skip_optional;
...
_codecs_readbuffer_encode(PyObject *module, PyObject *const *args, Py_ssize_t nargs)
{
    ...
    if (PyUnicode_Check(args[0])) {
        ...
        if (!PyBuffer_IsContiguous(&data, 'C')) {
            _PyArg_BadArgument("readbuffer_encode", "contiguous buffer", args[0]);
            goto exit;
        }
    }
    if (nargs < 2) {
    ...
    if (args[1] == NULL) {
        ...
        _PyArg_BadArgument("readbuffer_encode", "str or None", args[1]);
        goto exit;
    }
skip_optional:
...
_codecs_unicode_internal_encode(PyObject *module, PyObject *const *args, Py_ssize_t nargs)
{
    ...
    if (args[1] == NULL) {
        ...
        _PyArg_BadArgument("unicode_internal_encode", "str or None", args[1]);
        goto exit;
    }
skip_optional:
...
_codecs_utf_7_encode(PyObject *module, PyObject *const *args, Py_ssize_t nargs)
{
    ...
    if (!PyUnicode_Check(args[0])) {
        _PyArg_BadArgument("utf_7_encode", "str", args[0]);
        goto exit;
    }
    ...
    if (args[1] == NULL) {
        ...
        _PyArg_BadArgument("utf_7_encode", "str or None", args[1]);
        goto exit;
    }
skip_optional:
...
_codecs_utf_8_encode(PyObject *module, PyObject *const *args, Py_ssize_t nargs)
{
    ...
    if (!PyUnicode_Check(args[0])) {
        _PyArg_BadArgument("utf_8_encode", "str", args[0]);
        goto exit;
    }
    if (PyUnicode_READY(args[0]) == -1) {
        goto exit;
    ...
    if (args[1] == NULL) {
        ...
        _PyArg_BadArgument("utf_8_encode", "str or None", args[1]);
        goto exit;
    }
skip_optional:
...
_codecs_utf_16_encode(PyObject *module, PyObject *const *args, Py_ssize_t nargs)
{
    ...
    if (!PyUnicode_Check(args[0])) {
        _PyArg_BadArgument("utf_16_encode", "str", args[0]);
        goto exit;
    }
    if (PyUnicode_READY(args[0]) == -1) {
        goto exit;
    ...
    if (args[1] == NULL) {
        ...
        _PyArg_BadArgument("utf_16_encode", "str or None", args[1]);
        goto exit;
    }
    if (nargs < 3) {
        goto skip_optional;
...
_codecs_utf_16_le_encode(PyObject *module, PyObject *const *args, Py_ssize_t nargs)
{
    ...
    if (!PyUnicode_Check(args[0])) {
        _PyArg_BadArgument("utf_16_le_encode", "str", args[0]);
        goto exit;
    }
    if (PyUnicode_READY(args[0]) == -1) {
        goto exit;
    ...
    if (args[1] == NULL) {
        ...
        _PyArg_BadArgument("utf_16_le_encode", "str or None", args[1]);
        goto exit;
    }
skip_optional:
...
_codecs_utf_16_be_encode(PyObject *module, PyObject *const *args, Py_ssize_t nargs)
{
    ...
    if (!PyUnicode_Check(args[0])) {
        _PyArg_BadArgument("utf_16_be_encode", "str", args[0]);
        goto exit;
    }
    if (PyUnicode_READY(args[0]) == -1) {
        goto exit;
    ...
    if (args[1] == NULL) {
        ...
        _PyArg_BadArgument("utf_16_be_encode", "str or None", args[1]);
        goto exit;
    }
skip_optional:
...
_codecs_utf_32_encode(PyObject *module, PyObject *const *args, Py_ssize_t nargs)
{
    ...
    if (!PyUnicode_Check(args[0])) {
        _PyArg_BadArgument("utf_32_encode", "str", args[0]);
        goto exit;
    }
    if (PyUnicode_READY(args[0]) == -1) {
        goto exit;
    ...
    if (args[1] == NULL) {
        ...
        _PyArg_BadArgument("utf_32_encode", "str or None", args[1]);
        goto exit;
    }
    if (nargs < 3) {
        goto skip_optional;
...
_codecs_utf_32_le_encode(PyObject *module, PyObject *const *args, Py_ssize_t nargs)
{
    ...
    if (!PyUnicode_Check(args[0])) {
        _PyArg_BadArgument("utf_32_le_encode", "str", args[0]);
        goto exit;
    }
    if (PyUnicode_READY(args[0]) == -1) {
        goto exit;
    ...
    if (args[1] == NULL) {
        ...
        _PyArg_BadArgument("utf_32_le_encode", "str or None", args[1]);
        goto exit;
    }
skip_optional:
...
_codecs_utf_32_be_encode(PyObject *module, PyObject *const *args, Py_ssize_t nargs)
{
    ...
    if (!PyUnicode_Check(args[0])) {
        _PyArg_BadArgument("utf_32_be_encode", "str", args[0]);
        goto exit;
    }
    if (PyUnicode_READY(args[0]) == -1) {
        goto exit;
    ...
    if (args[1] == NULL) {
        ...
        _PyArg_BadArgument("utf_32_be_encode", "str or None", args[1]);
        goto exit;
    }
skip_optional:
...
_codecs_unicode_escape_encode(PyObject *module, PyObject *const *args, Py_ssize_t nargs)
{
    ...
    if (!PyUnicode_Check(args[0])) {
        _PyArg_BadArgument("unicode_escape_encode", "str", args[0]);
        goto exit;
    }
    if (PyUnicode_READY(args[0]) == -1) {
        goto exit;
    ...
    if (args[1] == NULL) {
        ...
        _PyArg_BadArgument("unicode_escape_encode", "str or None", args[1]);
        goto exit;
    }
skip_optional:
...
_codecs_raw_unicode_escape_encode(PyObject *module, PyObject *const *args, Py_ssize_t nargs)
{
    ...
    if (!PyUnicode_Check(args[0])) {
        _PyArg_BadArgument("raw_unicode_escape_encode", "str", args[0]);
        goto exit;
    }
    if (PyUnicode_READY(args[0]) == -1) {
        goto exit;
    ...
    if (args[1] == NULL) {
        ...
        _PyArg_BadArgument("raw_unicode_escape_encode", "str or None", args[1]);
        goto exit;
    }
skip_optional:
...
_codecs_latin_1_encode(PyObject *module, PyObject *const *args, Py_ssize_t nargs)
{
    ...
    if (!PyUnicode_Check(args[0])) {
        _PyArg_BadArgument("latin_1_encode", "str", args[0]);
        goto exit;
    }
    if (PyUnicode_READY(args[0]) == -1) {
        goto exit;
    ...
    if (args[1] == NULL) {
        ...
        _PyArg_BadArgument("latin_1_encode", "str or None", args[1]);
        goto exit;
    }
skip_optional:
...
_codecs_ascii_encode(PyObject *module, PyObject *const *args, Py_ssize_t nargs)
{
    ...
    if (!PyUnicode_Check(args[0])) {
        _PyArg_BadArgument("ascii_encode", "str", args[0]);
        goto exit;
    }
    if (PyUnicode_READY(args[0]) == -1) {
        goto exit;
    ...
    if (args[1] == NULL) {
        ...
        _PyArg_BadArgument("ascii_encode", "str or None", args[1]);
        goto exit;
    }
skip_optional:
...
_codecs_charmap_encode(PyObject *module, PyObject *const *args, Py_ssize_t nargs)
{
    ...
    if (!PyUnicode_Check(args[0])) {
        _PyArg_BadArgument("charmap_encode", "str", args[0]);
        goto exit;
    }
    if (PyUnicode_READY(args[0]) == -1) {
        goto exit;
    ...
    if (args[1] == NULL) {
        ...
        _PyArg_BadArgument("charmap_encode", "str or None", args[1]);
        goto exit;
    }
    if (nargs < 3) {
        goto skip_optional;
...
_codecs_mbcs_encode(PyObject *module, PyObject *const *args, Py_ssize_t nargs)
{
    ...
    if (!PyUnicode_Check(args[0])) {
        _PyArg_BadArgument("mbcs_encode", "str", args[0]);
        goto exit;
    }
    if (PyUnicode_READY(args[0]) == -1) {
        goto exit;
    ...
    if (args[1] == NULL) {
        ...
        _PyArg_BadArgument("mbcs_encode", "str or None", args[1]);
        goto exit;
    }
skip_optional:
...
_codecs_oem_encode(PyObject *module, PyObject *const *args, Py_ssize_t nargs)
{
    ...
    if (!PyUnicode_Check(args[0])) {
        _PyArg_BadArgument("oem_encode", "str", args[0]);
        goto exit;
    }
    if (PyUnicode_READY(args[0]) == -1) {
        goto exit;
    ...
    if (args[1] == NULL) {
        ...
        _PyArg_BadArgument("oem_encode", "str or None", args[1]);
        goto exit;
    }
skip_optional:
...
_codecs_code_page_encode(PyObject *module, PyObject *const *args, Py_ssize_t nargs)
{
    ...
    if (!PyUnicode_Check(args[1])) {
        _PyArg_BadArgument("code_page_encode", "str", args[1]);
        goto exit;
    }
    ...
    if (args[2] == NULL) {
        ...
        _PyArg_BadArgument("code_page_encode", "str or None", args[2]);
        goto exit;
    }
skip_optional:
...
_codecs_register_error(PyObject *module, PyObject *const *args, Py_ssize_t nargs)
{
    ...
    if (!PyUnicode_Check(args[0])) {
        _PyArg_BadArgument("register_error", "str", args[0]);
        goto exit;
    }
    Py_ssize_t errors_length;
...
/*[clinic end generated code: output=3e246fe3c6a61a7f input=a9049054013a1b77]*/
