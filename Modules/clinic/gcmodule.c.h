...
#define GC_IS_IMMORTAL_METHODDEF    \
    {"is_immortal", (PyCFunction)(void(*)(void))gc_is_immortal, METH_FASTCALL|METH_KEYWORDS, gc_is_immortal__doc__},

static int
gc_is_immortal_impl(PyObject *module, PyObject *instance);

static PyObject *
gc_is_immortal(PyObject *module, PyObject *const *args, Py_ssize_t nargs, PyObject *kwnames)
{
    PyObject *return_value = NULL;
    static const char * const _keywords[] = {"instance", NULL};
    static _PyArg_Parser _parser = {NULL, _keywords, "is_immortal", 0};
    PyObject *argsbuf[1];
    PyObject *instance;
    int _return_value;
    ...
    instance = args[0];
    _return_value = gc_is_immortal_impl(module, instance);
    if ((_return_value == -1) && PyErr_Occurred()) {
        goto exit;
    }
    return_value = PyBool_FromLong((long)_return_value);
...
/*[clinic end generated code: output=e017df03428c53c2 input=a9049054013a1b77]*/
