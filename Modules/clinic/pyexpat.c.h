...
#define PYEXPAT_XMLPARSER_SETBILLIONLAUGHSATTACKPROTECTIONACTIVATIONTHRESHOLD_METHODDEF    \
    {"SetBillionLaughsAttackProtectionActivationThreshold", (PyCFunction)(void(*)(void))pyexpat_xmlparser_SetBillionLaughsAttackProtectionActivationThreshold, METH_METHOD|METH_FASTCALL|METH_KEYWORDS, pyexpat_xmlparser_SetBillionLaughsAttackProtectionActivationThreshold__doc__},
...
pyexpat_xmlparser_SetBillionLaughsAttackProtectionActivationThreshold(xmlparseobject *self, PyTypeObject *cls, PyObject *const *args, Py_ssize_t nargs, PyObject *kwnames)
{
    PyObject *return_value = NULL;
    static const char * const _keywords[] = {"", NULL};
    static _PyArg_Parser _parser = {NULL, _keywords, "SetBillionLaughsAttackProtectionActivationThreshold", 0};
    PyObject *argsbuf[1];
    unsigned long long threshold;
...
#define PYEXPAT_XMLPARSER_SETBILLIONLAUGHSATTACKPROTECTIONMAXIMUMAMPLIFICATION_METHODDEF    \
    {"SetBillionLaughsAttackProtectionMaximumAmplification", (PyCFunction)(void(*)(void))pyexpat_xmlparser_SetBillionLaughsAttackProtectionMaximumAmplification, METH_METHOD|METH_FASTCALL|METH_KEYWORDS, pyexpat_xmlparser_SetBillionLaughsAttackProtectionMaximumAmplification__doc__},
...
pyexpat_xmlparser_SetBillionLaughsAttackProtectionMaximumAmplification(xmlparseobject *self, PyTypeObject *cls, PyObject *const *args, Py_ssize_t nargs, PyObject *kwnames)
{
    PyObject *return_value = NULL;
    static const char * const _keywords[] = {"", NULL};
    static _PyArg_Parser _parser = {NULL, _keywords, "SetBillionLaughsAttackProtectionMaximumAmplification", 0};
    PyObject *argsbuf[1];
    float max_factor;
...
#define PYEXPAT_XMLPARSER_SETALLOCTRACKERACTIVATIONTHRESHOLD_METHODDEF    \
    {"SetAllocTrackerActivationThreshold", (PyCFunction)(void(*)(void))pyexpat_xmlparser_SetAllocTrackerActivationThreshold, METH_METHOD|METH_FASTCALL|METH_KEYWORDS, pyexpat_xmlparser_SetAllocTrackerActivationThreshold__doc__},
...
pyexpat_xmlparser_SetAllocTrackerActivationThreshold(xmlparseobject *self, PyTypeObject *cls, PyObject *const *args, Py_ssize_t nargs, PyObject *kwnames)
{
    PyObject *return_value = NULL;
    static const char * const _keywords[] = {"", NULL};
    static _PyArg_Parser _parser = {NULL, _keywords, "SetAllocTrackerActivationThreshold", 0};
    PyObject *argsbuf[1];
    unsigned long long threshold;
...
#define PYEXPAT_XMLPARSER_SETALLOCTRACKERMAXIMUMAMPLIFICATION_METHODDEF    \
    {"SetAllocTrackerMaximumAmplification", (PyCFunction)(void(*)(void))pyexpat_xmlparser_SetAllocTrackerMaximumAmplification, METH_METHOD|METH_FASTCALL|METH_KEYWORDS, pyexpat_xmlparser_SetAllocTrackerMaximumAmplification__doc__},
...
pyexpat_xmlparser_SetAllocTrackerMaximumAmplification(xmlparseobject *self, PyTypeObject *cls, PyObject *const *args, Py_ssize_t nargs, PyObject *kwnames)
{
    PyObject *return_value = NULL;
    static const char * const _keywords[] = {"", NULL};
    static _PyArg_Parser _parser = {NULL, _keywords, "SetAllocTrackerMaximumAmplification", 0};
    PyObject *argsbuf[1];
    float max_factor;
...
/*[clinic end generated code: output=83751f4e6e556eec input=a9049054013a1b77]*/
