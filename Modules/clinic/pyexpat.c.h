...
pyexpat_xmlparser_SetBase(xmlparseobject *self, PyObject *arg)
{
    ...
    if (!PyUnicode_Check(arg)) {
        _PyArg_BadArgument("SetBase", 0, "argument", "str", arg);
        goto exit;
    }
...
pyexpat_xmlparser_ExternalEntityParserCreate(xmlparseobject *self, PyObject *const *args, Py_ssize_t nargs)
{
    ...
    if (args[0] == Py_None) {
        ...
        _PyArg_BadArgument("ExternalEntityParserCreate", 1, "argument 1", "str or None", args[0]);
        goto exit;
    }
    if (nargs < 2) {
        goto skip_optional;
    ...
    if (!PyUnicode_Check(args[1])) {
        _PyArg_BadArgument("ExternalEntityParserCreate", 2, "argument 2", "str", args[1]);
        goto exit;
    }
...
pyexpat_ParserCreate(PyObject *module, PyObject *const *args, Py_ssize_t nargs, PyObject *kwnames)
{
    ...
    if (args[0]) {
        if (args[0] == Py_None) {
            ...
            _PyArg_BadArgument("ParserCreate", 1, "argument 'encoding'", "str or None", args[0]);
            goto exit;
        }
        if (!--noptargs) {
            goto skip_optional_pos;
    ...
    if (args[1]) {
        if (args[1] == Py_None) {
            ...
            _PyArg_BadArgument("ParserCreate", 2, "argument 'namespace_separator'", "str or None", args[1]);
            goto exit;
        }
        if (!--noptargs) {
            goto skip_optional_pos;
...
/*[clinic end generated code: output=4d2fd19723be47af input=a9049054013a1b77]*/
