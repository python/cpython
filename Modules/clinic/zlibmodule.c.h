...
zlib_compress(PyObject *module, PyObject *const *args, Py_ssize_t nargs, PyObject *kwnames)
{
    ...
    if (!PyBuffer_IsContiguous(&data, 'C')) {
        _PyArg_BadArgument("compress", 1, NULL, "contiguous buffer", args[0]);
        goto exit;
    }
    if (!noptargs) {
...
zlib_decompress(PyObject *module, PyObject *const *args, Py_ssize_t nargs, PyObject *kwnames)
{
    ...
    if (!PyBuffer_IsContiguous(&data, 'C')) {
        _PyArg_BadArgument("decompress", 1, NULL, "contiguous buffer", args[0]);
        goto exit;
    }
    if (!noptargs) {
        goto skip_optional_pos;
...
zlib_compressobj(PyObject *module, PyObject *const *args, Py_ssize_t nargs, PyObject *kwnames)
{
    ...
    if (!PyBuffer_IsContiguous(&zdict, 'C')) {
        _PyArg_BadArgument("compressobj", 6, "zdict", "contiguous buffer", args[5]);
        goto exit;
    }
skip_optional_pos:
...
zlib_adler32(PyObject *module, PyObject *const *args, Py_ssize_t nargs)
{
    ...
    if (!PyBuffer_IsContiguous(&data, 'C')) {
        _PyArg_BadArgument("adler32", 1, NULL, "contiguous buffer", args[0]);
        goto exit;
    }
    if (nargs < 2) {
        goto skip_optional;
...
zlib_crc32(PyObject *module, PyObject *const *args, Py_ssize_t nargs)
{
    ...
    if (!PyBuffer_IsContiguous(&data, 'C')) {
        _PyArg_BadArgument("crc32", 1, NULL, "contiguous buffer", args[0]);
        goto exit;
    }
    if (nargs < 2) {
        goto skip_optional;
...
/*[clinic end generated code: output=d0bfacbb4ce266fa input=a9049054013a1b77]*/
