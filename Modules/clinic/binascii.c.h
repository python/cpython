...
binascii_b2a_uu(PyObject *module, PyObject *const *args, Py_ssize_t nargs, PyObject *kwnames)
{
    ...
    if (!PyBuffer_IsContiguous(&data, 'C')) {
        _PyArg_BadArgument("b2a_uu", 1, NULL, "contiguous buffer", args[0]);
        goto exit;
    }
    if (!noptargs) {
...
binascii_b2a_base64(PyObject *module, PyObject *const *args, Py_ssize_t nargs, PyObject *kwnames)
{
    ...
    if (!PyBuffer_IsContiguous(&data, 'C')) {
        _PyArg_BadArgument("b2a_base64", 1, NULL, "contiguous buffer", args[0]);
        goto exit;
    }
    if (!noptargs) {
        goto skip_optional_kwonly;
...
binascii_rlecode_hqx(PyObject *module, PyObject *arg)
{
    ...
    if (!PyBuffer_IsContiguous(&data, 'C')) {
        _PyArg_BadArgument("rlecode_hqx", 0, NULL, "contiguous buffer", arg);
        goto exit;
    }
...
binascii_b2a_hqx(PyObject *module, PyObject *arg)
{
    ...
    if (!PyBuffer_IsContiguous(&data, 'C')) {
        _PyArg_BadArgument("b2a_hqx", 0, NULL, "contiguous buffer", arg);
        goto exit;
    }
...
binascii_rledecode_hqx(PyObject *module, PyObject *arg)
{
    ...
    if (!PyBuffer_IsContiguous(&data, 'C')) {
        _PyArg_BadArgument("rledecode_hqx", 0, NULL, "contiguous buffer", arg);
        goto exit;
    }
...
binascii_crc_hqx(PyObject *module, PyObject *const *args, Py_ssize_t nargs)
{
    ...
    if (!PyBuffer_IsContiguous(&data, 'C')) {
        _PyArg_BadArgument("crc_hqx", 1, NULL, "contiguous buffer", args[0]);
        goto exit;
    }
    if (PyFloat_Check(args[1])) {
        PyErr_SetString(PyExc_TypeError,
...
binascii_b2a_hex(PyObject *module, PyObject *arg)
{
    ...
    if (!PyBuffer_IsContiguous(&data, 'C')) {
        _PyArg_BadArgument("b2a_hex", 0, NULL, "contiguous buffer", arg);
        goto exit;
    }
...
binascii_hexlify(PyObject *module, PyObject *arg)
{
    ...
    if (!PyBuffer_IsContiguous(&data, 'C')) {
        _PyArg_BadArgument("hexlify", 0, NULL, "contiguous buffer", arg);
        goto exit;
    }
...
binascii_b2a_qp(PyObject *module, PyObject *const *args, Py_ssize_t nargs, PyObject *kwnames)
{
    ...
    if (!PyBuffer_IsContiguous(&data, 'C')) {
        _PyArg_BadArgument("b2a_qp", 1, "data", "contiguous buffer", args[0]);
        goto exit;
    }
    if (!noptargs) {
        goto skip_optional_pos;
...
/*[clinic end generated code: output=b75bfb58823158a5 input=a9049054013a1b77]*/
