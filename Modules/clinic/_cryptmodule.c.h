...
crypt_crypt(PyObject *module, PyObject *const *args, Py_ssize_t nargs)
{
    ...
    if (!PyUnicode_Check(args[0])) {
        _PyArg_BadArgument("crypt", 1, "argument 1", "str", args[0]);
        goto exit;
    }
    ...
    if (!PyUnicode_Check(args[1])) {
        _PyArg_BadArgument("crypt", 2, "argument 2", "str", args[1]);
        goto exit;
    }
...
/*[clinic end generated code: output=2852ce911bcdd087 input=a9049054013a1b77]*/
