...
os_chflags(PyObject *module, PyObject *const *args, Py_ssize_t nargs, PyObject *kwnames)
{
    ...
    if (!PyLong_Check(args[1])) {
        _PyArg_BadArgument("chflags", 2, "argument 'flags'", "int", args[1]);
        goto exit;
    }
...
os_lchflags(PyObject *module, PyObject *const *args, Py_ssize_t nargs, PyObject *kwnames)
{
    ...
    if (!PyLong_Check(args[1])) {
        _PyArg_BadArgument("lchflags", 2, "argument 'flags'", "int", args[1]);
        goto exit;
    }
    flags = PyLong_AsUnsignedLongMask(args[1]);
...
os_write(PyObject *module, PyObject *const *args, Py_ssize_t nargs)
{
    ...
    if (!PyBuffer_IsContiguous(&data, 'C')) {
        _PyArg_BadArgument("write", 2, "argument 2", "contiguous buffer", args[1]);
        goto exit;
    }
...
os_pwrite(PyObject *module, PyObject *const *args, Py_ssize_t nargs)
{
    ...
    if (!PyBuffer_IsContiguous(&buffer, 'C')) {
        _PyArg_BadArgument("pwrite", 2, "argument 2", "contiguous buffer", args[1]);
        goto exit;
    }
    if (!Py_off_t_converter(args[2], &offset)) {
        goto exit;
...
os_putenv(PyObject *module, PyObject *const *args, Py_ssize_t nargs)
{
    ...
    if (!PyUnicode_Check(args[0])) {
        _PyArg_BadArgument("putenv", 1, "argument 1", "str", args[0]);
        goto exit;
    }
    ...
    if (!PyUnicode_Check(args[1])) {
        _PyArg_BadArgument("putenv", 2, "argument 2", "str", args[1]);
        goto exit;
    }
...
os_setxattr(PyObject *module, PyObject *const *args, Py_ssize_t nargs, PyObject *kwnames)
{
    ...
    if (!PyBuffer_IsContiguous(&value, 'C')) {
        _PyArg_BadArgument("setxattr", 3, "argument 'value'", "contiguous buffer", args[2]);
        goto exit;
    }
    if (!noptargs) {
        goto skip_optional_pos;
...
/*[clinic end generated code: output=0d9b49effa61b7dd input=a9049054013a1b77]*/
