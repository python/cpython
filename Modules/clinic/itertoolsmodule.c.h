...
batched_new(PyTypeObject *type, PyObject *args, PyObject *kwargs)
{
    ...
    static struct {
        ...
        .ob_item = { &_Py_ID(iterable), _Py_LATIN1_CHAR_STRING('n'), &_Py_ID(strict), },
    };
    #undef NUM_KEYWORDS
...
itertools_combinations(PyTypeObject *type, PyObject *args, PyObject *kwargs)
{
    ...
    static struct {
        ...
        .ob_base = PyVarObject_HEAD_INIT(&PyTuple_Type, NUM_KEYWORDS)
        .ob_item = { &_Py_ID(iterable), _Py_LATIN1_CHAR_STRING('r'), },
    };
    #undef NUM_KEYWORDS
    #define KWTUPLE (&_kwtuple.ob_base.ob_base)
...
/*[clinic end generated code: output=5ed6699e7bd8e7d9 input=a9049054013a1b77]*/
