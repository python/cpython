...
{
    PyObject *return_value = NULL;
    PyTypeObject *self_tp = &pairwise_type;
    PyObject *iterable;
...
{
    PyObject *return_value = NULL;
    PyTypeObject *self_tp = &_grouper_type;
    PyObject *parent;
    PyObject *tgtkey;
...
{
    PyObject *return_value = NULL;
    PyTypeObject *self_tp = &teedataobject_type;
    PyObject *it;
    PyObject *values;
    PyObject *next;
...
{
    PyObject *return_value = NULL;
    PyTypeObject *self_tp = &cycle_type;
    PyObject *iterable;
...
{
    PyObject *return_value = NULL;
    PyTypeObject *self_tp = &dropwhile_type;
    PyObject *func;
    PyObject *seq;
...
{
    PyObject *return_value = NULL;
    PyTypeObject *self_tp = &takewhile_type;
    PyObject *func;
    PyObject *seq;
...
{
    PyObject *return_value = NULL;
    PyTypeObject *self_tp = &starmap_type;
    PyObject *func;
    PyObject *seq;
...
{
    PyObject *return_value = NULL;
    PyTypeObject *self_tp = &filterfalse_type;
    PyObject *func;
    PyObject *seq;
...
/*[clinic end generated code: output=472265c393aa2dde input=a9049054013a1b77]*/
