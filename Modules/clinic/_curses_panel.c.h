...
_curses_panel_panel_replace(PyCursesPanelObject *self, PyObject *arg)
{
    ...
    if (!PyObject_TypeCheck(arg, &PyCursesWindow_Type)) {
        _PyArg_BadArgument("replace", 0, "argument", (&PyCursesWindow_Type)->tp_name, arg);
        goto exit;
    }
...
_curses_panel_new_panel(PyObject *module, PyObject *arg)
{
    ...
    if (!PyObject_TypeCheck(arg, &PyCursesWindow_Type)) {
        _PyArg_BadArgument("new_panel", 0, "argument", (&PyCursesWindow_Type)->tp_name, arg);
        goto exit;
    }
    win = (PyCursesWindowObject *)arg;
...
/*[clinic end generated code: output=5c0578d645fc9688 input=a9049054013a1b77]*/
