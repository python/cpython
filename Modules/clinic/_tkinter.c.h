...
_tkinter_tkapp_eval(TkappObject *self, PyObject *arg)
{
    ...
    if (!PyUnicode_Check(arg)) {
        _PyArg_BadArgument("eval", 0, "argument", "str", arg);
        goto exit;
    }
...
_tkinter_tkapp_evalfile(TkappObject *self, PyObject *arg)
{
    ...
    if (!PyUnicode_Check(arg)) {
        _PyArg_BadArgument("evalfile", 0, "argument", "str", arg);
        goto exit;
    }
...
_tkinter_tkapp_record(TkappObject *self, PyObject *arg)
{
    ...
    if (!PyUnicode_Check(arg)) {
        _PyArg_BadArgument("record", 0, "argument", "str", arg);
        goto exit;
    }
    Py_ssize_t script_length;
    script = PyUnicode_AsUTF8AndSize(arg, &script_length);
...
_tkinter_tkapp_adderrorinfo(TkappObject *self, PyObject *arg)
{
    ...
    if (!PyUnicode_Check(arg)) {
        _PyArg_BadArgument("adderrorinfo", 0, "argument", "str", arg);
        goto exit;
    }
...
_tkinter_tkapp_exprstring(TkappObject *self, PyObject *arg)
{
    ...
    if (!PyUnicode_Check(arg)) {
        _PyArg_BadArgument("exprstring", 0, "argument", "str", arg);
        goto exit;
    }
    Py_ssize_t s_length;
...
_tkinter_tkapp_exprlong(TkappObject *self, PyObject *arg)
{
    ...
    if (!PyUnicode_Check(arg)) {
        _PyArg_BadArgument("exprlong", 0, "argument", "str", arg);
        goto exit;
    }
    Py_ssize_t s_length;
    s = PyUnicode_AsUTF8AndSize(arg, &s_length);
...
_tkinter_tkapp_exprdouble(TkappObject *self, PyObject *arg)
{
    ...
    if (!PyUnicode_Check(arg)) {
        _PyArg_BadArgument("exprdouble", 0, "argument", "str", arg);
        goto exit;
    }
    Py_ssize_t s_length;
    s = PyUnicode_AsUTF8AndSize(arg, &s_length);
...
_tkinter_tkapp_exprboolean(TkappObject *self, PyObject *arg)
{
    ...
    if (!PyUnicode_Check(arg)) {
        _PyArg_BadArgument("exprboolean", 0, "argument", "str", arg);
        goto exit;
    }
    Py_ssize_t s_length;
    s = PyUnicode_AsUTF8AndSize(arg, &s_length);
...
_tkinter_tkapp_createcommand(TkappObject *self, PyObject *const *args, Py_ssize_t nargs)
{
    ...
    if (!PyUnicode_Check(args[0])) {
        _PyArg_BadArgument("createcommand", 1, "argument 1", "str", args[0]);
        goto exit;
    }
...
_tkinter_tkapp_deletecommand(TkappObject *self, PyObject *arg)
{
    ...
    if (!PyUnicode_Check(arg)) {
        _PyArg_BadArgument("deletecommand", 0, "argument", "str", arg);
        goto exit;
    }
    Py_ssize_t name_length;
...
_tkinter_create(PyObject *module, PyObject *const *args, Py_ssize_t nargs)
{
    ...
    if (args[0] == Py_None) {
        ...
        _PyArg_BadArgument("create", 1, "argument 1", "str or None", args[0]);
        goto exit;
    }
    if (nargs < 2) {
        goto skip_optional;
    ...
    if (!PyUnicode_Check(args[1])) {
        _PyArg_BadArgument("create", 2, "argument 2", "str", args[1]);
        goto exit;
    }
    ...
    if (!PyUnicode_Check(args[2])) {
        _PyArg_BadArgument("create", 3, "argument 3", "str", args[2]);
        goto exit;
    }
    ...
    if (args[7] == Py_None) {
        ...
        _PyArg_BadArgument("create", 8, "argument 8", "str or None", args[7]);
        goto exit;
    }
skip_optional:
...
/*[clinic end generated code: output=c2f9c5e9da1a5c73 input=a9049054013a1b77]*/
