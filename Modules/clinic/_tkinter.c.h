...
_tkinter_tkapp_createcommand(TkappObject *self, PyObject *const *args, Py_ssize_t nargs)
{
    ...
    if (!PyUnicode_Check(args[0])) {
        _PyArg_BadArgument("createcommand", "str", args[0]);
        goto exit;
    }
...
_tkinter_create(PyObject *module, PyObject *const *args, Py_ssize_t nargs)
{
    ...
    if (args[0] == Py_None) {
        ...
        _PyArg_BadArgument("create", "str or None", args[0]);
        goto exit;
    }
    if (nargs < 2) {
        goto skip_optional;
    ...
    if (!PyUnicode_Check(args[1])) {
        _PyArg_BadArgument("create", "str", args[1]);
        goto exit;
    }
    ...
    if (!PyUnicode_Check(args[2])) {
        _PyArg_BadArgument("create", "str", args[2]);
        goto exit;
    }
    ...
    if (args[7] == Py_None) {
        ...
        _PyArg_BadArgument("create", "str or None", args[7]);
        goto exit;
    }
skip_optional:
