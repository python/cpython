...
_lzma__decode_filter_properties(PyObject *module, PyObject *const *args, Py_ssize_t nargs)
{
    ...
    if (!PyBuffer_IsContiguous(&encoded_props, 'C')) {
        _PyArg_BadArgument("_decode_filter_properties", 2, "argument 2", "contiguous buffer", args[1]);
        goto exit;
    }
...
/*[clinic end generated code: output=3542c05a754219ec input=a9049054013a1b77]*/
