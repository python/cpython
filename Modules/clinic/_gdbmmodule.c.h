...
dbmopen(PyObject *module, PyObject *const *args, Py_ssize_t nargs)
{
    ...
    if (!PyUnicode_Check(args[0])) {
        _PyArg_BadArgument("open", 1, NULL, "str", args[0]);
        goto exit;
    }
    ...
    if (!PyUnicode_Check(args[1])) {
        _PyArg_BadArgument("open", 2, NULL, "str", args[1]);
        goto exit;
    }
...
/*[clinic end generated code: output=ce9ed8c29a10355e input=a9049054013a1b77]*/
