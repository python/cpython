...
dbmopen(PyObject *module, PyObject *const *args, Py_ssize_t nargs)
{
    ...
    if (!PyUnicode_Check(args[0])) {
        _PyArg_BadArgument("open", 1, "argument 1", "str", args[0]);
        goto exit;
    }
    ...
    if (!PyUnicode_Check(args[1])) {
        _PyArg_BadArgument("open", 2, "argument 2", "str", args[1]);
        goto exit;
    }
...
/*[clinic end generated code: output=70dd3dc96ca4de1c input=a9049054013a1b77]*/
