...
_curses_ungetmouse(PyObject *module, PyObject *const *args, Py_ssize_t nargs)
{
    ...
    if (!PyLong_Check(args[4])) {
        _PyArg_BadArgument("ungetmouse", 5, "argument 5", "int", args[4]);
        goto exit;
    }
...
_curses_setupterm(PyObject *module, PyObject *const *args, Py_ssize_t nargs, PyObject *kwnames)
{
    ...
    if (args[0]) {
        if (args[0] == Py_None) {
            ...
            _PyArg_BadArgument("setupterm", 1, "argument 'term'", "str or None", args[0]);
            goto exit;
        }
        if (!--noptargs) {
            goto skip_optional_pos;
...
_curses_mousemask(PyObject *module, PyObject *arg)
{
    ...
    if (!PyLong_Check(arg)) {
        _PyArg_BadArgument("mousemask", 0, "argument", "int", arg);
        goto exit;
    }
...
_curses_tigetflag(PyObject *module, PyObject *arg)
{
    ...
    if (!PyUnicode_Check(arg)) {
        _PyArg_BadArgument("tigetflag", 0, "argument", "str", arg);
        goto exit;
    }
...
_curses_tigetnum(PyObject *module, PyObject *arg)
{
    ...
    if (!PyUnicode_Check(arg)) {
        _PyArg_BadArgument("tigetnum", 0, "argument", "str", arg);
        goto exit;
    }
    Py_ssize_t capname_length;
    capname = PyUnicode_AsUTF8AndSize(arg, &capname_length);
...
_curses_tigetstr(PyObject *module, PyObject *arg)
{
    ...
    if (!PyUnicode_Check(arg)) {
        _PyArg_BadArgument("tigetstr", 0, "argument", "str", arg);
        goto exit;
    }
    Py_ssize_t capname_length;
    capname = PyUnicode_AsUTF8AndSize(arg, &capname_length);
...
/*[clinic end generated code: output=d9d73b7b67072df0 input=a9049054013a1b77]*/
