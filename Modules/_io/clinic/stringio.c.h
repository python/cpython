...
#if defined(_io_StringIO_closed_HAS_DOCSTR) && !defined(_io_StringIO_closed_DOCSTR)
#  define _io_StringIO_closed_DOCSTR _io_StringIO_closed__doc__
#elif !defined(_io_StringIO_closed_DOCSTR)
...
#if defined(_io_StringIO_line_buffering_HAS_DOCSTR) && !defined(_io_StringIO_line_buffering_DOCSTR)
#  define _io_StringIO_line_buffering_DOCSTR _io_StringIO_line_buffering__doc__
#elif !defined(_io_StringIO_line_buffering_DOCSTR)
...
#if defined(_io_StringIO_newlines_HAS_DOCSTR) && !defined(_io_StringIO_newlines_DOCSTR)
#  define _io_StringIO_newlines_DOCSTR _io_StringIO_newlines__doc__
#elif !defined(_io_StringIO_newlines_DOCSTR)
...
/*[clinic end generated code: output=17bb4f3d4856b757 input=a9049054013a1b77]*/
