...
#define _IO_TEXTIOWRAPPER_BACKREAD_METHODDEF    \
    {"backread", _PyCFunction_CAST(_io_TextIOWrapper_backread), METH_FASTCALL, _io_TextIOWrapper_backread__doc__},

static PyObject *
_io_TextIOWrapper_backread_impl(textio *self, Py_ssize_t n);

static PyObject *
_io_TextIOWrapper_backread(textio *self, PyObject *const *args, Py_ssize_t nargs)
{
    PyObject *return_value = NULL;
    Py_ssize_t n = -1;
...
skip_optional:
    Py_BEGIN_CRITICAL_SECTION(self);
    return_value = _io_TextIOWrapper_backread_impl(self, n);
    Py_END_CRITICAL_SECTION();
