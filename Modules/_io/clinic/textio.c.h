...
_io_TextIOWrapper___init__(PyObject *self, PyObject *args, PyObject *kwargs)
{
    ...
    if (fastargs[1]) {
        if (fastargs[1] == Py_None) {
            ...
            _PyArg_BadArgument("TextIOWrapper", 2, "argument 'encoding'", "str or None", fastargs[1]);
            goto exit;
        }
        if (!--noptargs) {
            goto skip_optional_pos;
    ...
    if (fastargs[3]) {
        if (fastargs[3] == Py_None) {
            ...
            _PyArg_BadArgument("TextIOWrapper", 4, "argument 'newline'", "str or None", fastargs[3]);
            goto exit;
        }
        if (!--noptargs) {
            goto skip_optional_pos;
...
_io_TextIOWrapper_write(textio *self, PyObject *arg)
{
    ...
    if (!PyUnicode_Check(arg)) {
        _PyArg_BadArgument("write", 0, "argument", "str", arg);
        goto exit;
    }
...
/*[clinic end generated code: output=fa25e938e78ed2c7 input=a9049054013a1b77]*/
