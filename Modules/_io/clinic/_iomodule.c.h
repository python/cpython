...
_io_open(PyObject *module, PyObject *const *args, Py_ssize_t nargs, PyObject *kwnames)
{
    ...
    if (args[1]) {
        if (!PyUnicode_Check(args[1])) {
            _PyArg_BadArgument("open", 2, "argument 'mode'", "str", args[1]);
            goto exit;
        }
    ...
    if (args[3]) {
        if (args[3] == Py_None) {
            ...
            _PyArg_BadArgument("open", 4, "argument 'encoding'", "str or None", args[3]);
            goto exit;
        }
        if (!--noptargs) {
            goto skip_optional_pos;
    ...
    if (args[4]) {
        if (args[4] == Py_None) {
            ...
            _PyArg_BadArgument("open", 5, "argument 'errors'", "str or None", args[4]);
            goto exit;
        }
        if (!--noptargs) {
            goto skip_optional_pos;
    ...
    if (args[5]) {
        if (args[5] == Py_None) {
            ...
            _PyArg_BadArgument("open", 6, "argument 'newline'", "str or None", args[5]);
            goto exit;
        }
        if (!--noptargs) {
            goto skip_optional_pos;
...
_io_open_code(PyObject *module, PyObject *const *args, Py_ssize_t nargs, PyObject *kwnames)
{
    ...
    if (!PyUnicode_Check(args[0])) {
        _PyArg_BadArgument("open_code", 1, "argument 'path'", "str", args[0]);
        goto exit;
    }
...
/*[clinic end generated code: output=16642398793371ec input=a9049054013a1b77]*/
