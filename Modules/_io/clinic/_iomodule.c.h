...
_io_open(PyObject *module, PyObject *const *args, Py_ssize_t nargs, PyObject *kwnames)
{
    ...
    if (args[1]) {
        ...
        mode = PyUnicode_AsUTF8NoNUL(args[1]);
        if (mode == NULL) {
            goto exit;
        }
        if (!--noptargs) {
    ...
    if (args[3]) {
        if (args[3] == Py_None) {
            ...
            encoding = PyUnicode_AsUTF8NoNUL(args[3]);
            if (encoding == NULL) {
                goto exit;
            }
        }
    ...
    if (args[4]) {
        if (args[4] == Py_None) {
            ...
            errors = PyUnicode_AsUTF8NoNUL(args[4]);
            if (errors == NULL) {
                goto exit;
            }
        }
    ...
    if (args[5]) {
        if (args[5] == Py_None) {
            ...
            newline = PyUnicode_AsUTF8NoNUL(args[5]);
            if (newline == NULL) {
                goto exit;
            }
        }
...
/*[clinic end generated code: output=0b66ce439402f1ac input=a9049054013a1b77]*/
