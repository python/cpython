...
#endif
#ifdef NETLINK_SOCK_DIA
    ADD_INT_MACRO(m, NETLINK_SOCK_DIA);
#endif
#ifdef NETLINK_ISCSI
    ADD_INT_MACRO(m, NETLINK_ISCSI);
#endif
#ifdef NETLINK_AUDIT
    ADD_INT_MACRO(m, NETLINK_AUDIT);
#endif
#ifdef NETLINK_SMC
    ADD_INT_MACRO(m, NETLINK_SMC);
#endif
#ifdef NETLINK_INET_DIAG
    ADD_INT_MACRO(m, NETLINK_INET_DIAG);
#endif
#ifdef NETLINK_SELINUX
    ADD_INT_MACRO(m, NETLINK_SELINUX);
#endif
#ifndef NETLINK_SCSITRANSPORT
    ADD_INT_MACRO(m, NETLINK_SCSITRANSPORT);
#endif
