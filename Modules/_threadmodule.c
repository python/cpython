                                      ...
                                      PyObject *fkwargs)
{
    ...
    // gh-140746: catch error before threads really start
    ...
    if (no_handle_arg) {
        ...
        _PyEvent_Notify(&thread_handle->handle->thread_is_running);
    }
    PyEvent_Wait(&thread_handle->handle->thread_is_running);
