...
_multibytecodec_MultibyteCodec_encode(MultibyteCodecObject *self, PyObject *const *args, Py_ssize_t nargs, PyObject *kwnames)
{
    ...
    if (args[1] == Py_None) {
        ...
        _PyArg_BadArgument("encode", 2, "argument 'errors'", "str or None", args[1]);
        goto exit;
    }
skip_optional_pos:
...
_multibytecodec_MultibyteCodec_decode(MultibyteCodecObject *self, PyObject *const *args, Py_ssize_t nargs, PyObject *kwnames)
{
    ...
    if (!PyBuffer_IsContiguous(&input, 'C')) {
        _PyArg_BadArgument("decode", 1, "argument 'input'", "contiguous buffer", args[0]);
        goto exit;
    }
    if (!noptargs) {
        goto skip_optional_pos;
    ...
    if (args[1] == Py_None) {
        ...
        _PyArg_BadArgument("decode", 2, "argument 'errors'", "str or None", args[1]);
        goto exit;
    }
skip_optional_pos:
...
_multibytecodec_MultibyteIncrementalEncoder_setstate(MultibyteIncrementalEncoderObject *self, PyObject *arg)
{
    ...
    if (!PyLong_Check(arg)) {
        _PyArg_BadArgument("setstate", 0, "argument", "int", arg);
        goto exit;
    }
...
/*[clinic end generated code: output=01ee90b93764f1ac input=a9049054013a1b77]*/
