...
static PyGetSetDef element_getsetlist[] = {
    {"tag",
        ...
        PyDoct_STR("A string identifying what kind of data this element represents")},
    {"text",
        (getter)element_text_getter,
        (setter)element_text_setter,
        PyDoct_STR("A string of text directly after the start tag, or None")},
    {"tail",
        (getter)element_tail_getter,
        (setter)element_tail_setter,
        PyDoct_STR("A string of text directly after the end tag, or None")},
    {"attrib",
        (getter)element_attrib_getter,
        (setter)element_attrib_setter,
        PyDoct_STR("A dictionary containing the element's attributes")},
    {NULL},
};
