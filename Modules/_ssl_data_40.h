...
/* Generated on 2026-04-15T09:18:34.696139+00:00 */
/* Generated from Git commit v3.15.0a8-132-gd14e31ed683 */
...
static struct py_ssl_error_code error_codes[] = {
  ...
  #endif
  #ifdef CRMF_R_ERROR_SIGNING_POPO
    {"ERROR_SIGNING_POPO", ERR_LIB_CRMF, CRMF_R_ERROR_SIGNING_POPO},
  #else
    {"ERROR_SIGNING_POPO", 56, 129},
  #endif
  ...
  #endif
  #ifdef EVP_R_CONTEXT_FINALIZED
    {"CONTEXT_FINALIZED", ERR_LIB_EVP, EVP_R_CONTEXT_FINALIZED},
  #else
    {"CONTEXT_FINALIZED", 6, 239},
  #endif
  ...
  #endif
  #ifdef EVP_R_PROVIDER_GET_CTX_PARAMS_NOT_SUPPORTED
    {"PROVIDER_GET_CTX_PARAMS_NOT_SUPPORTED", ERR_LIB_EVP, EVP_R_PROVIDER_GET_CTX_PARAMS_NOT_SUPPORTED},
  #else
    {"PROVIDER_GET_CTX_PARAMS_NOT_SUPPORTED", 6, 238},
  #endif
  ...
  #endif
  #ifdef OSSL_ENCODER_R_BAD_PARAMETER_VALUE
    {"BAD_PARAMETER_VALUE", ERR_LIB_OSSL_ENCODER, OSSL_ENCODER_R_BAD_PARAMETER_VALUE},
  #else
    {"BAD_PARAMETER_VALUE", 59, 103},
  #endif
  ...
  #endif
  #ifdef OSSL_ENCODER_R_UNKNOWN_PARAMETER_NAME
    {"UNKNOWN_PARAMETER_NAME", ERR_LIB_OSSL_ENCODER, OSSL_ENCODER_R_UNKNOWN_PARAMETER_NAME},
  #else
    {"UNKNOWN_PARAMETER_NAME", 59, 104},
  #endif
  ...
  #endif
  #ifdef OSSL_STORE_R_NOT_A_SYMMETRIC_KEY
    {"NOT_A_SYMMETRIC_KEY", ERR_LIB_OSSL_STORE, OSSL_STORE_R_NOT_A_SYMMETRIC_KEY},
  #else
    {"NOT_A_SYMMETRIC_KEY", 44, 124},
  #endif
  ...
  #endif
  #ifdef PKCS12_R_INVALID_SALT_LENGTH
    {"INVALID_SALT_LENGTH", ERR_LIB_PKCS12, PKCS12_R_INVALID_SALT_LENGTH},
  #else
    {"INVALID_SALT_LENGTH", 35, 117},
  #endif
    ...
    {"INVALID_AEAD", 57, 231},
  #endif
  #ifdef PROV_R_INVALID_CIPHER
    {"INVALID_CIPHER", ERR_LIB_PROV, PROV_R_INVALID_CIPHER},
  #else
    {"INVALID_CIPHER", 57, 260},
  #endif
  ...
  #endif
  #ifdef PROV_R_INVALID_FUNCTION_NAME
    {"INVALID_FUNCTION_NAME", ERR_LIB_PROV, PROV_R_INVALID_FUNCTION_NAME},
  #else
    {"INVALID_FUNCTION_NAME", 57, 258},
  #endif
  #ifdef PROV_R_INVALID_INDEX_LENGTH
    {"INVALID_INDEX_LENGTH", ERR_LIB_PROV, PROV_R_INVALID_INDEX_LENGTH},
  #else
    {"INVALID_INDEX_LENGTH", 57, 259},
  #endif
    ...
    {"INVALID_KDF", 57, 232},
  #endif
  #ifdef PROV_R_INVALID_KDR
    {"INVALID_KDR", ERR_LIB_PROV, PROV_R_INVALID_KDR},
  #else
    {"INVALID_KDR", 57, 256},
  #endif
  ...
  #endif
  #ifdef PROV_R_INVALID_LABEL
    {"INVALID_LABEL", ERR_LIB_PROV, PROV_R_INVALID_LABEL},
  #else
    {"INVALID_LABEL", 57, 257},
  #endif
  ...
  #endif
  #ifdef PROV_R_MISSING_EID
    {"MISSING_EID", ERR_LIB_PROV, PROV_R_MISSING_EID},
  #else
    {"MISSING_EID", 57, 255},
  #endif
  ...
  #endif
  #ifdef PROV_R_PASSWORD_STRENGTH_TOO_WEAK
    {"PASSWORD_STRENGTH_TOO_WEAK", ERR_LIB_PROV, PROV_R_PASSWORD_STRENGTH_TOO_WEAK},
  #else
    {"PASSWORD_STRENGTH_TOO_WEAK", 57, 254},
  #endif
    ...
    {"BAD_ECC_CERT", 20, 304},
  #endif
  #ifdef SSL_R_BAD_ECHCONFIG_EXTENSION
    {"BAD_ECHCONFIG_EXTENSION", ERR_LIB_SSL, SSL_R_BAD_ECHCONFIG_EXTENSION},
  #else
    {"BAD_ECHCONFIG_EXTENSION", 20, 425},
  #endif
  ...
  #endif
  #ifdef SSL_R_ECH_DECODE_ERROR
    {"ECH_DECODE_ERROR", ERR_LIB_SSL, SSL_R_ECH_DECODE_ERROR},
  #else
    {"ECH_DECODE_ERROR", 20, 426},
  #endif
  #ifdef SSL_R_ECH_REQUIRED
    {"ECH_REQUIRED", ERR_LIB_SSL, SSL_R_ECH_REQUIRED},
  #else
    {"ECH_REQUIRED", 20, 424},
  #endif
    ...
    {"TLS_ALERT_BAD_CERTIFICATE", ERR_LIB_SSL, SSL_R_TLS_ALERT_BAD_CERTIFICATE},
  #else
    {"TLS_ALERT_BAD_CERTIFICATE", 20, 1042},
  #endif
  #ifdef SSL_R_TLS_ALERT_BAD_CERTIFICATE
    {"TLS_ALERT_BAD_CERTIFICATE", ERR_LIB_SSL, SSL_R_TLS_ALERT_BAD_CERTIFICATE},
  #else
    {"TLS_ALERT_BAD_CERTIFICATE", 20, 1042},
  #endif
  #ifdef SSL_R_TLS_ALERT_BAD_RECORD_MAC
    {"TLS_ALERT_BAD_RECORD_MAC", ERR_LIB_SSL, SSL_R_TLS_ALERT_BAD_RECORD_MAC},
  #else
    {"TLS_ALERT_BAD_RECORD_MAC", 20, 1020},
  #endif
  #ifdef SSL_R_TLS_ALERT_BAD_RECORD_MAC
    {"TLS_ALERT_BAD_RECORD_MAC", ERR_LIB_SSL, SSL_R_TLS_ALERT_BAD_RECORD_MAC},
  #else
    ...
    {"TLS_ALERT_CERTIFICATE_EXPIRED", ERR_LIB_SSL, SSL_R_TLS_ALERT_CERTIFICATE_EXPIRED},
  #else
    {"TLS_ALERT_CERTIFICATE_EXPIRED", 20, 1045},
  #endif
  #ifdef SSL_R_TLS_ALERT_CERTIFICATE_EXPIRED
    {"TLS_ALERT_CERTIFICATE_EXPIRED", ERR_LIB_SSL, SSL_R_TLS_ALERT_CERTIFICATE_EXPIRED},
  #else
    ...
    {"TLS_ALERT_CERTIFICATE_REVOKED", ERR_LIB_SSL, SSL_R_TLS_ALERT_CERTIFICATE_REVOKED},
  #else
    {"TLS_ALERT_CERTIFICATE_REVOKED", 20, 1044},
  #endif
  #ifdef SSL_R_TLS_ALERT_CERTIFICATE_REVOKED
    {"TLS_ALERT_CERTIFICATE_REVOKED", ERR_LIB_SSL, SSL_R_TLS_ALERT_CERTIFICATE_REVOKED},
  #else
    ...
    {"TLS_ALERT_CERTIFICATE_UNKNOWN", ERR_LIB_SSL, SSL_R_TLS_ALERT_CERTIFICATE_UNKNOWN},
  #else
    {"TLS_ALERT_CERTIFICATE_UNKNOWN", 20, 1046},
  #endif
  #ifdef SSL_R_TLS_ALERT_CERTIFICATE_UNKNOWN
    {"TLS_ALERT_CERTIFICATE_UNKNOWN", ERR_LIB_SSL, SSL_R_TLS_ALERT_CERTIFICATE_UNKNOWN},
  #else
    {"TLS_ALERT_CERTIFICATE_UNKNOWN", 20, 1046},
  #endif
  #ifdef SSL_R_TLS_ALERT_DECOMPRESSION_FAILURE
    {"TLS_ALERT_DECOMPRESSION_FAILURE", ERR_LIB_SSL, SSL_R_TLS_ALERT_DECOMPRESSION_FAILURE},
  #else
    {"TLS_ALERT_DECOMPRESSION_FAILURE", 20, 1030},
  #endif
  #ifdef SSL_R_TLS_ALERT_DECOMPRESSION_FAILURE
    {"TLS_ALERT_DECOMPRESSION_FAILURE", ERR_LIB_SSL, SSL_R_TLS_ALERT_DECOMPRESSION_FAILURE},
  #else
    {"TLS_ALERT_DECOMPRESSION_FAILURE", 20, 1030},
  #endif
  #ifdef SSL_R_TLS_ALERT_HANDSHAKE_FAILURE
    {"TLS_ALERT_HANDSHAKE_FAILURE", ERR_LIB_SSL, SSL_R_TLS_ALERT_HANDSHAKE_FAILURE},
  #else
    {"TLS_ALERT_HANDSHAKE_FAILURE", 20, 1040},
  #endif
  #ifdef SSL_R_TLS_ALERT_HANDSHAKE_FAILURE
    {"TLS_ALERT_HANDSHAKE_FAILURE", ERR_LIB_SSL, SSL_R_TLS_ALERT_HANDSHAKE_FAILURE},
  #else
    {"TLS_ALERT_HANDSHAKE_FAILURE", 20, 1040},
  #endif
  #ifdef SSL_R_TLS_ALERT_ILLEGAL_PARAMETER
    {"TLS_ALERT_ILLEGAL_PARAMETER", ERR_LIB_SSL, SSL_R_TLS_ALERT_ILLEGAL_PARAMETER},
  #else
    {"TLS_ALERT_ILLEGAL_PARAMETER", 20, 1047},
  #endif
  #ifdef SSL_R_TLS_ALERT_ILLEGAL_PARAMETER
    {"TLS_ALERT_ILLEGAL_PARAMETER", ERR_LIB_SSL, SSL_R_TLS_ALERT_ILLEGAL_PARAMETER},
  #else
    ...
    {"TLS_ALERT_NO_CERTIFICATE", ERR_LIB_SSL, SSL_R_TLS_ALERT_NO_CERTIFICATE},
  #else
    {"TLS_ALERT_NO_CERTIFICATE", 20, 1041},
  #endif
  #ifdef SSL_R_TLS_ALERT_NO_CERTIFICATE
    {"TLS_ALERT_NO_CERTIFICATE", ERR_LIB_SSL, SSL_R_TLS_ALERT_NO_CERTIFICATE},
  #else
    {"TLS_ALERT_NO_CERTIFICATE", 20, 1041},
  #endif
  #ifdef SSL_R_TLS_ALERT_UNEXPECTED_MESSAGE
    {"TLS_ALERT_UNEXPECTED_MESSAGE", ERR_LIB_SSL, SSL_R_TLS_ALERT_UNEXPECTED_MESSAGE},
  #else
    {"TLS_ALERT_UNEXPECTED_MESSAGE", 20, 1010},
  #endif
  #ifdef SSL_R_TLS_ALERT_UNEXPECTED_MESSAGE
    {"TLS_ALERT_UNEXPECTED_MESSAGE", ERR_LIB_SSL, SSL_R_TLS_ALERT_UNEXPECTED_MESSAGE},
  #else
    ...
    {"TLS_ALERT_UNSUPPORTED_CERTIFICATE", ERR_LIB_SSL, SSL_R_TLS_ALERT_UNSUPPORTED_CERTIFICATE},
  #else
    {"TLS_ALERT_UNSUPPORTED_CERTIFICATE", 20, 1043},
  #endif
  #ifdef SSL_R_TLS_ALERT_UNSUPPORTED_CERTIFICATE
    {"TLS_ALERT_UNSUPPORTED_CERTIFICATE", ERR_LIB_SSL, SSL_R_TLS_ALERT_UNSUPPORTED_CERTIFICATE},
  #else
    {"TLS_ALERT_UNSUPPORTED_CERTIFICATE", 20, 1043},
  #endif
  #ifdef SSL_R_TLS_EXT_INVALID_MAX_FRAGMENT_LENGTH
    {"TLS_EXT_INVALID_MAX_FRAGMENT_LENGTH", ERR_LIB_SSL, SSL_R_TLS_EXT_INVALID_MAX_FRAGMENT_LENGTH},
  #else
    {"TLS_EXT_INVALID_MAX_FRAGMENT_LENGTH", 20, 232},
  #endif
  #ifdef SSL_R_TLS_EXT_INVALID_SERVERNAME
    {"TLS_EXT_INVALID_SERVERNAME", ERR_LIB_SSL, SSL_R_TLS_EXT_INVALID_SERVERNAME},
  #else
    {"TLS_EXT_INVALID_SERVERNAME", 20, 319},
  #endif
  #ifdef SSL_R_TLS_EXT_INVALID_SERVERNAME_TYPE
    {"TLS_EXT_INVALID_SERVERNAME_TYPE", ERR_LIB_SSL, SSL_R_TLS_EXT_INVALID_SERVERNAME_TYPE},
  #else
    {"TLS_EXT_INVALID_SERVERNAME_TYPE", 20, 320},
  #endif
  ...
  #endif
  #ifdef SSL_R_TLS_SESSION_ID_TOO_LONG
    {"TLS_SESSION_ID_TOO_LONG", ERR_LIB_SSL, SSL_R_TLS_SESSION_ID_TOO_LONG},
  #else
    {"TLS_SESSION_ID_TOO_LONG", 20, 300},
  #endif
  ...
  #endif
  #ifdef X509_R_INVALID_EXTENSION
    {"INVALID_EXTENSION", ERR_LIB_X509, X509_R_INVALID_EXTENSION},
  #else
    {"INVALID_EXTENSION", 11, 146},
  #endif
