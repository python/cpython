...
#include "pycore_gc.h" // For PyGC_Head
#include "math.h"
...
_serializer_serialize_code(PyObject *self, PyObject *args)
{
    ...
    PyObject *co_code = NULL, *co_consts = NULL, *co_names = NULL,
             ...
             *co_linetable = NULL, *null_str = NULL, *output_str = NULL;
    Py_ssize_t i;
    ...
    if (code->co_linetable) {
        co_linetable = PyObject_CallFunctionObjArgs(callback,
                                                    code->co_linetable,
                                                    NULL);
    ...
    output_str = PyUnicode_FromFormat(
        ...
        "\t(PyObject*)%U, (PyObject*)%U, (PyObject*)%U,\n"
        /* co_cell2arg, co_filename, co_name, co_linetable */
