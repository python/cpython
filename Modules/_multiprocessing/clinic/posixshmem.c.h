...
_posixshmem_shm_open(PyObject *module, PyObject *const *args, Py_ssize_t nargs, PyObject *kwnames)
{
    ...
    if (!PyUnicode_Check(args[0])) {
        _PyArg_BadArgument("shm_open", 1, "argument 'path'", "str", args[0]);
        goto exit;
    }
...
_posixshmem_shm_unlink(PyObject *module, PyObject *const *args, Py_ssize_t nargs, PyObject *kwnames)
{
    ...
    if (!PyUnicode_Check(args[0])) {
        _PyArg_BadArgument("shm_unlink", 1, "argument 'path'", "str", args[0]);
        goto exit;
    }
    if (PyUnicode_READY(args[0]) == -1) {
        goto exit;
...
/*[clinic end generated code: output=6f0f6a641a6f1a1c input=a9049054013a1b77]*/
