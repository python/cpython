...
typedef struct _zipimporter_resourcereader ZipImporterResourceReader;

struct _zipimporter_resourcereader {
    PyObject_HEAD
    PyObject *zipimporter;      /* ZipImporter for this ResourceReader */
    PyObject *package_name;     /* Package name for this reader */
};

static void
zipimporter_rr_dealloc(ZipImporterResourceReader *self)
{
    PyObject_GC_UnTrack(self);
    Py_XDECREF(self->zipimporter);
    Py_XDECREF(self->package_name);
    Py_TYPE(self)->tp_free((PyObject *)self);
}

static PyObject *
zipimporter_rr_repr(ZipImporterResourceReader *self)
{
    return PyUnicode_FromFormat(
        "<zipimporter ResourceReader for %U in %U>",
        self->package_name,
        zipimporter_repr(self->zimporter));
}

/* GC support. */
static int
zipimporter_rr_traverse(PyObject *obj, visitproc visit, void *arg)
{
    ZipImporterResourceReader *self = (ZipImporterResourceReader *)obj;
    Py_VISIT(self->zipimporter);
    return 0;
}

/*[clinic input]
module zipimport
class zipimport.resource_reader "ZipImportResourceREader *" "&Zipimporter_REsourceReader_type"
[clinic start generated code]*/
/*[clinic end generated code: output=da39a3ee5e6b4b0d input=9481ac191bb00ddc]*/

/*[clinic input]
zipimport.resource_reader.__init__
...
/*[clinic end generated code: output=cf7c87e6c6ce56f5 input=fdbe40a074392368]*/
{
    self->zipimporter = zipimporter;
    Py_INCREF(self->zipimporter);
    self->package_name = package_name;
    Py_INCREF(self->package_name);
}

static PyMethodDef zipimporter_rr_methods[] = {
    {NULL,              NULL}   /* sentinel */
};

static PyMemberDef zipimporter_rr_members[] = {
    {NULL}
};

static PyTypeObject ZipImporter_ResourceReader_type = {
    PyVarObject_HEAD_INIT(DEFERRED_ADDRESS(&PyType_Type), 0)
    "zipimport.resource_reader",
    sizeof(ZipImporterResourceReader),
    0,                                          /* tp_itemsize */
    (destructor)zipimporter_rr_dealloc,         /* tp_dealloc */
    0,                                          /* tp_print */
    0,                                          /* tp_getattr */
    0,                                          /* tp_setattr */
    0,                                          /* tp_reserved */
    (reprfunc)zipimporter_rr_repr,              /* tp_repr */
    0,                                          /* tp_as_number */
    0,                                          /* tp_as_sequence */
    0,                                          /* tp_as_mapping */
    0,                                          /* tp_hash */
    ...
    Py_TPFLAGS_DEFAULT | Py_TPFLAGS_BASETYPE |
        Py_TPFLAGS_HAVE_GC,                     /* tp_flags */
    zipimport_resource_reader___init____doc__,  /* tp_doc */
    zipimporter_rr_traverse,                    /* tp_traverse */
    0,                                          /* tp_clear */
    0,                                          /* tp_richcompare */
    0,                                          /* tp_weaklistoffset */
    0,                                          /* tp_iter */
    0,                                          /* tp_iternext */
    zipimporter_rr_methods,                     /* tp_methods */
    zipimporter_rr_members,                     /* tp_members */
    0,                                          /* tp_getset */
    0,                                          /* tp_base */
    0,                                          /* tp_dict */
    0,                                          /* tp_descr_get */
    0,                                          /* tp_descr_set */
    0,                                          /* tp_dictoffset */
    (initproc)zipimport_resource_reader___init__, /* tp_init */
    PyType_GenericAlloc,                        /* tp_alloc */
    PyType_GenericNew,                          /* tp_new */
    PyObject_GC_Del,                            /* tp_free */
};
