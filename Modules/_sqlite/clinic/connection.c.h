...
blobopen(pysqlite_Connection *self, PyObject *const *args, Py_ssize_t nargs, PyObject *kwnames)
{
    ...
    table = PyUnicode_AsUTF8NoNUL(args[0]);
    if (table == NULL) {
        goto exit;
    }
    ...
    col = PyUnicode_AsUTF8NoNUL(args[1]);
    if (col == NULL) {
        goto exit;
    }
    ...
    name = PyUnicode_AsUTF8NoNUL(args[4]);
    if (name == NULL) {
        goto exit;
    }
skip_optional_kwonly:
...
pysqlite_connection_load_extension(pysqlite_Connection *self, PyObject *const *args, Py_ssize_t nargs, PyObject *kwnames)
{
    ...
    extension_name = PyUnicode_AsUTF8NoNUL(args[0]);
    ...
    if (args[1] == Py_None) {
        ...
        entrypoint = PyUnicode_AsUTF8NoNUL(args[1]);
        if (entrypoint == NULL) {
            goto exit;
        }
    }
...
pysqlite_connection_backup(pysqlite_Connection *self, PyObject *const *args, Py_ssize_t nargs, PyObject *kwnames)
{
    ...
    if (args[3]) {
        ...
        name = PyUnicode_AsUTF8NoNUL(args[3]);
        if (name == NULL) {
            goto exit;
        }
        if (!--noptargs) {
...
deserialize(pysqlite_Connection *self, PyObject *const *args, Py_ssize_t nargs, PyObject *kwnames)
{
    ...
    name = PyUnicode_AsUTF8NoNUL(args[1]);
    if (name == NULL) {
        goto exit;
    }
skip_optional_kwonly:
...
/*[clinic end generated code: output=7b73e7401cd046ea input=a9049054013a1b77]*/
