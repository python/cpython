...
static PyMethodDef connection_methods[] = {
    {"cursor", (PyCFunction)(void *)pysqlite_connection_cursor, METH_VARARGS|METH_KEYWORDS,
    ...
    {"create_function", (PyCFunction)(void *)pysqlite_connection_create_function, METH_VARARGS|METH_KEYWORDS,
        PyDoc_STR("Creates a new function. Non-standard.")},
    {"create_aggregate", (PyCFunction)(void *)pysqlite_connection_create_aggregate, METH_VARARGS|METH_KEYWORDS,
        PyDoc_STR("Creates a new aggregate. Non-standard.")},
    {"set_authorizer", (PyCFunction)(void *)pysqlite_connection_set_authorizer, METH_VARARGS|METH_KEYWORDS,
    ...
    #endif
    {"set_progress_handler", (PyCFunction)(void *)pysqlite_connection_set_progress_handler, METH_VARARGS|METH_KEYWORDS,
        PyDoc_STR("Sets progress handler callback. Non-standard.")},
    {"set_trace_callback", (PyCFunction)(void *)pysqlite_connection_set_trace_callback, METH_VARARGS|METH_KEYWORDS,
    ...
    #ifdef HAVE_BACKUP_API
    {"backup", (PyCFunction)(void *)pysqlite_connection_backup, METH_VARARGS | METH_KEYWORDS,
