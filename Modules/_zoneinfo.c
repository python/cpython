...
#define _PyZoneInfo_ZoneInfo_FAST_CAST(op)  ((PyZoneInfo_ZoneInfo *)(op))
#define _PyZoneInfo_ZoneInfo_CAST(op)       _PyZoneInfo_ZoneInfo_FAST_CAST(op)
...
zoneinfo_new_instance(zoneinfo_state *state, PyTypeObject *type, PyObject *key)
{
    ...
    if (load_data(state, _PyZoneInfo_ZoneInfo_FAST_CAST(self), file_obj)) {
        goto error;
    }
    ...
    _PyZoneInfo_ZoneInfo_FAST_CAST(self)->key = Py_NewRef(key);
...
/*[clinic end generated code: output=95e61dab86bb95c3 input=ef73d7a83bf8790e]*/
{
    ...
    if (instance == Py_None) {
        ...
        _PyZoneInfo_ZoneInfo_FAST_CAST(instance)->source = SOURCE_CACHE;
    }
...
{
    PyZoneInfo_ZoneInfo *self = _PyZoneInfo_ZoneInfo_CAST(op);
...
{
    PyZoneInfo_ZoneInfo *self = _PyZoneInfo_ZoneInfo_CAST(obj_self);
...
/*[clinic end generated code: output=77887d1d56a48324 input=d26111f29eed6863]*/
{
    ...
    self = _PyZoneInfo_ZoneInfo_FAST_CAST(obj_self);
...
{
    zoneinfo_state *state = zoneinfo_get_state_by_cls(cls);
    _ttinfo *tti = find_ttinfo(state, _PyZoneInfo_ZoneInfo_CAST(self), dt);
    if (tti == NULL) {
        return NULL;
    }
