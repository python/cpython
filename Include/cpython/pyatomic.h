...
// Performs an atomic compare-and-exchange. If `*obj` and `*expected` are
// equal, then `desired` is stored in `*obj`. Otherwise `*expected` is updated
// with the current value of `*obj`. Returns 1 on success and 0 on failure.
