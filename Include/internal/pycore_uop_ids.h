...
#define _MATCH_CLASS_GET_OPT_ATTR_r13 1125
#define _MATCH_CLASS_ISINSTANCE_r22 1126
#define _MATCH_KEYS_r23 1127
#define _MATCH_MAPPING_r02 1128
#define _MATCH_MAPPING_r12 1129
#define _MATCH_MAPPING_r23 1130
#define _MATCH_SEQUENCE_r02 1131
#define _MATCH_SEQUENCE_r12 1132
#define _MATCH_SEQUENCE_r23 1133
#define _MAYBE_EXPAND_METHOD_r00 1134
#define _MAYBE_EXPAND_METHOD_KW_r11 1135
#define _MONITOR_CALL_r00 1136
#define _MONITOR_CALL_KW_r11 1137
#define _MONITOR_JUMP_BACKWARD_r00 1138
#define _MONITOR_JUMP_BACKWARD_r11 1139
#define _MONITOR_JUMP_BACKWARD_r22 1140
#define _MONITOR_JUMP_BACKWARD_r33 1141
#define _MONITOR_RESUME_r00 1142
#define _NOP_r00 1143
#define _NOP_r11 1144
#define _NOP_r22 1145
#define _NOP_r33 1146
#define _POP_CALL_r20 1147
#define _POP_CALL_LOAD_CONST_INLINE_BORROW_r21 1148
#define _POP_CALL_ONE_r30 1149
#define _POP_CALL_ONE_LOAD_CONST_INLINE_BORROW_r31 1150
#define _POP_CALL_TWO_r30 1151
#define _POP_CALL_TWO_LOAD_CONST_INLINE_BORROW_r31 1152
#define _POP_EXCEPT_r10 1153
#define _POP_ITER_r20 1154
#define _POP_JUMP_IF_FALSE_r00 1155
#define _POP_JUMP_IF_FALSE_r10 1156
#define _POP_JUMP_IF_FALSE_r21 1157
#define _POP_JUMP_IF_FALSE_r32 1158
#define _POP_JUMP_IF_TRUE_r00 1159
#define _POP_JUMP_IF_TRUE_r10 1160
#define _POP_JUMP_IF_TRUE_r21 1161
#define _POP_JUMP_IF_TRUE_r32 1162
#define _POP_TOP_r10 1163
#define _POP_TOP_FLOAT_r00 1164
#define _POP_TOP_FLOAT_r10 1165
#define _POP_TOP_FLOAT_r21 1166
#define _POP_TOP_FLOAT_r32 1167
#define _POP_TOP_INT_r00 1168
#define _POP_TOP_INT_r10 1169
#define _POP_TOP_INT_r21 1170
#define _POP_TOP_INT_r32 1171
#define _POP_TOP_LOAD_CONST_INLINE_r11 1172
#define _POP_TOP_LOAD_CONST_INLINE_BORROW_r11 1173
#define _POP_TOP_NOP_r00 1174
#define _POP_TOP_NOP_r10 1175
#define _POP_TOP_NOP_r21 1176
#define _POP_TOP_NOP_r32 1177
#define _POP_TOP_UNICODE_r00 1178
#define _POP_TOP_UNICODE_r10 1179
#define _POP_TOP_UNICODE_r21 1180
#define _POP_TOP_UNICODE_r32 1181
#define _POP_TWO_r20 1182
#define _POP_TWO_LOAD_CONST_INLINE_BORROW_r21 1183
#define _PUSH_EXC_INFO_r02 1184
#define _PUSH_EXC_INFO_r12 1185
#define _PUSH_EXC_INFO_r23 1186
#define _PUSH_FRAME_r10 1187
#define _PUSH_NULL_r01 1188
#define _PUSH_NULL_r12 1189
#define _PUSH_NULL_r23 1190
#define _PUSH_NULL_CONDITIONAL_r00 1191
#define _PY_FRAME_GENERAL_r01 1192
#define _PY_FRAME_KW_r11 1193
#define _QUICKEN_RESUME_r00 1194
#define _QUICKEN_RESUME_r11 1195
#define _QUICKEN_RESUME_r22 1196
#define _QUICKEN_RESUME_r33 1197
#define _REPLACE_WITH_TRUE_r11 1198
#define _RESUME_CHECK_r00 1199
#define _RESUME_CHECK_r11 1200
#define _RESUME_CHECK_r22 1201
#define _RESUME_CHECK_r33 1202
#define _RETURN_GENERATOR_r01 1203
#define _RETURN_VALUE_r11 1204
#define _SAVE_RETURN_OFFSET_r00 1205
#define _SAVE_RETURN_OFFSET_r11 1206
#define _SAVE_RETURN_OFFSET_r22 1207
#define _SAVE_RETURN_OFFSET_r33 1208
#define _SEND_r22 1209
#define _SEND_GEN_FRAME_r22 1210
#define _SETUP_ANNOTATIONS_r00 1211
#define _SET_ADD_r10 1212
#define _SET_FUNCTION_ATTRIBUTE_r01 1213
#define _SET_FUNCTION_ATTRIBUTE_r11 1214
#define _SET_FUNCTION_ATTRIBUTE_r21 1215
#define _SET_FUNCTION_ATTRIBUTE_r32 1216
#define _SET_IP_r00 1217
#define _SET_IP_r11 1218
#define _SET_IP_r22 1219
#define _SET_IP_r33 1220
#define _SET_UPDATE_r10 1221
#define _SHUFFLE_3_LOAD_CONST_INLINE_BORROW_r03 1222
#define _SHUFFLE_3_LOAD_CONST_INLINE_BORROW_r13 1223
#define _SHUFFLE_3_LOAD_CONST_INLINE_BORROW_r23 1224
#define _SHUFFLE_3_LOAD_CONST_INLINE_BORROW_r33 1225
#define _SPILL_OR_RELOAD_r01 1226
#define _SPILL_OR_RELOAD_r02 1227
#define _SPILL_OR_RELOAD_r03 1228
#define _SPILL_OR_RELOAD_r10 1229
#define _SPILL_OR_RELOAD_r12 1230
#define _SPILL_OR_RELOAD_r13 1231
#define _SPILL_OR_RELOAD_r20 1232
#define _SPILL_OR_RELOAD_r21 1233
#define _SPILL_OR_RELOAD_r23 1234
#define _SPILL_OR_RELOAD_r30 1235
#define _SPILL_OR_RELOAD_r31 1236
#define _SPILL_OR_RELOAD_r32 1237
#define _START_EXECUTOR_r00 1238
#define _STORE_ATTR_r20 1239
#define _STORE_ATTR_INSTANCE_VALUE_r21 1240
#define _STORE_ATTR_SLOT_r21 1241
#define _STORE_ATTR_WITH_HINT_r21 1242
#define _STORE_DEREF_r10 1243
#define _STORE_FAST_r10 1244
#define _STORE_FAST_0_r10 1245
#define _STORE_FAST_1_r10 1246
#define _STORE_FAST_2_r10 1247
#define _STORE_FAST_3_r10 1248
#define _STORE_FAST_4_r10 1249
#define _STORE_FAST_5_r10 1250
#define _STORE_FAST_6_r10 1251
#define _STORE_FAST_7_r10 1252
#define _STORE_FAST_LOAD_FAST_r11 1253
#define _STORE_FAST_STORE_FAST_r20 1254
#define _STORE_GLOBAL_r10 1255
#define _STORE_NAME_r10 1256
#define _STORE_SLICE_r30 1257
#define _STORE_SUBSCR_r30 1258
#define _STORE_SUBSCR_DICT_r31 1259
#define _STORE_SUBSCR_LIST_INT_r32 1260
#define _SWAP_r11 1261
#define _SWAP_2_r02 1262
#define _SWAP_2_r12 1263
#define _SWAP_2_r22 1264
#define _SWAP_2_r33 1265
#define _SWAP_3_r03 1266
#define _SWAP_3_r13 1267
#define _SWAP_3_r23 1268
#define _SWAP_3_r33 1269
#define _TIER2_RESUME_CHECK_r00 1270
#define _TIER2_RESUME_CHECK_r11 1271
#define _TIER2_RESUME_CHECK_r22 1272
#define _TIER2_RESUME_CHECK_r33 1273
#define _TO_BOOL_r11 1274
#define _TO_BOOL_BOOL_r01 1275
#define _TO_BOOL_BOOL_r11 1276
#define _TO_BOOL_BOOL_r22 1277
#define _TO_BOOL_BOOL_r33 1278
#define _TO_BOOL_INT_r11 1279
#define _TO_BOOL_LIST_r11 1280
#define _TO_BOOL_NONE_r01 1281
#define _TO_BOOL_NONE_r11 1282
#define _TO_BOOL_NONE_r22 1283
#define _TO_BOOL_NONE_r33 1284
#define _TO_BOOL_STR_r11 1285
#define _TRACE_RECORD_r00 1286
#define _UNARY_INVERT_r11 1287
#define _UNARY_NEGATIVE_r11 1288
#define _UNARY_NOT_r01 1289
#define _UNARY_NOT_r11 1290
#define _UNARY_NOT_r22 1291
#define _UNARY_NOT_r33 1292
#define _UNPACK_EX_r10 1293
#define _UNPACK_SEQUENCE_r10 1294
#define _UNPACK_SEQUENCE_LIST_r10 1295
#define _UNPACK_SEQUENCE_TUPLE_r10 1296
#define _UNPACK_SEQUENCE_TWO_TUPLE_r12 1297
#define _WITH_EXCEPT_START_r33 1298
#define _YIELD_VALUE_r11 1299
#define MAX_UOP_REGS_ID 1299
