...
#define _CALL_BUILTIN_O_r01 604
...
#define _CALL_LEN_r31 609
#define _CALL_LIST_APPEND_r30 610
...
#define _CALL_STR_1_r31 616
#define _CALL_TUPLE_1_r31 617
...
#define _LOAD_FAST_LOAD_FAST_r02 1081
#define _LOAD_FAST_LOAD_FAST_r13 1082
#define _LOAD_FROM_DICT_OR_DEREF_r11 1083
#define _LOAD_FROM_DICT_OR_GLOBALS_r11 1084
#define _LOAD_GLOBAL_r00 1085
#define _LOAD_GLOBAL_BUILTINS_r01 1086
#define _LOAD_GLOBAL_MODULE_r01 1087
#define _LOAD_LOCALS_r01 1088
#define _LOAD_NAME_r01 1089
#define _LOAD_SMALL_INT_r01 1090
#define _LOAD_SMALL_INT_r12 1091
#define _LOAD_SMALL_INT_r23 1092
#define _LOAD_SMALL_INT_0_r01 1093
#define _LOAD_SMALL_INT_0_r12 1094
#define _LOAD_SMALL_INT_0_r23 1095
#define _LOAD_SMALL_INT_1_r01 1096
#define _LOAD_SMALL_INT_1_r12 1097
#define _LOAD_SMALL_INT_1_r23 1098
#define _LOAD_SMALL_INT_2_r01 1099
#define _LOAD_SMALL_INT_2_r12 1100
#define _LOAD_SMALL_INT_2_r23 1101
#define _LOAD_SMALL_INT_3_r01 1102
#define _LOAD_SMALL_INT_3_r12 1103
#define _LOAD_SMALL_INT_3_r23 1104
#define _LOAD_SPECIAL_r00 1105
#define _LOAD_SUPER_ATTR_ATTR_r31 1106
#define _LOAD_SUPER_ATTR_METHOD_r32 1107
#define _MAKE_CALLARGS_A_TUPLE_r33 1108
#define _MAKE_CELL_r00 1109
#define _MAKE_FUNCTION_r11 1110
#define _MAKE_WARM_r00 1111
#define _MAKE_WARM_r11 1112
#define _MAKE_WARM_r22 1113
#define _MAKE_WARM_r33 1114
#define _MAP_ADD_r20 1115
#define _MATCH_CLASS_r31 1116
#define _MATCH_KEYS_r23 1117
#define _MATCH_MAPPING_r02 1118
#define _MATCH_MAPPING_r12 1119
#define _MATCH_MAPPING_r23 1120
#define _MATCH_SEQUENCE_r02 1121
#define _MATCH_SEQUENCE_r12 1122
#define _MATCH_SEQUENCE_r23 1123
#define _MAYBE_EXPAND_METHOD_r00 1124
#define _MAYBE_EXPAND_METHOD_KW_r11 1125
#define _MONITOR_CALL_r00 1126
#define _MONITOR_CALL_KW_r11 1127
#define _MONITOR_JUMP_BACKWARD_r00 1128
#define _MONITOR_JUMP_BACKWARD_r11 1129
#define _MONITOR_JUMP_BACKWARD_r22 1130
#define _MONITOR_JUMP_BACKWARD_r33 1131
#define _MONITOR_RESUME_r00 1132
#define _NOP_r00 1133
#define _NOP_r11 1134
#define _NOP_r22 1135
#define _NOP_r33 1136
#define _POP_CALL_r20 1137
#define _POP_CALL_LOAD_CONST_INLINE_BORROW_r21 1138
#define _POP_CALL_ONE_r30 1139
#define _POP_CALL_ONE_LOAD_CONST_INLINE_BORROW_r31 1140
#define _POP_CALL_TWO_r30 1141
#define _POP_CALL_TWO_LOAD_CONST_INLINE_BORROW_r31 1142
#define _POP_EXCEPT_r10 1143
#define _POP_ITER_r20 1144
#define _POP_JUMP_IF_FALSE_r00 1145
#define _POP_JUMP_IF_FALSE_r10 1146
#define _POP_JUMP_IF_FALSE_r21 1147
#define _POP_JUMP_IF_FALSE_r32 1148
#define _POP_JUMP_IF_TRUE_r00 1149
#define _POP_JUMP_IF_TRUE_r10 1150
#define _POP_JUMP_IF_TRUE_r21 1151
#define _POP_JUMP_IF_TRUE_r32 1152
#define _POP_TOP_r10 1153
#define _POP_TOP_FLOAT_r00 1154
#define _POP_TOP_FLOAT_r10 1155
#define _POP_TOP_FLOAT_r21 1156
#define _POP_TOP_FLOAT_r32 1157
#define _POP_TOP_INT_r00 1158
#define _POP_TOP_INT_r10 1159
#define _POP_TOP_INT_r21 1160
#define _POP_TOP_INT_r32 1161
#define _POP_TOP_LOAD_CONST_INLINE_r11 1162
#define _POP_TOP_LOAD_CONST_INLINE_BORROW_r11 1163
#define _POP_TOP_NOP_r00 1164
#define _POP_TOP_NOP_r10 1165
#define _POP_TOP_NOP_r21 1166
#define _POP_TOP_NOP_r32 1167
#define _POP_TOP_UNICODE_r00 1168
#define _POP_TOP_UNICODE_r10 1169
#define _POP_TOP_UNICODE_r21 1170
#define _POP_TOP_UNICODE_r32 1171
#define _POP_TWO_r20 1172
#define _POP_TWO_LOAD_CONST_INLINE_BORROW_r21 1173
#define _PUSH_EXC_INFO_r02 1174
#define _PUSH_EXC_INFO_r12 1175
#define _PUSH_EXC_INFO_r23 1176
#define _PUSH_FRAME_r10 1177
#define _PUSH_NULL_r01 1178
#define _PUSH_NULL_r12 1179
#define _PUSH_NULL_r23 1180
#define _PUSH_NULL_CONDITIONAL_r00 1181
#define _PY_FRAME_GENERAL_r01 1182
#define _PY_FRAME_KW_r11 1183
#define _QUICKEN_RESUME_r00 1184
#define _QUICKEN_RESUME_r11 1185
#define _QUICKEN_RESUME_r22 1186
#define _QUICKEN_RESUME_r33 1187
#define _REPLACE_WITH_TRUE_r11 1188
#define _RESUME_CHECK_r00 1189
#define _RESUME_CHECK_r11 1190
#define _RESUME_CHECK_r22 1191
#define _RESUME_CHECK_r33 1192
#define _RETURN_GENERATOR_r01 1193
#define _RETURN_VALUE_r11 1194
#define _SAVE_RETURN_OFFSET_r00 1195
#define _SAVE_RETURN_OFFSET_r11 1196
#define _SAVE_RETURN_OFFSET_r22 1197
#define _SAVE_RETURN_OFFSET_r33 1198
#define _SEND_r22 1199
#define _SEND_GEN_FRAME_r22 1200
#define _SETUP_ANNOTATIONS_r00 1201
#define _SET_ADD_r10 1202
#define _SET_FUNCTION_ATTRIBUTE_r01 1203
#define _SET_FUNCTION_ATTRIBUTE_r11 1204
#define _SET_FUNCTION_ATTRIBUTE_r21 1205
#define _SET_FUNCTION_ATTRIBUTE_r32 1206
#define _SET_IP_r00 1207
#define _SET_IP_r11 1208
#define _SET_IP_r22 1209
#define _SET_IP_r33 1210
#define _SET_UPDATE_r10 1211
#define _SPILL_OR_RELOAD_r01 1212
#define _SPILL_OR_RELOAD_r02 1213
#define _SPILL_OR_RELOAD_r03 1214
#define _SPILL_OR_RELOAD_r10 1215
#define _SPILL_OR_RELOAD_r12 1216
#define _SPILL_OR_RELOAD_r13 1217
#define _SPILL_OR_RELOAD_r20 1218
#define _SPILL_OR_RELOAD_r21 1219
#define _SPILL_OR_RELOAD_r23 1220
#define _SPILL_OR_RELOAD_r30 1221
#define _SPILL_OR_RELOAD_r31 1222
#define _SPILL_OR_RELOAD_r32 1223
#define _START_EXECUTOR_r00 1224
#define _STORE_ATTR_r20 1225
#define _STORE_ATTR_INSTANCE_VALUE_r20 1226
#define _STORE_ATTR_SLOT_r20 1227
#define _STORE_ATTR_WITH_HINT_r20 1228
#define _STORE_DEREF_r10 1229
#define _STORE_FAST_r10 1230
#define _STORE_FAST_0_r10 1231
#define _STORE_FAST_1_r10 1232
#define _STORE_FAST_2_r10 1233
#define _STORE_FAST_3_r10 1234
#define _STORE_FAST_4_r10 1235
#define _STORE_FAST_5_r10 1236
#define _STORE_FAST_6_r10 1237
#define _STORE_FAST_7_r10 1238
#define _STORE_FAST_LOAD_FAST_r11 1239
#define _STORE_FAST_STORE_FAST_r20 1240
#define _STORE_GLOBAL_r10 1241
#define _STORE_NAME_r10 1242
#define _STORE_SLICE_r30 1243
#define _STORE_SUBSCR_r30 1244
#define _STORE_SUBSCR_DICT_r30 1245
#define _STORE_SUBSCR_LIST_INT_r30 1246
#define _SWAP_r11 1247
#define _SWAP_2_r02 1248
#define _SWAP_2_r12 1249
#define _SWAP_2_r22 1250
#define _SWAP_2_r33 1251
#define _SWAP_3_r03 1252
#define _SWAP_3_r13 1253
#define _SWAP_3_r23 1254
#define _SWAP_3_r33 1255
#define _TIER2_RESUME_CHECK_r00 1256
#define _TIER2_RESUME_CHECK_r11 1257
#define _TIER2_RESUME_CHECK_r22 1258
#define _TIER2_RESUME_CHECK_r33 1259
#define _TO_BOOL_r11 1260
#define _TO_BOOL_BOOL_r01 1261
#define _TO_BOOL_BOOL_r11 1262
#define _TO_BOOL_BOOL_r22 1263
#define _TO_BOOL_BOOL_r33 1264
#define _TO_BOOL_INT_r11 1265
#define _TO_BOOL_LIST_r11 1266
#define _TO_BOOL_NONE_r01 1267
#define _TO_BOOL_NONE_r11 1268
#define _TO_BOOL_NONE_r22 1269
#define _TO_BOOL_NONE_r33 1270
#define _TO_BOOL_STR_r11 1271
#define _TRACE_RECORD_r00 1272
#define _UNARY_INVERT_r11 1273
#define _UNARY_NEGATIVE_r11 1274
#define _UNARY_NOT_r01 1275
#define _UNARY_NOT_r11 1276
#define _UNARY_NOT_r22 1277
#define _UNARY_NOT_r33 1278
#define _UNPACK_EX_r10 1279
#define _UNPACK_SEQUENCE_r10 1280
#define _UNPACK_SEQUENCE_LIST_r10 1281
#define _UNPACK_SEQUENCE_TUPLE_r10 1282
#define _UNPACK_SEQUENCE_TWO_TUPLE_r12 1283
#define _WITH_EXCEPT_START_r33 1284
#define _YIELD_VALUE_r11 1285
#define MAX_UOP_REGS_ID 1285
