...
#define _LOAD_ATTR_INSTANCE_VALUE_r02 987
#define _LOAD_ATTR_INSTANCE_VALUE_r12 988
#define _LOAD_ATTR_INSTANCE_VALUE_r23 989
#define _LOAD_ATTR_METHOD_LAZY_DICT_r02 990
#define _LOAD_ATTR_METHOD_LAZY_DICT_r12 991
#define _LOAD_ATTR_METHOD_LAZY_DICT_r23 992
#define _LOAD_ATTR_METHOD_NO_DICT_r02 993
#define _LOAD_ATTR_METHOD_NO_DICT_r12 994
#define _LOAD_ATTR_METHOD_NO_DICT_r23 995
#define _LOAD_ATTR_METHOD_WITH_VALUES_r02 996
#define _LOAD_ATTR_METHOD_WITH_VALUES_r12 997
#define _LOAD_ATTR_METHOD_WITH_VALUES_r23 998
#define _LOAD_ATTR_MODULE_r11 999
#define _LOAD_ATTR_NONDESCRIPTOR_NO_DICT_r11 1000
#define _LOAD_ATTR_NONDESCRIPTOR_WITH_VALUES_r11 1001
#define _LOAD_ATTR_PROPERTY_FRAME_r11 1002
#define _LOAD_ATTR_SLOT_r11 1003
#define _LOAD_ATTR_WITH_HINT_r11 1004
#define _LOAD_BUILD_CLASS_r01 1005
#define _LOAD_BYTECODE_r00 1006
#define _LOAD_COMMON_CONSTANT_r01 1007
#define _LOAD_COMMON_CONSTANT_r12 1008
#define _LOAD_COMMON_CONSTANT_r23 1009
#define _LOAD_CONST_r01 1010
#define _LOAD_CONST_r12 1011
#define _LOAD_CONST_r23 1012
#define _LOAD_CONST_INLINE_r01 1013
#define _LOAD_CONST_INLINE_r12 1014
#define _LOAD_CONST_INLINE_r23 1015
#define _LOAD_CONST_INLINE_BORROW_r01 1016
#define _LOAD_CONST_INLINE_BORROW_r12 1017
#define _LOAD_CONST_INLINE_BORROW_r23 1018
#define _LOAD_CONST_UNDER_INLINE_r02 1019
#define _LOAD_CONST_UNDER_INLINE_r12 1020
#define _LOAD_CONST_UNDER_INLINE_r23 1021
#define _LOAD_CONST_UNDER_INLINE_BORROW_r02 1022
#define _LOAD_CONST_UNDER_INLINE_BORROW_r12 1023
#define _LOAD_CONST_UNDER_INLINE_BORROW_r23 1024
#define _LOAD_DEREF_r01 1025
#define _LOAD_FAST_r01 1026
#define _LOAD_FAST_r12 1027
#define _LOAD_FAST_r23 1028
#define _LOAD_FAST_0_r01 1029
#define _LOAD_FAST_0_r12 1030
#define _LOAD_FAST_0_r23 1031
#define _LOAD_FAST_1_r01 1032
#define _LOAD_FAST_1_r12 1033
#define _LOAD_FAST_1_r23 1034
#define _LOAD_FAST_2_r01 1035
#define _LOAD_FAST_2_r12 1036
#define _LOAD_FAST_2_r23 1037
#define _LOAD_FAST_3_r01 1038
#define _LOAD_FAST_3_r12 1039
#define _LOAD_FAST_3_r23 1040
#define _LOAD_FAST_4_r01 1041
#define _LOAD_FAST_4_r12 1042
#define _LOAD_FAST_4_r23 1043
#define _LOAD_FAST_5_r01 1044
#define _LOAD_FAST_5_r12 1045
#define _LOAD_FAST_5_r23 1046
#define _LOAD_FAST_6_r01 1047
#define _LOAD_FAST_6_r12 1048
#define _LOAD_FAST_6_r23 1049
#define _LOAD_FAST_7_r01 1050
#define _LOAD_FAST_7_r12 1051
#define _LOAD_FAST_7_r23 1052
#define _LOAD_FAST_AND_CLEAR_r01 1053
#define _LOAD_FAST_AND_CLEAR_r12 1054
#define _LOAD_FAST_AND_CLEAR_r23 1055
#define _LOAD_FAST_BORROW_r01 1056
#define _LOAD_FAST_BORROW_r12 1057
#define _LOAD_FAST_BORROW_r23 1058
#define _LOAD_FAST_BORROW_0_r01 1059
#define _LOAD_FAST_BORROW_0_r12 1060
#define _LOAD_FAST_BORROW_0_r23 1061
#define _LOAD_FAST_BORROW_1_r01 1062
#define _LOAD_FAST_BORROW_1_r12 1063
#define _LOAD_FAST_BORROW_1_r23 1064
#define _LOAD_FAST_BORROW_2_r01 1065
#define _LOAD_FAST_BORROW_2_r12 1066
#define _LOAD_FAST_BORROW_2_r23 1067
#define _LOAD_FAST_BORROW_3_r01 1068
#define _LOAD_FAST_BORROW_3_r12 1069
#define _LOAD_FAST_BORROW_3_r23 1070
#define _LOAD_FAST_BORROW_4_r01 1071
#define _LOAD_FAST_BORROW_4_r12 1072
#define _LOAD_FAST_BORROW_4_r23 1073
#define _LOAD_FAST_BORROW_5_r01 1074
#define _LOAD_FAST_BORROW_5_r12 1075
#define _LOAD_FAST_BORROW_5_r23 1076
#define _LOAD_FAST_BORROW_6_r01 1077
#define _LOAD_FAST_BORROW_6_r12 1078
#define _LOAD_FAST_BORROW_6_r23 1079
#define _LOAD_FAST_BORROW_7_r01 1080
#define _LOAD_FAST_BORROW_7_r12 1081
#define _LOAD_FAST_BORROW_7_r23 1082
#define _LOAD_FAST_BORROW_LOAD_FAST_BORROW_r02 1083
#define _LOAD_FAST_BORROW_LOAD_FAST_BORROW_r13 1084
#define _LOAD_FAST_CHECK_r01 1085
#define _LOAD_FAST_CHECK_r12 1086
#define _LOAD_FAST_CHECK_r23 1087
#define _LOAD_FAST_LOAD_FAST_r02 1088
#define _LOAD_FAST_LOAD_FAST_r13 1089
#define _LOAD_FROM_DICT_OR_DEREF_r11 1090
#define _LOAD_FROM_DICT_OR_GLOBALS_r11 1091
#define _LOAD_GLOBAL_r00 1092
#define _LOAD_GLOBAL_BUILTINS_r01 1093
#define _LOAD_GLOBAL_MODULE_r01 1094
#define _LOAD_LOCALS_r01 1095
#define _LOAD_LOCALS_r12 1096
#define _LOAD_LOCALS_r23 1097
#define _LOAD_NAME_r01 1098
#define _LOAD_SMALL_INT_r01 1099
#define _LOAD_SMALL_INT_r12 1100
#define _LOAD_SMALL_INT_r23 1101
#define _LOAD_SMALL_INT_0_r01 1102
#define _LOAD_SMALL_INT_0_r12 1103
#define _LOAD_SMALL_INT_0_r23 1104
#define _LOAD_SMALL_INT_1_r01 1105
#define _LOAD_SMALL_INT_1_r12 1106
#define _LOAD_SMALL_INT_1_r23 1107
#define _LOAD_SMALL_INT_2_r01 1108
#define _LOAD_SMALL_INT_2_r12 1109
#define _LOAD_SMALL_INT_2_r23 1110
#define _LOAD_SMALL_INT_3_r01 1111
#define _LOAD_SMALL_INT_3_r12 1112
#define _LOAD_SMALL_INT_3_r23 1113
#define _LOAD_SPECIAL_r00 1114
#define _LOAD_SUPER_ATTR_ATTR_r31 1115
#define _LOAD_SUPER_ATTR_METHOD_r32 1116
#define _MAKE_CALLARGS_A_TUPLE_r33 1117
#define _MAKE_CELL_r00 1118
#define _MAKE_FUNCTION_r11 1119
#define _MAKE_WARM_r00 1120
#define _MAKE_WARM_r11 1121
#define _MAKE_WARM_r22 1122
#define _MAKE_WARM_r33 1123
#define _MAP_ADD_r20 1124
#define _MATCH_CLASS_r31 1125
#define _MATCH_KEYS_r23 1126
#define _MATCH_MAPPING_r02 1127
#define _MATCH_MAPPING_r12 1128
#define _MATCH_MAPPING_r23 1129
#define _MATCH_SEQUENCE_r02 1130
#define _MATCH_SEQUENCE_r12 1131
#define _MATCH_SEQUENCE_r23 1132
#define _MAYBE_EXPAND_METHOD_r00 1133
#define _MAYBE_EXPAND_METHOD_KW_r11 1134
#define _MONITOR_CALL_r00 1135
#define _MONITOR_CALL_KW_r11 1136
#define _MONITOR_JUMP_BACKWARD_r00 1137
#define _MONITOR_JUMP_BACKWARD_r11 1138
#define _MONITOR_JUMP_BACKWARD_r22 1139
#define _MONITOR_JUMP_BACKWARD_r33 1140
#define _MONITOR_RESUME_r00 1141
#define _NOP_r00 1142
#define _NOP_r11 1143
#define _NOP_r22 1144
#define _NOP_r33 1145
#define _POP_CALL_r20 1146
#define _POP_CALL_LOAD_CONST_INLINE_BORROW_r21 1147
#define _POP_CALL_ONE_r30 1148
#define _POP_CALL_ONE_LOAD_CONST_INLINE_BORROW_r31 1149
#define _POP_CALL_TWO_r30 1150
#define _POP_CALL_TWO_LOAD_CONST_INLINE_BORROW_r31 1151
#define _POP_EXCEPT_r10 1152
#define _POP_ITER_r20 1153
#define _POP_JUMP_IF_FALSE_r00 1154
#define _POP_JUMP_IF_FALSE_r10 1155
#define _POP_JUMP_IF_FALSE_r21 1156
#define _POP_JUMP_IF_FALSE_r32 1157
#define _POP_JUMP_IF_TRUE_r00 1158
#define _POP_JUMP_IF_TRUE_r10 1159
#define _POP_JUMP_IF_TRUE_r21 1160
#define _POP_JUMP_IF_TRUE_r32 1161
#define _POP_TOP_r10 1162
#define _POP_TOP_FLOAT_r00 1163
#define _POP_TOP_FLOAT_r10 1164
#define _POP_TOP_FLOAT_r21 1165
#define _POP_TOP_FLOAT_r32 1166
#define _POP_TOP_INT_r00 1167
#define _POP_TOP_INT_r10 1168
#define _POP_TOP_INT_r21 1169
#define _POP_TOP_INT_r32 1170
#define _POP_TOP_LOAD_CONST_INLINE_r11 1171
#define _POP_TOP_LOAD_CONST_INLINE_BORROW_r11 1172
#define _POP_TOP_NOP_r00 1173
#define _POP_TOP_NOP_r10 1174
#define _POP_TOP_NOP_r21 1175
#define _POP_TOP_NOP_r32 1176
#define _POP_TOP_UNICODE_r00 1177
#define _POP_TOP_UNICODE_r10 1178
#define _POP_TOP_UNICODE_r21 1179
#define _POP_TOP_UNICODE_r32 1180
#define _POP_TWO_r20 1181
#define _POP_TWO_LOAD_CONST_INLINE_BORROW_r21 1182
#define _PUSH_EXC_INFO_r02 1183
#define _PUSH_EXC_INFO_r12 1184
#define _PUSH_EXC_INFO_r23 1185
#define _PUSH_FRAME_r10 1186
#define _PUSH_NULL_r01 1187
#define _PUSH_NULL_r12 1188
#define _PUSH_NULL_r23 1189
#define _PUSH_NULL_CONDITIONAL_r00 1190
#define _PY_FRAME_GENERAL_r01 1191
#define _PY_FRAME_KW_r11 1192
#define _QUICKEN_RESUME_r00 1193
#define _QUICKEN_RESUME_r11 1194
#define _QUICKEN_RESUME_r22 1195
#define _QUICKEN_RESUME_r33 1196
#define _REPLACE_WITH_TRUE_r11 1197
#define _RESUME_CHECK_r00 1198
#define _RESUME_CHECK_r11 1199
#define _RESUME_CHECK_r22 1200
#define _RESUME_CHECK_r33 1201
#define _RETURN_GENERATOR_r01 1202
#define _RETURN_VALUE_r11 1203
#define _SAVE_RETURN_OFFSET_r00 1204
#define _SAVE_RETURN_OFFSET_r11 1205
#define _SAVE_RETURN_OFFSET_r22 1206
#define _SAVE_RETURN_OFFSET_r33 1207
#define _SEND_r22 1208
#define _SEND_GEN_FRAME_r22 1209
#define _SETUP_ANNOTATIONS_r00 1210
#define _SET_ADD_r10 1211
#define _SET_FUNCTION_ATTRIBUTE_r01 1212
#define _SET_FUNCTION_ATTRIBUTE_r11 1213
#define _SET_FUNCTION_ATTRIBUTE_r21 1214
#define _SET_FUNCTION_ATTRIBUTE_r32 1215
#define _SET_IP_r00 1216
#define _SET_IP_r11 1217
#define _SET_IP_r22 1218
#define _SET_IP_r33 1219
#define _SET_UPDATE_r10 1220
#define _SPILL_OR_RELOAD_r01 1221
#define _SPILL_OR_RELOAD_r02 1222
#define _SPILL_OR_RELOAD_r03 1223
#define _SPILL_OR_RELOAD_r10 1224
#define _SPILL_OR_RELOAD_r12 1225
#define _SPILL_OR_RELOAD_r13 1226
#define _SPILL_OR_RELOAD_r20 1227
#define _SPILL_OR_RELOAD_r21 1228
#define _SPILL_OR_RELOAD_r23 1229
#define _SPILL_OR_RELOAD_r30 1230
#define _SPILL_OR_RELOAD_r31 1231
#define _SPILL_OR_RELOAD_r32 1232
#define _START_EXECUTOR_r00 1233
#define _STORE_ATTR_r20 1234
#define _STORE_ATTR_INSTANCE_VALUE_r21 1235
#define _STORE_ATTR_SLOT_r20 1236
#define _STORE_ATTR_WITH_HINT_r20 1237
#define _STORE_DEREF_r10 1238
#define _STORE_FAST_r10 1239
#define _STORE_FAST_0_r10 1240
#define _STORE_FAST_1_r10 1241
#define _STORE_FAST_2_r10 1242
#define _STORE_FAST_3_r10 1243
#define _STORE_FAST_4_r10 1244
#define _STORE_FAST_5_r10 1245
#define _STORE_FAST_6_r10 1246
#define _STORE_FAST_7_r10 1247
#define _STORE_FAST_LOAD_FAST_r11 1248
#define _STORE_FAST_STORE_FAST_r20 1249
#define _STORE_GLOBAL_r10 1250
#define _STORE_NAME_r10 1251
#define _STORE_SLICE_r30 1252
#define _STORE_SUBSCR_r30 1253
#define _STORE_SUBSCR_DICT_r31 1254
#define _STORE_SUBSCR_LIST_INT_r32 1255
#define _SWAP_r11 1256
#define _SWAP_2_r02 1257
#define _SWAP_2_r12 1258
#define _SWAP_2_r22 1259
#define _SWAP_2_r33 1260
#define _SWAP_3_r03 1261
#define _SWAP_3_r13 1262
#define _SWAP_3_r23 1263
#define _SWAP_3_r33 1264
#define _TIER2_RESUME_CHECK_r00 1265
#define _TIER2_RESUME_CHECK_r11 1266
#define _TIER2_RESUME_CHECK_r22 1267
#define _TIER2_RESUME_CHECK_r33 1268
#define _TO_BOOL_r11 1269
#define _TO_BOOL_BOOL_r01 1270
#define _TO_BOOL_BOOL_r11 1271
#define _TO_BOOL_BOOL_r22 1272
#define _TO_BOOL_BOOL_r33 1273
#define _TO_BOOL_INT_r11 1274
#define _TO_BOOL_LIST_r11 1275
#define _TO_BOOL_NONE_r01 1276
#define _TO_BOOL_NONE_r11 1277
#define _TO_BOOL_NONE_r22 1278
#define _TO_BOOL_NONE_r33 1279
#define _TO_BOOL_STR_r11 1280
#define _TRACE_RECORD_r00 1281
#define _UNARY_INVERT_r11 1282
#define _UNARY_NEGATIVE_r11 1283
#define _UNARY_NOT_r01 1284
#define _UNARY_NOT_r11 1285
#define _UNARY_NOT_r22 1286
#define _UNARY_NOT_r33 1287
#define _UNPACK_EX_r10 1288
#define _UNPACK_SEQUENCE_r10 1289
#define _UNPACK_SEQUENCE_LIST_r10 1290
#define _UNPACK_SEQUENCE_TUPLE_r10 1291
#define _UNPACK_SEQUENCE_TWO_TUPLE_r12 1292
#define _WITH_EXCEPT_START_r33 1293
#define _YIELD_VALUE_r11 1294
#define MAX_UOP_REGS_ID 1294
