...
// To use preserve_none in JIT builds, we need to declare a separate function pointer with __attribute__((preserve_none)) since
// this attribute is not supported in < clang 19.
