...
const uint16_t _PyUop_Flags[MAX_UOP_ID+1] = {
    ...
    [_CHECK_FUNCTION_VERSION_EX] = HAS_EXIT_FLAG,
    [_CALLARGS_TO_TUPLE] = HAS_ERROR_FLAG | HAS_ERROR_NO_POP_FLAG | HAS_ESCAPES_FLAG,
    [_PY_FRAME_EX] = HAS_ERROR_FLAG | HAS_ESCAPES_FLAG,
    [_CHECK_IS_NOT_PY_CALLABLE_EX] = HAS_EXIT_FLAG,
    [_CALL_EX_NON_PY] = HAS_ERROR_FLAG | HAS_ESCAPES_FLAG,
...
const char *const _PyOpcode_uop_name[MAX_UOP_ID+1] = {
    ...
    [_CALLARGS_TO_TUPLE] = "_CALLARGS_TO_TUPLE",
    ...
    [_CALL_EX_NON_PY] = "_CALL_EX_NON_PY",
    ...
    [_CHECK_FUNCTION_VERSION_EX] = "_CHECK_FUNCTION_VERSION_EX",
