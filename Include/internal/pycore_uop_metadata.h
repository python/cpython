...
const uint16_t _PyUop_Flags[MAX_UOP_ID+1] = {
    ...
    [_PUSH_FRAME_INLINEABLE] = HAS_ESCAPES_FLAG,
    ...
    [_GROW_TIER2_FRAME] = HAS_ARG_FLAG | HAS_DEOPT_FLAG | HAS_ESCAPES_FLAG,
    [_RECONSTRUCT_FRAME_INFO] = 0,
    [_TRUE_END] = 0,
};
...
const char *const _PyOpcode_uop_name[MAX_UOP_ID+1] = {
    ...
    [_GROW_TIER2_FRAME] = "_GROW_TIER2_FRAME",
    ...
    [_PUSH_FRAME_INLINEABLE] = "_PUSH_FRAME_INLINEABLE",
    [_PUSH_NULL] = "_PUSH_NULL",
    [_RECONSTRUCT_FRAME_INFO] = "_RECONSTRUCT_FRAME_INFO",
