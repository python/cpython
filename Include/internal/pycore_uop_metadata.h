...
const uint16_t _PyUop_Flags[MAX_UOP_ID+1] = {
    ...
    [_BINARY_OP_MULTIPLY_FLOAT__NO_INPUT_DECREF] = HAS_ERROR_FLAG | HAS_PURE_FLAG,
    [_BINARY_OP_ADD_FLOAT__NO_INPUT_DECREF] = HAS_ERROR_FLAG | HAS_PURE_FLAG,
    [_BINARY_OP_SUBTRACT_FLOAT__NO_INPUT_DECREF] = HAS_ERROR_FLAG | HAS_PURE_FLAG,
    ...
    [_BINARY_OP_SUBSCR_LIST_INT__NO_INPUT_DECREF] = HAS_DEOPT_FLAG | HAS_ESCAPES_FLAG,
    ...
    [_STORE_SUBSCR_LIST_INT__NO_INPUT_DECREF] = HAS_DEOPT_FLAG | HAS_ESCAPES_FLAG,
...
const char *const _PyOpcode_uop_name[MAX_UOP_ID+1] = {
    ...
    [_BINARY_OP_ADD_FLOAT__NO_INPUT_DECREF] = "_BINARY_OP_ADD_FLOAT__NO_INPUT_DECREF",
    ...
    [_BINARY_OP_MULTIPLY_FLOAT__NO_INPUT_DECREF] = "_BINARY_OP_MULTIPLY_FLOAT__NO_INPUT_DECREF",
    ...
    [_BINARY_OP_SUBSCR_LIST_INT__NO_INPUT_DECREF] = "_BINARY_OP_SUBSCR_LIST_INT__NO_INPUT_DECREF",
    ...
    [_BINARY_OP_SUBTRACT_FLOAT__NO_INPUT_DECREF] = "_BINARY_OP_SUBTRACT_FLOAT__NO_INPUT_DECREF",
    ...
    [_STORE_SUBSCR_LIST_INT__NO_INPUT_DECREF] = "_STORE_SUBSCR_LIST_INT__NO_INPUT_DECREF",
    [_SWAP] = "_SWAP",
