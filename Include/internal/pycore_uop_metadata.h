...
const uint16_t _PyUop_Flags[MAX_UOP_ID+1] = {
    ...
    [_LOAD_CONST] = HAS_ARG_FLAG | HAS_CONST_FLAG | HAS_ESCAPES_FLAG,
    [_LOAD_SMALL_INT_0] = HAS_ESCAPES_FLAG,
    [_LOAD_SMALL_INT_1] = HAS_ESCAPES_FLAG,
    [_LOAD_SMALL_INT_2] = HAS_ESCAPES_FLAG,
    [_LOAD_SMALL_INT_3] = HAS_ESCAPES_FLAG,
    [_LOAD_SMALL_INT] = HAS_ARG_FLAG | HAS_ESCAPES_FLAG,
