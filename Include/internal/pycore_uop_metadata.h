...
const uint16_t _PyUop_Flags[MAX_UOP_ID+1] = {
    ...
    [_LOAD_FAST_CHECK] = HAS_ARG_FLAG | HAS_ERROR_FLAG,
    [_LOAD_FAST] = HAS_ARG_FLAG,
    [_LOAD_FAST_AND_CLEAR] = HAS_ARG_FLAG,
    [_LOAD_FAST_LOAD_FAST] = HAS_ARG_FLAG,
    [_LOAD_CONST] = HAS_ARG_FLAG | HAS_CONST_FLAG,
    [_STORE_FAST] = HAS_ARG_FLAG,
    [_STORE_FAST_LOAD_FAST] = HAS_ARG_FLAG,
    [_STORE_FAST_STORE_FAST] = HAS_ARG_FLAG,
    [_POP_TOP] = 0,
    [_PUSH_NULL] = 0,
    ...
    [_BINARY_OP_INPLACE_ADD_UNICODE] = HAS_DEOPT_FLAG | HAS_ERROR_FLAG | HAS_ESCAPES_FLAG,
    ...
    [_INSTRUMENTED_RETURN_CONST] = HAS_ARG_FLAG | HAS_ERROR_FLAG | HAS_ESCAPES_FLAG | HAS_CONST_FLAG,
    ...
    [_STORE_NAME] = HAS_ARG_FLAG | HAS_ERROR_FLAG | HAS_ESCAPES_FLAG,
    [_DELETE_NAME] = HAS_ARG_FLAG | HAS_ERROR_FLAG | HAS_ESCAPES_FLAG,
    ...
    [_SPECIALIZE_STORE_ATTR] = HAS_ARG_FLAG | HAS_ESCAPES_FLAG,
    [_STORE_ATTR] = HAS_ARG_FLAG | HAS_ERROR_FLAG | HAS_ESCAPES_FLAG,
    [_DELETE_ATTR] = HAS_ARG_FLAG | HAS_ERROR_FLAG | HAS_ESCAPES_FLAG,
    [_STORE_GLOBAL] = HAS_ARG_FLAG | HAS_ERROR_FLAG | HAS_ESCAPES_FLAG,
    [_DELETE_GLOBAL] = HAS_ARG_FLAG | HAS_ERROR_FLAG | HAS_ESCAPES_FLAG,
    [_LOAD_LOCALS] = HAS_ERROR_FLAG | HAS_ESCAPES_FLAG,
    [_LOAD_FROM_DICT_OR_GLOBALS] = HAS_ARG_FLAG | HAS_ERROR_FLAG | HAS_ESCAPES_FLAG,
    [_LOAD_NAME] = HAS_ARG_FLAG | HAS_ERROR_FLAG | HAS_ESCAPES_FLAG,
    [_SPECIALIZE_LOAD_GLOBAL] = HAS_ARG_FLAG | HAS_ESCAPES_FLAG,
    [_LOAD_GLOBAL] = HAS_ARG_FLAG | HAS_ERROR_FLAG | HAS_ESCAPES_FLAG,
    ...
    [_DELETE_FAST] = HAS_ARG_FLAG | HAS_ERROR_FLAG,
    [_MAKE_CELL] = HAS_ARG_FLAG | HAS_ERROR_FLAG | HAS_ESCAPES_FLAG,
    [_DELETE_DEREF] = HAS_ARG_FLAG | HAS_ERROR_FLAG | HAS_ESCAPES_FLAG,
    [_LOAD_FROM_DICT_OR_DEREF] = HAS_ARG_FLAG | HAS_ERROR_FLAG | HAS_ESCAPES_FLAG,
    [_LOAD_DEREF] = HAS_ARG_FLAG | HAS_ERROR_FLAG | HAS_ESCAPES_FLAG,
    [_STORE_DEREF] = HAS_ARG_FLAG | HAS_ESCAPES_FLAG,
    ...
    [_LOAD_SUPER_ATTR] = HAS_ARG_FLAG | HAS_ERROR_FLAG | HAS_ESCAPES_FLAG,
    [_LOAD_SUPER_ATTR_ATTR] = HAS_ARG_FLAG | HAS_DEOPT_FLAG | HAS_ERROR_FLAG | HAS_ESCAPES_FLAG,
    [_LOAD_SUPER_ATTR_METHOD] = HAS_ARG_FLAG | HAS_DEOPT_FLAG | HAS_ERROR_FLAG | HAS_ESCAPES_FLAG,
    [_SPECIALIZE_LOAD_ATTR] = HAS_ARG_FLAG | HAS_ESCAPES_FLAG,
    [_LOAD_ATTR] = HAS_ARG_FLAG | HAS_ERROR_FLAG | HAS_ESCAPES_FLAG,
    ...
    [_LOAD_ATTR_WITH_HINT] = HAS_ARG_FLAG | HAS_DEOPT_FLAG | HAS_ESCAPES_FLAG,
    ...
    [_LOAD_ATTR_GETATTRIBUTE_OVERRIDDEN] = HAS_ARG_FLAG | HAS_DEOPT_FLAG | HAS_ESCAPES_FLAG,
    [_GUARD_DORV_VALUES] = HAS_DEOPT_FLAG,
    [_STORE_ATTR_INSTANCE_VALUE] = HAS_ESCAPES_FLAG,
    [_STORE_ATTR_WITH_HINT] = HAS_ARG_FLAG | HAS_DEOPT_FLAG | HAS_ESCAPES_FLAG,
    ...
    [_IMPORT_NAME] = HAS_ARG_FLAG | HAS_ERROR_FLAG | HAS_ESCAPES_FLAG,
    [_IMPORT_FROM] = HAS_ARG_FLAG | HAS_ERROR_FLAG | HAS_ESCAPES_FLAG,
