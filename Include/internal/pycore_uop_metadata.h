...
const uint32_t _PyUop_Flags[MAX_UOP_ID+1] = {
    ...
    [_BINARY_OP_ADD_INT_INPLACE] = HAS_EXIT_FLAG | HAS_ERROR_FLAG,
    [_BINARY_OP_SUBTRACT_INT_INPLACE] = HAS_EXIT_FLAG | HAS_ERROR_FLAG,
    [_BINARY_OP_MULTIPLY_INT_INPLACE] = HAS_EXIT_FLAG | HAS_ERROR_FLAG,
    [_BINARY_OP_ADD_INT_INPLACE_RIGHT] = HAS_EXIT_FLAG | HAS_ERROR_FLAG,
    [_BINARY_OP_SUBTRACT_INT_INPLACE_RIGHT] = HAS_EXIT_FLAG | HAS_ERROR_FLAG,
