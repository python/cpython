...
const uint16_t _PyUop_Flags[MAX_UOP_ID+1] = {
    ...
    [_LOAD_FAST_0] = HAS_LOCAL_FLAG | HAS_ESCAPES_FLAG | HAS_PURE_FLAG,
    [_LOAD_FAST_1] = HAS_LOCAL_FLAG | HAS_ESCAPES_FLAG | HAS_PURE_FLAG,
    ...
    [_LOAD_FAST_7] = HAS_LOCAL_FLAG | HAS_ESCAPES_FLAG | HAS_PURE_FLAG,
    [_LOAD_FAST] = HAS_ARG_FLAG | HAS_LOCAL_FLAG | HAS_ESCAPES_FLAG | HAS_PURE_FLAG,
    [_LOAD_FAST_AND_CLEAR] = HAS_ARG_FLAG | HAS_LOCAL_FLAG | HAS_ESCAPES_FLAG,
    [_LOAD_FAST_LOAD_FAST] = HAS_ARG_FLAG | HAS_LOCAL_FLAG | HAS_ESCAPES_FLAG,
    ...
    [_COPY_FREE_VARS] = HAS_ARG_FLAG | HAS_ESCAPES_FLAG,
