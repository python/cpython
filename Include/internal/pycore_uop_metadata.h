...
const uint16_t _PyUop_Flags[MAX_UOP_ID+1] = {
    ...
    [_GUARD_CALL_BUILTIN_O] = HAS_ARG_FLAG | HAS_EXIT_FLAG,
    [_CALL_BUILTIN_O_0] = HAS_EXIT_FLAG | HAS_ERROR_FLAG | HAS_ESCAPES_FLAG,
    [_CALL_BUILTIN_O_1] = HAS_EXIT_FLAG | HAS_ERROR_FLAG | HAS_ESCAPES_FLAG,
    [_CALL_BUILTIN_O] = HAS_ARG_FLAG | HAS_EXIT_FLAG | HAS_ERROR_FLAG | HAS_ESCAPES_FLAG,
    [_GUARD_CALL_BUILTIN_FAST] = HAS_ARG_FLAG | HAS_DEOPT_FLAG,
...
const char *const _PyOpcode_uop_name[MAX_UOP_ID+1] = {
    ...
    [_CALL_BUILTIN_O_0] = "_CALL_BUILTIN_O_0",
    [_CALL_BUILTIN_O_1] = "_CALL_BUILTIN_O_1",
    ...
    [_GUARD_CALL_BUILTIN_FAST] = "_GUARD_CALL_BUILTIN_FAST",
    [_GUARD_CALL_BUILTIN_O] = "_GUARD_CALL_BUILTIN_O",
