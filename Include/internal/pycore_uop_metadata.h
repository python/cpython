...
const uint16_t _PyUop_Flags[MAX_UOP_ID+1] = {
    ...
    [_LOAD_FAST_WITH_COUNT_0] = HAS_LOCAL_FLAG | HAS_ESCAPES_FLAG | HAS_PURE_FLAG,
    ...
    [_LOAD_CONST] = HAS_ARG_FLAG | HAS_CONST_FLAG | HAS_ESCAPES_FLAG | HAS_PURE_FLAG,
    ...
    [_CREATE_INIT_FRAME] = HAS_ARG_FLAG | HAS_ERROR_FLAG | HAS_ESCAPES_FLAG,
...
const char *const _PyOpcode_uop_name[MAX_UOP_ID+1] = {
    ...
    [_LOAD_FAST_WITH_COUNT] = "_LOAD_FAST_WITH_COUNT",
    [_LOAD_FAST_WITH_COUNT_0] = "_LOAD_FAST_WITH_COUNT_0",
    [_LOAD_FAST_WITH_COUNT_1] = "_LOAD_FAST_WITH_COUNT_1",
    [_LOAD_FAST_WITH_COUNT_2] = "_LOAD_FAST_WITH_COUNT_2",
    [_LOAD_FAST_WITH_COUNT_3] = "_LOAD_FAST_WITH_COUNT_3",
    [_LOAD_FAST_WITH_COUNT_4] = "_LOAD_FAST_WITH_COUNT_4",
    [_LOAD_FAST_WITH_COUNT_5] = "_LOAD_FAST_WITH_COUNT_5",
    [_LOAD_FAST_WITH_COUNT_6] = "_LOAD_FAST_WITH_COUNT_6",
    [_LOAD_FAST_WITH_COUNT_7] = "_LOAD_FAST_WITH_COUNT_7",
