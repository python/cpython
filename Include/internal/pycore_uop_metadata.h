...
const uint32_t _PyUop_Flags[MAX_UOP_ID+1] = {
    ...
    [_STORE_SUBSCR_DICT] = HAS_ERROR_FLAG | HAS_ERROR_NO_POP_FLAG | HAS_ESCAPES_FLAG,
...
const uint16_t _PyUop_Uncached[MAX_UOP_REGS_ID+1] = {
    ...
    [_STORE_SUBSCR_DICT_r32] = _STORE_SUBSCR_DICT,
...
const char *const _PyOpcode_uop_name[MAX_UOP_REGS_ID+1] = {
    ...
    [_STORE_SUBSCR_DICT_r32] = "_STORE_SUBSCR_DICT_r32",
