...
const uint32_t _PyUop_Flags[MAX_UOP_ID+1] = {
    ...
    [_STORE_SUBSCR_LIST_INT] = HAS_EXIT_FLAG | HAS_ESCAPES_FLAG,
    ...
    [_UNPACK_SEQUENCE_LIST] = HAS_ARG_FLAG | HAS_EXIT_FLAG | HAS_ESCAPES_FLAG,
    ...
    [_CALL_LIST_APPEND] = HAS_ARG_FLAG | HAS_EXIT_FLAG | HAS_ERROR_FLAG | HAS_ERROR_NO_POP_FLAG,
