...
const uint16_t _PyUop_Flags[MAX_UOP_ID+1] = {
    ...
    [_CHECK_PERIODIC_NOT_YIELD_FROM] = HAS_ARG_FLAG | HAS_EVAL_BREAK_FLAG | HAS_ERROR_FLAG | HAS_ESCAPES_FLAG,
...
const char *const _PyOpcode_uop_name[MAX_UOP_ID+1] = {
    ...
    [_CHECK_PERIODIC_NOT_YIELD_FROM] = "_CHECK_PERIODIC_NOT_YIELD_FROM",
