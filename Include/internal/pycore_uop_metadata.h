...
const uint16_t _PyUop_Flags[MAX_UOP_ID+1] = {
    ...
    [_LOAD_GLOBAL_0] = HAS_ARG_FLAG | HAS_NAME_FLAG | HAS_ERROR_FLAG | HAS_ESCAPES_FLAG,
    [_LOAD_GLOBAL_1] = HAS_ARG_FLAG | HAS_NAME_FLAG | HAS_ERROR_FLAG | HAS_ESCAPES_FLAG,
    [_LOAD_GLOBAL] = HAS_ARG_FLAG | HAS_NAME_FLAG | HAS_ERROR_FLAG | HAS_ESCAPES_FLAG | HAS_OPARG_AND_1_FLAG,
    [_GUARD_GLOBALS_VERSION] = HAS_DEOPT_FLAG,
    [_GUARD_BUILTINS_VERSION] = HAS_DEOPT_FLAG,
    [_LOAD_GLOBAL_MODULE_0] = HAS_ARG_FLAG | HAS_DEOPT_FLAG,
    [_LOAD_GLOBAL_MODULE_1] = HAS_ARG_FLAG | HAS_DEOPT_FLAG,
    [_LOAD_GLOBAL_MODULE] = HAS_ARG_FLAG | HAS_DEOPT_FLAG | HAS_OPARG_AND_1_FLAG,
    [_LOAD_GLOBAL_BUILTINS_0] = HAS_ARG_FLAG | HAS_DEOPT_FLAG,
    [_LOAD_GLOBAL_BUILTINS_1] = HAS_ARG_FLAG | HAS_DEOPT_FLAG,
    [_LOAD_GLOBAL_BUILTINS] = HAS_ARG_FLAG | HAS_DEOPT_FLAG | HAS_OPARG_AND_1_FLAG,
    ...
    [_LOAD_ATTR_0] = HAS_ARG_FLAG | HAS_NAME_FLAG | HAS_ERROR_FLAG | HAS_ESCAPES_FLAG,
    [_LOAD_ATTR_1] = HAS_ARG_FLAG | HAS_NAME_FLAG | HAS_ERROR_FLAG | HAS_ESCAPES_FLAG,
    [_LOAD_ATTR] = HAS_ARG_FLAG | HAS_NAME_FLAG | HAS_ERROR_FLAG | HAS_ESCAPES_FLAG | HAS_OPARG_AND_1_FLAG,
    ...
    [_LOAD_ATTR_INSTANCE_VALUE_0] = HAS_ARG_FLAG | HAS_DEOPT_FLAG,
    [_LOAD_ATTR_INSTANCE_VALUE_1] = HAS_ARG_FLAG | HAS_DEOPT_FLAG,
    ...
    [_LOAD_ATTR_MODULE_0] = HAS_ARG_FLAG | HAS_DEOPT_FLAG,
    [_LOAD_ATTR_MODULE_1] = HAS_ARG_FLAG | HAS_DEOPT_FLAG,
    [_LOAD_ATTR_MODULE] = HAS_ARG_FLAG | HAS_DEOPT_FLAG | HAS_OPARG_AND_1_FLAG,
    [_CHECK_ATTR_WITH_HINT] = HAS_DEOPT_FLAG | HAS_ESCAPES_FLAG | HAS_PASSTHROUGH_FLAG,
    [_LOAD_ATTR_WITH_HINT_0] = HAS_ARG_FLAG | HAS_NAME_FLAG | HAS_DEOPT_FLAG | HAS_ESCAPES_FLAG,
    [_LOAD_ATTR_WITH_HINT_1] = HAS_ARG_FLAG | HAS_NAME_FLAG | HAS_DEOPT_FLAG | HAS_ESCAPES_FLAG,
    [_LOAD_ATTR_WITH_HINT] = HAS_ARG_FLAG | HAS_NAME_FLAG | HAS_DEOPT_FLAG | HAS_ESCAPES_FLAG | HAS_OPARG_AND_1_FLAG,
    [_LOAD_ATTR_SLOT_0] = HAS_ARG_FLAG | HAS_DEOPT_FLAG,
    [_LOAD_ATTR_SLOT_1] = HAS_ARG_FLAG | HAS_DEOPT_FLAG,
    [_LOAD_ATTR_SLOT] = HAS_ARG_FLAG | HAS_DEOPT_FLAG | HAS_OPARG_AND_1_FLAG,
    [_CHECK_ATTR_CLASS] = HAS_DEOPT_FLAG | HAS_PASSTHROUGH_FLAG,
    [_LOAD_ATTR_CLASS_0] = HAS_ARG_FLAG,
    [_LOAD_ATTR_CLASS_1] = HAS_ARG_FLAG,
...
const char *const _PyOpcode_uop_name[MAX_UOP_ID+1] = {
    ...
    [_LOAD_ATTR_0] = "_LOAD_ATTR_0",
    [_LOAD_ATTR_1] = "_LOAD_ATTR_1",
    ...
    [_LOAD_ATTR_MODULE_0] = "_LOAD_ATTR_MODULE_0",
    [_LOAD_ATTR_MODULE_1] = "_LOAD_ATTR_MODULE_1",
    ...
    [_LOAD_ATTR_WITH_HINT_0] = "_LOAD_ATTR_WITH_HINT_0",
    [_LOAD_ATTR_WITH_HINT_1] = "_LOAD_ATTR_WITH_HINT_1",
    ...
    [_LOAD_GLOBAL_0] = "_LOAD_GLOBAL_0",
    [_LOAD_GLOBAL_1] = "_LOAD_GLOBAL_1",
    [_LOAD_GLOBAL_BUILTINS] = "_LOAD_GLOBAL_BUILTINS",
    [_LOAD_GLOBAL_BUILTINS_0] = "_LOAD_GLOBAL_BUILTINS_0",
    [_LOAD_GLOBAL_BUILTINS_1] = "_LOAD_GLOBAL_BUILTINS_1",
    [_LOAD_GLOBAL_MODULE] = "_LOAD_GLOBAL_MODULE",
    [_LOAD_GLOBAL_MODULE_0] = "_LOAD_GLOBAL_MODULE_0",
    [_LOAD_GLOBAL_MODULE_1] = "_LOAD_GLOBAL_MODULE_1",
