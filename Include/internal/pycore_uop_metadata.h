...
const uint16_t _PyUop_Flags[MAX_UOP_ID+1] = {
    [_NOP] = 0,
    [_RESUME_CHECK] = HAS_DEOPT_FLAG | HAS_PASSTHROUGH_FLAG,
    [_LOAD_FAST_CHECK] = HAS_ARG_FLAG | HAS_LOCAL_FLAG | HAS_ERROR_FLAG,
    [_LOAD_FAST] = HAS_ARG_FLAG | HAS_LOCAL_FLAG | HAS_PURE_FLAG,
    [_LOAD_FAST_AND_CLEAR] = HAS_ARG_FLAG | HAS_LOCAL_FLAG | HAS_PURE_FLAG,
    ...
    [_POP_FRAME] = HAS_ESCAPES_FLAG | HAS_PURE_FLAG,
    ...
    [_GUARD_GLOBALS_VERSION] = HAS_DEOPT_FLAG | HAS_PASSTHROUGH_FLAG,
    ...
    [_CHECK_PEP_523] = HAS_DEOPT_FLAG | HAS_PASSTHROUGH_FLAG,
    ...
    [_SAVE_RETURN_OFFSET] = HAS_ARG_FLAG | HAS_PASSTHROUGH_FLAG,
