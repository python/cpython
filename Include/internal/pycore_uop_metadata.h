...
const uint32_t _PyUop_Flags[MAX_UOP_ID+1] = {
    ...
    [_GUARD_TOS_COMPACT] = HAS_EXIT_FLAG,
    [_GUARD_NOS_COMPACT] = HAS_EXIT_FLAG,
    ...
    [_BINARY_OP_SUBTRACT_INT_WIDE] = HAS_EXIT_FLAG | HAS_ERROR_FLAG | HAS_ESCAPES_FLAG | HAS_PURE_FLAG,
    [_BINARY_OP_MULTIPLY_INT_WIDE] = HAS_EXIT_FLAG | HAS_ERROR_FLAG | HAS_ESCAPES_FLAG | HAS_PURE_FLAG,
    ...
    [_BINARY_OP_ADD_INT_WIDE_INPLACE] = HAS_EXIT_FLAG | HAS_ERROR_FLAG,
    [_BINARY_OP_SUBTRACT_INT_WIDE_INPLACE] = HAS_EXIT_FLAG | HAS_ERROR_FLAG,
    [_BINARY_OP_MULTIPLY_INT_WIDE_INPLACE] = HAS_EXIT_FLAG | HAS_ERROR_FLAG,
    [_BINARY_OP_ADD_INT_WIDE_INPLACE_RIGHT] = HAS_EXIT_FLAG | HAS_ERROR_FLAG,
    [_BINARY_OP_SUBTRACT_INT_WIDE_INPLACE_RIGHT] = HAS_EXIT_FLAG | HAS_ERROR_FLAG,
    [_BINARY_OP_MULTIPLY_INT_WIDE_INPLACE_RIGHT] = HAS_EXIT_FLAG | HAS_ERROR_FLAG,
    ...
    [_COMPARE_OP_INT] = HAS_ARG_FLAG | HAS_EXIT_FLAG | HAS_ESCAPES_FLAG,
...
const _PyUopCachingInfo _PyUop_Caching[MAX_UOP_ID+1] = {
    ...
    [_GUARD_TOS_COMPACT] = {
        .best = { 0, 1, 2, 3 },
        .entries = {
            { 1, 0, _GUARD_TOS_COMPACT_r01 },
            { 1, 1, _GUARD_TOS_COMPACT_r11 },
            { 2, 2, _GUARD_TOS_COMPACT_r22 },
            { 3, 3, _GUARD_TOS_COMPACT_r33 },
        },
    },
    [_GUARD_NOS_COMPACT] = {
        .best = { 0, 1, 2, 3 },
        .entries = {
            { 2, 0, _GUARD_NOS_COMPACT_r02 },
            { 2, 1, _GUARD_NOS_COMPACT_r12 },
            { 2, 2, _GUARD_NOS_COMPACT_r22 },
            { 3, 3, _GUARD_NOS_COMPACT_r33 },
        },
    },
    ...
    [_BINARY_OP_SUBTRACT_INT_WIDE] = {
        ...
        .entries = {
            { -1, -1, -1 },
            { -1, -1, -1 },
            { 3, 2, _BINARY_OP_SUBTRACT_INT_WIDE_r23 },
            { -1, -1, -1 },
        },
    },
    [_BINARY_OP_MULTIPLY_INT_WIDE] = {
        ...
        .entries = {
            { -1, -1, -1 },
            { -1, -1, -1 },
            { 3, 2, _BINARY_OP_MULTIPLY_INT_WIDE_r23 },
            { -1, -1, -1 },
        },
    },
    ...
    [_BINARY_OP_ADD_INT_WIDE_INPLACE] = {
        .best = { 0, 1, 2, 2 },
        .entries = {
            { 3, 0, _BINARY_OP_ADD_INT_WIDE_INPLACE_r03 },
            { 3, 1, _BINARY_OP_ADD_INT_WIDE_INPLACE_r13 },
            { 3, 2, _BINARY_OP_ADD_INT_WIDE_INPLACE_r23 },
            { -1, -1, -1 },
        },
    },
    [_BINARY_OP_SUBTRACT_INT_WIDE_INPLACE] = {
        .best = { 0, 1, 2, 2 },
        .entries = {
            { 3, 0, _BINARY_OP_SUBTRACT_INT_WIDE_INPLACE_r03 },
            { 3, 1, _BINARY_OP_SUBTRACT_INT_WIDE_INPLACE_r13 },
            { 3, 2, _BINARY_OP_SUBTRACT_INT_WIDE_INPLACE_r23 },
            { -1, -1, -1 },
        },
    },
    [_BINARY_OP_MULTIPLY_INT_WIDE_INPLACE] = {
        .best = { 0, 1, 2, 2 },
        .entries = {
            { 3, 0, _BINARY_OP_MULTIPLY_INT_WIDE_INPLACE_r03 },
            { 3, 1, _BINARY_OP_MULTIPLY_INT_WIDE_INPLACE_r13 },
            { 3, 2, _BINARY_OP_MULTIPLY_INT_WIDE_INPLACE_r23 },
            { -1, -1, -1 },
        },
    },
    [_BINARY_OP_ADD_INT_WIDE_INPLACE_RIGHT] = {
        .best = { 0, 1, 2, 2 },
        .entries = {
            { 3, 0, _BINARY_OP_ADD_INT_WIDE_INPLACE_RIGHT_r03 },
            { 3, 1, _BINARY_OP_ADD_INT_WIDE_INPLACE_RIGHT_r13 },
            { 3, 2, _BINARY_OP_ADD_INT_WIDE_INPLACE_RIGHT_r23 },
            { -1, -1, -1 },
        },
    },
    [_BINARY_OP_SUBTRACT_INT_WIDE_INPLACE_RIGHT] = {
        .best = { 0, 1, 2, 2 },
        .entries = {
            { 3, 0, _BINARY_OP_SUBTRACT_INT_WIDE_INPLACE_RIGHT_r03 },
            { 3, 1, _BINARY_OP_SUBTRACT_INT_WIDE_INPLACE_RIGHT_r13 },
            { 3, 2, _BINARY_OP_SUBTRACT_INT_WIDE_INPLACE_RIGHT_r23 },
            { -1, -1, -1 },
        },
    },
    [_BINARY_OP_MULTIPLY_INT_WIDE_INPLACE_RIGHT] = {
        .best = { 0, 1, 2, 2 },
        .entries = {
            { 3, 0, _BINARY_OP_MULTIPLY_INT_WIDE_INPLACE_RIGHT_r03 },
            { 3, 1, _BINARY_OP_MULTIPLY_INT_WIDE_INPLACE_RIGHT_r13 },
            { 3, 2, _BINARY_OP_MULTIPLY_INT_WIDE_INPLACE_RIGHT_r23 },
            { -1, -1, -1 },
        },
    },
    [_GUARD_NOS_FLOAT] = {
...
const uint16_t _PyUop_Uncached[MAX_UOP_REGS_ID+1] = {
    ...
    [_GUARD_TOS_COMPACT_r01] = _GUARD_TOS_COMPACT,
    [_GUARD_TOS_COMPACT_r11] = _GUARD_TOS_COMPACT,
    [_GUARD_TOS_COMPACT_r22] = _GUARD_TOS_COMPACT,
    [_GUARD_TOS_COMPACT_r33] = _GUARD_TOS_COMPACT,
    [_GUARD_NOS_COMPACT_r02] = _GUARD_NOS_COMPACT,
    [_GUARD_NOS_COMPACT_r12] = _GUARD_NOS_COMPACT,
    [_GUARD_NOS_COMPACT_r22] = _GUARD_NOS_COMPACT,
    [_GUARD_NOS_COMPACT_r33] = _GUARD_NOS_COMPACT,
    ...
    [_BINARY_OP_SUBTRACT_INT_WIDE_r23] = _BINARY_OP_SUBTRACT_INT_WIDE,
    [_BINARY_OP_MULTIPLY_INT_WIDE_r23] = _BINARY_OP_MULTIPLY_INT_WIDE,
    ...
    [_BINARY_OP_ADD_INT_WIDE_INPLACE_r03] = _BINARY_OP_ADD_INT_WIDE_INPLACE,
    [_BINARY_OP_ADD_INT_WIDE_INPLACE_r13] = _BINARY_OP_ADD_INT_WIDE_INPLACE,
    [_BINARY_OP_ADD_INT_WIDE_INPLACE_r23] = _BINARY_OP_ADD_INT_WIDE_INPLACE,
    [_BINARY_OP_SUBTRACT_INT_WIDE_INPLACE_r03] = _BINARY_OP_SUBTRACT_INT_WIDE_INPLACE,
    [_BINARY_OP_SUBTRACT_INT_WIDE_INPLACE_r13] = _BINARY_OP_SUBTRACT_INT_WIDE_INPLACE,
    [_BINARY_OP_SUBTRACT_INT_WIDE_INPLACE_r23] = _BINARY_OP_SUBTRACT_INT_WIDE_INPLACE,
    [_BINARY_OP_MULTIPLY_INT_WIDE_INPLACE_r03] = _BINARY_OP_MULTIPLY_INT_WIDE_INPLACE,
    [_BINARY_OP_MULTIPLY_INT_WIDE_INPLACE_r13] = _BINARY_OP_MULTIPLY_INT_WIDE_INPLACE,
    [_BINARY_OP_MULTIPLY_INT_WIDE_INPLACE_r23] = _BINARY_OP_MULTIPLY_INT_WIDE_INPLACE,
    [_BINARY_OP_ADD_INT_WIDE_INPLACE_RIGHT_r03] = _BINARY_OP_ADD_INT_WIDE_INPLACE_RIGHT,
    [_BINARY_OP_ADD_INT_WIDE_INPLACE_RIGHT_r13] = _BINARY_OP_ADD_INT_WIDE_INPLACE_RIGHT,
    [_BINARY_OP_ADD_INT_WIDE_INPLACE_RIGHT_r23] = _BINARY_OP_ADD_INT_WIDE_INPLACE_RIGHT,
    [_BINARY_OP_SUBTRACT_INT_WIDE_INPLACE_RIGHT_r03] = _BINARY_OP_SUBTRACT_INT_WIDE_INPLACE_RIGHT,
    [_BINARY_OP_SUBTRACT_INT_WIDE_INPLACE_RIGHT_r13] = _BINARY_OP_SUBTRACT_INT_WIDE_INPLACE_RIGHT,
    [_BINARY_OP_SUBTRACT_INT_WIDE_INPLACE_RIGHT_r23] = _BINARY_OP_SUBTRACT_INT_WIDE_INPLACE_RIGHT,
    [_BINARY_OP_MULTIPLY_INT_WIDE_INPLACE_RIGHT_r03] = _BINARY_OP_MULTIPLY_INT_WIDE_INPLACE_RIGHT,
    [_BINARY_OP_MULTIPLY_INT_WIDE_INPLACE_RIGHT_r13] = _BINARY_OP_MULTIPLY_INT_WIDE_INPLACE_RIGHT,
    [_BINARY_OP_MULTIPLY_INT_WIDE_INPLACE_RIGHT_r23] = _BINARY_OP_MULTIPLY_INT_WIDE_INPLACE_RIGHT,
...
const char *const _PyOpcode_uop_name[MAX_UOP_REGS_ID+1] = {
    ...
    [_BINARY_OP_ADD_INT_WIDE_INPLACE] = "_BINARY_OP_ADD_INT_WIDE_INPLACE",
    [_BINARY_OP_ADD_INT_WIDE_INPLACE_r03] = "_BINARY_OP_ADD_INT_WIDE_INPLACE_r03",
    [_BINARY_OP_ADD_INT_WIDE_INPLACE_r13] = "_BINARY_OP_ADD_INT_WIDE_INPLACE_r13",
    [_BINARY_OP_ADD_INT_WIDE_INPLACE_r23] = "_BINARY_OP_ADD_INT_WIDE_INPLACE_r23",
    [_BINARY_OP_ADD_INT_WIDE_INPLACE_RIGHT] = "_BINARY_OP_ADD_INT_WIDE_INPLACE_RIGHT",
    [_BINARY_OP_ADD_INT_WIDE_INPLACE_RIGHT_r03] = "_BINARY_OP_ADD_INT_WIDE_INPLACE_RIGHT_r03",
    [_BINARY_OP_ADD_INT_WIDE_INPLACE_RIGHT_r13] = "_BINARY_OP_ADD_INT_WIDE_INPLACE_RIGHT_r13",
    [_BINARY_OP_ADD_INT_WIDE_INPLACE_RIGHT_r23] = "_BINARY_OP_ADD_INT_WIDE_INPLACE_RIGHT_r23",
    ...
    [_BINARY_OP_MULTIPLY_INT_WIDE] = "_BINARY_OP_MULTIPLY_INT_WIDE",
    [_BINARY_OP_MULTIPLY_INT_WIDE_r23] = "_BINARY_OP_MULTIPLY_INT_WIDE_r23",
    [_BINARY_OP_MULTIPLY_INT_WIDE_INPLACE] = "_BINARY_OP_MULTIPLY_INT_WIDE_INPLACE",
    [_BINARY_OP_MULTIPLY_INT_WIDE_INPLACE_r03] = "_BINARY_OP_MULTIPLY_INT_WIDE_INPLACE_r03",
    [_BINARY_OP_MULTIPLY_INT_WIDE_INPLACE_r13] = "_BINARY_OP_MULTIPLY_INT_WIDE_INPLACE_r13",
    [_BINARY_OP_MULTIPLY_INT_WIDE_INPLACE_r23] = "_BINARY_OP_MULTIPLY_INT_WIDE_INPLACE_r23",
    [_BINARY_OP_MULTIPLY_INT_WIDE_INPLACE_RIGHT] = "_BINARY_OP_MULTIPLY_INT_WIDE_INPLACE_RIGHT",
    [_BINARY_OP_MULTIPLY_INT_WIDE_INPLACE_RIGHT_r03] = "_BINARY_OP_MULTIPLY_INT_WIDE_INPLACE_RIGHT_r03",
    [_BINARY_OP_MULTIPLY_INT_WIDE_INPLACE_RIGHT_r13] = "_BINARY_OP_MULTIPLY_INT_WIDE_INPLACE_RIGHT_r13",
    [_BINARY_OP_MULTIPLY_INT_WIDE_INPLACE_RIGHT_r23] = "_BINARY_OP_MULTIPLY_INT_WIDE_INPLACE_RIGHT_r23",
    ...
    [_BINARY_OP_SUBTRACT_INT_WIDE] = "_BINARY_OP_SUBTRACT_INT_WIDE",
    [_BINARY_OP_SUBTRACT_INT_WIDE_r23] = "_BINARY_OP_SUBTRACT_INT_WIDE_r23",
    [_BINARY_OP_SUBTRACT_INT_WIDE_INPLACE] = "_BINARY_OP_SUBTRACT_INT_WIDE_INPLACE",
    [_BINARY_OP_SUBTRACT_INT_WIDE_INPLACE_r03] = "_BINARY_OP_SUBTRACT_INT_WIDE_INPLACE_r03",
    [_BINARY_OP_SUBTRACT_INT_WIDE_INPLACE_r13] = "_BINARY_OP_SUBTRACT_INT_WIDE_INPLACE_r13",
    [_BINARY_OP_SUBTRACT_INT_WIDE_INPLACE_r23] = "_BINARY_OP_SUBTRACT_INT_WIDE_INPLACE_r23",
    [_BINARY_OP_SUBTRACT_INT_WIDE_INPLACE_RIGHT] = "_BINARY_OP_SUBTRACT_INT_WIDE_INPLACE_RIGHT",
    [_BINARY_OP_SUBTRACT_INT_WIDE_INPLACE_RIGHT_r03] = "_BINARY_OP_SUBTRACT_INT_WIDE_INPLACE_RIGHT_r03",
    [_BINARY_OP_SUBTRACT_INT_WIDE_INPLACE_RIGHT_r13] = "_BINARY_OP_SUBTRACT_INT_WIDE_INPLACE_RIGHT_r13",
    [_BINARY_OP_SUBTRACT_INT_WIDE_INPLACE_RIGHT_r23] = "_BINARY_OP_SUBTRACT_INT_WIDE_INPLACE_RIGHT_r23",
    ...
    [_GUARD_NOS_COMPACT] = "_GUARD_NOS_COMPACT",
    [_GUARD_NOS_COMPACT_r02] = "_GUARD_NOS_COMPACT_r02",
    [_GUARD_NOS_COMPACT_r12] = "_GUARD_NOS_COMPACT_r12",
    [_GUARD_NOS_COMPACT_r22] = "_GUARD_NOS_COMPACT_r22",
    [_GUARD_NOS_COMPACT_r33] = "_GUARD_NOS_COMPACT_r33",
    ...
    [_GUARD_TOS_COMPACT] = "_GUARD_TOS_COMPACT",
    [_GUARD_TOS_COMPACT_r01] = "_GUARD_TOS_COMPACT_r01",
    [_GUARD_TOS_COMPACT_r11] = "_GUARD_TOS_COMPACT_r11",
    [_GUARD_TOS_COMPACT_r22] = "_GUARD_TOS_COMPACT_r22",
    [_GUARD_TOS_COMPACT_r33] = "_GUARD_TOS_COMPACT_r33",
