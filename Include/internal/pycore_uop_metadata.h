...
const uint16_t _PyUop_Flags[MAX_UOP_ID+1] = {
    ...
    [_GUARD_CALLABLE_ISINSTANCE_NULL] = HAS_ARG_FLAG | HAS_DEOPT_FLAG,
    [_GUARD_CALLABLE_ISINSTANCE] = HAS_ARG_FLAG | HAS_DEOPT_FLAG,
    [_CALL_ISINSTANCE] = HAS_ARG_FLAG | HAS_ERROR_FLAG | HAS_ERROR_NO_POP_FLAG | HAS_ESCAPES_FLAG,
...
const char *const _PyOpcode_uop_name[MAX_UOP_ID+1] = {
    ...
    [_GUARD_CALLABLE_ISINSTANCE_NULL] = "_GUARD_CALLABLE_ISINSTANCE_NULL",
