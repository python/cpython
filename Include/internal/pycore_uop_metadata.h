...
const uint16_t _PyUop_Flags[MAX_UOP_ID+1] = {
    ...
    [_LOAD_CONST_INLINE] = HAS_SPECIAL_OPT_FLAG,
    [_LOAD_CONST_INLINE_BORROW] = HAS_SPECIAL_OPT_FLAG,
    [_LOAD_CONST_INLINE_WITH_NULL] = HAS_SPECIAL_OPT_FLAG,
    [_LOAD_CONST_INLINE_BORROW_WITH_NULL] = HAS_SPECIAL_OPT_FLAG,
    [_CHECK_GLOBALS] = HAS_DEOPT_FLAG | HAS_SPECIAL_OPT_FLAG,
    [_CHECK_BUILTINS] = HAS_DEOPT_FLAG | HAS_SPECIAL_OPT_FLAG,
