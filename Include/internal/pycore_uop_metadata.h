...
const uint16_t _PyUop_Flags[MAX_UOP_ID+1] = {
    ...
    [_UNARY_NOT] = HAS_ESCAPES_FLAG | HAS_PURE_FLAG,
    [_TO_BOOL] = HAS_ERROR_FLAG | HAS_ESCAPES_FLAG,
    [_TO_BOOL_BOOL] = HAS_EXIT_FLAG,
    [_TO_BOOL_INT] = HAS_EXIT_FLAG | HAS_ESCAPES_FLAG,
    [_TO_BOOL_LIST] = HAS_EXIT_FLAG | HAS_ESCAPES_FLAG,
    [_TO_BOOL_NONE] = HAS_EXIT_FLAG | HAS_ESCAPES_FLAG,
    ...
    [_BINARY_OP_ADD_FLOAT] = HAS_ESCAPES_FLAG | HAS_PURE_FLAG,
    [_BINARY_OP_SUBTRACT_FLOAT] = HAS_ESCAPES_FLAG | HAS_PURE_FLAG,
    ...
    [_LOAD_ATTR_INSTANCE_VALUE_0] = HAS_DEOPT_FLAG | HAS_ESCAPES_FLAG,
    [_LOAD_ATTR_INSTANCE_VALUE_1] = HAS_DEOPT_FLAG | HAS_ESCAPES_FLAG,
    [_LOAD_ATTR_INSTANCE_VALUE] = HAS_ARG_FLAG | HAS_DEOPT_FLAG | HAS_ESCAPES_FLAG | HAS_OPARG_AND_1_FLAG,
    [_CHECK_ATTR_MODULE] = HAS_DEOPT_FLAG,
    [_LOAD_ATTR_MODULE] = HAS_ARG_FLAG | HAS_DEOPT_FLAG | HAS_ESCAPES_FLAG,
    [_CHECK_ATTR_WITH_HINT] = HAS_DEOPT_FLAG,
    [_LOAD_ATTR_WITH_HINT] = HAS_ARG_FLAG | HAS_NAME_FLAG | HAS_DEOPT_FLAG | HAS_ESCAPES_FLAG,
    [_LOAD_ATTR_SLOT_0] = HAS_DEOPT_FLAG | HAS_ESCAPES_FLAG,
    [_LOAD_ATTR_SLOT_1] = HAS_DEOPT_FLAG | HAS_ESCAPES_FLAG,
    [_LOAD_ATTR_SLOT] = HAS_ARG_FLAG | HAS_DEOPT_FLAG | HAS_ESCAPES_FLAG | HAS_OPARG_AND_1_FLAG,
    [_CHECK_ATTR_CLASS] = HAS_DEOPT_FLAG,
    [_LOAD_ATTR_CLASS_0] = HAS_ESCAPES_FLAG,
    [_LOAD_ATTR_CLASS_1] = HAS_ESCAPES_FLAG,
    [_LOAD_ATTR_CLASS] = HAS_ARG_FLAG | HAS_ESCAPES_FLAG | HAS_OPARG_AND_1_FLAG,
    ...
    [_MATCH_MAPPING] = HAS_ESCAPES_FLAG,
    [_MATCH_SEQUENCE] = HAS_ESCAPES_FLAG,
    ...
    [_FOR_ITER_GEN_FRAME] = HAS_ARG_FLAG | HAS_DEOPT_FLAG | HAS_ESCAPES_FLAG,
    ...
    [_CHECK_METHOD_VERSION] = HAS_ARG_FLAG | HAS_EXIT_FLAG | HAS_ESCAPES_FLAG,
    ...
    [_CHECK_CALL_BOUND_METHOD_EXACT_ARGS] = HAS_ARG_FLAG | HAS_EXIT_FLAG | HAS_ESCAPES_FLAG,
    [_INIT_CALL_BOUND_METHOD_EXACT_ARGS] = HAS_ARG_FLAG,
    [_CHECK_PEP_523] = HAS_DEOPT_FLAG,
    [_CHECK_FUNCTION_EXACT_ARGS] = HAS_ARG_FLAG | HAS_EXIT_FLAG | HAS_ESCAPES_FLAG,
