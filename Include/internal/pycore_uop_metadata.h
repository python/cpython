...
const uint16_t _PyUop_Flags[MAX_UOP_ID+1] = {
    ...
    [_LOAD_FAST_1] = HAS_LOCAL_FLAG,
    [_LOAD_FAST_2] = HAS_LOCAL_FLAG,
    [_LOAD_FAST_3] = HAS_LOCAL_FLAG,
    [_LOAD_FAST_4] = HAS_LOCAL_FLAG,
    [_LOAD_FAST_5] = HAS_LOCAL_FLAG,
    [_LOAD_FAST_6] = HAS_LOCAL_FLAG,
    [_LOAD_FAST_7] = HAS_LOCAL_FLAG,
    [_LOAD_FAST] = HAS_ARG_FLAG | HAS_LOCAL_FLAG,
    [_LOAD_FAST_BORROW_0] = HAS_LOCAL_FLAG,
    [_LOAD_FAST_BORROW_1] = HAS_LOCAL_FLAG,
    [_LOAD_FAST_BORROW_2] = HAS_LOCAL_FLAG,
    [_LOAD_FAST_BORROW_3] = HAS_LOCAL_FLAG,
    [_LOAD_FAST_BORROW_4] = HAS_LOCAL_FLAG,
    [_LOAD_FAST_BORROW_5] = HAS_LOCAL_FLAG,
    [_LOAD_FAST_BORROW_6] = HAS_LOCAL_FLAG,
    [_LOAD_FAST_BORROW_7] = HAS_LOCAL_FLAG,
    ...
    [_END_SEND] = HAS_ESCAPES_FLAG,
    [_UNARY_NEGATIVE] = HAS_ERROR_FLAG | HAS_ESCAPES_FLAG | HAS_PURE_FLAG,
    ...
    [_UNARY_INVERT] = HAS_ERROR_FLAG | HAS_ESCAPES_FLAG | HAS_PURE_FLAG,
    ...
    [_BINARY_OP_MULTIPLY_FLOAT] = HAS_ERROR_FLAG,
    [_BINARY_OP_ADD_FLOAT] = HAS_ERROR_FLAG,
    [_BINARY_OP_SUBTRACT_FLOAT] = HAS_ERROR_FLAG,
    ...
    [_POP_TOP_LOAD_CONST_INLINE] = HAS_ESCAPES_FLAG,
