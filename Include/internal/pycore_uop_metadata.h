...
const char *const _PyOpcode_uop_name[MAX_UOP_ID+1] = {
    ...
    [_LOAD_FAST__LOAD_FAST_0] = "_LOAD_FAST__LOAD_FAST_0",
    [_LOAD_FAST__LOAD_FAST_1] = "_LOAD_FAST__LOAD_FAST_1",
    [_LOAD_FAST__LOAD_FAST_2] = "_LOAD_FAST__LOAD_FAST_2",
    [_LOAD_FAST__LOAD_FAST_3] = "_LOAD_FAST__LOAD_FAST_3",
    [_LOAD_FAST__LOAD_FAST_4] = "_LOAD_FAST__LOAD_FAST_4",
    [_LOAD_FAST__LOAD_FAST_5] = "_LOAD_FAST__LOAD_FAST_5",
    [_LOAD_FAST__LOAD_FAST_6] = "_LOAD_FAST__LOAD_FAST_6",
    [_LOAD_FAST__LOAD_FAST_7] = "_LOAD_FAST__LOAD_FAST_7",
