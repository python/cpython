...
const uint16_t _PyUop_Flags[MAX_UOP_ID+1] = {
    [_NOP] = 0,
    [_RESUME_CHECK] = HAS_DEOPT_FLAG | PASSTHROUGH,
    [_LOAD_FAST_CHECK] = HAS_ARG_FLAG | HAS_LOCAL_FLAG | HAS_ERROR_FLAG,
    [_LOAD_FAST] = HAS_ARG_FLAG | HAS_LOCAL_FLAG | PURE,
    [_LOAD_FAST_AND_CLEAR] = HAS_ARG_FLAG | HAS_LOCAL_FLAG | PURE,
    [_LOAD_FAST_LOAD_FAST] = HAS_ARG_FLAG | HAS_LOCAL_FLAG,
    [_LOAD_CONST] = HAS_ARG_FLAG | HAS_CONST_FLAG | PURE,
    ...
    [_GUARD_BOTH_INT] = HAS_DEOPT_FLAG | PASSTHROUGH,
    [_BINARY_OP_MULTIPLY_INT] = HAS_ERROR_FLAG | PURE,
    [_BINARY_OP_ADD_INT] = HAS_ERROR_FLAG | PURE,
    [_BINARY_OP_SUBTRACT_INT] = HAS_ERROR_FLAG | PURE,
    [_GUARD_BOTH_FLOAT] = HAS_DEOPT_FLAG | PASSTHROUGH,
    [_BINARY_OP_MULTIPLY_FLOAT] = PURE,
    [_BINARY_OP_ADD_FLOAT] = PURE,
    [_BINARY_OP_SUBTRACT_FLOAT] = PURE,
    [_GUARD_BOTH_UNICODE] = HAS_DEOPT_FLAG,
    [_BINARY_OP_ADD_UNICODE] = HAS_ERROR_FLAG | HAS_ESCAPES_FLAG | PURE,
    ...
    [_POP_FRAME] = HAS_ESCAPES_FLAG | PURE,
    ...
    [_GUARD_GLOBALS_VERSION] = HAS_DEOPT_FLAG | PASSTHROUGH,
    [_GUARD_BUILTINS_VERSION] = HAS_DEOPT_FLAG | PASSTHROUGH,
    ...
    [_GUARD_TYPE_VERSION] = HAS_DEOPT_FLAG | PASSTHROUGH,
    [_CHECK_MANAGED_OBJECT_HAS_VALUES] = HAS_DEOPT_FLAG | PASSTHROUGH,
    ...
    [_GUARD_DORV_VALUES] = HAS_DEOPT_FLAG | PASSTHROUGH,
    ...
    [_PUSH_EXC_INFO] = 0,
    [_GUARD_DORV_VALUES_INST_ATTR_FROM_DICT] = HAS_DEOPT_FLAG | PASSTHROUGH,
    [_GUARD_KEYS_VERSION] = HAS_DEOPT_FLAG | PASSTHROUGH,
    ...
    [_CHECK_CALL_BOUND_METHOD_EXACT_ARGS] = HAS_ARG_FLAG | HAS_DEOPT_FLAG | PASSTHROUGH,
    [_INIT_CALL_BOUND_METHOD_EXACT_ARGS] = HAS_ARG_FLAG,
    [_CHECK_PEP_523] = HAS_DEOPT_FLAG | PASSTHROUGH,
    [_CHECK_FUNCTION_EXACT_ARGS] = HAS_ARG_FLAG | HAS_DEOPT_FLAG | PASSTHROUGH,
    [_CHECK_STACK_SPACE] = HAS_ARG_FLAG | HAS_DEOPT_FLAG | PASSTHROUGH,
    [_INIT_CALL_PY_EXACT_ARGS] = HAS_ARG_FLAG | HAS_ESCAPES_FLAG | PURE,
    [_PUSH_FRAME] = PURE,
    ...
    [_COPY] = HAS_ARG_FLAG | PURE,
    [_BINARY_OP] = HAS_ARG_FLAG | HAS_ERROR_FLAG,
    [_SWAP] = HAS_ARG_FLAG | PURE,
    ...
    [_SAVE_RETURN_OFFSET] = HAS_ARG_FLAG | PASSTHROUGH,
