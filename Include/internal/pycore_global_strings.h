...
struct _Py_global_strings {
    ...
    struct {
        STRUCT_FOR_ID(AMPEREQUAL)
        STRUCT_FOR_ID(ATEQUAL)
        STRUCT_FOR_ID(CANCELLED)
        STRUCT_FOR_ID(CIRCUMFLEXEQUAL)
        STRUCT_FOR_ID(COLONEQUAL)
        STRUCT_FOR_ID(DOUBLESLASH)
        STRUCT_FOR_ID(DOUBLESLASHEQUAL)
        STRUCT_FOR_ID(DOUBLESTAR)
        STRUCT_FOR_ID(DOUBLESTAREQUAL)
        STRUCT_FOR_ID(ELLIPSIS)
        STRUCT_FOR_ID(EQEQUAL)
        STRUCT_FOR_ID(Emax)
        STRUCT_FOR_ID(Emin)
        STRUCT_FOR_ID(FINISHED)
        STRUCT_FOR_ID(False)
        STRUCT_FOR_ID(GREATEREQUAL)
        STRUCT_FOR_ID(JSONDecodeError)
        STRUCT_FOR_ID(LEFTSHIFT)
        STRUCT_FOR_ID(LEFTSHIFTEQUAL)
        STRUCT_FOR_ID(LESSEQUAL)
        STRUCT_FOR_ID(MINEQUAL)
        STRUCT_FOR_ID(NOTEQUAL)
        STRUCT_FOR_ID(PENDING)
        STRUCT_FOR_ID(PERCENTEQUAL)
        STRUCT_FOR_ID(PLUSEQUAL)
        STRUCT_FOR_ID(Py_Repr)
        STRUCT_FOR_ID(RARROW)
        STRUCT_FOR_ID(RIGHTSHIFT)
        STRUCT_FOR_ID(RIGHTSHIFTEQUAL)
        STRUCT_FOR_ID(SLASHEQUAL)
        STRUCT_FOR_ID(STAREQUAL)
        STRUCT_FOR_ID(TextIOWrapper)
        STRUCT_FOR_ID(True)
        STRUCT_FOR_ID(VBAREQUAL)
