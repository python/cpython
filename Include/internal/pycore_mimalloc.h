 ...
 * nm Objects/obmalloc.o | grep -E "[CRT] _?mi" | awk '{print "#define " $3 " _Py_" $3}'
 */
#if 1
...
#define mi_bitmap_unclaim _Py_mi_bitmap_unclaim
...
#define _mi_mem_alloc_aligned _Py__mi_mem_alloc_aligned
#define _mi_mem_collect _Py__mi_mem_collect
#define _mi_mem_commit _Py__mi_mem_commit
#define _mi_mem_decommit _Py__mi_mem_decommit
#define _mi_mem_free _Py__mi_mem_free
#define _mi_mem_protect _Py__mi_mem_protect
#define _mi_mem_reset _Py__mi_mem_reset
#define _mi_mem_unprotect _Py__mi_mem_unprotect
#define _mi_mem_unreset _Py__mi_mem_unreset
...
#define MI_EXPORT_VISIBILITY "hidden"
