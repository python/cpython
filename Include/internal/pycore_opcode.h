...
const uint8_t _PyOpcode_Deopt[256] = {
    ...
    [JUMP_IF_FALSE_R] = JUMP_IF_FALSE_R,
    ...
    [LOAD_CONST_R] = LOAD_CONST_R,
    [LOAD_CONST__LOAD_FAST] = LOAD_CONST,
    [LOAD_DEREF] = LOAD_DEREF,
    [LOAD_FAST] = LOAD_FAST,
    [LOAD_FAST_CHECK] = LOAD_FAST_CHECK,
    [LOAD_FAST_R] = LOAD_FAST_R,
    ...
    [UNARY_INVERT_R] = UNARY_INVERT_R,
    [UNARY_NEGATIVE] = UNARY_NEGATIVE,
    [UNARY_NEGATIVE_R] = UNARY_NEGATIVE_R,
    [UNARY_NOT] = UNARY_NOT,
    [UNARY_NOT_R] = UNARY_NOT_R,
    [UNARY_POSITIVE] = UNARY_POSITIVE,
    [UNARY_POSITIVE_R] = UNARY_POSITIVE_R,
    [UNPACK_EX] = UNPACK_EX,
