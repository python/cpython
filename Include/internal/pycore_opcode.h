...
const uint8_t _PyOpcode_Deopt[256] = {
    ...
    [LOAD_ATTR_METHOD_CLASS] = LOAD_ATTR,
    [LOAD_ATTR_METHOD_LAZY_DICT] = LOAD_ATTR,
    [LOAD_ATTR_METHOD_MODULE] = LOAD_ATTR,
...
static const char *const _PyOpcode_OpName[256] = {
    ...
    [LOAD_ATTR_METHOD_CLASS] = "LOAD_ATTR_METHOD_CLASS",
    [GET_ITER] = "GET_ITER",
    [GET_YIELD_FROM_ITER] = "GET_YIELD_FROM_ITER",
    [PRINT_EXPR] = "PRINT_EXPR",
    [LOAD_BUILD_CLASS] = "LOAD_BUILD_CLASS",
    [LOAD_ATTR_METHOD_LAZY_DICT] = "LOAD_ATTR_METHOD_LAZY_DICT",
    [LOAD_ATTR_METHOD_MODULE] = "LOAD_ATTR_METHOD_MODULE",
    [LOAD_ASSERTION_ERROR] = "LOAD_ASSERTION_ERROR",
    [RETURN_GENERATOR] = "RETURN_GENERATOR",
