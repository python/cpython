...
const uint8_t _PyOpcode_Deopt[256] = {
    ...
    [CALL_FUNCTION_EX_ADAPTIVE] = CALL_FUNCTION_EX,
    [CALL_FUNCTION_EX_BUILTIN_PYCFUNCTIONWITHKEYWORDS] = CALL_FUNCTION_EX,
    [CALL_FUNCTION_EX_PY_KWARGS] = CALL_FUNCTION_EX,
    [CALL_FUNCTION_EX_PY_NO_KWARGS] = CALL_FUNCTION_EX,
...
static const char *const _PyOpcode_OpName[263] = {
    ...
    [CALL_FUNCTION_EX_ADAPTIVE] = "CALL_FUNCTION_EX_ADAPTIVE",
    [CALL_FUNCTION_EX_PY_KWARGS] = "CALL_FUNCTION_EX_PY_KWARGS",
    [CALL_FUNCTION_EX_PY_NO_KWARGS] = "CALL_FUNCTION_EX_PY_NO_KWARGS",
    [STORE_SUBSCR] = "STORE_SUBSCR",
    [DELETE_SUBSCR] = "DELETE_SUBSCR",
    [CALL_FUNCTION_EX_BUILTIN_PYCFUNCTIONWITHKEYWORDS] = "CALL_FUNCTION_EX_BUILTIN_PYCFUNCTIONWITHKEYWORDS",
