...
const uint8_t _PyOpcode_Deopt[256] = {
    ...
    [JUMP_BACKWARD_INTO_TRACE] = JUMP_BACKWARD,
    [JUMP_BACKWARD_NO_INTERRUPT] = JUMP_BACKWARD_NO_INTERRUPT,
    [JUMP_BACKWARD_QUICK] = JUMP_BACKWARD,
    [JUMP_BACKWARD_RECORDING] = JUMP_BACKWARD,
...
static const char *const _PyOpcode_OpName[266] = {
    ...
    [JUMP_BACKWARD_INTO_TRACE] = "JUMP_BACKWARD_INTO_TRACE",
    [JUMP_BACKWARD_QUICK] = "JUMP_BACKWARD_QUICK",
    [GET_ITER] = "GET_ITER",
    [GET_YIELD_FROM_ITER] = "GET_YIELD_FROM_ITER",
    [JUMP_BACKWARD_RECORDING] = "JUMP_BACKWARD_RECORDING",
    [LOAD_BUILD_CLASS] = "LOAD_BUILD_CLASS",
