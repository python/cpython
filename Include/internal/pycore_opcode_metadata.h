...
const struct opcode_metadata _PyOpcode_opcode_metadata[266] = {
    ...
    [BUILD_INTERPOLATION] = { true, INSTR_FMT_IX, HAS_ERROR_FLAG },
    ...
    [BUILD_TEMPLATE] = { true, INSTR_FMT_IB, HAS_ARG_FLAG | HAS_ERROR_FLAG },
    [BUILD_TEMPLATE_LIST] = { true, INSTR_FMT_IX, HAS_ERROR_FLAG },
