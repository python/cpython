...
_PyOpcode_macro_expansion[256] = {
    ...
    [BINARY_OP_ADD_FLOAT] = { .nuops = 3, .uops = { { _NOP, 0, 0 }, { _GUARD_BOTH_FLOAT, 0, 0 }, { _BINARY_OP_ADD_FLOAT, 0, 0 } } },
    [BINARY_OP_ADD_INT] = { .nuops = 3, .uops = { { _NOP, 0, 0 }, { _GUARD_BOTH_INT, 0, 0 }, { _BINARY_OP_ADD_INT, 0, 0 } } },
    [BINARY_OP_ADD_UNICODE] = { .nuops = 3, .uops = { { _NOP, 0, 0 }, { _GUARD_BOTH_UNICODE, 0, 0 }, { _BINARY_OP_ADD_UNICODE, 0, 0 } } },
    [BINARY_OP_INPLACE_ADD_UNICODE] = { .nuops = 4, .uops = { { _NOP, 0, 0 }, { _NOP, 0, 0 }, { _GUARD_BOTH_UNICODE, 0, 0 }, { _BINARY_OP_INPLACE_ADD_UNICODE, 0, 0 } } },
    [BINARY_OP_MULTIPLY_FLOAT] = { .nuops = 3, .uops = { { _NOP, 0, 0 }, { _GUARD_BOTH_FLOAT, 0, 0 }, { _BINARY_OP_MULTIPLY_FLOAT, 0, 0 } } },
    [BINARY_OP_MULTIPLY_INT] = { .nuops = 3, .uops = { { _NOP, 0, 0 }, { _GUARD_BOTH_INT, 0, 0 }, { _BINARY_OP_MULTIPLY_INT, 0, 0 } } },
    [BINARY_OP_SUBTRACT_FLOAT] = { .nuops = 3, .uops = { { _NOP, 0, 0 }, { _GUARD_BOTH_FLOAT, 0, 0 }, { _BINARY_OP_SUBTRACT_FLOAT, 0, 0 } } },
    [BINARY_OP_SUBTRACT_INT] = { .nuops = 3, .uops = { { _NOP, 0, 0 }, { _GUARD_BOTH_INT, 0, 0 }, { _BINARY_OP_SUBTRACT_INT, 0, 0 } } },
