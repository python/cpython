...
const struct opcode_metadata _PyOpcode_opcode_metadata[268] = {
    ...
    [CALL_BOUND_METHOD_GENERAL] = { true, INSTR_FMT_IBC00, HAS_ARG_FLAG | HAS_DEOPT_FLAG | HAS_ERROR_FLAG | HAS_ERROR_NO_POP_FLAG | HAS_ESCAPES_FLAG },
...
_PyOpcode_macro_expansion[256] = {
    ...
    [CALL_BOUND_METHOD_GENERAL] = { .nuops = 5, .uops = { { _CHECK_PEP_523, 0, 0 }, { _CHECK_IS_METHOD, 0, 0 }, { _EXPAND_METHOD, 0, 0 }, { _CALL_PY_GENERAL, 0, 0 }, { _PUSH_FRAME, 0, 0 } } },
    ...
    [CALL_NON_PY_GENERAL] = { .nuops = 4, .uops = { { _CHECK_IS_NOT_PY_CALLABLE, 0, 0 }, { _EXPAND_METHOD, 0, 0 }, { _CALL_NON_PY_GENERAL, 0, 0 }, { _CHECK_PERIODIC, 0, 0 } } },
    ...
    [CALL_PY_GENERAL] = { .nuops = 4, .uops = { { _CHECK_PEP_523, 0, 0 }, { _CHECK_IS_FUNCTION, 0, 0 }, { _CALL_PY_GENERAL, 0, 0 }, { _PUSH_FRAME, 0, 0 } } },
