...
const struct opcode_metadata _PyOpcode_opcode_metadata[266] = {
    ...
    [LOAD_FAST_WITH_COUNT] = { true, INSTR_FMT_IB, HAS_ARG_FLAG | HAS_LOCAL_FLAG | HAS_ESCAPES_FLAG | HAS_PURE_FLAG },
...
_PyOpcode_macro_expansion[256] = {
    ...
    [LOAD_FAST_WITH_COUNT] = { .nuops = 1, .uops = { { _LOAD_FAST_WITH_COUNT, 0, 0 } } },
...
const char *_PyOpcode_OpName[266] = {
    ...
    [LOAD_FAST_WITH_COUNT] = "LOAD_FAST_WITH_COUNT",
