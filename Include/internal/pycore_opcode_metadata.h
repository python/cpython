...
_PyOpcode_macro_expansion[256] = {
    ...
    [CALL_BOUND_METHOD_GENERAL] = { .nuops = 5, .uops = { { _CHECK_PEP_523, 0, 0 }, { _CHECK_METHOD_VERSION, 2, 1 }, { _EXPAND_METHOD, 0, 0 }, { _CALL_PY_GENERAL, 0, 0 }, { _PUSH_FRAME, 0, 0 } } },
    ...
    [CALL_PY_GENERAL] = { .nuops = 4, .uops = { { _CHECK_PEP_523, 0, 0 }, { _CHECK_FUNCTION_VERSION, 2, 1 }, { _CALL_PY_GENERAL, 0, 0 }, { _PUSH_FRAME, 0, 0 } } },
