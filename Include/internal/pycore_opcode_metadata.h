...
const struct opcode_metadata _PyOpcode_opcode_metadata[267] = {
    ...
    [CALL_ISINSTANCE] = { true, INSTR_FMT_IXC00, HAS_EVAL_BREAK_FLAG | HAS_DEOPT_FLAG | HAS_ERROR_FLAG | HAS_ERROR_NO_POP_FLAG | HAS_ESCAPES_FLAG },
...
_PyOpcode_macro_expansion[256] = {
    ...
    [CALL_ISINSTANCE] = { .nuops = 4, .uops = { { _GUARD_THIRD_NULL, OPARG_SIMPLE, 3 }, { _GUARD_CALLABLE_ISINSTANCE, OPARG_SIMPLE, 3 }, { _CALL_ISINSTANCE, OPARG_SIMPLE, 3 }, { _SKIP_CHECK_PERIODIC, OPARG_SIMPLE, 3 } } },
