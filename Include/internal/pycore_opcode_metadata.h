...
const struct opcode_metadata _PyOpcode_opcode_metadata[OPCODE_METADATA_SIZE] = {
    ...
    [SEND] = { true, INSTR_FMT_IBC000, HAS_ARG_FLAG | HAS_JUMP_FLAG | HAS_ERROR_FLAG },
    [SEND_GEN] = { true, INSTR_FMT_IBC000, HAS_ARG_FLAG | HAS_DEOPT_FLAG },
    [INSTRUMENTED_YIELD_VALUE] = { true, INSTR_FMT_IB, HAS_ARG_FLAG | HAS_ERROR_FLAG },
    [YIELD_VALUE] = { true, INSTR_FMT_IB, HAS_ARG_FLAG | HAS_DEOPT_FLAG },
    ...
    [FOR_ITER] = { true, INSTR_FMT_IBC000, HAS_ARG_FLAG | HAS_JUMP_FLAG | HAS_ERROR_FLAG },
    ...
    [FOR_ITER_LIST] = { true, INSTR_FMT_IBC000, HAS_ARG_FLAG | HAS_JUMP_FLAG | HAS_DEOPT_FLAG },
    ...
    [FOR_ITER_TUPLE] = { true, INSTR_FMT_IBC000, HAS_ARG_FLAG | HAS_JUMP_FLAG | HAS_DEOPT_FLAG },
    ...
    [FOR_ITER_RANGE] = { true, INSTR_FMT_IBC000, HAS_ARG_FLAG | HAS_JUMP_FLAG | HAS_DEOPT_FLAG | HAS_ERROR_FLAG },
    [FOR_ITER_GEN] = { true, INSTR_FMT_IBC000, HAS_ARG_FLAG | HAS_DEOPT_FLAG },
...
const struct opcode_macro_expansion _PyOpcode_macro_expansion[OPCODE_MACRO_EXPANSION_SIZE] = {
    ...
    [YIELD_VALUE] = { .nuops = 1, .uops = { { YIELD_VALUE, 0, 0 } } },
