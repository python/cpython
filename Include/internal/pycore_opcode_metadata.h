...
_PyOpcode_macro_expansion[256] = {
    ...
    [BINARY_OP_ADD_INT] = { .nuops = 5, .uops = { { _GUARD_TOS_INT_WIDE, OPARG_SIMPLE, 0 }, { _GUARD_NOS_INT_WIDE, OPARG_SIMPLE, 0 }, { _BINARY_OP_ADD_INT_WIDE, OPARG_SIMPLE, 5 }, { _POP_TOP_INT, OPARG_SIMPLE, 5 }, { _POP_TOP_INT, OPARG_SIMPLE, 5 } } },
