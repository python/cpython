...
const struct opcode_metadata _PyOpcode_opcode_metadata[267] = {
    ...
    [CALL_LIST_APPEND_SUBTYPE] = { true, INSTR_FMT_IBC00, HAS_ARG_FLAG | HAS_DEOPT_FLAG | HAS_EXIT_FLAG | HAS_ERROR_FLAG | HAS_ERROR_NO_POP_FLAG | HAS_ESCAPES_FLAG },
...
_PyOpcode_macro_expansion[256] = {
    ...
    [CALL_LIST_APPEND_SUBTYPE] = { .nuops = 6, .uops = { { _GUARD_CALLABLE_LIST_APPEND, OPARG_SIMPLE, 3 }, { _GUARD_NOS_NOT_NULL, OPARG_SIMPLE, 3 }, { _GUARD_NOS_LIST_SUBTYPE, OPARG_SIMPLE, 3 }, { _CALL_LIST_APPEND, OPARG_SIMPLE, 3 }, { _POP_TOP, OPARG_SIMPLE, 3 }, { _POP_TOP, OPARG_SIMPLE, 3 } } },
...
const char *_PyOpcode_OpName[267] = {
    ...
    [CALL_LIST_APPEND_SUBTYPE] = "CALL_LIST_APPEND_SUBTYPE",
