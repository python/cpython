...
_PyOpcode_macro_expansion[256] = {
    ...
    [LOAD_ATTR_INSTANCE_VALUE] = { .nuops = 6, .uops = { { _RECORD_TOS_TYPE, OPARG_SIMPLE, 1 }, { _GUARD_TYPE_VERSION, 2, 1 }, { _CHECK_MANAGED_OBJECT_HAS_VALUES_OFFSET, 1, 3 }, { _LOAD_ATTR_INSTANCE_VALUE, 1, 4 }, { _POP_TOP, OPARG_SIMPLE, 5 }, { _PUSH_NULL_CONDITIONAL, OPARG_SIMPLE, 9 } } },
