...
const struct opcode_metadata _PyOpcode_opcode_metadata[267] = {
    ...
    [CALL_EX_NON_PY_GENERAL] = { true, INSTR_FMT_IXC, HAS_EVAL_BREAK_FLAG | HAS_ERROR_FLAG | HAS_ERROR_NO_POP_FLAG | HAS_ESCAPES_FLAG },
...
_PyOpcode_macro_expansion[256] = {
    ...
    [CALL_EX_NON_PY_GENERAL] = { .nuops = 3, .uops = { { _MAKE_CALLARGS_A_TUPLE, OPARG_SIMPLE, 1 }, { _CALL_FUNCTION_EX_NON_PY_GENERAL, OPARG_SIMPLE, 1 }, { _CHECK_PERIODIC_AT_END, OPARG_REPLACED, 1 } } },
