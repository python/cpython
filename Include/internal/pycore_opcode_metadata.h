...
_PyOpcode_macro_expansion[256] = {
    ...
    [CALL_BUILTIN_FAST] = { .nuops = 3, .uops = { { _GUARD_CALL_BUILTIN_FAST, OPARG_SIMPLE, 3 }, { _CALL_BUILTIN_FAST, OPARG_SIMPLE, 3 }, { _CHECK_PERIODIC, OPARG_SIMPLE, 3 } } },
    ...
    [CALL_BUILTIN_O] = { .nuops = 3, .uops = { { _GUARD_CALL_BUILTIN_O, OPARG_SIMPLE, 3 }, { _CALL_BUILTIN_O, OPARG_SIMPLE, 3 }, { _CHECK_PERIODIC, OPARG_SIMPLE, 3 } } },
