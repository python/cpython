...
const struct opcode_metadata _PyOpcode_opcode_metadata[268] = {
    ...
    [COPY] = { true, INSTR_FMT_IB, HAS_ARG_FLAG | HAS_PURE_FLAG | HAS_PASSTHROUGH_FLAG },
    ...
    [END_FOR] = { true, INSTR_FMT_IX, HAS_PURE_FLAG | HAS_PASSTHROUGH_FLAG },
    [END_SEND] = { true, INSTR_FMT_IX, HAS_PURE_FLAG | HAS_PASSTHROUGH_FLAG },
    ...
    [LOAD_CONST] = { true, INSTR_FMT_IB, HAS_ARG_FLAG | HAS_CONST_FLAG | HAS_PURE_FLAG | HAS_PASSTHROUGH_FLAG },
    [LOAD_DEREF] = { true, INSTR_FMT_IB, HAS_ARG_FLAG | HAS_FREE_FLAG | HAS_ERROR_FLAG | HAS_ESCAPES_FLAG },
    [LOAD_FAST] = { true, INSTR_FMT_IB, HAS_ARG_FLAG | HAS_LOCAL_FLAG | HAS_PURE_FLAG | HAS_PASSTHROUGH_FLAG },
    ...
    [NOP] = { true, INSTR_FMT_IX, HAS_PURE_FLAG | HAS_PASSTHROUGH_FLAG },
    ...
    [POP_TOP] = { true, INSTR_FMT_IX, HAS_PURE_FLAG | HAS_PASSTHROUGH_FLAG },
    [PUSH_EXC_INFO] = { true, INSTR_FMT_IX, 0 },
    [PUSH_NULL] = { true, INSTR_FMT_IX, HAS_PURE_FLAG | HAS_PASSTHROUGH_FLAG },
    ...
    [SWAP] = { true, INSTR_FMT_IB, HAS_ARG_FLAG | HAS_PURE_FLAG | HAS_PASSTHROUGH_FLAG },
    ...
    [UNARY_NOT] = { true, INSTR_FMT_IX, HAS_PURE_FLAG | HAS_PASSTHROUGH_FLAG },
    ...
    [LOAD_CLOSURE] = { true, -1, HAS_ARG_FLAG | HAS_LOCAL_FLAG | HAS_PURE_FLAG | HAS_PASSTHROUGH_FLAG },
    ...
    [POP_BLOCK] = { true, -1, HAS_PURE_FLAG | HAS_PASSTHROUGH_FLAG },
    [SETUP_CLEANUP] = { true, -1, HAS_PURE_FLAG | HAS_PASSTHROUGH_FLAG | HAS_ARG_FLAG },
    [SETUP_FINALLY] = { true, -1, HAS_PURE_FLAG | HAS_PASSTHROUGH_FLAG | HAS_ARG_FLAG },
    [SETUP_WITH] = { true, -1, HAS_PURE_FLAG | HAS_PASSTHROUGH_FLAG | HAS_ARG_FLAG },
