...
_PyOpcode_macro_expansion[256] = {
    ...
    [TO_BOOL_INT] = { .nuops = 3, .uops = { { _GUARD_TOS_INT, OPARG_SIMPLE, 0 }, { _TO_BOOL_BIT_INT, OPARG_SIMPLE, 3 }, { _BIT_TO_BOOL, OPARG_SIMPLE, 3 } } },
    ...
    [TO_BOOL_STR] = { .nuops = 3, .uops = { { _GUARD_TOS_UNICODE, OPARG_SIMPLE, 0 }, { _TO_BOOL_BIT_STR, OPARG_SIMPLE, 3 }, { _BIT_TO_BOOL, OPARG_SIMPLE, 3 } } },
