...
int _PyOpcode_num_popped(int opcode, int oparg)  {
    switch(opcode) {
        ...
        case BINARY_OP_SUBSCR_LIST_SLICE:
            return 2;
        case BINARY_OP_SUBSCR_NCSTR_INT:
            return 2;
...
const struct opcode_metadata _PyOpcode_opcode_metadata[267] = {
    ...
    [BINARY_OP_SUBSCR_NCSTR_INT] = { true, INSTR_FMT_IXC0000, HAS_DEOPT_FLAG | HAS_EXIT_FLAG | HAS_ESCAPES_FLAG },
...
_PyOpcode_macro_expansion[256] = {
    ...
    [BINARY_OP_SUBSCR_NCSTR_INT] = { .nuops = 5, .uops = { { _GUARD_TOS_INT, OPARG_SIMPLE, 0 }, { _GUARD_NOS_UNICODE, OPARG_SIMPLE, 0 }, { _BINARY_OP_SUBSCR_NCSTR_INT, OPARG_SIMPLE, 5 }, { _POP_TOP_INT, OPARG_SIMPLE, 5 }, { _POP_TOP, OPARG_SIMPLE, 5 } } },
...
const char *_PyOpcode_OpName[267] = {
    ...
    [BINARY_OP_SUBSCR_NCSTR_INT] = "BINARY_OP_SUBSCR_NCSTR_INT",
...
const uint8_t _PyOpcode_Deopt[256] = {
    ...
    [BINARY_OP_SUBSCR_NCSTR_INT] = BINARY_OP,
