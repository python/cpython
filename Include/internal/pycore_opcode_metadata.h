...
_PyOpcode_macro_expansion[256] = {
    ...
    [BINARY_OP] = { .nuops = 0, .uops = {  } },
    [BINARY_OP_ADD_FLOAT] = { .nuops = 2, .uops = { { _GUARD_BOTH_FLOAT 0, 0 }, { _BINARY_OP_ADD_FLOAT 1, 0 } } },
    [BINARY_OP_ADD_INT] = { .nuops = 2, .uops = { { _GUARD_BOTH_INT 0, 0 }, { _BINARY_OP_ADD_INT 1, 0 } } },
    [BINARY_OP_ADD_UNICODE] = { .nuops = 2, .uops = { { _GUARD_BOTH_UNICODE 0, 0 }, { _BINARY_OP_ADD_UNICODE 1, 0 } } },
    [BINARY_OP_INPLACE_ADD_UNICODE] = { .nuops = 2, .uops = { { _GUARD_BOTH_UNICODE 0, 0 }, { _BINARY_OP_INPLACE_ADD_UNICODE 1, 0 } } },
    [BINARY_OP_MULTIPLY_FLOAT] = { .nuops = 2, .uops = { { _GUARD_BOTH_FLOAT 0, 0 }, { _BINARY_OP_MULTIPLY_FLOAT 1, 0 } } },
    [BINARY_OP_MULTIPLY_INT] = { .nuops = 2, .uops = { { _GUARD_BOTH_INT 0, 0 }, { _BINARY_OP_MULTIPLY_INT 1, 0 } } },
    [BINARY_OP_SUBTRACT_FLOAT] = { .nuops = 2, .uops = { { _GUARD_BOTH_FLOAT 0, 0 }, { _BINARY_OP_SUBTRACT_FLOAT 1, 0 } } },
    [BINARY_OP_SUBTRACT_INT] = { .nuops = 2, .uops = { { _GUARD_BOTH_INT 0, 0 }, { _BINARY_OP_SUBTRACT_INT 1, 0 } } },
    [BINARY_SLICE] = { .nuops = 1, .uops = { { _BINARY_SLICE 0, 0 } } },
    [BINARY_SUBSCR] = { .nuops = 0, .uops = {  } },
    [BINARY_SUBSCR_DICT] = { .nuops = 1, .uops = { { _BINARY_SUBSCR_DICT 1, 0 } } },
    [BINARY_SUBSCR_GETITEM] = { .nuops = 0, .uops = {  } },
    [BINARY_SUBSCR_LIST_INT] = { .nuops = 1, .uops = { { _BINARY_SUBSCR_LIST_INT 1, 0 } } },
    [BINARY_SUBSCR_STR_INT] = { .nuops = 1, .uops = { { _BINARY_SUBSCR_STR_INT 1, 0 } } },
    [BINARY_SUBSCR_TUPLE_INT] = { .nuops = 1, .uops = { { _BINARY_SUBSCR_TUPLE_INT 1, 0 } } },
    ...
    [CACHE] = { .nuops = 1, .uops = { { _CACHE 0, 0 } } },
    [CALL] = { .nuops = 0, .uops = {  } },
    [CALL_ALLOC_AND_ENTER_INIT] = { .nuops = 0, .uops = {  } },
    [CALL_BOUND_METHOD_EXACT_ARGS] = { .nuops = 9, .uops = { { unused/1 1, 0 }, { _CHECK_PEP_523 0, 0 }, { _CHECK_CALL_BOUND_METHOD_EXACT_ARGS 0, 0 }, { _INIT_CALL_BOUND_METHOD_EXACT_ARGS 0, 0 }, { _CHECK_FUNCTION_EXACT_ARGS 2, 1 }, { _CHECK_STACK_SPACE 0, 0 }, { _INIT_CALL_PY_EXACT_ARGS 0, 0 }, { _SAVE_RETURN_OFFSET 7, 3 }, { _PUSH_FRAME 0, 0 } } },
    [CALL_BUILTIN_CLASS] = { .nuops = 1, .uops = { { _CALL_BUILTIN_CLASS 3, 0 } } },
    [CALL_BUILTIN_FAST] = { .nuops = 1, .uops = { { _CALL_BUILTIN_FAST 3, 0 } } },
    [CALL_BUILTIN_FAST_WITH_KEYWORDS] = { .nuops = 1, .uops = { { _CALL_BUILTIN_FAST_WITH_KEYWORDS 3, 0 } } },
    [CALL_BUILTIN_O] = { .nuops = 1, .uops = { { _CALL_BUILTIN_O 3, 0 } } },
    [CALL_FUNCTION_EX] = { .nuops = 0, .uops = {  } },
    [CALL_INTRINSIC_1] = { .nuops = 1, .uops = { { _CALL_INTRINSIC_1 0, 0 } } },
    [CALL_INTRINSIC_2] = { .nuops = 1, .uops = { { _CALL_INTRINSIC_2 0, 0 } } },
    [CALL_ISINSTANCE] = { .nuops = 1, .uops = { { _CALL_ISINSTANCE 3, 0 } } },
    [CALL_KW] = { .nuops = 0, .uops = {  } },
    [CALL_LEN] = { .nuops = 1, .uops = { { _CALL_LEN 3, 0 } } },
    [CALL_LIST_APPEND] = { .nuops = 1, .uops = { { _CALL_LIST_APPEND 3, 0 } } },
    [CALL_METHOD_DESCRIPTOR_FAST] = { .nuops = 1, .uops = { { _CALL_METHOD_DESCRIPTOR_FAST 3, 0 } } },
    [CALL_METHOD_DESCRIPTOR_FAST_WITH_KEYWORDS] = { .nuops = 1, .uops = { { _CALL_METHOD_DESCRIPTOR_FAST_WITH_KEYWORDS 3, 0 } } },
    [CALL_METHOD_DESCRIPTOR_NOARGS] = { .nuops = 1, .uops = { { _CALL_METHOD_DESCRIPTOR_NOARGS 3, 0 } } },
    [CALL_METHOD_DESCRIPTOR_O] = { .nuops = 1, .uops = { { _CALL_METHOD_DESCRIPTOR_O 3, 0 } } },
    [CALL_PY_EXACT_ARGS] = { .nuops = 7, .uops = { { unused/1 1, 0 }, { _CHECK_PEP_523 0, 0 }, { _CHECK_FUNCTION_EXACT_ARGS 2, 1 }, { _CHECK_STACK_SPACE 0, 0 }, { _INIT_CALL_PY_EXACT_ARGS 0, 0 }, { _SAVE_RETURN_OFFSET 7, 3 }, { _PUSH_FRAME 0, 0 } } },
    [CALL_PY_WITH_DEFAULTS] = { .nuops = 0, .uops = {  } },
    [CALL_STR_1] = { .nuops = 1, .uops = { { _CALL_STR_1 3, 0 } } },
    [CALL_TUPLE_1] = { .nuops = 1, .uops = { { _CALL_TUPLE_1 3, 0 } } },
    [CALL_TYPE_1] = { .nuops = 1, .uops = { { _CALL_TYPE_1 3, 0 } } },
    [CHECK_EG_MATCH] = { .nuops = 1, .uops = { { _CHECK_EG_MATCH 0, 0 } } },
    [CHECK_EXC_MATCH] = { .nuops = 1, .uops = { { _CHECK_EXC_MATCH 0, 0 } } },
    [CLEANUP_THROW] = { .nuops = 0, .uops = {  } },
    [COMPARE_OP] = { .nuops = 0, .uops = {  } },
    [COMPARE_OP_FLOAT] = { .nuops = 1, .uops = { { _COMPARE_OP_FLOAT 1, 0 } } },
    [COMPARE_OP_INT] = { .nuops = 1, .uops = { { _COMPARE_OP_INT 1, 0 } } },
    [COMPARE_OP_STR] = { .nuops = 1, .uops = { { _COMPARE_OP_STR 1, 0 } } },
    ...
    [END_ASYNC_FOR] = { .nuops = 0, .uops = {  } },
    [END_FOR] = { .nuops = 2, .uops = { { _POP_TOP 0, 0 }, { _POP_TOP 0, 0 } } },
    [END_SEND] = { .nuops = 1, .uops = { { _END_SEND 0, 0 } } },
    [ENTER_EXECUTOR] = { .nuops = 1, .uops = { { _ENTER_EXECUTOR 0, 0 } } },
    [EXIT_INIT_CHECK] = { .nuops = 1, .uops = { { _EXIT_INIT_CHECK 0, 0 } } },
    [EXTENDED_ARG] = { .nuops = 1, .uops = { { _EXTENDED_ARG 0, 0 } } },
    [FORMAT_SIMPLE] = { .nuops = 1, .uops = { { _FORMAT_SIMPLE 0, 0 } } },
    [FORMAT_WITH_SPEC] = { .nuops = 1, .uops = { { _FORMAT_WITH_SPEC 0, 0 } } },
    [FOR_ITER] = { .nuops = 0, .uops = {  } },
    [FOR_ITER_GEN] = { .nuops = 0, .uops = {  } },
    [FOR_ITER_LIST] = { .nuops = 0, .uops = {  } },
    [FOR_ITER_RANGE] = { .nuops = 0, .uops = {  } },
    [FOR_ITER_TUPLE] = { .nuops = 0, .uops = {  } },
    ...
    [INSTRUMENTED_CALL] = { .nuops = 0, .uops = {  } },
    [INSTRUMENTED_CALL_FUNCTION_EX] = { .nuops = 0, .uops = {  } },
    [INSTRUMENTED_CALL_KW] = { .nuops = 0, .uops = {  } },
    [INSTRUMENTED_END_FOR] = { .nuops = 0, .uops = {  } },
    [INSTRUMENTED_END_SEND] = { .nuops = 0, .uops = {  } },
    [INSTRUMENTED_FOR_ITER] = { .nuops = 0, .uops = {  } },
    [INSTRUMENTED_INSTRUCTION] = { .nuops = 0, .uops = {  } },
    [INSTRUMENTED_JUMP_BACKWARD] = { .nuops = 0, .uops = {  } },
    [INSTRUMENTED_JUMP_FORWARD] = { .nuops = 0, .uops = {  } },
    [INSTRUMENTED_LOAD_SUPER_ATTR] = { .nuops = 0, .uops = {  } },
    [INSTRUMENTED_POP_JUMP_IF_FALSE] = { .nuops = 0, .uops = {  } },
    [INSTRUMENTED_POP_JUMP_IF_NONE] = { .nuops = 0, .uops = {  } },
    [INSTRUMENTED_POP_JUMP_IF_NOT_NONE] = { .nuops = 0, .uops = {  } },
    [INSTRUMENTED_POP_JUMP_IF_TRUE] = { .nuops = 0, .uops = {  } },
    [INSTRUMENTED_RESUME] = { .nuops = 0, .uops = {  } },
    [INSTRUMENTED_RETURN_CONST] = { .nuops = 0, .uops = {  } },
    [INSTRUMENTED_RETURN_VALUE] = { .nuops = 0, .uops = {  } },
    [INSTRUMENTED_YIELD_VALUE] = { .nuops = 0, .uops = {  } },
    [INTERPRETER_EXIT] = { .nuops = 1, .uops = { { _INTERPRETER_EXIT 0, 0 } } },
    [IS_OP] = { .nuops = 1, .uops = { { _IS_OP 0, 0 } } },
    [JUMP_BACKWARD] = { .nuops = 0, .uops = {  } },
    [JUMP_BACKWARD_NO_INTERRUPT] = { .nuops = 1, .uops = { { _JUMP_BACKWARD_NO_INTERRUPT 0, 0 } } },
    [JUMP_FORWARD] = { .nuops = 1, .uops = { { _JUMP_FORWARD 0, 0 } } },
    ...
    [LOAD_ATTR] = { .nuops = 0, .uops = {  } },
    [LOAD_ATTR_CLASS] = { .nuops = 4, .uops = { { unused/1 1, 0 }, { _CHECK_ATTR_CLASS 2, 1 }, { unused/2 2, 3 }, { _LOAD_ATTR_CLASS 4, 5 } } },
    [LOAD_ATTR_GETATTRIBUTE_OVERRIDDEN] = { .nuops = 0, .uops = {  } },
    [LOAD_ATTR_INSTANCE_VALUE] = { .nuops = 5, .uops = { { unused/1 1, 0 }, { _GUARD_TYPE_VERSION 2, 1 }, { _CHECK_MANAGED_OBJECT_HAS_VALUES 0, 0 }, { _LOAD_ATTR_INSTANCE_VALUE 1, 3 }, { unused/5 5, 4 } } },
    [LOAD_ATTR_METHOD_LAZY_DICT] = { .nuops = 5, .uops = { { unused/1 1, 0 }, { _GUARD_TYPE_VERSION 2, 1 }, { _CHECK_ATTR_METHOD_LAZY_DICT 0, 0 }, { unused/2 2, 3 }, { _LOAD_ATTR_METHOD_LAZY_DICT 4, 5 } } },
    [LOAD_ATTR_METHOD_NO_DICT] = { .nuops = 4, .uops = { { unused/1 1, 0 }, { _GUARD_TYPE_VERSION 2, 1 }, { unused/2 2, 3 }, { _LOAD_ATTR_METHOD_NO_DICT 4, 5 } } },
    [LOAD_ATTR_METHOD_WITH_VALUES] = { .nuops = 5, .uops = { { unused/1 1, 0 }, { _GUARD_TYPE_VERSION 2, 1 }, { _GUARD_DORV_VALUES_INST_ATTR_FROM_DICT 0, 0 }, { _GUARD_KEYS_VERSION 2, 3 }, { _LOAD_ATTR_METHOD_WITH_VALUES 4, 5 } } },
    [LOAD_ATTR_MODULE] = { .nuops = 4, .uops = { { unused/1 1, 0 }, { _CHECK_ATTR_MODULE 2, 1 }, { _LOAD_ATTR_MODULE 1, 3 }, { unused/5 5, 4 } } },
    [LOAD_ATTR_NONDESCRIPTOR_NO_DICT] = { .nuops = 4, .uops = { { unused/1 1, 0 }, { _GUARD_TYPE_VERSION 2, 1 }, { unused/2 2, 3 }, { _LOAD_ATTR_NONDESCRIPTOR_NO_DICT 4, 5 } } },
    [LOAD_ATTR_NONDESCRIPTOR_WITH_VALUES] = { .nuops = 5, .uops = { { unused/1 1, 0 }, { _GUARD_TYPE_VERSION 2, 1 }, { _GUARD_DORV_VALUES_INST_ATTR_FROM_DICT 0, 0 }, { _GUARD_KEYS_VERSION 2, 3 }, { _LOAD_ATTR_NONDESCRIPTOR_WITH_VALUES 4, 5 } } },
    [LOAD_ATTR_PROPERTY] = { .nuops = 0, .uops = {  } },
    [LOAD_ATTR_SLOT] = { .nuops = 4, .uops = { { unused/1 1, 0 }, { _GUARD_TYPE_VERSION 2, 1 }, { _LOAD_ATTR_SLOT 1, 3 }, { unused/5 5, 4 } } },
    [LOAD_ATTR_WITH_HINT] = { .nuops = 5, .uops = { { unused/1 1, 0 }, { _GUARD_TYPE_VERSION 2, 1 }, { _CHECK_ATTR_WITH_HINT 0, 0 }, { _LOAD_ATTR_WITH_HINT 1, 3 }, { unused/5 5, 4 } } },
    ...
    [LOAD_GLOBAL] = { .nuops = 0, .uops = {  } },
    [LOAD_GLOBAL_BUILTIN] = { .nuops = 4, .uops = { { unused/1 1, 0 }, { _GUARD_GLOBALS_VERSION 1, 1 }, { _GUARD_BUILTINS_VERSION 1, 2 }, { _LOAD_GLOBAL_BUILTINS 1, 3 } } },
    [LOAD_GLOBAL_MODULE] = { .nuops = 4, .uops = { { unused/1 1, 0 }, { _GUARD_GLOBALS_VERSION 1, 1 }, { unused/1 1, 2 }, { _LOAD_GLOBAL_MODULE 1, 3 } } },
    [LOAD_LOCALS] = { .nuops = 1, .uops = { { _LOAD_LOCALS 0, 0 } } },
    [LOAD_NAME] = { .nuops = 1, .uops = { { _LOAD_NAME 0, 0 } } },
    [LOAD_SUPER_ATTR] = { .nuops = 0, .uops = {  } },
    [LOAD_SUPER_ATTR_ATTR] = { .nuops = 1, .uops = { { _LOAD_SUPER_ATTR_ATTR 1, 0 } } },
    [LOAD_SUPER_ATTR_METHOD] = { .nuops = 1, .uops = { { _LOAD_SUPER_ATTR_METHOD 1, 0 } } },
    ...
    [POP_JUMP_IF_FALSE] = { .nuops = 0, .uops = {  } },
    [POP_JUMP_IF_NONE] = { .nuops = 0, .uops = {  } },
    [POP_JUMP_IF_NOT_NONE] = { .nuops = 0, .uops = {  } },
    [POP_JUMP_IF_TRUE] = { .nuops = 0, .uops = {  } },
    [POP_TOP] = { .nuops = 1, .uops = { { _POP_TOP 0, 0 } } },
    [PUSH_EXC_INFO] = { .nuops = 1, .uops = { { _PUSH_EXC_INFO 0, 0 } } },
    [PUSH_NULL] = { .nuops = 1, .uops = { { _PUSH_NULL 0, 0 } } },
    [RAISE_VARARGS] = { .nuops = 0, .uops = {  } },
    [RERAISE] = { .nuops = 0, .uops = {  } },
    [RESERVED] = { .nuops = 1, .uops = { { _RESERVED 0, 0 } } },
    [RESUME] = { .nuops = 0, .uops = {  } },
    ...
    [STORE_ATTR] = { .nuops = 0, .uops = {  } },
    [STORE_ATTR_INSTANCE_VALUE] = { .nuops = 4, .uops = { { unused/1 1, 0 }, { _GUARD_TYPE_VERSION 2, 1 }, { _GUARD_DORV_VALUES 0, 0 }, { _STORE_ATTR_INSTANCE_VALUE 1, 3 } } },
    [STORE_ATTR_SLOT] = { .nuops = 3, .uops = { { unused/1 1, 0 }, { _GUARD_TYPE_VERSION 2, 1 }, { _STORE_ATTR_SLOT 1, 3 } } },
    [STORE_ATTR_WITH_HINT] = { .nuops = 0, .uops = {  } },
    ...
    [STORE_SUBSCR] = { .nuops = 0, .uops = {  } },
    [STORE_SUBSCR_DICT] = { .nuops = 1, .uops = { { _STORE_SUBSCR_DICT 1, 0 } } },
    [STORE_SUBSCR_LIST_INT] = { .nuops = 1, .uops = { { _STORE_SUBSCR_LIST_INT 1, 0 } } },
    [SWAP] = { .nuops = 1, .uops = { { _SWAP 0, 0 } } },
    [TO_BOOL] = { .nuops = 0, .uops = {  } },
    [TO_BOOL_ALWAYS_TRUE] = { .nuops = 1, .uops = { { _TO_BOOL_ALWAYS_TRUE 3, 0 } } },
    [TO_BOOL_BOOL] = { .nuops = 1, .uops = { { _TO_BOOL_BOOL 3, 0 } } },
    [TO_BOOL_INT] = { .nuops = 1, .uops = { { _TO_BOOL_INT 3, 0 } } },
    [TO_BOOL_LIST] = { .nuops = 1, .uops = { { _TO_BOOL_LIST 3, 0 } } },
    [TO_BOOL_NONE] = { .nuops = 1, .uops = { { _TO_BOOL_NONE 3, 0 } } },
    [TO_BOOL_STR] = { .nuops = 1, .uops = { { _TO_BOOL_STR 3, 0 } } },
    ...
    [UNPACK_SEQUENCE] = { .nuops = 0, .uops = {  } },
    [UNPACK_SEQUENCE_LIST] = { .nuops = 1, .uops = { { _UNPACK_SEQUENCE_LIST 1, 0 } } },
    [UNPACK_SEQUENCE_TUPLE] = { .nuops = 1, .uops = { { _UNPACK_SEQUENCE_TUPLE 1, 0 } } },
    [UNPACK_SEQUENCE_TWO_TUPLE] = { .nuops = 1, .uops = { { _UNPACK_SEQUENCE_TWO_TUPLE 1, 0 } } },
