...
int _PyOpcode_num_popped(int opcode, int oparg)  {
    switch(opcode) {
        ...
        case BINARY_OP_MULTIPLY_INT:
            return 2;
        case BINARY_OP_MULTIPLY_INT_WIDE:
            return 2;
...
const struct opcode_metadata _PyOpcode_opcode_metadata[267] = {
    ...
    [BINARY_OP_MULTIPLY_INT_WIDE] = { true, INSTR_FMT_IXC0000, HAS_EXIT_FLAG | HAS_ERROR_FLAG | HAS_ESCAPES_FLAG },
    ...
    [BINARY_OP_SUBTRACT_INT_WIDE] = { true, INSTR_FMT_IXC0000, HAS_EXIT_FLAG | HAS_ERROR_FLAG | HAS_ESCAPES_FLAG },
    ...
    [COMPARE_OP_INT] = { true, INSTR_FMT_IBC, HAS_ARG_FLAG | HAS_EXIT_FLAG | HAS_ESCAPES_FLAG },
...
_PyOpcode_macro_expansion[256] = {
    ...
    [BINARY_OP_ADD_INT_WIDE] = { .nuops = 5, .uops = { { _GUARD_TOS_INT_WIDE, OPARG_SIMPLE, 0 }, { _GUARD_NOS_INT_WIDE, OPARG_SIMPLE, 0 }, { _BINARY_OP_ADD_INT_WIDE, OPARG_SIMPLE, 5 }, { _POP_TOP_INT, OPARG_SIMPLE, 5 }, { _POP_TOP_INT, OPARG_SIMPLE, 5 } } },
    ...
    [BINARY_OP_MULTIPLY_INT_WIDE] = { .nuops = 5, .uops = { { _GUARD_TOS_INT_WIDE, OPARG_SIMPLE, 0 }, { _GUARD_NOS_INT_WIDE, OPARG_SIMPLE, 0 }, { _BINARY_OP_MULTIPLY_INT_WIDE, OPARG_SIMPLE, 5 }, { _POP_TOP_INT, OPARG_SIMPLE, 5 }, { _POP_TOP_INT, OPARG_SIMPLE, 5 } } },
    ...
    [BINARY_OP_SUBTRACT_INT_WIDE] = { .nuops = 5, .uops = { { _GUARD_TOS_INT_WIDE, OPARG_SIMPLE, 0 }, { _GUARD_NOS_INT_WIDE, OPARG_SIMPLE, 0 }, { _BINARY_OP_SUBTRACT_INT_WIDE, OPARG_SIMPLE, 5 }, { _POP_TOP_INT, OPARG_SIMPLE, 5 }, { _POP_TOP_INT, OPARG_SIMPLE, 5 } } },
...
const char *_PyOpcode_OpName[267] = {
    ...
    [BINARY_OP_MULTIPLY_INT_WIDE] = "BINARY_OP_MULTIPLY_INT_WIDE",
...
const uint8_t _PyOpcode_Deopt[256] = {
    ...
    [BINARY_OP_MULTIPLY_INT_WIDE] = BINARY_OP,
