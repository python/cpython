...
extern const int8_t _PyUop_OperandSize[OPCODE_METADATA_SIZE];
#ifdef NEED_OPCODE_METADATA
const int8_t _PyUop_OperandSize[OPCODE_METADATA_SIZE] = {
    ...
    [TO_BOOL_NONE] = 0,
    [TO_BOOL_STR] = 0,
    [TO_BOOL_ALWAYS_TRUE] = 2,
    [UNARY_INVERT] = 0,
    [_GUARD_BOTH_INT] = 0,
    [_BINARY_OP_MULTIPLY_INT] = 0,
    [_BINARY_OP_ADD_INT] = 0,
    [_BINARY_OP_SUBTRACT_INT] = 0,
    [_GUARD_BOTH_FLOAT] = 0,
    [_BINARY_OP_MULTIPLY_FLOAT] = 0,
    [_BINARY_OP_ADD_FLOAT] = 0,
    [_BINARY_OP_SUBTRACT_FLOAT] = 0,
    [_GUARD_BOTH_UNICODE] = 0,
    [_BINARY_OP_ADD_UNICODE] = 0,
    [_BINARY_OP_INPLACE_ADD_UNICODE] = 0,
    [_SPECIALIZE_BINARY_SUBSCR] = 1,
    [_BINARY_SUBSCR] = 0,
    [BINARY_SLICE] = 0,
    [STORE_SLICE] = 0,
    [BINARY_SUBSCR_LIST_INT] = 0,
    [BINARY_SUBSCR_STR_INT] = 0,
    [BINARY_SUBSCR_TUPLE_INT] = 0,
    [BINARY_SUBSCR_DICT] = 0,
    [BINARY_SUBSCR_GETITEM] = 0,
    [LIST_APPEND] = 0,
    [SET_ADD] = 0,
    [_SPECIALIZE_STORE_SUBSCR] = 1,
    [_STORE_SUBSCR] = 0,
    ...
    [STORE_NAME] = 0,
    [DELETE_NAME] = 0,
    [_SPECIALIZE_UNPACK_SEQUENCE] = 1,
    [_UNPACK_SEQUENCE] = 0,
    [UNPACK_SEQUENCE_TWO_TUPLE] = 0,
    [UNPACK_SEQUENCE_TUPLE] = 0,
    [UNPACK_SEQUENCE_LIST] = 0,
    [UNPACK_EX] = 0,
    [_SPECIALIZE_STORE_ATTR] = 1,
    [_STORE_ATTR] = 0,
    [DELETE_ATTR] = 0,
    [STORE_GLOBAL] = 0,
    [DELETE_GLOBAL] = 0,
    ...
    [LOAD_NAME] = 0,
    [_SPECIALIZE_LOAD_GLOBAL] = 1,
    [_LOAD_GLOBAL] = 0,
    [_GUARD_GLOBALS_VERSION] = 1,
    [_GUARD_BUILTINS_VERSION] = 1,
    [_LOAD_GLOBAL_MODULE] = 1,
    [_LOAD_GLOBAL_BUILTINS] = 1,
    [DELETE_FAST] = 0,
    [MAKE_CELL] = 0,
    [DELETE_DEREF] = 0,
    ...
    [_SPECIALIZE_LOAD_SUPER_ATTR] = 1,
    [_LOAD_SUPER_ATTR] = 0,
    [LOAD_SUPER_ATTR_ATTR] = 0,
    [LOAD_SUPER_ATTR_METHOD] = 0,
    [_SPECIALIZE_LOAD_ATTR] = 1,
    [_LOAD_ATTR] = 0,
    [_GUARD_TYPE_VERSION] = 2,
    [_CHECK_MANAGED_OBJECT_HAS_VALUES] = 0,
    [_LOAD_ATTR_INSTANCE_VALUE] = 1,
    [_CHECK_ATTR_MODULE] = 2,
    [_LOAD_ATTR_MODULE] = 1,
    ...
    [_STORE_ATTR_INSTANCE_VALUE] = 1,
    [STORE_ATTR_WITH_HINT] = -1,
    [_STORE_ATTR_SLOT] = 1,
    [_SPECIALIZE_COMPARE_OP] = 1,
    [_COMPARE_OP] = 0,
    [COMPARE_OP_FLOAT] = 0,
    [COMPARE_OP_INT] = 0,
    [COMPARE_OP_STR] = 0,
    ...
    [_GUARD_KEYS_VERSION] = 2,
    [_LOAD_ATTR_METHOD_WITH_VALUES] = 4,
    [_LOAD_ATTR_METHOD_NO_DICT] = 4,
    [_LOAD_ATTR_NONDESCRIPTOR_WITH_VALUES] = 4,
    [_LOAD_ATTR_NONDESCRIPTOR_NO_DICT] = 4,
    [_CHECK_ATTR_METHOD_LAZY_DICT] = 0,
    [_LOAD_ATTR_METHOD_LAZY_DICT] = 4,
    [INSTRUMENTED_CALL] = 0,
    [_SPECIALIZE_CALL] = 1,
    [_CALL] = 0,
    ...
    [_CHECK_PEP_523] = 0,
    [_CHECK_FUNCTION_EXACT_ARGS] = 2,
    [_CHECK_STACK_SPACE] = 0,
    [_INIT_CALL_PY_EXACT_ARGS] = 0,
    [_PUSH_FRAME] = 0,
    [CALL_PY_WITH_DEFAULTS] = 2,
    [CALL_TYPE_1] = 0,
    [CALL_STR_1] = 0,
    [CALL_TUPLE_1] = 0,
    [CALL_ALLOC_AND_ENTER_INIT] = 0,
    [EXIT_INIT_CHECK] = 0,
    [CALL_BUILTIN_CLASS] = 0,
    [CALL_BUILTIN_O] = 0,
    [CALL_BUILTIN_FAST] = 0,
    [CALL_BUILTIN_FAST_WITH_KEYWORDS] = 0,
    [CALL_LEN] = 0,
    [CALL_ISINSTANCE] = 0,
    [CALL_LIST_APPEND] = 0,
    [CALL_METHOD_DESCRIPTOR_O] = 0,
    [CALL_METHOD_DESCRIPTOR_FAST_WITH_KEYWORDS] = 0,
    [CALL_METHOD_DESCRIPTOR_NOARGS] = 0,
