...
const char * const _PyOpcode_uop_name[512] = {
    ...
    [_ITER_EXHAUSTED_LIST] = "_ITER_EXHAUSTED_LIST",
    [_ITER_NEXT_LIST] = "_ITER_NEXT_LIST",
    [_ITER_CHECK_TUPLE] = "_ITER_CHECK_TUPLE",
    [_ITER_EXHAUSTED_TUPLE] = "_ITER_EXHAUSTED_TUPLE",
