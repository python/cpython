...
const struct opcode_metadata _PyOpcode_opcode_metadata[268] = {
    ...
    [BINARY_OP_11] = { true, INSTR_FMT_IXC0, HAS_EXIT_FLAG | HAS_ESCAPES_FLAG },
    [BINARY_OP_1I] = { true, INSTR_FMT_IXC0, HAS_EXIT_FLAG | HAS_ESCAPES_FLAG },
    [BINARY_OP_1X] = { true, INSTR_FMT_IXC0, HAS_EXIT_FLAG | HAS_ESCAPES_FLAG },
    [BINARY_OP_I1] = { true, INSTR_FMT_IXC0, HAS_EXIT_FLAG | HAS_ESCAPES_FLAG },
    [BINARY_OP_II] = { true, INSTR_FMT_IXC0, HAS_EXIT_FLAG },
    [BINARY_OP_IX] = { true, INSTR_FMT_IXC0, HAS_EXIT_FLAG },
    [BINARY_OP_X1] = { true, INSTR_FMT_IXC0, HAS_EXIT_FLAG | HAS_ESCAPES_FLAG },
    [BINARY_OP_XI] = { true, INSTR_FMT_IXC0, HAS_EXIT_FLAG },
...
_PyOpcode_macro_expansion[256] = {
    ...
    [BINARY_OP_II] = { .nuops = 3, .uops = { { _GUARD_NOS_IMMORTAL, 0, 0 }, { _GUARD_TOS_IMMORTAL, 0, 0 }, { _BINARY_OP_TABLE_NN, 1, 1 } } },
    [BINARY_OP_IX] = { .nuops = 2, .uops = { { _GUARD_NOS_IMMORTAL, 0, 0 }, { _BINARY_OP_TABLE_ND, 1, 1 } } },
    [BINARY_OP_X1] = { .nuops = 2, .uops = { { _GUARD_TOS_REFCNT1, 0, 0 }, { _BINARY_OP_TABLE_DN, 1, 1 } } },
    [BINARY_OP_XI] = { .nuops = 2, .uops = { { _GUARD_TOS_IMMORTAL, 0, 0 }, { _BINARY_OP_TABLE_DN, 1, 1 } } },
    [BINARY_OP_XX] = { .nuops = 1, .uops = { { _BINARY_OP_TABLE_DD, 1, 1 } } },
