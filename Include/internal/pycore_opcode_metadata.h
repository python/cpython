...
const struct opcode_metadata _PyOpcode_opcode_metadata[267] = {
    ...
    [CALL_LIST_APPEND] = { true, INSTR_FMT_IBC00, HAS_ARG_FLAG | HAS_EXIT_FLAG | HAS_ERROR_FLAG | HAS_ERROR_NO_POP_FLAG | HAS_ESCAPES_FLAG },
    ...
    [STORE_SUBSCR_LIST_INT] = { true, INSTR_FMT_IXC, HAS_EXIT_FLAG | HAS_ESCAPES_FLAG },
    ...
    [UNPACK_SEQUENCE_LIST] = { true, INSTR_FMT_IBC, HAS_ARG_FLAG | HAS_EXIT_FLAG | HAS_ESCAPES_FLAG },
