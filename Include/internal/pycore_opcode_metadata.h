...
const struct opcode_metadata _PyOpcode_opcode_metadata[266] = {
    ...
    [END_SEND] = { true, INSTR_FMT_IX, HAS_ESCAPES_FLAG },
    ...
    [POP_TOP] = { true, INSTR_FMT_IX, HAS_ESCAPES_FLAG },
    ...
    [UNARY_INVERT] = { true, INSTR_FMT_IX, HAS_ERROR_FLAG | HAS_ESCAPES_FLAG | HAS_PURE_FLAG },
    [UNARY_NEGATIVE] = { true, INSTR_FMT_IX, HAS_ERROR_FLAG | HAS_ESCAPES_FLAG | HAS_PURE_FLAG },
