...
_PyOpcode_macro_expansion[256] = {
    ...
    [CALL_STR_1] = { .nuops = 1, .uops = { { _CALL_STR_1, OPARG_SIMPLE, 3 } } },
    [CALL_TUPLE_1] = { .nuops = 1, .uops = { { _CALL_TUPLE_1, OPARG_SIMPLE, 3 } } },
    ...
    [CHECK_PERIODIC] = { .nuops = 1, .uops = { { _CHECK_PERIODIC, OPARG_SIMPLE, 0 } } },
